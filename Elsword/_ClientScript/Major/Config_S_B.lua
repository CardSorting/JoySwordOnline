...
g_pMain:SetClientVersion_LUA( "N_20101215_A_SB" )
...
-- 채널 서버
g_pMain:AddChannelServerIP_LUA( "211.39.155.91" )
...
--X2Define에도 선언해줘야함
g_pFontManager:CreateNewUIUKFont( XUF_DODUM_11_NORMAL,		"2002L_KOG",			12, FONT_WEIGHT["FW_NORMAL"],	1	)
g_pFontManager:CreateNewUIUKFont( XUF_DODUM_13_SEMIBOLD,	"2002L_KOG",			14, FONT_WEIGHT["FW_NORMAL"], 1	)
g_pFontManager:CreateNewUIUKFont( XUF_DODUM_15_BOLD,		"2002L_KOG",			16, FONT_WEIGHT["FW_NORMAL"],		1	)
g_pFontManager:CreateNewUIUKFont( XUF_DODUM_20_BOLD,		"2002L_KOG",			21, FONT_WEIGHT["FW_NORMAL"],		1	)

g_pFontManager:CreateNewUIUKFont( XUF_HEADLINE_30_NORMAL,	"HY헤드라인M",	30, FONT_WEIGHT["FW_NORMAL"],	1	)
