...
{		
	...
	m_CommonMotion	= "Motion_EL_Common.x",
	m_FieldMotion	= "Motion_EL_Field.x",
	m_LobbyMotion	= "Motion_EL_Lobby.x",
	m_EmotionMotion	= "Motion_EL_Emotion.x",	

	m_GameMotion0	= "Motion_EL.x",
}
g_pUnitManager:AddUnitTemplet
{		
	unitType				= UNIT_TYPE["UT_ELESIS"],
