...
g_pBattleFieldManager:AddSpawnMonsterGroup
{
	...
	{
		MONSTER_ID					= NPC_UNIT_ID["NUI_ELDER_BRIDGE_GUARD_SMALL"],
		RATE						= 50,
		...
		PLAY_LINE_INDEX =
		{
			3, 4, 5, 6, 7, 15, 55, 56, 57, 58, 59, 60, 
			8, 9, 10, 11, 12, 13, 84, 85, 	
		},
	},
	{
		MONSTER_ID					= NPC_UNIT_ID["NUI_ELDER_BRIDGE_GUARD_BIG"],
		RATE						= 45,
		MAX_NUMBER_OF_THIS_MONSTER	= 2,
		ADD_LEVEL					= 1,
		DROP						= TRUE,
...
g_pBattleFieldManager:AddSpawnMonsterGroup
{
	...
	},
	{
		...
		PLAY_LINE_INDEX =
		{
			11, 12, 13, 84, 85, 102, 103, 105, 106, 107, 
...
g_pBattleFieldManager:AddSpawnMonsterGroup
{
	...
	{
		MONSTER_ID					= NPC_UNIT_ID["NUI_BENDERS_SCOUT_BIG"],
		RATE						= 45,
		MAX_NUMBER_OF_THIS_MONSTER	= 3,
		ADD_LEVEL					= 2,
		DROP						= TRUE,
...
g_pBattleFieldManager:AddSpawnMonsterGroup
{
	...
	{
		MONSTER_ID					= NPC_UNIT_ID["NUI_LOW_WATER_MUSHROOM_FD"],
		RATE						= 60,
		MAX_NUMBER_OF_THIS_MONSTER	= 2,
		ADD_LEVEL					= 0,
		DROP						= TRUE,
		...
		{
			53, 54, 
			81, 82, 83, 86, 87, 88, 89, 90, 91, 92, 93, 94, 
			110, 111, 
			97, 104, 
			98, 99, 100, 101, 
		},
	...
	{
		MONSTER_ID					= NPC_UNIT_ID["NUI_LOW_WATER_FAIRY_FD"],
		RATE						= 40,
		MAX_NUMBER_OF_THIS_MONSTER	= 2,
		ADD_LEVEL					= 1,
		DROP						= TRUE,
