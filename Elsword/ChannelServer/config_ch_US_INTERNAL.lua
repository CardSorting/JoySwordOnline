...
Server:AddScriptParsingErrReportMail( 'chonusftw@hotmail.com' )	-- 조효진
Server:AddScriptParsingErrReportMail( 'chonusftw@hotmail.com' ) -- 임규수
...
-- 점검 모드 IP 체크
SimLayer:AddCheckModeIP( "127.0.0.1" )
SimLayer:SetCheckModeCheckIPType( CIT_CHECK_IP_BLOCK )

-- 서비스 모드 IP 체크
SimLayer:AddIP( "127.0.0.1" )
...
-- OFFLINE: K3RComboAuthManager:AddWebServiceAddress( 'http://gamewcf.kill3rcombo.com:83/GameSecurityService.svc' )
