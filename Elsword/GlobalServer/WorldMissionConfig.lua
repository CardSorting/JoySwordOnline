...
------------------------------------------------------------------------------------------------[ 방학 세팅 ]
-- 월드 버프 지속 시간(초)
WorldMissionManager:SetWorldBuffDurationTime( 3600 )	-- 해외팀 버프 시간 변경 3600
...
WorldMissionManager:SetWorldBuffDurationTime( 3600 )	-- 해외팀 버프 시간 변경 43200
...
WorldMissionManager:SetWorldBuffDurationTime( 3600 )	-- 해외팀 버프 시간 변경 240
