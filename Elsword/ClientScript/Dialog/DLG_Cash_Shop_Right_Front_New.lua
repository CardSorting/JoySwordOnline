...
g_pButton_coupon:SetNormalPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(911-35,656)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButton_coupon:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(912-35,657)",
...
---------------------------현재 캐릭터가 장비중인 아이템도 모두 벗기
--- 오현빈 // 패치 예정 없는 테스트 코드입니다.
--- 서비스 리소스에 들어가면 안됩니다.
g_pButton = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton )
g_pButton:SetNormalTex( "DLG_Common_New_Texture51.TGA", "all_off_normal" )
g_pButton:SetOverTex( "DLG_Common_New_Texture51.TGA", "all_off_over" )
g_pButton:SetDownTex( "DLG_Common_New_Texture51.TGA", "all_off_over" )
g_pButton:SetNormalPoint
{
 	"LEFT_TOP		= D3DXVECTOR2(10+240,366)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton:SetOverPoint
{
	"LEFT_TOP		= D3DXVECTOR2(6+240,362)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(7+240,363)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton:SetCustomMsgMouseUp( CASH_SHOP_CUSTOM_UI_MSG["CSCUM_TAKE_OFF_ALL_ITEM_AND_INVEN_EQUIP_ITEM"] )
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
g_pRadioButtontab_Pet:SetNormalTex( "DLG_Common_New_Texture53.TGA", "OTHER_TAB_NORMAL" )
...
g_pRadioButtontab_Pet:SetRBPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(364+71+71+71+71+71+71+71,12)",
