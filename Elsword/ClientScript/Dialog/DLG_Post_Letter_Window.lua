...
g_pUIDialog:SetName( "DLG_Mail_View" )
...
g_pPicturepaper_window_BG1:SetTex( "DLG_Common_New_Texture67.TGA", "PAPER_WRITE" )
...
g_pPicturepaper_window_BG4:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(31,114-18)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStaticpaper_window:AddString
{
    MSG 			= STR_ID_11371, --"* 운영자 사칭 우편 주의!!!\n* 일반우편 입니다.\n* 운영자는 시스템우편만을 이용합니다.",
	FONT_INDEX		=  XUF_DODUM_13_SEMIBOLD,
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_LEFT"],
	"POS 			= D3DXVECTOR2(33,143-21)",
	"COLOR			= D3DXCOLOR(0.95,0.3,0.4,1.0)",
...
g_pPicturepaper_window_BG5:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(30,373+25)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturepaper_window_BG8:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(119,371+26)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
ADD_SIZE_X = -2,
ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(73+1,443+1)",
...
ADD_SIZE_Y = -2,
 	...
 	"LEFT_TOP		= D3DXVECTOR2(182+1,443+1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStaticpost_window_Font:AddString
{
	...
	"POS 			= D3DXVECTOR2(84,76-19)",
	"COLOR			= D3DXCOLOR(0.8,0.9,0.3,1.0)",
	"OUTLINE_COLOR		= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pIME_Edit_Message:SetTextPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(30,148+28)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(337,363-6+28)",
