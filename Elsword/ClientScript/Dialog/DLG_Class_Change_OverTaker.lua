...
g_pUIDialog:SetName( "DLG_Class_Change_OverTaker" )
...
g_pPictureChange_Class_OverTaker= g_pUIDialog:CreatePicture()
g_pStaticClass_Change1:AddPicture( g_pPictureChange_Class_OverTaker)

g_pPictureChange_Class_OverTaker:SetTex( "DLG_CC_Raven03.TGA", "CC_RAVEN03"  )

g_pPictureChange_Class_OverTaker:SetPoint
{
...
g_pPictureChange_Class_OverTaker2= g_pUIDialog:CreatePicture()
g_pStaticClass_Change1:AddPicture( g_pPictureChange_Class_OverTaker2)

g_pPictureChange_Class_OverTaker2:SetTex( "DLG_CC_Raven04.TGA", "CC_RAVEN04"  )

g_pPictureChange_Class_OverTaker2:SetPoint
{
...
g_pPictureChange_Class_OverTaker3= g_pUIDialog:CreatePicture()
g_pStaticClass_Change1:AddPicture( g_pPictureChange_Class_OverTaker3)

g_pPictureChange_Class_OverTaker3:SetTex( "DLG_CC_Raven05.TGA", "CC_RAVEN03_BOTTOM"  )

g_pPictureChange_Class_OverTaker3:SetPoint
{
...
g_pPictureChange_Class_OverTaker4= g_pUIDialog:CreatePicture()
g_pStaticClass_Change1:AddPicture( g_pPictureChange_Class_OverTaker4)

g_pPictureChange_Class_OverTaker4:SetTex( "DLG_CC_Raven05.TGA", "CC_RAVEN04_BOTTOM"  )

g_pPictureChange_Class_OverTaker4:SetPoint
{

		
	"LEFT_TOP		= D3DXVECTOR2(511+16,510+83-50-7)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
