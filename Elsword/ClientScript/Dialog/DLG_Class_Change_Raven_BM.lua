...
g_pPictureChange_Class_BALSDE_MASTER:SetTex( "DLG_CC_RAVEN_2ND_03.tga", "CC_RAVEN_03"  )
...
g_pPictureChange_Class_BALSDE_MASTER2:SetTex( "DLG_CC_RAVEN_2ND_04.tga", "CC_RAVEN_04"  )
...
g_pPictureChange_Class_BALSDE_MASTER3:SetTex( "DLG_CC_RAVEN_2ND_05.tga", "CC_RAVEN_03_BOTTOM"  )
...
g_pPictureChange_Class_BALSDE_MASTER4:SetTex( "DLG_CC_RAVEN_2ND_05.tga", "CC_RAVEN_04_BOTTOM"  )

g_pPictureChange_Class_BALSDE_MASTER4:SetPoint
{

		
	"LEFT_TOP		= D3DXVECTOR2(510+17,511+83-54)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
