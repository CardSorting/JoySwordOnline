...
g_pPicture_RED_BG = g_pUIDialog:CreatePicture() -- 0
...
----게이지
g_pPicture_RED_GAGE = g_pUIDialog:CreatePicture() -- 1
...
------------------기폭 차지
g_pPictureDetonation = g_pUIDialog:CreatePicture() -- 2
g_pStatic_EL_RED:AddPicture( g_pPictureDetonation )
g_pPictureDetonation:SetTex( "DLG_UI_Common_Texture16_NEW.tga", "EL_RED_2" )
g_pPictureDetonation:SetPoint
{
	"LEFT_TOP		= D3DXVECTOR2(101-1,72-1)",
...
----게이지_EFFECT
g_pPicture_RED_GAGE_EFFECT = g_pUIDialog:CreatePicture() -- 3
...
----반구슬
g_pPicture_RED_NORMAL = g_pUIDialog:CreatePicture() -- 4
...
----FULL구슬
g_pPicture_RED_FULL = g_pUIDialog:CreatePicture() -- 5
