...
{
	  ADD_SIZE_Y=-28,
	"LEFT_TOP		= D3DXVECTOR2(904+8,722)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonCharac:SetNormalTex( "DLG_UI_Button12.tga", "character_normal" )

g_pButtonCharac:SetOverTex( "DLG_UI_Button12.tga", "character_over" )

g_pButtonCharac:SetDownTex( "DLG_UI_Button12.tga", "character_over" )

g_pButtonCharac:SetDisableTex( "DLG_UI_Button12.tga", "character_noactive" )
...
g_pButtonInven:SetNormalTex( "DLG_UI_Button12.tga", "Inventory_normal" )

g_pButtonInven:SetOverTex( "DLG_UI_Button12.tga", "Inventory_over" )

g_pButtonInven:SetDownTex( "DLG_UI_Button12.tga", "Inventory_over" )

g_pButtonInven:SetDisableTex( "DLG_UI_Button12.tga", "Inventory_noactive" )

g_pButtonInven:SetNormalPoint
{
      

 	"LEFT_TOP		= D3DXVECTOR2(324,720)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonInven:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(317+1,713+1)",
...
g_pButtonSkill:SetNormalTex( "DLG_UI_Button12.tga", "Skill_normal" )

g_pButtonSkill:SetOverTex( "DLG_UI_Button12.tga", "Skill_over" )

g_pButtonSkill:SetDownTex( "DLG_UI_Button12.tga", "Skill_over" )

g_pButtonSkill:SetDisableTex( "DLG_UI_Button12.tga", "Skill_noactive" )

g_pButtonSkill:SetNormalPoint
{
      

 	"LEFT_TOP		= D3DXVECTOR2(368,720)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonSkill:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(361+1,713+1)",
...
g_pButtonQuest:SetNormalTex( "DLG_UI_Button12.tga", "Quest_normal" )

g_pButtonQuest:SetOverTex( "DLG_UI_Button12.tga", "Quest_over" )

g_pButtonQuest:SetDownTex( "DLG_UI_Button12.tga", "Quest_over" )

g_pButtonQuest:SetDisableTex( "DLG_UI_Button12.tga", "Quest_noactive" )

g_pButtonQuest:SetNormalPoint
{
      

 	"LEFT_TOP		= D3DXVECTOR2(412,720)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonQuest:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(405+1,713+1)",
...
g_pButtonParty:SetNormalTex( "DLG_UI_Button12.tga", "Party_normal" )

g_pButtonParty:SetOverTex( "DLG_UI_Button12.tga", "Party_over" )

g_pButtonParty:SetDownTex( "DLG_UI_Button12.tga", "Party_over" )

g_pButtonParty:SetDisableTex( "DLG_UI_Button12.tga", "Party_noactive" )

g_pButtonParty:SetNormalPoint
{
      

 	"LEFT_TOP		= D3DXVECTOR2(456,720)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonParty:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(449+1,713+1)",
...
g_pButtonParty:SetGuideDesc( STR_ID_2704 )
...
g_pButtonCommu:SetNormalTex( "DLG_UI_Button12.tga", "Community_normal" )

g_pButtonCommu:SetOverTex( "DLG_UI_Button12.tga", "Community_over" )

g_pButtonCommu:SetDownTex( "DLG_UI_Button12.tga", "Community_over" )

g_pButtonCommu:SetDisableTex( "DLG_UI_Button12.tga", "Community_noactive" )

g_pButtonCommu:SetNormalPoint
{
      

 	"LEFT_TOP		= D3DXVECTOR2(499,720)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonCommu:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(493+1,713+1)",
...
g_pButtonsystem:SetNormalTex( "DLG_UI_Button12.tga", "system_normal" )

g_pButtonsystem:SetOverTex( "DLG_UI_Button12.tga", "system_over" )

g_pButtonsystem:SetDownTex( "DLG_UI_Button12.tga", "system_over" )

g_pButtonsystem:SetDisableTex( "DLG_UI_Button12.tga", "system_noactive" )

g_pButtonsystem:SetNormalPoint
{
      

 	"LEFT_TOP		= D3DXVECTOR2(544,720)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonsystem:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(537+1,713+1)",
...
g_pButtonCash:SetNormalTex( "DLG_UI_Button12.tga", "Cash_shop_normal" )

g_pButtonCash:SetOverTex( "DLG_UI_Button12.tga", "Cash_shop_over" )

g_pButtonCash:SetDownTex( "DLG_UI_Button12.tga", "Cash_shop_over" )

g_pButtonCash:SetDisableTex( "DLG_UI_Button12.tga", "Cash_shop_noactive" )

g_pButtonCash:SetNormalPoint
{
      

 	"LEFT_TOP		= D3DXVECTOR2(588,720)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonCash:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(581+1,713+1)",
