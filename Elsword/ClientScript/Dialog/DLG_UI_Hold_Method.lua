...
g_pUIDialog:SetName( "DLG_UI_HOLD_METHOD" )
...
g_pUIDialog:SetCloseCustomUIEventID( SKILL_TREE_UI_CUSTOM_UI_MSG["STUCUM_SELECT_SKILL_CHARGE_MODE_CANCEL"] )
...
g_pStatic_hold = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_hold )
g_pStatic_hold:SetName( "g_pStatic_hold" )



g_pPictureWindow1 = g_pUIDialog:CreatePicture()
g_pStatic_hold:AddPicture( g_pPictureWindow1 )

g_pPictureWindow1:SetTex( "DLG_UI_Common_Texture06.tga", "hold_method" )
...
g_pButton_chois:SetNormalPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(145,379+82)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_chois:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(142.5,376+82)",
...
g_pButton_chois:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(142.5+1,376+1+82)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_chois:SetCustomMsgMouseUp( SKILL_TREE_UI_CUSTOM_UI_MSG["STUCUM_SELECT_SKILL_CHARGE_MODE_OK"] )
...
g_pButton_cancle:SetNormalPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(235,379+82)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_cancle:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(232,376+82)",
...
g_pButton_cancle:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(232+1,376+1+82)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_cancle:SetCustomMsgMouseUp( SKILL_TREE_UI_CUSTOM_UI_MSG["STUCUM_SELECT_SKILL_CHARGE_MODE_CANCEL"] )
