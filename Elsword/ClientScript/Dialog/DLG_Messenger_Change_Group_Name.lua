...
g_pUIDialog:SetCloseCustomUIEventID( X2_MESSENGER_CUSTOM_UI_MSG["XMCUM_MGR_CHANGE_GROUP_NAME_EXIT"] )
...
g_pPictureMaking_Group_Title:SetTex( "DLG_Common_New_Texture04.tga", "GroupReName_Title"  )
...
g_pPictureMaking_Group_Text:SetTex( "DLG_Common_New_Texture04.tga", "NewGroup_Font"  )
...
g_pButtonConfirm:SetName( "confirmok" )
...
g_pButtonConfirm:SetCustomMsgMouseUp( X2_MESSENGER_CUSTOM_UI_MSG["XMCUM_MGR_CHANGE_GROUP_NAME_OK"] )
...
g_pButtonX:SetCustomMsgMouseUp( X2_MESSENGER_CUSTOM_UI_MSG["XMCUM_MGR_CHANGE_GROUP_NAME_EXIT"] )



g_pIMEEditBoxGroupName = g_pUIDialog:CreateIMEEditBox()
g_pUIDialog:AddControl( g_pIMEEditBoxGroupName )
g_pIMEEditBoxGroupName:SetName( "IMEEditBoxChangeGroupName" )
g_pIMEEditBoxGroupName:SetTextPoint
{
	USE_TEXTURE_SIZE= FALSE,
	"LEFT_TOP		= D3DXVECTOR2(118,81)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(352,98)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pIMEEditBoxGroupName:SetTabControlName( "IMEEditBoxChangeGroupName" )
