...
g_pButtonMenu1:SetNormalTex( "DLG_Common_Texture24.TGA", "Unit_Back_Normal" )
g_pButtonMenu1:SetOverTex( "DLG_Common_Texture24.TGA", "Unit_Back_Over" )
g_pButtonMenu1:SetDownTex( "DLG_Common_Texture24.TGA", "Unit_Back_Over" )
g_pButtonMenu1:SetNormalPoint
{
	"LEFT_TOP	= D3DXVECTOR2(75,721)",
...
g_pButtonCreate_Box:SetNormalTex( "DLG_Common_Texture24.TGA", "Unit_Create_Normal" )
g_pButtonCreate_Box:SetOverTex( "DLG_Common_Texture24.TGA", "Unit_Create_Over" )
g_pButtonCreate_Box:SetDownTex( "DLG_Common_Texture24.TGA", "Unit_Create_Over" )
g_pButtonCreate_Box:SetNormalPoint
{
	"LEFT_TOP	= D3DXVECTOR2(316,480)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
g_pButtonCreate_Box:SetOverPoint
{
	"LEFT_TOP	= D3DXVECTOR2(316-4,480-5)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
g_pButtonCreate_Box:SetDownPoint
{
	ADD_SIZE_X	= -2,
	ADD_SIZE_Y	= -2,
	"LEFT_TOP	= D3DXVECTOR2(316-3,480-4)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
