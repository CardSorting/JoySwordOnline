...
g_pStaticID = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticID )
g_pStaticID:SetName( "resurrectionNum" )
...
g_pStaticHP_Point_Left = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticHP_Point_Left )
g_pStaticHP_Point_Left:SetName( "HP_Point" )

g_pStaticHP_Point_Left:AddString
{
	-- MSG 			= "999999",
