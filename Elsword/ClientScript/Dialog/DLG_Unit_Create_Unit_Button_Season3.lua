...
g_pPicture:SetTex( "DLG_UI_Common_Texture69_NEW.tga", "NEW_TEXT" )
g_pPicture:SetPoint
{
...
g_pPicture = g_pUIDialog:CreatePicture()
g_pStatic_NewCharacter:AddPicture( g_pPicture )
g_pPicture:SetTex( "DLG_Common_Texture_INT_TW01.tga", "NEW" )
g_pPicture:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2(882+20,557-40)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}

g_pStatic_NewCharacter2 = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_NewCharacter2 )
g_pStatic_NewCharacter:SetName( "g_pStatic_NewCharacter2" )

g_pPicture = g_pUIDialog:CreatePicture()
g_pStatic_NewCharacter2:AddPicture( g_pPicture )
g_pPicture:SetTex( "DLG_Common_Texture_INT_TW01.tga", "SPECIAL_ITEM_TEXT" )
g_pPicture:SetPoint
{
	ADD_SIZE_X	= -40,
	ADD_SIZE_Y	= -10,
	"LEFT_TOP	= D3DXVECTOR2(882-55-100,557-10)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
--]]
...
--[[
--아라 머리위에 Comming_soon
-- 12/9 패치 이후 요 아래는 다 지워주세요
g_pStatic_NewCharacter = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_NewCharacter )
g_pStatic_NewCharacter:SetName( "g_pStatic_NewCharacter" )
...
g_pPicture = g_pUIDialog:CreatePicture()
g_pStatic_NewCharacter:AddPicture( g_pPicture )
g_pPicture:SetTex( "DLG_Common_New_Texture_US01.tga", "comming_soon" )
g_pPicture:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2(882,547)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
...
g_pRadioButtonAra_Slot:SetEnable(false)
--]]