...
-- #ifdef HACKSHIELD_RULE_AGREEMENT
...
g_pPicture_title:SetTex( "DLG_UI_Title_EU01.tga", "HACKSHIELD_AGREEMENT_TITLE" )
...
g_pButtonOK:SetCustomMsgMouseUp( STATE_LOGIN_UI_CUSTOM_MSG["SLUCM_HACKSHIELD_RULE_AGREEMENT"] )
...
-- #endif HACKSHIELD_RULE_AGREEMENT