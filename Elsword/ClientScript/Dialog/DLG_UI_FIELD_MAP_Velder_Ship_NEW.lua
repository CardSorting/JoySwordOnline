...
g_pUIDialog:SetName( "DLG_UI_FIELD_MAP_VELDER_Ship" )
...
-- 지도 부분
g_pStaticVelder_Ship = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticVelder_Ship )
g_pStaticVelder_Ship:SetName( "Velder_Ship" )

g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Ship:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Ship_01.DDS", "VELDER_Ship_01" ) 
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Ship:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Ship_02.DDS", "VELDER_Ship_02" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Ship:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Ship_03.DDS", "VELDER_Ship_03" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Ship:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Ship_04.DDS", "VELDER_Ship_04" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Ship:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Ship_04.DDS", "VELDER_Ship_05" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Ship:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Ship_05.DDS", "VELDER_Ship_06" ) 
g_pPicture_bg1:SetPoint
{
...
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 105-1, 243-2 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 2,
 	"LEFT_TOP	= D3DXVECTOR2( 100+3, 243 )",
    "COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 1360-1, 435-1 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
