...
g_pStatic_POPUP_RURIEL = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_POPUP_RURIEL )
g_pStatic_POPUP_RURIEL:SetName( "RURIEL" )


----------루리엘
g_pPicture_POPUP_RURIEL = g_pUIDialog:CreatePicture()
g_pStatic_POPUP_RURIEL:AddPicture( g_pPicture_POPUP_RURIEL )
g_pPicture_POPUP_RURIEL:SetTex( "ARIEL_RURIEL.tga", "RURIEL_BG" )
g_pPicture_POPUP_RURIEL:SetPoint
{
...
g_pPicture_POPUP_RURIEL = g_pUIDialog:CreatePicture()
g_pStatic_POPUP_RURIEL:AddPicture( g_pPicture_POPUP_RURIEL )
g_pPicture_POPUP_RURIEL:SetTex( "POPUP_BOX_RURIEL.tga", "POPUP_BOX_RURIEL" )
g_pPicture_POPUP_RURIEL:SetPoint
{
...
g_pPicture_POPUP_ARIEL:SetName( "POPUP_RURIEL_Text" )
...
g_pButton_Close:SetName( "POPUP_RURIEL_Button_Close" )
