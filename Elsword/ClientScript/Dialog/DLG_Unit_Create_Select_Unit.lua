...
g_pPictureCharacter_Create_Font_Elsword:SetTex( "DLG_Common_Texture24.tga", "Elsword_Title" )

g_pPictureCharacter_Create_Font_Elsword:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(70,59)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPictureElsword_Title = g_pUIDialog:CreatePicture()
g_pStaticUnit_Create:AddPicture( g_pPictureElsword_Title )

g_pPictureElsword_Title:SetTex( "DLG_Common_Texture04.tga", "Ardentboy" )

g_pPictureElsword_Title:SetPoint
{
...
g_pPictureElsword_SubTitle = g_pUIDialog:CreatePicture()
g_pStaticUnit_Create:AddPicture( g_pPictureElsword_SubTitle )

g_pPictureElsword_SubTitle:SetTex( "DLG_Common_Texture04.tga", "Elsword" )

g_pPictureElsword_SubTitle:SetPoint
{
...
g_pPictureCharacter_Create_Font_Aisha:SetTex( "DLG_Common_Texture24.tga", "Aisha_Title" )
...
g_pPictureAisha_Title = g_pUIDialog:CreatePicture()
g_pStaticUnit_Create:AddPicture( g_pPictureAisha_Title )

g_pPictureAisha_Title:SetTex( "DLG_Common_Texture04.tga", "Vivacious_Aisha" )

g_pPictureAisha_Title:SetPoint
{
...
g_pPictureAisha_SubTitle = g_pUIDialog:CreatePicture()
g_pStaticUnit_Create:AddPicture( g_pPictureAisha_SubTitle )

g_pPictureAisha_SubTitle:SetTex( "DLG_Common_Texture04.tga", "Aisha" )

g_pPictureAisha_SubTitle:SetPoint
{
...
g_pPictureCharacter_Create_Font_Rena:SetTex( "DLG_Common_Texture24.tga", "Rena_Title" )
...
g_pPictureRena_Title = g_pUIDialog:CreatePicture()
g_pStaticUnit_Create:AddPicture( g_pPictureRena_Title )

g_pPictureRena_Title:SetTex( "DLG_Common_Texture04.tga", "Dispassionate" )

g_pPictureRena_Title:SetPoint
{
...
g_pPictureRena_SubTitle = g_pUIDialog:CreatePicture()
g_pStaticUnit_Create:AddPicture( g_pPictureRena_SubTitle )

g_pPictureRena_SubTitle:SetTex( "DLG_Common_Texture04.tga", "Rena" )

g_pPictureRena_SubTitle:SetPoint
{
...
g_pPictureCharacter_Create_Font_RAVEN:SetTex( "DLG_Common_Texture24.tga", "RAVEN_Title" )
...
g_pPictureRAVEN_Title:SetTex( "DLG_Common_New_Texture58.tga", "VENGEFUL" )
...
g_pPictureRaven_SubTitle = g_pUIDialog:CreatePicture()
g_pStaticUnit_Create:AddPicture( g_pPictureRaven_SubTitle )

g_pPictureRaven_SubTitle:SetTex( "DLG_Common_New_Texture58.tga", "RAVEN" )

g_pPictureRaven_SubTitle:SetPoint
{
...
g_pPictureCharacter_Create_Font_Eve:SetTex( "DLG_Common_Texture24.tga", "EVE_Title" )
...
g_pPictureCharacter_Create_Font_Chung:SetTex( "DLG_Common_Texture24.tga", "Chung_Title" )
...
g_pPictureChung_SubTitle = g_pUIDialog:CreatePicture()
g_pStaticUnit_Create:AddPicture( g_pPictureChung_SubTitle )

g_pPictureChung_SubTitle:SetTex( "DLG_Common_Texture21.tga", "Chung_name" )

g_pPictureChung_SubTitle:SetPoint
{
...
g_pStaticUnit_Create:AddString
{
 	...
 	FONT_INDEX      = XUF_DODUM_15B_BOLD,
 	SORT_FLAG       = DRAW_TEXT["DT_LEFT"],
 	"POS            = D3DXVECTOR2(508,279-5-20+5)",
 	"COLOR          = D3DXCOLOR(0.1,0.5,0.7,1.0)",
	"OUTLINE_COLOR  = D3DXCOLOR(0.0,0.0,0.0,1.0)",
	}
...
g_pPictureCharacter_Create_Font_Ara = g_pUIDialog:CreatePicture()
g_pStaticUnit_Create:AddPicture( g_pPictureCharacter_Create_Font_Ara )
g_pPictureCharacter_Create_Font_Ara:SetTex( "DLG_Common_Texture24.tga", "EVE_Title" )
g_pPictureCharacter_Create_Font_Ara:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2(70,59)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
...
g_pPictureUnit_Ara:SetTex( "DLG_UI_Character02.tga", "Eve" )
