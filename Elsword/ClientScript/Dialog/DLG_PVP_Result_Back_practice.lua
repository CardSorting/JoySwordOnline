...
g_pPicturePVP_Result_InfoBgRed1_Text:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(432-90,503)",
...
g_pPicturePVP_Result_InfoBgBlue1_Text:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(408-90,629)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.1)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturePVP_Result_InfoBgBlue2_Text:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(408-90,503)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.1)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturePVP_Result_InfoBgRed2_Text:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(432-90,629)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.1)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturePVP_Result_InfoBgDraw1:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(370-90,558)",
...
g_pPicturePVP_Result_InfoBg1:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(106+15,427)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturePVP_Result_InfoBg2:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(106+432-35,427)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
         ADD_SIZE_X = 350,
	"LEFT_TOP		= D3DXVECTOR2(145+15,427)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturePVP_Result_Rank:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(257-40,449)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturePVP_Result_Nick_Name:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(197+100+20,449)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturePVP_Result_Nick_Name:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(321+90+20,449)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturePVP_Result_Death:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(321+250+20,449)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
