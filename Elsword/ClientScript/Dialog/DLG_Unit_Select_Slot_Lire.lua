...
g_pStaticUnit_Select_Slot_White:SetName( "Unit_Select1" )
...
g_pStaticUnit_Select_Slot_Yellow_Down:SetName( "Unit_Select3" )
...
g_pButtonUnit_Slot_White:SetName( "ButtonSlot_Lire" )
