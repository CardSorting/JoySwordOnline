...
g_pPicturePVP_Result_Info_Rank_Icon3:SetTex( "DLG_Common_Emblem00.tga", "PE_RANK_ARRANGING" )

g_pPicturePVP_Result_Info_Rank_Icon3:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(257-75,3)",
...
g_pPicturePVP_Result_Info_PCROOM:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(152+110,1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
