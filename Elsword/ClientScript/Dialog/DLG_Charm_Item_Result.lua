...
g_pPicture_BG1:SetTex( "DLG_UI_Common_Texture04.TGA", "ice_heater_result_bg_top" )
...
g_pPicture_BG1:SetTex( "DLG_UI_Common_Texture04.TGA", "ice_heater_result_bg_middle" )
...
g_pPicture_BG1:SetTex( "DLG_UI_Common_Texture04.TGA", "ice_heater_result_bg_bottom" )

g_pPicture_BG1:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(0,258)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStaticIce_Heater_Result:AddPicture( g_pPicture_BG2 )

g_pPicture_BG2:SetTex( "DLG_UI_Common_Texture04.TGA", "ice_heater_result_bg2_left" )

g_pPicture_BG2:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(13,71)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_BG2:SetTex( "DLG_UI_Common_Texture04.TGA", "ice_heater_result_bg2_middle" )

g_pPicture_BG2:SetPoint
{
     ADD_SIZE_X = 361,
	"LEFT_TOP		= D3DXVECTOR2(22,71)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_BG2:SetTex( "DLG_UI_Common_Texture04.TGA", "ice_heater_result_bg2_right" )

g_pPicture_BG2:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(384,71)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStaticIce_Heater_Result:AddPicture( g_pPicture_bg3 )
...
g_pStaticIce_Heater_Result:AddPicture( g_pPicture_bg4 )

g_pPicture_bg4:SetTex( "DLG_UI_Common_Texture01.TGA", "apart_bg3_left" )

g_pPicture_bg4:SetPoint
{
    
	"LEFT_TOP		= D3DXVECTOR2(17,144)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_bg4:SetTex( "DLG_UI_Common_Texture01.TGA", "apart_bg3_middle" )

g_pPicture_bg4:SetPoint
{
    ADD_SIZE_X = 358,
	"LEFT_TOP		= D3DXVECTOR2(24,144)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_bg4:SetTex( "DLG_UI_Common_Texture01.TGA", "apart_bg3_right" )

g_pPicture_bg4:SetPoint
{
    
	"LEFT_TOP		= D3DXVECTOR2(382,144)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPictureTitle:SetTex( "DLG_UI_Title02.TGA", "heater_title" )
...
g_pStaticIce_Heater_Result:AddPicture( g_pPictureBar)
...
g_pPictureBonus_Item = g_pUIDialog:CreatePicture()
g_pStatic_charm_item_result:AddPicture( g_pPictureBonus_Item )

g_pPictureBonus_Item:SetTex( "DLG_UI_Common_Texture02.TGA", "slot" )

g_pPictureBonus_Item:SetPoint
{
...
g_pStaticIce_Heater_Result:AddPicture( g_pPictureBar3)

g_pPictureBar3:SetTex( "DLG_UI_Common_Texture01.TGA", "bar2" )

g_pPictureBar3:SetPoint
{
     ADD_SIZE_Y = 55,
	"LEFT_TOP		= D3DXVECTOR2(80,149)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonOK:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(156+1,220+1)",
