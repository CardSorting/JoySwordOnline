...
g_pPictureChange_Class_CodeExotic= g_pUIDialog:CreatePicture()
g_pStaticClass_Change1:AddPicture( g_pPictureChange_Class_CodeExotic)

g_pPictureChange_Class_CodeExotic:SetTex( "DLG_CC_Eve01.TGA", "CC_EVE_01"  )

g_pPictureChange_Class_CodeExotic:SetPoint
{
...
g_pPictureChange_Class_CodeExotic2= g_pUIDialog:CreatePicture()
g_pStaticClass_Change1:AddPicture( g_pPictureChange_Class_CodeExotic2)

g_pPictureChange_Class_CodeExotic2:SetTex( "DLG_CC_Eve02.TGA", "CC_EVE_02"  )

g_pPictureChange_Class_CodeExotic2:SetPoint
{
...
g_pPictureChange_Class_CodeExotic3= g_pUIDialog:CreatePicture()
g_pStaticClass_Change1:AddPicture( g_pPictureChange_Class_CodeExotic3)

g_pPictureChange_Class_CodeExotic3:SetTex( "DLG_CC_Eve05.TGA", "CC_EVE_01_BOTTOM"  )

g_pPictureChange_Class_CodeExotic3:SetPoint
{
...
g_pPictureChange_Class_CodeExotic4= g_pUIDialog:CreatePicture()
g_pStaticClass_Change1:AddPicture( g_pPictureChange_Class_CodeExotic4)

g_pPictureChange_Class_CodeExotic4:SetTex( "DLG_CC_Eve05.TGA", "CC_EVE_02_BOTTOM"  )

g_pPictureChange_Class_CodeExotic4:SetPoint
{
