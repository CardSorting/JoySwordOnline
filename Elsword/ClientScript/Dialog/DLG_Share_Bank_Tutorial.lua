...
g_pPicturePVP_PR_1:SetTex( "DLG_SHARE_BANK_PR1.tga", "PVP_PR_1"  )
...
g_pPicturePVP_PR_2_1:SetTex( "DLG_SHARE_BANK_PR2.tga", "PVP_PR2_1"  )

g_pPicturePVP_PR_2_1:SetPoint
{


	"LEFT_TOP		= D3DXVECTOR2(212+509,54)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturePVP_PR_2_2:SetTex( "DLG_SHARE_BANK_PR2.tga", "PVP_PR2_2"  )

g_pPicturePVP_PR_2_2:SetPoint
{


	"LEFT_TOP		= D3DXVECTOR2(212-2,54+511)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturePVP_PR_2_3:SetTex( "DLG_SHARE_BANK_PR2.tga", "PVP_PR2_3"  )

g_pPicturePVP_PR_2_3:SetPoint
{


	"LEFT_TOP		= D3DXVECTOR2(212+450-19+1+75,54+511)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonPVP_PR_Right_Enter:SetNormalPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(646+130-35,562+65)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonPVP_PR_Right_Enter:SetDownPoint
{
    ADD_SIZE_X = -2,
    ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(646+130+1-35,562+1+65)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonPVP_PR_Right_Enter:SetCustomMsgMouseUp( CLASS_CHANGE_UI_CUSTOM_MSG["CCUCM_STATE_CHANGE_VILLAGE"] )
