...
g_pPictureBase_Info_Stone_Icon:SetTex( "DLG_UI_Common_Texture64_NEW.TGA", "Stone_Icon" )
g_pPictureBase_Info_Stone_Icon:SetPoint
{
	"LEFT_TOP		= D3DXVECTOR2(278,9)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	--MSG    		= "9999",
 	FONT_INDEX	= XUF_DODUM_13_SEMIBOLSD,
 	FONT_STYLE	= FONT_STYLE["FS_SHELL"],
 	SORT_FLAG		= DRAW_TEXT["DT_LEFT"],
 	"POS				= D3DXVECTOR2(287+13,17)",
