...
g_pUIDialog:SetCloseCustomUIEventID( UI_INVENTORY_MSG["UIM_RECOMMEND_CANCEL"] )
...
g_pButton_OK:SetNormalTex( "DLG_Common_New_Texture37_A.tga", "add_Nominator_normal" )

g_pButton_OK:SetOverTex( "DLG_Common_New_Texture37_A.tga", "add_Nominator_over" )

g_pButton_OK:SetDownTex( "DLG_Common_New_Texture37_A.tga", "add_Nominator_over" )
...
g_pButton_OK:SetCustomMsgMouseUp( UI_INVENTORY_MSG["UIM_RECOMMEND_OK"] )
...
g_pButtonX:SetCustomMsgMouseUp( UI_INVENTORY_MSG["UIM_RECOMMEND_CANCEL"] )
