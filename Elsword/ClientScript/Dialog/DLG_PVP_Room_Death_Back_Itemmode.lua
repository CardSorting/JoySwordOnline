...
g_pUIDialog:SetName( "DLG_PVP_Room_Death_Back" )
...
g_pUIDialog:AddDummyPos( D3DXVECTOR3( -30, 15, 2000 ) )
...
------------(서바이벌 백 그라운드)
g_pStaticPVP_Room_Survival_BG = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticPVP_Room_Survival_BG )
g_pStaticPVP_Room_Survival_BG:SetName( "Background1" )


g_pPicturePVP_Room_Survival_Bg1_1 = g_pUIDialog:CreatePicture()
g_pStaticPVP_Room_Survival_BG:AddPicture( g_pPicturePVP_Room_Survival_Bg1_1 )

g_pPicturePVP_Room_Survival_Bg1_1:SetTex( "DLG_Common_New_Texture50.TGA", "PVP_Survival_BG1" )
...
g_pStaticPVP_Room_Survival_BG:AddPicture( g_pPicturePVP_Room_Survival_Bg1_2 )

g_pPicturePVP_Room_Survival_Bg1_2:SetTex( "DLG_Common_New_Texture50.TGA", "PVP_Survival_BG2" )
...
g_pStaticPVP_Room_Survival_BG:AddPicture( g_pPicturePVP_Room_Survival_Bg1_3 )

g_pPicturePVP_Room_Survival_Bg1_3:SetTex( "DLG_Common_New_Texture50.TGA", "PVP_Survival_BG3" )
...
g_pStaticPVP_Room_Survival_BG:AddPicture( g_pPicturePVP_Room_Survival_Bg2 )

g_pPicturePVP_Room_Survival_Bg2:SetTex( "DLG_Common_New_Texture50.TGA", "PVP_Survival_BG1" )
...
g_pStaticPVP_Room_Survival_BG:AddPicture( g_pPicturePVP_Room_Survival_Bg2_1 )

g_pPicturePVP_Room_Survival_Bg2_1:SetTex( "DLG_Common_New_Texture50.TGA", "PVP_Survival_BG2" )

g_pPicturePVP_Room_Survival_Bg2_1:SetPoint
{
    ADD_SIZE_X = 715-26+20,
    ADD_SIZE_Y=-8,
	"LEFT_TOP		= D3DXVECTOR2(264+16-2,388)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}

g_pPicturePVP_Room_Survival_Bg2_2 = g_pUIDialog:CreatePicture()
g_pStaticPVP_Room_Survival_BG:AddPicture( g_pPicturePVP_Room_Survival_Bg2_2 )

g_pPicturePVP_Room_Survival_Bg2_2:SetTex( "DLG_Common_New_Texture50.TGA", "PVP_Survival_BG3" )
...
g_pPicturePVP_Room_Control_Bg2 = g_pUIDialog:CreatePicture()
g_pStaticPVP_Room_Control_Window:AddPicture( g_pPicturePVP_Room_Control_Bg2 )

g_pPicturePVP_Room_Control_Bg2:SetTex( "DLG_Common_New_Texture09.TGA", "PVP_Bg_Plus" )

g_pPicturePVP_Room_Control_Bg2:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(779+13,51+155)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pIMEPVP_Room_Name = g_pUIDialog:CreateIMEEditBox()
g_pUIDialog:AddControl( g_pIMEPVP_Room_Name )
g_pIMEPVP_Room_Name:SetName( "IMEPVP_Room_Name" )
g_pIMEPVP_Room_Name:SetTextPoint
{
	USE_TEXTURE_SIZE= FALSE,
	"LEFT_TOP		= D3DXVECTOR2(295-60,20)",
	"RIGHT_BOTTOM		= D3DXVECTOR2(295-60+450,20+18)",
	"COLOR			= D3DXCOLOR(0.0,0.0,0.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pIMEPVP_Room_Name:SetFont( XUF_DODUM_11_NORMAL )
g_pIMEPVP_Room_Name:SetTextColor( 1.0, 1.0, 1.0, 1.0 )
g_pIMEPVP_Room_Name:SetSelectedTextColor( 1.0, 1.0, 1.0, 1.0 )
g_pIMEPVP_Room_Name:SetSelectedBackColor( 0.7, 0.0, 0.0, 1.0 )
g_pIMEPVP_Room_Name:SetCaretColor( 1.0, 1.0, 1.0, 1.0 )
g_pIMEPVP_Room_Name:SetCustomMsgEnter( PVP_ROOM_UI_CUSTOM_MSG["PRUCM_CHANGE_PVP_ROOM_NAME_OK"] )
g_pIMEPVP_Room_Name:SetCustomMsgFocusOut( PVP_ROOM_UI_CUSTOM_MSG["PRUCM_CHANGE_PVP_ROOM_NAME_OK"] )
g_pIMEPVP_Room_Name:SetByteLimit( 40 )
...
IncludeLua( "DLG_PVP_Room_Button_ItemMode.lua" )
...
g_pPicturePractice_Channel_Notice:SetTex( "DLG_Common_New_Texture09.tga", "CHANNEL" )

g_pPicturePractice_Channel_Notice:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(797,69)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButton_Channel_practice_Left_Triangle = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_Channel_practice_Left_Triangle )
g_pButton_Channel_practice_Left_Triangle:SetName( "PVP_Room_Practice_Item_LeftArrow" )
g_pButton_Channel_practice_Left_Triangle:SetNormalTex( "DLG_Common_New_Texture10.TGA", "LeftArrow_Normal" )

g_pButton_Channel_practice_Left_Triangle:SetOverTex( "DLG_Common_New_Texture10.TGA", "LeftArrow_Over" )

g_pButton_Channel_practice_Left_Triangle:SetDownTex( "DLG_Common_New_Texture10.TGA", "LeftArrow_Normal" )

g_pButton_Channel_practice_Left_Triangle:SetNormalPoint
{

 	"LEFT_TOP		= D3DXVECTOR2(876.7,114)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Channel_practice_Left_Triangle:SetOverPoint
{

	"LEFT_TOP		= D3DXVECTOR2(874.7,112)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Channel_practice_Left_Triangle:SetDownPoint
{
...
g_pButton_Channel_practice_Left_Triangle:SetCustomMsgMouseUp( PVP_ROOM_UI_CUSTOM_MSG["PRUCM_CHANGE_PVP_ITEMMODE"] )

--버튼2

g_pButton_Channel_practice_Right_Triangle = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_Channel_practice_Right_Triangle )
g_pButton_Channel_practice_Right_Triangle:SetName( "PVP_Room_Practice_Item_RightArrow" )
g_pButton_Channel_practice_Right_Triangle:SetNormalTex( "DLG_Common_New_Texture10.TGA", "RightArrow_Normal" )

g_pButton_Channel_practice_Right_Triangle:SetOverTex( "DLG_Common_New_Texture10.TGA", "RightArrow_Over" )

g_pButton_Channel_practice_Right_Triangle:SetDownTex( "DLG_Common_New_Texture10.TGA", "RightArrow_Normal" )

g_pButton_Channel_practice_Right_Triangle:SetNormalPoint
{

 	"LEFT_TOP		= D3DXVECTOR2(880-12+84+9.5,114)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Channel_practice_Right_Triangle:SetOverPoint
{

	"LEFT_TOP		= D3DXVECTOR2(878-12+84+9.5,112)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Channel_practice_Right_Triangle:SetDownPoint
{
...
g_pButton_Channel_practice_Right_Triangle:SetCustomMsgMouseUp( PVP_ROOM_UI_CUSTOM_MSG["PRUCM_CHANGE_PVP_ITEMMODE"] )