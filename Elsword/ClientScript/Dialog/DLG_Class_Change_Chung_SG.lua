...
g_pPictureChange_Class_BALSDE_MASTER:SetTex( "DLG_CC_Chung03.tga", "cc_chung03"  )
...
g_pPictureChange_Class_BALSDE_MASTER2:SetTex( "DLG_CC_Chung04.tga", "CC_CHUNG04"  )
...
g_pPictureChange_Class_BALSDE_MASTER3:SetTex( "DLG_CC_Chung05.tga", "cc_chung03_bottom"  )
...
g_pPictureChange_Class_BALSDE_MASTER4:SetTex( "DLG_CC_Chung05.tga", "cc_chung04_bottom"  )

g_pPictureChange_Class_BALSDE_MASTER4:SetPoint
{

		
	"LEFT_TOP		= D3DXVECTOR2(510+17,511+83-58)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
