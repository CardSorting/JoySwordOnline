...
g_pPicturePVP_Result_User_Box4th = g_pUIDialog:CreatePicture()
g_pStaticPVP_Result_Info_Bg_Rank:AddPicture( g_pPicturePVP_Result_User_Box4th )
g_pPicturePVP_Result_User_Box4th:SetTex( "DLG_Common_Texture24.tga", "PVP_Result_4th" )
g_pPicturePVP_Result_User_Box4th:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2(-5,9)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}