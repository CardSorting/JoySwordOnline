...
g_pStaticUnit_Select_Slot_White:SetName( "gasdfasdfasdf" )
...
g_pPictureUnKnow_Mark_Yellow = g_pUIDialog:CreatePicture()
g_pStaticUnit_Select_Slot_White:AddPicture( g_pPictureUnKnow_Mark_Yellow )

g_pPictureUnKnow_Mark_Yellow:SetTex( "DLG_Common_Texture02.tga", "UnKnow_Mark_Yellow" )

g_pPictureUnKnow_Mark_Yellow:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(59,103)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}


g_pPictureCharacter_Creat = g_pUIDialog:CreatePicture()
g_pStaticUnit_Select_Slot_White:AddPicture( g_pPictureCharacter_Creat )

g_pPictureCharacter_Creat:SetTex( "DLG_Common_Texture00.tga", "Character_Creat" )

g_pPictureCharacter_Creat:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(56,181)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStaticUnit_Select_Slot_Yellow:SetName( "asdfasdffffff" )
...
g_pPictureUnKnow_Mark_Yellow = g_pUIDialog:CreatePicture()
g_pStaticUnit_Select_Slot_Yellow:AddPicture( g_pPictureUnKnow_Mark_Yellow )
...
g_pPictureCharacter_Creat = g_pUIDialog:CreatePicture()
g_pStaticUnit_Select_Slot_Yellow:AddPicture( g_pPictureCharacter_Creat )
...
g_pStaticUnit_Select_Slot_Yellow_Down:SetName( "gsdfsdfsdf" )
...
g_pPictureUnKnow_Mark_Yellow = g_pUIDialog:CreatePicture()
g_pStaticUnit_Select_Slot_Yellow_Down:AddPicture( g_pPictureUnKnow_Mark_Yellow )
...
g_pPictureCharacter_Creat = g_pUIDialog:CreatePicture()
g_pStaticUnit_Select_Slot_Yellow_Down:AddPicture( g_pPictureCharacter_Creat )
...
g_pButtonUnit_Slot_White:SetName( "ButtonSlot_Unknow" )
...
g_pButtonUnit_Slot_White:SetCustomMsgMouseUp( STATE_SERVER_SELECT_UI_CUSTOM_MSG["SUSUCM_CREATE_UNIT"] )
