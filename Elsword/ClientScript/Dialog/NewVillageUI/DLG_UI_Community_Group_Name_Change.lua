...
--g_pUIDialog:SetName( "DLG_Messenger_Change_Group_Name" )
...
g_pUIDialog:SetCloseCustomUIEventID( X2_COMMUNITY_CUSTOM_UI_MSG["XCCUM_MGR_CHANGE_GROUP_NAME_EXIT"] )

g_pStatic_Group_Name_Change = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_Group_Name_Change)
g_pStatic_Group_Name_Change:SetName( "Group_Name_Change" )

-----BG
g_pPicture_BG1 = g_pUIDialog:CreatePicture()
g_pStatic_Group_Name_Change:AddPicture( g_pPicture_BG1 )
...
g_pStatic_Group_Name_Change:AddPicture( g_pPicture_title )
...
g_pPicture_title:SetTex( "DLG_UI_Title01.TGA", "name" )

g_pPicture_title:SetPoint

{ 
         "LEFT_TOP         = D3DXVECTOR2(49+5 + 10,10+1)",
		 "COLOR            = D3DXCOLOR(1.0,1.0,1.0,1.0)",
		 CHANGE_TIME    =0.0,
}
...
g_pPicture_title:SetTex( "DLG_UI_Title01.TGA", "change" )

g_pPicture_title:SetPoint

{ 
         "LEFT_TOP         = D3DXVECTOR2(49+5+45+20,10+1)",
		 "COLOR            = D3DXCOLOR(1.0,1.0,1.0,1.0)",
		 CHANGE_TIME    =0.0,
}
...
g_pStatic_Group_Name_Change:AddPicture( g_pPicture_bar )
...
g_pStatic_Group_Name_Change:AddPicture( g_pPicturebg2 )
...
g_pStatic_Group_Name_Change:AddPicture( g_pPicturebg3 )
...
g_pStatic_Group_Name_Change:AddPicture( g_pPicturebox )

g_pPicturebox:SetTex( "DLG_UI_Common_Texture08.TGA", "blank_left" )

g_pPicturebox:SetPoint
{
     "LEFT_TOP    = D3DXVECTOR2 (85+17,60)",
	 "COLOR       = D3DXCOLOR(1.0,1.0,1.0,1.0)",
	 CHANGE_TIME = 0.0,
...
g_pIME_EditName:SetName( "IMEEditBoxChangeGroupName" )
g_pIME_EditName:SetTextPoint
{
	USE_TEXTURE_SIZE= FALSE,
	"LEFT_TOP		= D3DXVECTOR2(90+17,60)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(368,81)",
...
g_pIME_EditName:SetLengthLimit( 6 )
--g_pIME_EditName:SetCustomMsgChange( POSTBOX_SEND_UI_MSG["PBSUM_TITLE_CHANGE"] )
...
g_pButton_ok:SetName( "confirmok" )
...
g_pButton_ok:SetCustomMsgMouseUp( X2_COMMUNITY_CUSTOM_UI_MSG["XCCUM_MGR_CHANGE_GROUP_NAME_OK"] )
...
g_pButton_exit:SetCustomMsgMouseUp( X2_COMMUNITY_CUSTOM_UI_MSG["XCCUM_MGR_CHANGE_GROUP_NAME_EXIT"] )
