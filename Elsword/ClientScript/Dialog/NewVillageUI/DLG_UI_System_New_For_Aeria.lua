...
-- #ifdef SERV_CHANNELING_AERIA
g_pButton_UserSupport = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_UserSupport )
g_pButton_UserSupport:SetName( "ButtonAdvertisement" )
g_pButton_UserSupport:SetNormalTex( "DLG_ui_button10_A.tga", "CS_NORMAL" )	-- DLG_ui_button10_A.tga , ANNOUNCEMENT_NORMAL , ANNOUNCEMENT_OVER
g_pButton_UserSupport:SetOverTex( "DLG_ui_button10_A.tga", "CS_OVER" )
g_pButton_UserSupport:SetDownTex( "DLG_ui_button10_A.tga", "CS_OVER" )
g_pButton_UserSupport:SetNormalPoint
{
	"LEFT_TOP		= D3DXVECTOR2(0+400-61-325,0+15+120-15+35 +35 +35 + 35 )",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_UserSupport:SetOverPoint
{
	"LEFT_TOP		= D3DXVECTOR2(0+400-4-61-325,0+15-4+120-15+35+35 +35+ 35)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_UserSupport:SetDownPoint
{
    ADD_SIZE_X = -3,
    ADD_SIZE_Y = -3,
    "LEFT_TOP		= D3DXVECTOR2(0+400-61-2-325-1,0+15-2+120-15+35+35 +35+ 35)",
    "COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
CHANGE_TIME		= 0.0,
}
g_pButton_UserSupport:SetCustomMsgMouseUp( STATE_MENU_UI_CUSTOM_MSG["SMUCM_SHOW_AERIA_USER_SUPPORT"] )
g_pButton_UserSupport:SetPrevTabControlName( "ButtonSecurity" )
g_pButton_UserSupport:SetTabControlName( "game_out" )
g_pButton_UserSupport:SetEdge( false, 1, D3DXCOLOR( 0.4,0.6,0.8,1 ) )
-- #endif SERV_CHANNELING_AERIA
