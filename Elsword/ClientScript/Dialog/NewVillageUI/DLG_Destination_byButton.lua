...
g_pUIDialog:SetCloseCustomUIEventID( STATE_MENU_UI_CUSTOM_MSG["SMUCM_WARP_DEST_CLOSE"] )
...
g_pButton_BG:SetCustomMsgMouseUp( STATE_MENU_UI_CUSTOM_MSG["SMUCM_WARP_DEST"] )
...
g_pButtonExit:SetCustomMsgMouseUp( STATE_MENU_UI_CUSTOM_MSG["SMUCM_WARP_DEST_CLOSE"] )
