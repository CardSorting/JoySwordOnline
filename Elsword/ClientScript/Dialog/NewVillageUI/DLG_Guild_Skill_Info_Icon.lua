...
g_pPicture_Bg_Relation:SetTex( "DLG_UI_Common_Texture10.TGA", "Skill_BG_Passive" )
...
g_pButtonPlus:SetCustomMsgMouseUp( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_BUTTON_SKILL_LEVEL_PLUS"] )
g_pButtonPlus:SetCustomMsgMouseOver( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_BUTTON_SKILL_LEVEL_PLUS_MOUSEOVER"] )
g_pButtonPlus:SetCustomMsgMouseOut( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_BUTTON_SKILL_LEVEL_PLUS_MOUSEOUT"] )
...
g_pButtonMinus:SetCustomMsgMouseUp( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_BUTTON_SKILL_LEVEL_MINUS"] )
g_pButtonMinus:SetCustomMsgMouseOver( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_BUTTON_SKILL_LEVEL_MINUS_MOUSEOVER"] )
g_pButtonMinus:SetCustomMsgMouseOut( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_BUTTON_SKILL_LEVEL_MINUS_MOUSEOUT"] )
...
g_pButtonMaster:SetCustomMsgMouseOver( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_BUTTON_SKILL_MASTER_MOUSEOVER"] )
g_pButtonMaster:SetCustomMsgMouseOut( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_BUTTON_SKILL_MASTER_MOUSEOUT"] )
...
g_pStaticLevel:AddString
{
	...
	SORT_FLAG		= DRAW_TEXT["DT_CENTER"],
	"POS 			= D3DXVECTOR2(36+14-1,53+13-1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	"OUTLINE_COLOR		= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pSlotSkillTree:SetCustomMsgMouseRightUp( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_SKILLTREESLOT_RMOUSEUP"] )
g_pSlotSkillTree:SetCustomMsgMouseOver( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_SKILLTREESLOT_MOUSEIN"] )
g_pSlotSkillTree:SetCustomMsgMouseOut( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_SKILLTREESLOT_MOUSEOUT"] )
