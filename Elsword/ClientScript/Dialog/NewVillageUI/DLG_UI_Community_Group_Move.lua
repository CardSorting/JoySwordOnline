...
g_pUIDialog:SetCloseCustomUIEventID( X2_COMMUNITY_CUSTOM_UI_MSG["XCCUM_MGR_GROUP_MOVE_EXIT"] )

g_pStatic_Group_move = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_Group_move)
g_pStatic_Group_move:SetName( "Group_move" )

-----BG
g_pPicture_BG1 = g_pUIDialog:CreatePicture()
g_pStatic_Group_move:AddPicture( g_pPicture_BG1 )
...
g_pStatic_Group_move:AddPicture( g_pPicture_title )
...
g_pPicture_title:SetTex( "DLG_UI_Title01.TGA", "move" )

g_pPicture_title:SetPoint

{ 
         "LEFT_TOP         = D3DXVECTOR2(49 + 15,10+1)",
		 "COLOR            = D3DXCOLOR(1.0,1.0,1.0,1.0)",
		 CHANGE_TIME    =0.0,
}
...
g_pStatic_Group_move:AddPicture( g_pPicture_bar )
...
g_pStatic_Group_move:AddPicture( g_pPicturebg2 )
...
g_pStatic_Group_move:AddPicture( g_pPicturebg3 )
...
g_pComboBoxPresent_Select_User:SetName( "Combo_Group_Name" )

--거꾸로 나오게 할것인가?
g_pComboBoxPresent_Select_User:SetReverseDropdown( TRUE )

--버튼 클릭했을 때 드랍 텍스쳐 높이
g_pComboBoxPresent_Select_User:SetDropHeight( 100 )
...
--g_pComboBoxPresent_Select_User:SetTextTex( "DLG_UI_Common_Texture07.tga", "COMBOBOX" )
...
--g_pComboBoxPresent_Select_User:SetDropdownTex ( "DLG_UI_Common_Texture07.tga", "combobox_bg" )
g_pComboBoxPresent_Select_User:SetDropdownTex ( "DLG_UI_Common_Texture01.tga", "COMBO_DOWN" )


g_pComboBoxPresent_Select_User:SetDropdownTextTex ( "DLG_Common_New_Texture62.tga", "Select_Bar" )
...
--수동으로 만들 때
g_pComboBoxPresent_Select_User:SetTextPos( 114-7, 64)
g_pComboBoxPresent_Select_User:SetTextSize( 209+52, 21)

--텍스트 시작 포인트
g_pComboBoxPresent_Select_User:SetTextStringOffsetPos( 6, 1 )
g_pComboBoxPresent_Select_User:SetButtonPos( 346, 65)
...
g_pButton_ok:SetName( "confirmButton" )
...
g_pButton_ok:SetCustomMsgMouseUp( X2_COMMUNITY_CUSTOM_UI_MSG["XCCUM_MGR_GROUP_MOVE_OK"] )
...
g_pButton_exit:SetCustomMsgMouseUp( X2_COMMUNITY_CUSTOM_UI_MSG["XCCUM_MGR_GROUP_MOVE_EXIT"] )
