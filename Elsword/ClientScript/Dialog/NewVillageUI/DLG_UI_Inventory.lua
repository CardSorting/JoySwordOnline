...
g_pRadioButtonPC_Room:SetBGMouseOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(895-7,320-7)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonL_arrow:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(886+1,602+1)",
...
g_pButtonR_arrow:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(964+1,602+1)",
...
g_pPictureitem_resolve:SetTex( "DLG_UI_COMMON_TEXTURE09.TGA", "item_resolve_noactive" )
...
g_pButtonresolve:SetNormalTex( "DLG_UI_BUTTON09.tga", "item_resolve_normal" )

g_pButtonresolve:SetOverTex( "DLG_UI_BUTTON09.tga", "item_resolve_over" )

g_pButtonresolve:SetDownTex( "DLG_UI_BUTTON09.tga", "item_resolve_over" )
...
g_pButtonsoket:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(655-3,637-3)",
...
g_pButtonsoket:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(655+1-3,637+1-3)",
...
g_pButtonTrash:SetNormalTex( "DLG_UI_BUTTON11.tga", "trash_normal" )

g_pButtonTrash:SetOverTex( "DLG_UI_BUTTON11.tga", "trash_over" )

g_pButtonTrash:SetDownTex( "DLG_UI_BUTTON11.tga", "trash_over" )

g_pButtonTrash:SetDisableTex( "DLG_UI_BUTTON11.tga", "trash_gray" )
...
g_pCheckBoxsecret:SetBGPoint
{
	USE_TEXTURE_SIZE	= FALSE,
	"LEFT_TOP		= D3DXVECTOR2(582,607)",
 	"RIGHT_BOTTOM		= D3DXVECTOR2(597,622)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonComplete:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(603+1,601+1)",
...
g_pButtonDelete:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(605+55,603)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonDelete:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(603+55,601)",
...
g_pButtonDelete:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(603+1+55,601+1)",
...
g_pButtonDelete:SetString
{
	...
	"POS 			= D3DXVECTOR2(603+55+3,603+3)",
...
g_pPicture_Note:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(655+81,637)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButton_Note:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(655-3+81,637-3)",
...
g_pButton_Note:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(655+1-3+81,637+1-3)",
