...
g_pStaticfail = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticfail )
g_pStaticfail:SetName( "fail" )
...
g_pStaticfail:AddPicture( g_pPicture_bg )
...
g_pStaticfail:AddPicture( g_pPicture_title )
...
g_pStaticfail:AddPicture( g_pPicturebg2 )
...
g_pStaticfail:AddPicture( g_pPictureWindow_image )

g_pPictureWindow_image:SetTex( "DLG_UI_Common_Texture07.tga", "failure" )

g_pPictureWindow_image:SetPoint
{


	"LEFT_TOP		= D3DXVECTOR2(33,59)",
...
g_pPictureWindow_image:SetTex( "DLG_UI_Title01_A.tga", "failure" )

g_pPictureWindow_image:SetPoint
{


	"LEFT_TOP		= D3DXVECTOR2(145+5,54-30)",
...
g_pStaticfail:AddPicture( g_pPicturebg3 )
...
g_pStaticfail:AddPicture( g_pPicturemark )
...
g_pStaticfail:AddPicture( g_pPicturelevel_box )
...
g_pStaticfail:AddPicture( g_pPicturebar )
