...
g_pStaticHamel_town:SetName( "Hamel_town" )

-- 그림자
g_pPicture_shadow = g_pUIDialog:CreatePicture()
g_pStaticHamel_town:AddPicture( g_pPicture_shadow )
...
g_pPicture_bg1:SetTex( "DLG_UI_MAP_Village03.tga", "HAMEL_TOWN" )
...
g_pButtonNPC2:SetNormalPoint
{
    "LEFT_TOP		= D3DXVECTOR2(467+50,393)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonNPC2:SetOverPoint
...
{
    "LEFT_TOP		= D3DXVECTOR2(467+20,393)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
    "LEFT_TOP		= D3DXVECTOR2(653,410+5)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStaticHamel_town:AddPicture( g_pPicturehamel )

g_pPicturehamel:SetTex( "DLG_UI_Title02.tga", "Hamel_town" )
...
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2(99-2,432-2)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonLeft:AddDummyInt( VILLAGE_MAP_ID["VMI_DUNGEON_GATE_VELDER"] )

-- 오른쪽 게이트(하멜 외곽(하멜 던전 게이트)를 표시)
...
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2(884-2,432-2)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonRight:AddDummyInt( VILLAGE_MAP_ID["VMI_DUNGEON_GATE_HAMEL"] )

-- 도움말
g_pPictureHelper = g_pUIDialog:CreatePicture()
g_pStaticHamel_town:AddPicture( g_pPictureHelper )
