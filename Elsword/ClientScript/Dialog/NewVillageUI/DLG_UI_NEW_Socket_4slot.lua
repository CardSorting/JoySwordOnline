...
g_pPicture_bg4:SetTex( "DLG_UI_Common_Texture30.TGA", "bg_center" )

g_pPicture_bg4:SetPoint
{
    
	"LEFT_TOP		= D3DXVECTOR2(0,193+40+40)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_bg5:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(0,193+40+40+40-1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButton_Socket:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(201+4,362+4)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButton_Socket:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(201+1,362+1)",
