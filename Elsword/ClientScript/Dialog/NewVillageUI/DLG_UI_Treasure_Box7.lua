...
g_pPictureImage7 = g_pUIDialog:CreatePicture()
g_pStaticTreasure_Box:AddPicture( g_pPictureImage7 )

g_pPictureImage7:SetTex( "DLG_UI_Treasure_Box7.tga", "TREASURE_BOX7" )

g_pPictureImage7:SetPoint
{
