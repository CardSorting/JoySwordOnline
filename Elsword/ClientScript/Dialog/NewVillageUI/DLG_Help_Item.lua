...
g_pUIDialog:SetCloseCustomUIEventID( GUIDE_UI_CUSTOM_MESSAGE["GUI_ITEM_EXIT"] )

g_pStatic_Help_Epic = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_Help_Epic )
g_pStatic_Help_Epic:SetName( "Help_Item" )
...
g_pPicture_Q:SetTex( "DLG_UI_Common_Texture34.TGA", "Guide_Item01" )

g_pPicture_Q:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(108,63)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Q:SetTex( "DLG_UI_Common_Texture35.TGA", "Guide_Item02" )

g_pPicture_Q:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(619,64)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
ADD_SIZE_X = 15,
	"LEFT_TOP		= D3DXVECTOR2(400-4,546-4)",
...
g_pButtoncomplete:SetDownPoint
{
      ...
      ADD_SIZE_X = 15-2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(400-4+1,546-4+1)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtoncomplete:SetCustomMsgMouseUp( GUIDE_UI_CUSTOM_MESSAGE["GUI_ITEM_EXIT"] )
