...
g_pButtonchanal1:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(341+OFFSET_X1,117+OFFSET_Y1)",
...
g_pButtonchanal1:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(341+1+OFFSET_X1,117+1+OFFSET_Y1)",
...
g_pButtonchanal2:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(665+OFFSET_X2,117+OFFSET_Y2)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.5)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonchanal2:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(665+1+OFFSET_X2,117+1+OFFSET_Y2)",
...
g_pPicture_one:SetTex( "DLG_UI_Title02.TGA", "1" )

g_pPicture_one:SetPoint
{
    
	"LEFT_TOP		= D3DXVECTOR2(358+OFFSET_X1,126+OFFSET_Y1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_two:SetTex( "DLG_UI_Title02.TGA", "2" )

g_pPicture_two:SetPoint
{
    
	"LEFT_TOP		= D3DXVECTOR2(681+OFFSET_X2,126+OFFSET_Y2)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_three:SetTex( "DLG_UI_Title02.TGA", "3" )
...
g_pPicture_four:SetTex( "DLG_UI_Title02.TGA", "4" )

g_pPicture_four:SetPoint
{
    
	"LEFT_TOP		= D3DXVECTOR2(681,174)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_five:SetTex( "DLG_UI_Title02.TGA", "5" )
...
g_pPicture_six:SetTex( "DLG_UI_Title02.TGA", "6" ) -- 엘더 3
--g_pPicture_six:SetTex( "DLG_UI_Title02.TGA", "8" ) -- 알테라 1
...
g_pPicture_seven:SetTex( "DLG_UI_Title02.TGA", "7" )
...
g_pPicture_eight:SetTex( "DLG_UI_Title02.TGA", "8" )
...
g_pPicture_nine:SetTex( "DLG_UI_Title02.TGA", "9" )
...
g_pPicture_ten:SetTex( "DLG_UI_Title02.TGA", "10" )
...
g_pPicture_eleven:SetTex( "DLG_UI_Title02.TGA", "11" )
...
g_pPicture_twelve:SetTex( "DLG_UI_Title02.TGA", "12" )
...
g_pPicture_thirteen:SetTex( "DLG_UI_Title02.TGA", "13" )
...
g_pPicture_fourteen:SetTex( "DLG_UI_Title02.TGA", "14" )
...
g_pPicture_fourteen:SetTex( "DLG_UI_Title02.TGA", "Besma05" )
...
g_pPicture_fourteen:SetTex( "DLG_UI_Title02.TGA", "15" )
...
g_pPicture_box1:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(433+OFFSET_X1,131+OFFSET_Y1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
    ADD_SIZE_X = 212,
	"LEFT_TOP		= D3DXVECTOR2(438+OFFSET_X1,131+OFFSET_Y1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_box1:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(651+OFFSET_X1,131+OFFSET_Y1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_box2:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(756+OFFSET_X2 ,131+OFFSET_Y2)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
    ADD_SIZE_X = 212,
	"LEFT_TOP		= D3DXVECTOR2(761+OFFSET_X2,131+OFFSET_Y2)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_box2:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(974+OFFSET_X2,131+OFFSET_Y2)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
   ADD_SIZE_X = 218,
	"LEFT_TOP		= D3DXVECTOR2(435+OFFSET_X1,133+OFFSET_Y1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
   ADD_SIZE_X = 218,
	"LEFT_TOP		= D3DXVECTOR2(758+OFFSET_X2,133+OFFSET_Y2)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStatic_chanal1:AddString
{
	...
	"POS 			= D3DXVECTOR2(440+OFFSET_X1,136+OFFSET_Y1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
...
g_pStatic_chanal2:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_LEFT"],
	"POS 			= D3DXVECTOR2(763+OFFSET_X2,136+OFFSET_Y2)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	"OUTLINE_COLOR		= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
{
    ADD_SIZE_Y = 38,
	"LEFT_TOP		= D3DXVECTOR2(425+OFFSET_X1,123+OFFSET_Y1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
    ADD_SIZE_Y = 38,
	"LEFT_TOP		= D3DXVECTOR2(748+OFFSET_X2,123+OFFSET_Y2)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
