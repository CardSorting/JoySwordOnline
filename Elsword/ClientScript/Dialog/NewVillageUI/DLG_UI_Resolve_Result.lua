...
g_pUIDialog:SetCloseCustomUIEventID( UI_RESOLVE_ITEM_CUSTOM_MSG["URICM_RESOLVE_ITEM_RESULT_OK"] )
...
g_pButtoncheck:SetCustomMsgMouseUp( UI_RESOLVE_ITEM_CUSTOM_MSG["URICM_RESOLVE_ITEM_RESULT_OK"] )
