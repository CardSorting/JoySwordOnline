...
g_pPictureImage1 = g_pUIDialog:CreatePicture()
g_pStaticTreasure_Box:AddPicture( g_pPictureImage1 )

g_pPictureImage1:SetTex( "DLG_UI_Treasure_Box1.tga", "TREASURE_BOX1" )

g_pPictureImage1:SetPoint
{
