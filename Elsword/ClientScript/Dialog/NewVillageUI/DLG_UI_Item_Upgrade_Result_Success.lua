...
g_pPictureWindow_image:SetTex( "DLG_UI_Common_Texture07.tga", "success" )

g_pPictureWindow_image:SetPoint
{


	"LEFT_TOP		= D3DXVECTOR2(5,40)",
...
g_pPictureWindow_image:SetTex( "DLG_UI_Title01_A.tga", "success" )

g_pPictureWindow_image:SetPoint
{


	"LEFT_TOP		= D3DXVECTOR2(158,56-5-10)",
...
g_pPicturemark:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(72-60,202-5)",
...
g_pStaticsuccess:AddPicture( g_pPicturelevel_box )
...
g_pPicturelevel_box:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(270+3,82+51)",
