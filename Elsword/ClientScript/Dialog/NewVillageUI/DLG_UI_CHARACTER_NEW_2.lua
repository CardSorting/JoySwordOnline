...
{
	"LEFT_TOP	= D3DXVECTOR2(0,560+31-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pPictureInfo_BG2:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2(14,347+38)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(14,360+38)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
    ADD_SIZE_Y	= 12,
	"LEFT_TOP	= D3DXVECTOR2(14,370+38)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(14,410-26+38)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
----------HP/물공/마공/물방/마방 / 크리티컬/추데/명중/각충/각지/회피/데감/속도/이속/점속_BG
g_pPictureInfo_BG10_1 = g_pUIDialog:CreatePicture() 
g_pStaticInfo:AddPicture( g_pPictureInfo_BG10_1 )
g_pPictureInfo_BG10_1:SetTex( "DLG_UI_Common_Texture66_NEW.TGA", "BG_DUNGEON_PVP_BACK" )
g_pPictureInfo_BG10_1:SetPoint
{

	"LEFT_TOP	= D3DXVECTOR2(14,436)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(14,563-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 10 ,
	"LEFT_TOP	= D3DXVECTOR2(14,573-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(14,585-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 126,
	"LEFT_TOP	= D3DXVECTOR2(296,427-26+38+16)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 126,
	"LEFT_TOP	= D3DXVECTOR2(152,427-26+38+16)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
-----칭호 버튼
...
{
	ADD_SIZE_X	= -3,
 	"LEFT_TOP	= D3DXVECTOR2(285+10+5,392-26-10)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButton_title:SetDownPoint
{
	ADD_SIZE_X	= -5 ,
	ADD_SIZE_Y	= -2 ,
	"LEFT_TOP	= D3DXVECTOR2(285-2+3+10+5,392-1+2-26-10)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pPictureText_title:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2(248+8+8+8,397-27-10)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
--길드 이름 
g_pPictureText_title = g_pUIDialog:CreatePicture() 
g_pStaticText:AddPicture( g_pPictureText_title )
g_pPictureText_title:SetTex( "DLG_UI_Title03.TGA", "Guild" )
g_pPictureText_title:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2(23,397-27-10)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(259-3-120+100+74,369+38)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(259-3-120+30+45-20,369+38)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pPictureText_vp= g_pUIDialog:CreatePicture()
g_pStaticText:AddPicture( g_pPictureText_vp)
g_pPictureText_vp:SetTex( "DLG_UI_Title03.TGA", "SEASON_SCORE" )
g_pPictureText_vp:SetPoint
{
	ADD_SIZE_X	= -38,
	ADD_SIZE_Y	= -8,
	"LEFT_TOP	= D3DXVECTOR2(17+25,369+38)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(20,366+38)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pPictureText_cash:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(227-15,52)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(26-4,438-7-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(25-4,460-6-26+38+18+ysize)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(25-4,484-3-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(25-4,507+1-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonPhysicDefence:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(18,507-2-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(25-4,531+3-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonMagicDefence:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(18,531-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pPictureAvata_OnePiece = g_pUIDialog:CreatePicture() 
g_pStaticAvata:AddPicture( g_pPictureAvata_OnePiece )
g_pPictureAvata_OnePiece:SetTex( "DLG_Common_Texture_INT_ALL01.tga", "AVATA_ONEPIECE_OVER" )
g_pPictureAvata_OnePiece:SetPoint
{
	ADD_SIZE_X	= -11,
	ADD_SIZE_Y	= -11,
	"LEFT_TOP		= D3DXVECTOR2( 26,90 )",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(19,568-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(88,568-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(159,568-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(228,568-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(298,568-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(367,568-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStaticInfo_Title:AddString
{
	...
	"POS 			= D3DXVECTOR2(351+14,397-26-11)",
	"COLOR			= D3DXCOLOR(1.0,0.9,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticInfo_PVP_SCORE:AddString
{
	...
	FONT_INDEX	= XUF_DODUM_11_NORMAL,
	SORT_FLAG	= DRAW_TEXT["DT_LEFT"],
	"POS 		= D3DXVECTOR2(78+150+15+10,371+38)",
	"COLOR		= D3DXCOLOR(0.1,0.1,0.1,1.0)",
}

---통산 전적( 2012. 09 )
g_pStaticInfo_PVP_Total = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticInfo_PVP_Total )
g_pStaticInfo_PVP_Total:SetName( "g_pStaticInfo_PVP_Total" )
g_pStaticInfo_PVP_Total:AddString
{
	--MSG 			= "99,999",
	FONT_INDEX      = XUF_DODUM_11_NORMAL,
	SORT_FLAG       = DRAW_TEXT["DT_LEFT"],
	"POS 			= D3DXVECTOR2(78+150+140,371+38)",
	"COLOR			= D3DXCOLOR(0.1,0.1,0.1,1.0)",
}
...
g_pStaticinfo_hp:AddString
{
	...
	FONT_STYLE		= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(171-38-3,439-7-26+38+18)",
	"COLOR			= D3DXCOLOR(1.0,0.9,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticinfo_b_attack:AddString
{
	...
	FONT_STYLE		= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(171-38-3,463-7-26+38+18)",
	"COLOR			= D3DXCOLOR(1.0,0.9,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticinfo_m_attack:AddString
{
	...
	FONT_STYLE		= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(171-38-3,486-3-26+38+18)",
	"COLOR			= D3DXCOLOR(1.0,0.9,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticinfo_b_depense:AddString
{
	...
	FONT_STYLE		= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(171-38-3,509-26+38+18)",
	"COLOR			= D3DXCOLOR(1.0,0.9,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticinfo_m_depense:AddString
{
	...
	FONT_STYLE		= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(171-38-3,533+3-26+38+18)",
	"COLOR			= D3DXCOLOR(1.0,0.9,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticInfo_fire:AddString
{
	...
	--FONT_STYLE	= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(18+38,571-26+38+18)",
	"COLOR			= D3DXCOLOR(0.1,0.1,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticInfo_water:AddString
{
	...
	--FONT_STYLE	= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(87+37,571-26+38+18)",
	"COLOR			= D3DXCOLOR(0.1,0.1,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticInfo_nature:AddString
{
	...
	--FONT_STYLE	= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(158+37,571-26+38+18)",
	"COLOR			= D3DXCOLOR(0.1,0.1,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticInfo_wind:AddString
{
	...
	--FONT_STYLE	= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(227+37,571-26+38+18)",
	"COLOR			= D3DXCOLOR(0.1,0.1,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticInfo_light:AddString
{
	...
	--FONT_STYLE	= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(297+37,571-26+38+18)",
	"COLOR			= D3DXCOLOR(0.1,0.1,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pStaticInfo_dark:AddString
{
	...
	--FONT_STYLE    = FONT_STYLE["FS_SHELL"],
	SORT_FLAG       = DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(367+37,571-26+38+18)",
	"COLOR			= D3DXCOLOR(0.1,0.1,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(162,438-7-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStatic_cri:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(158+116,439-7-26+38+18)",
...
g_pButton_Critical:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(162,438-10-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(162,460-6-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStatic_add:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(158+116,463-7-26+38+18)",
	"COLOR			= D3DXCOLOR(0.5,1.0,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pButton_Add:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(162,460-9-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(162,484-3-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStatic_speed:AddString
{
	...
	FONT_STYLE  	= FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(158+116,486-4-26+38+18)",
	"COLOR			= D3DXCOLOR(0.5,1.0,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pButton_Accuracy:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(162,484-6-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(162,507+1-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStatic_charge:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(158+116,509+1-26+38+18)",
	"COLOR			= D3DXCOLOR(0.5,1.0,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pButton_Charge:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(162,507-2-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(162,531+3-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStatic_time:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(158+116,533+3-26+38+18)",
	"COLOR			= D3DXCOLOR(0.5,1.0,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pButton_Time:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(162,531-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(306,438-7-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStatic_dex:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(306+110,439-7-26+38+18)",
	"COLOR			= D3DXCOLOR(0.5,1.0,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pButton_Evade:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(306,438-10-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(306,460-6-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStatic_decline:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(306+110,463-7-26+38+18)",
	"COLOR			= D3DXCOLOR(0.5,1.0,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pButton_Decline:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(306,460-9-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(306,484-3-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStatic_moving:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(306+110,486-4-26+38+18)",
	"COLOR			= D3DXCOLOR(0.5,1.0,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pButton_Moving:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(306,484-6-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pPicturespeed:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2(306,507+1-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStatic_speed:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(306+110,509+1-26+38+18)",
	"COLOR			= D3DXCOLOR(0.5,1.0,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pButton_Speed:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(306,507-2-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(306,531+3-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pStatic_jump:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_RIGHT"],
	"POS 			= D3DXVECTOR2(306+110,533+3-26+38+18)",
	"COLOR			= D3DXCOLOR(0.5,1.0,0.1,1.0)",
	"OUTLINE_COLOR	= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pButton_Jump:SetNormalPoint
{
	ADD_SIZE_X	= 125,
	ADD_SIZE_Y	= 20,
	"LEFT_TOP	= D3DXVECTOR2(306,531-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButton_opacity1:SetNormalPoint
{
	ADD_SIZE_X	= 55,
	ADD_SIZE_Y	= 26,
	"LEFT_TOP	= D3DXVECTOR2(18,562-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButton_opacity2:SetNormalPoint
{
	ADD_SIZE_X	= 55,
	ADD_SIZE_Y	= 26,
	"LEFT_TOP	= D3DXVECTOR2(87,562-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButton_opacity3:SetNormalPoint
{
	ADD_SIZE_X	= 55,
	ADD_SIZE_Y	= 26,
	"LEFT_TOP	= D3DXVECTOR2(158,562-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButton_opacity4:SetNormalPoint
{
	ADD_SIZE_X	= 55,
	ADD_SIZE_Y	= 26,
	"LEFT_TOP	= D3DXVECTOR2(227,562-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButton_opacity5:SetNormalPoint
{
	ADD_SIZE_X	= 55,
	ADD_SIZE_Y	= 26,
	"LEFT_TOP	= D3DXVECTOR2(297,562-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pButton_opacity6:SetNormalPoint
{
	ADD_SIZE_X	= 55,
	ADD_SIZE_Y	= 26,
	"LEFT_TOP	= D3DXVECTOR2(367,562-26+38+18)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
---------------------던전&대전 스탯 버튼
----던전스탯 버튼
g_pRadioButtonDungeonStat = g_pUIDialog:CreateRadioButton()
g_pUIDialog:AddControl( g_pRadioButtonDungeonStat )
g_pRadioButtonDungeonStat:SetFixOverByCheck( true ) 
g_pRadioButtonDungeonStat:SetShowOffBGByCheck( true )
g_pRadioButtonDungeonStat:SetName( "DungeonStat" )
g_pRadioButtonDungeonStat:SetNormalTex( "DLG_UI_Common_Texture65_NEW.tga", "BT_DUNGEONSTATE_INACTIVITY" )
g_pRadioButtonDungeonStat:SetOverTex( "DLG_UI_Common_Texture65_NEW.tga", "BT_DUNGEONSTATE_NORMAL" )
g_pRadioButtonDungeonStat:SetCheckedTex( "DLG_UI_Common_Texture65_NEW.tga", "BT_DUNGEONSTATE_OVER" )
g_pRadioButtonDungeonStat:SetBGPoint
{
 	"LEFT_TOP		= D3DXVECTOR2(157,440)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pRadioButtonDungeonStat:SetBGMouseOverPoint
{
 	"LEFT_TOP		= D3DXVECTOR2(157,440)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pRadioButtonDungeonStat:SetRBPoint
{
 	USE_TEXTURE_SIZE	= FALSE,
 	"LEFT_TOP		= D3DXVECTOR2(157,440)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(157+66,440+15)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pRadioButtonDungeonStat:SetCheckPoint
{
 	"LEFT_TOP		= D3DXVECTOR2(157,440)",
 	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pRadioButtonDungeonStat:SetGroupID(1)
g_pRadioButtonDungeonStat:AddDummyInt(0)
g_pRadioButtonDungeonStat:SetCustomMsgChecked( CHARACTER_INFORMATION_MSG["CIM_SPECIAL_OPTIONDATA_TOGGLE"] )
----대전스탯 버튼
g_pRadioButtonPvpStat = g_pUIDialog:CreateRadioButton()
g_pUIDialog:AddControl( g_pRadioButtonPvpStat )
g_pRadioButtonPvpStat:SetFixOverByCheck( true ) 
g_pRadioButtonPvpStat:SetShowOffBGByCheck( true )
g_pRadioButtonPvpStat:SetName( "PvpStat" )
g_pRadioButtonPvpStat:SetNormalTex( "DLG_UI_Common_Texture65_NEW.tga", "BT_PVPSTATE_INACTIVITY" )
g_pRadioButtonPvpStat:SetOverTex( "DLG_UI_Common_Texture65_NEW.tga", "BT_PVPSTATE_NORMAL" )
g_pRadioButtonPvpStat:SetCheckedTex( "DLG_UI_Common_Texture65_NEW.tga", "BT_PVPSTATE_OVER" )
g_pRadioButtonPvpStat:SetBGPoint
{
 	"LEFT_TOP		= D3DXVECTOR2(226,440)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pRadioButtonPvpStat:SetBGMouseOverPoint
{
 	"LEFT_TOP		= D3DXVECTOR2(226,440)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pRadioButtonPvpStat:SetRBPoint
{
 	USE_TEXTURE_SIZE	= FALSE,
 	"LEFT_TOP		= D3DXVECTOR2(226,440)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(226+66,440+15)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pRadioButtonPvpStat:SetCheckPoint
{
 	"LEFT_TOP		= D3DXVECTOR2(226,440)",
 	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pRadioButtonPvpStat:SetGroupID(1)
g_pRadioButtonPvpStat:AddDummyInt(1)
g_pRadioButtonPvpStat:SetCustomMsgChecked( CHARACTER_INFORMATION_MSG["CIM_SPECIAL_OPTIONDATA_TOGGLE"] )
