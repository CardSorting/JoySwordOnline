...
g_pUIDialog:SetName( "DLG_Change_Nickname" )
g_pUIDialog:SetPos( 400, 250 )
g_pUIDialog:SetModal( false )
g_pUIDialog:SetFront( true )
g_pUIDialog:SetCloseCustomUIEventID( STATE_SERVER_SELECT_UI_CUSTOM_MSG["SUSUCM_RENAME_CANCEL"] )
...
g_pIME_NewNick:SetCustomMsgEnter( STATE_SERVER_SELECT_UI_CUSTOM_MSG["SUSUCM_RENAME_OK"] )
...
g_pButtonX:SetCustomMsgMouseUp( STATE_SERVER_SELECT_UI_CUSTOM_MSG["SUSUCM_RENAME_CANCEL"] )
...
g_pButton:SetCustomMsgMouseUp( STATE_SERVER_SELECT_UI_CUSTOM_MSG["SUSUCM_RENAME_OK"] )
...
g_pButton:SetCustomMsgMouseUp( STATE_SERVER_SELECT_UI_CUSTOM_MSG["SUSUCM_RENAME_CANCEL"] )
