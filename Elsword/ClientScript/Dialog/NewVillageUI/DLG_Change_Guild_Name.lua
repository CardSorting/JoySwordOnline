...
g_pUIDialog:SetName( "DLG_Change_Guild_Name" )
g_pUIDialog:SetPos( 400, 250 )
g_pUIDialog:SetModal( false )
g_pUIDialog:SetFront( true )
g_pUIDialog:SetCloseCustomUIEventID( GUILD_UI_MESSAGE["GUM_GUILD_NAME_CHANGE_CHECK_CANCEL"] )
...
g_pPicture_box:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(27+83 + FIX_ADD_X,145)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
     ADD_SIZE_X = 139,
	"LEFT_TOP		= D3DXVECTOR2(32+83 + FIX_ADD_X,145)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_box:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(172+83 + FIX_ADD_X,145)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pIME_NewNick:SetTextPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(116 + FIX_ADD_X,147)",
...
g_pIME_NewNick:SetCustomMsgEnter( GUILD_UI_MESSAGE["GUM_GUILD_NAME_CHANGE_CHECK_OK"] )
g_pIME_NewNick:SetByteLimit( 16 )
...
g_pButtonX:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(242+4+ FIX_ADD_X,13+4)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonX:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(242+ FIX_ADD_X,13)",
...
g_pButtonX:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(242+1+ FIX_ADD_X,13+1)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonX:SetCustomMsgMouseUp( GUILD_UI_MESSAGE["GUM_GUILD_NAME_CHANGE_CHECK_CANCEL"] )
...
{
	"LEFT_TOP		= D3DXVECTOR2(53+4 + (FIX_ADD_X/2),195+4)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
	"LEFT_TOP		= D3DXVECTOR2(53+ (FIX_ADD_X/2),195)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
ADD_SIZE_Y = -2,
	...
	"LEFT_TOP		= D3DXVECTOR2(53+1+ (FIX_ADD_X/2),195+1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton:SetCustomMsgMouseUp( GUILD_UI_MESSAGE["GUM_GUILD_NAME_CHANGE_CHECK_OK"] )
...
g_pButton:SetNormalPoint
{
	"LEFT_TOP		= D3DXVECTOR2(143+3+ (FIX_ADD_X/2),196+3)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButton:SetOverPoint
{
	"LEFT_TOP		= D3DXVECTOR2(143+ (FIX_ADD_X/2),196)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
ADD_SIZE_Y = -2,
	...
	"LEFT_TOP		= D3DXVECTOR2(143+1+ (FIX_ADD_X/2),196+1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton:SetCustomMsgMouseUp( GUILD_UI_MESSAGE["GUM_GUILD_NAME_CHANGE_CHECK_CANCEL"] )
