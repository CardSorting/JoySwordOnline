...
--------------- Static
g_pStatic_Pat_Inven2 = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_Pat_Inven2 )
g_pStatic_Pat_Inven2:SetName( "g_pStatic_Pat_Inven2" )
...
posForBGLeftTopOfBottom			= 621	- ( 4 - numOfLineInPetInven ) * 50

sizeYForBlackBox				= 239	- ( 4 - numOfLineInPetInven ) * 50
posForBlackBoxLeftTopOfBottom	= 605	- ( 4 - numOfLineInPetInven ) * 50

sizeYForWin						= 229	- ( 4 - numOfLineInPetInven ) * 50
posForWinLeftTopOfBottom		= 599	- ( 4 - numOfLineInPetInven ) * 50




--------------- BG
g_pPicture_Pat_Inven_BG2_top = g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven2:AddPicture( g_pPicture_Pat_Inven_BG2_top )
g_pPicture_Pat_Inven_BG2_top:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_BG2_TOP" )
g_pPicture_Pat_Inven_BG2_top:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(338,302)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}


g_pPicture_Pat_Inven_BG2_middle = g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven2:AddPicture( g_pPicture_Pat_Inven_BG2_middle )

g_pPicture_Pat_Inven_BG2_middle:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_BG2_MIDDLE" )
g_pPicture_Pat_Inven_BG2_middle:SetPoint
{
--	ADD_SIZE_Y = 299,
	ADD_SIZE_Y = sizeYForBG,     
	"LEFT_TOP		= D3DXVECTOR2(343,300+20)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}

g_pPicture_Pat_Inven_BG2_bottom= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven2:AddPicture( g_pPicture_Pat_Inven_BG2_bottom )

g_pPicture_Pat_Inven_BG2_bottom:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_BG2_BOTTOM" )
g_pPicture_Pat_Inven_BG2_bottom:SetPoint
{

--	"LEFT_TOP		= D3DXVECTOR2(342,621)",
	"LEFT_TOP		= D3DXVECTOR2(342, posForBGLeftTopOfBottom)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Pat_Inven_balck2_box_top= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven2:AddPicture( g_pPicture_Pat_Inven_balck2_box_top )
g_pPicture_Pat_Inven_balck2_box_top:SetTex( "DLG_UI_Common_Texture39.TGA", "PAT_INVEN_GRAY2_TOP" )

g_pPicture_Pat_Inven_balck2_box_top:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(361,352)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Pat_Inven_balck2_box_middle= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven2:AddPicture( g_pPicture_Pat_Inven_balck2_box_middle )
g_pPicture_Pat_Inven_balck2_box_middle:SetTex( "DLG_UI_Common_Texture39.TGA", "PAT_INVEN_GRAY2_MIDDLE" )

g_pPicture_Pat_Inven_balck2_box_middle:SetPoint
{
--  ADD_SIZE_Y = 239,
	ADD_SIZE_Y = sizeYForBlackBox,
	"LEFT_TOP		= D3DXVECTOR2(361,352+11)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Pat_Inven_balck2_box_bottom= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven2:AddPicture( g_pPicture_Pat_Inven_balck2_box_bottom )
g_pPicture_Pat_Inven_balck2_box_bottom:SetTex( "DLG_UI_Common_Texture39.TGA", "PAT_INVEN_GRAY2_BOTTOM" )

g_pPicture_Pat_Inven_balck2_box_bottom:SetPoint
{

--	"LEFT_TOP		= D3DXVECTOR2(361,605)",
	"LEFT_TOP		= D3DXVECTOR2(361, posForBlackBoxLeftTopOfBottom)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Pat_Inven_win2_top= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven2:AddPicture( g_pPicture_Pat_Inven_win2_top )

g_pPicture_Pat_Inven_win2_top:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_win2_top" )
g_pPicture_Pat_Inven_win2_top:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(362,355)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}

g_pPicture_Pat_Inven_win2_middle= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven2:AddPicture( g_pPicture_Pat_Inven_win2_middle )
g_pPicture_Pat_Inven_win2_middle:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_win2_middle" )

g_pPicture_Pat_Inven_win2_middle:SetPoint
{
--	ADD_SIZE_Y = 229,
    ADD_SIZE_Y = sizeYForWin,
	"LEFT_TOP		= D3DXVECTOR2(362+1,368)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Pat_Inven_win2_bottom= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven2:AddPicture( g_pPicture_Pat_Inven_win2_bottom )

g_pPicture_Pat_Inven_win2_bottom:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_win2_bottom" )

g_pPicture_Pat_Inven_win2_bottom:SetPoint
{
    
--	"LEFT_TOP		= D3DXVECTOR2(362,599)",
	"LEFT_TOP		= D3DXVECTOR2(362, posForWinLeftTopOfBottom)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonX:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(513-4,316)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonX:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(513+1-4,316+1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStatic_Pat_Inven2:AddPicture( g_pPicture_Pat_Inven_title)
...
if numOfLineInPetInven >= 1 then
	...
	g_pPicture_Pat_Inven_Slot2:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(373+51,395)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 373+51 + 1 ,395 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}
	...
	g_pPicture_Pat_Inven_Slot3:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(373+51+51,395)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 373+51+51 + 1 ,395 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}	
end	
...
if numOfLineInPetInven >= 2 then
	...
	g_pPicture_Pat_Inven_Slot5:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(373+51,446)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 373+51 + 1 ,446 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}
	...
	g_pPicture_Pat_Inven_Slot6:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(373+51+51,446)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 373+51+51 + 1 ,446 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}
...
if numOfLineInPetInven >= 3 then
	...
	g_pPicture_Pat_Inven_Slot8:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(373+51,497)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 373+51 + 1 ,497 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}	
	...
	g_pPicture_Pat_Inven_Slot9:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(373+51+51,497)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 373+51+51 + 1 ,497 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}	
end
...
if numOfLineInPetInven >= 4 then
	...
	g_pPicture_Pat_Inven_Slot11:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(373+51,548)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 373+51 + 1 ,548 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}
	...
	g_pPicture_Pat_Inven_Slot12:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(373+51+51,548)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 373+51+51 + 1 ,548 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}	
...
g_pCheckBoxsecret:SetBGPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(455,370)",
 	"RIGHT_BOTTOM	= D3DXVECTOR2(455+15,370+15)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
