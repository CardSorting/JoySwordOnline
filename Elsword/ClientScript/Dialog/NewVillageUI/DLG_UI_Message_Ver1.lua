...
g_pButton_pvp = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_pvp )
g_pButton_pvp:SetName( "formal_pvp" )
g_pButton_pvp:SetNormalTex( "DLG_UI_BUTTON18.tga", "OFFICIAL_NORMAL" )

g_pButton_pvp:SetOverTex( "DLG_UI_BUTTON18.tga", "OFFICIAL_OVER" )

g_pButton_pvp:SetDownTex( "DLG_UI_BUTTON18.tga", "OFFICIAL_OVER" )
...
g_pButton_pvp:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(26+2,656+2)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_pvp:SetCustomMsgMouseUp( NPC_MESSAGE_UI_MSG["NMUM_FORMAL_PVP"] )


-----------연습대전
g_pButton_pr_pvp = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_pr_pvp )
g_pButton_pr_pvp:SetName( "pvp" )
g_pButton_pr_pvp:SetNormalTex( "DLG_UI_BUTTON18.tga", "PRACTICE_NORMAL" )

g_pButton_pr_pvp:SetOverTex( "DLG_UI_BUTTON18.tga", "PRACTICE_OVER" )

g_pButton_pr_pvp:SetDownTex( "DLG_UI_BUTTON18.tga", "PRACTICE_OVER" )

g_pButton_pr_pvp:SetNormalPoint
{
...
g_pButton_pr_pvp:SetOverPoint
{

	"LEFT_TOP		= D3DXVECTOR2(26+1,656)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_pr_pvp:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(26+2,656+1)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_pr_pvp:SetCustomMsgMouseUp( NPC_MESSAGE_UI_MSG["NMUM_PVP"] )
...
--[[
-- #ifdef SERV_SYNTHESIS_AVATAR ( 합성 시스템 )
g_pButton_Synthesis = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_Synthesis )
g_pButton_Synthesis:SetName( "Synthesis" )

g_pButton_Synthesis:SetNormalTex( "DLG_UI_BUTTON18.tga", "BT_SYNTHESIS_TOWN_NORMAL" )
g_pButton_Synthesis:SetOverTex( "DLG_UI_BUTTON18.tga", "BT_SYNTHESIS_TOWN_OVER" )
g_pButton_Synthesis:SetDownTex( "DLG_UI_BUTTON18.tga", "BT_SYNTHESIS_TOWN_OVER" )

g_pButton_Synthesis:SetNormalPoint
{
...
g_pButton_Synthesis:SetOverPoint
{

	"LEFT_TOP		= D3DXVECTOR2(27,657-1)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Synthesis:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(27+1,657+1-1)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Synthesis:SetCustomMsgMouseUp( NPC_MESSAGE_UI_MSG["NMUM_SYNTHESIS"] )
g_pButton_Synthesis:SetShow( false )
-- #endif SERV_SYNTHESIS_AVATAR
--]]
--#ifdef NPC_EVENT_BUTTON
g_pButton_Event1 = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_Event1 )
g_pButton_Event1:SetName( "Event1" )
g_pButton_Event1:SetNormalTex( "DLG_UI_BUTTON_INT02.tga", "ARA_FIRST_CLASS_NAME_NORMAL" )
g_pButton_Event1:SetOverTex( "DLG_UI_BUTTON_INT02.tga", "ARA_FIRST_CLASS_NAME_OVER" )
g_pButton_Event1:SetDownTex( "DLG_UI_BUTTON_INT02.tga", "ARA_FIRST_CLASS_NAME_OVER" )

g_pButton_Event1:SetNormalPoint
{	
    "LEFT_TOP		= D3DXVECTOR2(30,660)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Event1:SetOverPoint
{
	"LEFT_TOP		= D3DXVECTOR2(27,657-1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Event1:SetDownPoint
{
	ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(27+1,657+1-1)",
...
g_pButton_Event1:SetCustomMsgMouseUp( NPC_MESSAGE_UI_MSG["NMUM_EVENT1"] )
g_pButton_Event1:SetShow( false )

g_pButton_Event2 = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_Event2 )
g_pButton_Event2:SetName( "Event2" )
g_pButton_Event2:SetNormalTex( "DLG_UI_BUTTON_INT02.tga", "YES_OVER" )
g_pButton_Event2:SetOverTex( "DLG_UI_BUTTON_INT02.tga", "YES_OVER" )
g_pButton_Event2:SetDownTex( "DLG_UI_BUTTON_INT02.tga", "YES_OVER" )

g_pButton_Event2:SetNormalPoint
{	
    "LEFT_TOP		= D3DXVECTOR2(30,660)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Event2:SetOverPoint
{
	"LEFT_TOP		= D3DXVECTOR2(27,657-1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Event2:SetDownPoint
{
	ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(27+1,657+1-1)",
...
g_pButton_Event2:SetCustomMsgMouseUp( NPC_MESSAGE_UI_MSG["NMUM_EVENT2"] )
g_pButton_Event2:SetShow( false )

g_pButton_Event3 = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_Event3 )
g_pButton_Event3:SetName( "Event3" )
g_pButton_Event3:SetNormalTex( "DLG_UI_BUTTON_INT02.tga", "YES_OVER" )
g_pButton_Event3:SetOverTex( "DLG_UI_BUTTON_INT02.tga", "YES_OVER" )
g_pButton_Event3:SetDownTex( "DLG_UI_BUTTON_INT02.tga", "YES_OVER" )

g_pButton_Event3:SetNormalPoint
{	
    "LEFT_TOP		= D3DXVECTOR2(30,660)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Event3:SetOverPoint
{
	"LEFT_TOP		= D3DXVECTOR2(27,657-1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Event3:SetDownPoint
{
	ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(27+1,657+1-1)",
...
g_pButton_Event3:SetCustomMsgMouseUp( NPC_MESSAGE_UI_MSG["NMUM_EVENT3"] )
g_pButton_Event3:SetShow( false )

g_pButton_Event4 = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_Event4 )
g_pButton_Event4:SetName( "Event4" )
g_pButton_Event4:SetNormalTex( "DLG_UI_BUTTON_INT02.tga", "YES_OVER" )
g_pButton_Event4:SetOverTex( "DLG_UI_BUTTON_INT02.tga", "YES_OVER" )
g_pButton_Event4:SetDownTex( "DLG_UI_BUTTON_INT02.tga", "YES_OVER" )

g_pButton_Event4:SetNormalPoint
{	
    "LEFT_TOP		= D3DXVECTOR2(30,660)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Event4:SetOverPoint
{
	"LEFT_TOP		= D3DXVECTOR2(27,657-1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Event4:SetDownPoint
{
	ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(27+1,657+1-1)",
...
g_pButton_Event4:SetCustomMsgMouseUp( NPC_MESSAGE_UI_MSG["NMUM_EVENT4"] )
g_pButton_Event4:SetShow( false )
--#endif NPC_EVENT_BUTTON


-- 아이템개편/아이템 교환 버튼
g_pButton_ExchangeNewItem = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButton_ExchangeNewItem )
g_pButton_ExchangeNewItem:SetName( "ExchangeNewItem" )
g_pButton_ExchangeNewItem:SetShow(false)

g_pButton_ExchangeNewItem:SetNormalTex( "DLG_UI_Common_Texture_MarriageSystem_04.tga", "Bt_ItemChange_Normal" )
g_pButton_ExchangeNewItem:SetOverTex( "DLG_UI_Common_Texture_MarriageSystem_04.tga", "Bt_ItemChange_Over" )
g_pButton_ExchangeNewItem:SetDownTex( "DLG_UI_Common_Texture_MarriageSystem_04.tga", "Bt_ItemChange_Over" )

g_pButton_ExchangeNewItem:SetNormalPoint
{
    "LEFT_TOP		= D3DXVECTOR2(30,660)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_ExchangeNewItem:SetOverPoint
{
	"LEFT_TOP		= D3DXVECTOR2(24,654)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_ExchangeNewItem:SetDownPoint
{
    ADD_SIZE_X = -2,
    ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(24+1,654+1)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_ExchangeNewItem:SetCustomMsgMouseUp( NPC_MESSAGE_UI_MSG["NMUM_NEW_ITEM_EXCHANGE"] )
