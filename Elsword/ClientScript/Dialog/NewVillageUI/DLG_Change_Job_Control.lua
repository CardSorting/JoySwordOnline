...
g_pButton_List_BTN01:SetCustomMsgMouseUp( UI_INVENTORY_MSG["UIM_UNLIMITED_SECOND_CHANGE_JOB_SELECT"] )
g_pButton_List_BTN01:SetCustomMsgMouseDblClk( UI_INVENTORY_MSG["UIM_UNLIMITED_SECOND_CHANGE_JOB_DEST"] )
