...
g_pPictureImage4 = g_pUIDialog:CreatePicture()
g_pStaticTreasure_Box:AddPicture( g_pPictureImage4 )

g_pPictureImage4:SetTex( "DLG_UI_Treasure_Box4.tga", "TREASURE_BOX4" )

g_pPictureImage4:SetPoint
{
