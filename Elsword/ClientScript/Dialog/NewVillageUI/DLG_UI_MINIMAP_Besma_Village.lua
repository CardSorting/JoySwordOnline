...
g_pStaticbesma_town = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticbesma_town )
g_pStaticbesma_town:SetName( "besma_town" )
...
g_pStaticbesma_town:AddPicture( g_pPicture_shadow )
...
g_pStaticbesma_town:AddPicture( g_pPicture_bg1 )

g_pPicture_bg1:SetTex( "DLG_UI_MAP_Village02.tga", "besma_town" ) 
...
g_pButtonNPC1:AddDummyInt( NPC_UNIT_ID["NUI_STELLA"] )
...
g_pButtonNPC2:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(350+35,433)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonNPC2:SetOverPoint
...
g_pButtonAlche:AddDummyInt( NPC_UNIT_ID["NUI_CHACHABUK"] )
...
g_pButtonBank:SetCustomMsgMouseOver( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_NPC_MOUSE_OVER"] )
g_pButtonBank:SetCustomMsgMouseOut( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_NPC_MOUSE_OUT"] )
-- fix!! g_pButtonBank:AddDummyInt( NPC_UNIT_ID["NUI_CHACHABUK"] )
...
g_pButtonWeapon:AddDummyInt( NPC_UNIT_ID["NUI_TOMA"] )
...
g_pButtonAcc:AddDummyInt( NPC_UNIT_ID["NUI_RICHANG"] )
...
g_pStaticbesma_town:AddPicture( g_pPicturebesma )

g_pPicturebesma:SetTex( "DLG_UI_Title02.tga", "besma_town" )
...
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(66-2,343-2)",
...
g_pButtonLeft:AddDummyInt( VILLAGE_MAP_ID["VMI_DUNGEON_GATE_ELDER"] )
...
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(881-2,339-2)",
...
g_pButtonRight:AddDummyInt( VILLAGE_MAP_ID["VMI_DUNGEON_GATE_BESMA"] )
---------------------- 도움말

g_pPictureHelper = g_pUIDialog:CreatePicture()
g_pStaticbesma_town:AddPicture( g_pPictureHelper )
...
g_pButtonEldu_Out = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButtonEldu_Out )
g_pButtonEldu_Out:SetName( "Eldu_Out" )

g_pButtonEldu_Out:SetNormalTex( "DLG_UI_Button11.tga", "L_Eldu_Out_normal" )

g_pButtonEldu_Out:SetOverTex( "DLG_UI_Button11.tga", "L_Eldu_Out_over" )

g_pButtonEldu_Out:SetDownTex( "DLG_UI_Button11.tga", "L_Eldu_Out_over" )

g_pButtonEldu_Out:SetDisableTex( "DLG_UI_Button11.tga", "L_Eldu_Out_noactive" )

g_pButtonEldu_Out:SetNormalPoint
{
	
    "LEFT_TOP		= D3DXVECTOR2(45,340)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonEldu_Out:SetOverPoint
{
...
g_pButtonEldu_Out:SetDownPoint
{
     ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(45+1,340+1)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}

g_pButtonEldu_Out:SetDisablePoint
{
...
g_pButtonEldu_Out:SetCustomMsgMouseUp( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_DUNGEON_GATE_CLICKED"] )
g_pButtonEldu_Out:AddDummyInt( VILLAGE_MAP_ID["VMI_DUNGEON_GATE_ELDER"] )
...
g_pButtonBesma_Out:SetNormalTex( "DLG_UI_Button11.tga", "R_Besma_Out_normal" )

g_pButtonBesma_Out:SetOverTex( "DLG_UI_Button11.tga", "R_Besma_Out_over" )

g_pButtonBesma_Out:SetDownTex( "DLG_UI_Button11.tga", "R_Besma_Out_over" )

g_pButtonBesma_Out:SetDisableTex( "DLG_UI_Button11.tga", "R_Besma_Out_noactive" )

g_pButtonBesma_Out:SetNormalPoint
{
	
    "LEFT_TOP		= D3DXVECTOR2(869,339)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonBesma_Out:SetDownPoint
{
     ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(869+1,339+1)",
