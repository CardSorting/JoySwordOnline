...
g_pStaticeldu_town = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticeldu_town )
g_pStaticeldu_town:SetName( "eldu_town" )
...
g_pStaticeldu_town:AddPicture( g_pPicture_shadow )
...
g_pStaticeldu_town:AddPicture( g_pPicture_bg1 )

g_pPicture_bg1:SetTex( "DLG_UI_MAP_Village01.tga", "eldu_town" ) 
...
g_pButtonNPC2:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(548+20,302)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonNPC2:SetOverPoint
...
g_pStaticeldu_town:AddPicture( g_pPictureeldu )

g_pPictureeldu:SetTex( "DLG_UI_Title02.tga", "eldu_town" )
...
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(65-2,371-2)",
...
g_pButtonLeft:AddDummyInt( VILLAGE_MAP_ID["VMI_DUNGEON_GATE_RUBEN"] )
...
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(923-2,375-2)",
...
g_pButtonRight:AddDummyInt( VILLAGE_MAP_ID["VMI_DUNGEON_GATE_ELDER"] )

---------------------- 도움말

g_pPictureHelper = g_pUIDialog:CreatePicture()
g_pStaticeldu_town:AddPicture( g_pPictureHelper )
...
g_pButtonRuben_Out:SetNormalTex( "DLG_UI_Button11.tga", "L_Ruben_Out_normal" )

g_pButtonRuben_Out:SetOverTex( "DLG_UI_Button11.tga", "L_Ruben_Out_over" )

g_pButtonRuben_Out:SetDownTex( "DLG_UI_Button11.tga", "L_Ruben_Out_over" )

g_pButtonRuben_Out:SetDisableTex( "DLG_UI_Button11.tga", "L_Ruben_Out_noactive" )

g_pButtonRuben_Out:SetNormalPoint
{
	
    "LEFT_TOP		= D3DXVECTOR2(45,367)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonRuben_Out:SetDownPoint
{
     ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(45+1,367+1)",
...
g_pButtonEldu_Out:SetNormalTex( "DLG_UI_Button11.tga", "R_Eldu_Out_normal" )

g_pButtonEldu_Out:SetOverTex( "DLG_UI_Button11.tga", "R_Eldu_Out_over" )

g_pButtonEldu_Out:SetDownTex( "DLG_UI_Button11.tga", "R_Eldu_Out_over" )

g_pButtonEldu_Out:SetDisableTex( "DLG_UI_Button11.tga", "R_Eldu_Out_noactive" )

g_pButtonEldu_Out:SetNormalPoint
{
	
    "LEFT_TOP		= D3DXVECTOR2(869,367)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonEldu_Out:SetDownPoint
{
     ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(869+1,367+1)",
