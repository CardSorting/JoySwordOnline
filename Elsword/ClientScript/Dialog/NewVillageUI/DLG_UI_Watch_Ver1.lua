...
g_pPicture_total_rank:SetTex( "DLG_UI_Title03.TGA", "TOTAL_score" )
...
g_pPicture_ranking:SetTex( "DLG_UI_Title03.TGA", "ranking_SCORE" )
...
g_pPicture_grade_icon:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(406-126,85)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
pItemSlot:SetSlotData
{
	...
	"POS		= D3DXVECTOR2( 28,127 )",
	"SIZE		= D3DXVECTOR2( slotsize_x-9, slotsize_y-9 )",
