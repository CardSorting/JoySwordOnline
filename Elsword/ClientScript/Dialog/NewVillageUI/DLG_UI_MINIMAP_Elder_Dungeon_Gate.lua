...
g_pStaticeldu_Gate = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticeldu_Gate )
g_pStaticeldu_Gate:SetName( "eldu_Gate" )
...
g_pStaticeldu_Gate:AddPicture( g_pPicture_shadow )
...
g_pStaticeldu_Gate:AddPicture( g_pPicture_bg1 )

g_pPicture_bg1:SetTex( "DLG_UI_MAP_Gate01.tga", "eldu_Gate" ) 

g_pPicture_bg1:SetPoint
{
     ADD_SIZE_X = 188+214,
	 ADD_SIZE_Y = 82+92,
	"LEFT_TOP		= D3DXVECTOR2(58,190)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonNPC1:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(286-17,435+20)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonNPC2:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(286+83+2,435+20)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonBOARD1:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(438+4,435+20)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPictureeldu_Gate = g_pUIDialog:CreatePicture()
g_pStaticeldu_Gate:AddPicture( g_pPictureeldu_Gate )

g_pPictureeldu_Gate:SetTex( "DLG_UI_Title02.tga", "eldu_out" )

g_pPictureeldu_Gate:SetPoint
{
...
g_pButtonLeft:SetNormalPoint
{
	ADD_SIZE_X = 2,
	ADD_SIZE_Y = 2,
    "LEFT_TOP		= D3DXVECTOR2(89,450+20)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(90-2,451-2+20)",
...
g_pButtonLeft:AddDummyInt( VILLAGE_MAP_ID["VMI_ELDER"] )
...
g_pButtonRight:SetNormalPoint
{
	ADD_SIZE_X = 2,
	ADD_SIZE_Y = 2,
    "LEFT_TOP		= D3DXVECTOR2(920,452+20)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(921-2,453-2+20)",
...
g_pButtonRight:AddDummyInt( VILLAGE_MAP_ID["VMI_BESMA"] )


---------------------- 도움말

g_pPictureHelper = g_pUIDialog:CreatePicture()
g_pStaticeldu_Gate:AddPicture( g_pPictureHelper )
...
g_pButtonEldu_Town:SetNormalTex( "DLG_UI_Button11.tga", "L_Eldu_Town_normal" )

g_pButtonEldu_Town:SetOverTex( "DLG_UI_Button11.tga", "L_Eldu_Town_over" )

g_pButtonEldu_Town:SetDownTex( "DLG_UI_Button11.tga", "L_Eldu_Town_over" )

g_pButtonEldu_Town:SetDisableTex( "DLG_UI_Button11.tga", "L_Eldu_Town_noactive" )

g_pButtonEldu_Town:SetNormalPoint
{
	 
    "LEFT_TOP		= D3DXVECTOR2(45,448)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonEldu_Town:SetDownPoint
{
     ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(45+1,448+1)",
...
g_pButtonBesma_Town:SetNormalTex( "DLG_UI_Button11.tga", "R_Besma_Town_normal" )

g_pButtonBesma_Town:SetOverTex( "DLG_UI_Button11.tga", "R_Besma_Town_over" )

g_pButtonBesma_Town:SetDownTex( "DLG_UI_Button11.tga", "R_Besma_Town_over" )

g_pButtonBesma_Town:SetDisableTex( "DLG_UI_Button11.tga", "R_Besma_Town_noactive" )

g_pButtonBesma_Town:SetNormalPoint
{
	 
    "LEFT_TOP		= D3DXVECTOR2(869,448)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonBesma_Town:SetDownPoint
{
     ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(869+1,448+1)",
...
ADD_SIZE_X = -10,
ADD_SIZE_Y = -10, 	
    "LEFT_TOP		= D3DXVECTOR2(286+83+2-35,435+20)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
