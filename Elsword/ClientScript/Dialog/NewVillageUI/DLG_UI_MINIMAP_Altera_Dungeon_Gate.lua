...
g_pPicture_bg1:SetTex( "DLG_UI_MAP_Gate02.tga", "altera_Gate" ) 
...
g_pButtonBOARD1:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(438-35,473)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicturealtera_Gate:SetTex( "DLG_UI_Title02.tga", "altera_out" )
...
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(67-2,491-2)",
...
--[[
	...
	g_pButtonRight:SetOverPoint
	{
		ADD_SIZE_X = 2,
		ADD_SIZE_Y = 2,
		"LEFT_TOP		= D3DXVECTOR2(820-1,466-1)",
...
g_pButtonAltera_Town:SetNormalTex( "DLG_UI_Button11.tga", "L_Altera_Town_normal" )

g_pButtonAltera_Town:SetOverTex( "DLG_UI_Button11.tga", "L_Altera_Town_over" )

g_pButtonAltera_Town:SetDownTex( "DLG_UI_Button11.tga", "L_Altera_Town_over" )

g_pButtonAltera_Town:SetDisableTex( "DLG_UI_Button11.tga", "L_Altera_Town_noactive" )

g_pButtonAltera_Town:SetNormalPoint
{
	
    "LEFT_TOP		= D3DXVECTOR2(45,468)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonAltera_Town:SetDownPoint
{
     ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(45+1,468+1)",
...
ADD_SIZE_X = -10,
ADD_SIZE_Y = -10, 	
    "LEFT_TOP		= D3DXVECTOR2(330-163,473)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
