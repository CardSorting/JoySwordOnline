...
g_pUIDialog:SetCloseCustomUIEventID( UI_INVENTORY_MSG["UIM_RESOLVE_ITEM_RESULT_OK"] )
...
g_pPicture_result = g_pUIDialog:CreatePicture()
g_pStaticresult:AddPicture( g_pPicture_result )

g_pPicture_result:SetTex( "DLG_UI_Title01.TGA", "item_apart" )

g_pPicture_result:SetPoint
{
...
g_pPicture_result:SetTex( "DLG_UI_Title01.TGA", "result" )

g_pPicture_result:SetPoint
{
    
	"LEFT_TOP		= D3DXVECTOR2(117+20,11+1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtoncheck:SetCustomMsgMouseUp( UI_INVENTORY_MSG["UIM_RESOLVE_ITEM_RESULT_OK"] )
g_pButtoncheck:SetEdge( false, 1, D3DXCOLOR( 0.4,0.6,0.8,1 ) )
g_pButtoncheck:RequestFocus()

--#ifdef ELLIPSE_GLOBAL 말줄임표 툴팁
g_pStaticToolTipDesc1= g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pStaticToolTipDesc1 )
g_pStaticToolTipDesc1:SetName( "DungeonDescriptionToolTip1" )
g_pStaticToolTipDesc1:SetNormalTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc1:SetOverTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc1:SetDownTex( "DLG_Common_New_Texture03.tga", "invisible" )

 g_pStaticToolTipDesc1:SetNormalPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
	 
 	"LEFT_TOP		= D3DXVECTOR2(81,82)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pStaticToolTipDesc1:SetOverPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc1:SetDownPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc1:SetGuideDesc( STR_ID_27 )

--#ifdef ELLIPSE_GLOBAL 말줄임표 툴팁
g_pStaticToolTipDesc2= g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pStaticToolTipDesc2 )
g_pStaticToolTipDesc2:SetName( "DungeonDescriptionToolTip2" )
g_pStaticToolTipDesc2:SetNormalTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc2:SetOverTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc2:SetDownTex( "DLG_Common_New_Texture03.tga", "invisible" )

 g_pStaticToolTipDesc2:SetNormalPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
	 
 	"LEFT_TOP		= D3DXVECTOR2(281,82)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pStaticToolTipDesc2:SetOverPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc2:SetDownPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc2:SetGuideDesc( STR_ID_27 )

--#ifdef ELLIPSE_GLOBAL 말줄임표 툴팁
g_pStaticToolTipDesc3= g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pStaticToolTipDesc3 )
g_pStaticToolTipDesc3:SetName( "DungeonDescriptionToolTip3" )
g_pStaticToolTipDesc3:SetNormalTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc3:SetOverTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc3:SetDownTex( "DLG_Common_New_Texture03.tga", "invisible" )

 g_pStaticToolTipDesc3:SetNormalPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
	 
 	"LEFT_TOP		= D3DXVECTOR2(81,82+65)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pStaticToolTipDesc3:SetOverPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc3:SetDownPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc3:SetGuideDesc( STR_ID_27 )

--#ifdef ELLIPSE_GLOBAL 말줄임표 툴팁
g_pStaticToolTipDesc4= g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pStaticToolTipDesc4 )
g_pStaticToolTipDesc4:SetName( "DungeonDescriptionToolTip4" )
g_pStaticToolTipDesc4:SetNormalTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc4:SetOverTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc4:SetDownTex( "DLG_Common_New_Texture03.tga", "invisible" )

 g_pStaticToolTipDesc4:SetNormalPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
	 
 	"LEFT_TOP		= D3DXVECTOR2(281,82+65)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pStaticToolTipDesc4:SetOverPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc4:SetDownPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc4:SetGuideDesc( STR_ID_27 )

--#ifdef ELLIPSE_GLOBAL 말줄임표 툴팁
g_pStaticToolTipDesc5= g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pStaticToolTipDesc5 )
g_pStaticToolTipDesc5:SetName( "DungeonDescriptionToolTip5" )
g_pStaticToolTipDesc5:SetNormalTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc5:SetOverTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc5:SetDownTex( "DLG_Common_New_Texture03.tga", "invisible" )

 g_pStaticToolTipDesc5:SetNormalPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
	 
 	"LEFT_TOP		= D3DXVECTOR2(81,82+65+65)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pStaticToolTipDesc5:SetOverPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc5:SetDownPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc5:SetGuideDesc( STR_ID_27 )

--#ifdef ELLIPSE_GLOBAL 말줄임표 툴팁
g_pStaticToolTipDesc6= g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pStaticToolTipDesc6 )
g_pStaticToolTipDesc6:SetName( "DungeonDescriptionToolTip6" )
g_pStaticToolTipDesc6:SetNormalTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc6:SetOverTex( "DLG_Common_New_Texture03.tga", "invisible" )
g_pStaticToolTipDesc6:SetDownTex( "DLG_Common_New_Texture03.tga", "invisible" )

 g_pStaticToolTipDesc6:SetNormalPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
	 
 	"LEFT_TOP		= D3DXVECTOR2(281,82+65+65)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pStaticToolTipDesc6:SetOverPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc6:SetDownPoint
{
    ADD_SIZE_X = 130,
	ADD_SIZE_Y = 25,
...
g_pStaticToolTipDesc6:SetGuideDesc( STR_ID_27 )
--#endif ELLIPSE_GLOBAL 말줄임표 툴팁