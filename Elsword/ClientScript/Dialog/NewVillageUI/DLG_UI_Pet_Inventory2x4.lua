...
--------------- Static
g_pStatic_Pat_Inven3 = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_Pat_Inven3 )
g_pStatic_Pat_Inven3:SetName( "g_pStatic_Pat_Inven3" )
...
--------------- BG
g_pPicture_Pat_Inven_BG3_top = g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven3:AddPicture( g_pPicture_Pat_Inven_BG3_top )
g_pPicture_Pat_Inven_BG3_top:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_BG3_TOP" )
g_pPicture_Pat_Inven_BG3_top:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(393,300)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}


g_pPicture_Pat_Inven_BG3_middle = g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven3:AddPicture( g_pPicture_Pat_Inven_BG3_middle )

g_pPicture_Pat_Inven_BG3_middle:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_BG3_MIDDLE" )
g_pPicture_Pat_Inven_BG3_middle:SetPoint
{
--	ADD_SIZE_Y = 299,
	ADD_SIZE_Y = sizeYForBG,
	"LEFT_TOP		= D3DXVECTOR2(393,300+20)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}

g_pPicture_Pat_Inven_BG3_bottom= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven3:AddPicture( g_pPicture_Pat_Inven_BG3_bottom )

g_pPicture_Pat_Inven_BG3_bottom:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_BG3_BOTTOM" )
g_pPicture_Pat_Inven_BG3_bottom:SetPoint
{

--	"LEFT_TOP		= D3DXVECTOR2(393,621)",
	"LEFT_TOP		= D3DXVECTOR2(393, posForBGLeftTopOfBottom)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Pat_Inven_balck3_box_top= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven3:AddPicture( g_pPicture_Pat_Inven_balck3_box_top )
g_pPicture_Pat_Inven_balck3_box_top:SetTex( "DLG_UI_Common_Texture39.TGA", "PAT_INVEN_GRAY3_TOP" )

g_pPicture_Pat_Inven_balck3_box_top:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(412,352)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Pat_Inven_balck3_box_middle= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven3:AddPicture( g_pPicture_Pat_Inven_balck3_box_middle )
g_pPicture_Pat_Inven_balck3_box_middle:SetTex( "DLG_UI_Common_Texture39.TGA", "PAT_INVEN_GRAY3_MIDDLE" )

g_pPicture_Pat_Inven_balck3_box_middle:SetPoint
{
--	ADD_SIZE_Y = 239,
	ADD_SIZE_Y = sizeYForBlackBox,
	"LEFT_TOP		= D3DXVECTOR2(412,352+11)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Pat_Inven_balck3_box_bottom= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven3:AddPicture( g_pPicture_Pat_Inven_balck3_box_bottom )
g_pPicture_Pat_Inven_balck3_box_bottom:SetTex( "DLG_UI_Common_Texture39.TGA", "PAT_INVEN_GRAY3_BOTTOM" )

g_pPicture_Pat_Inven_balck3_box_bottom:SetPoint
{

--	"LEFT_TOP		= D3DXVECTOR2(412,605)",
	"LEFT_TOP		= D3DXVECTOR2(412, posForBlackBoxLeftTopOfBottom)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
--------------- 펫 인벤 창
g_pPicture_Pat_Inven_win3_top= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven3:AddPicture( g_pPicture_Pat_Inven_win3_top )
g_pPicture_Pat_Inven_win3_top:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_win3_top" )

g_pPicture_Pat_Inven_win3_top:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(413,355)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}

g_pPicture_Pat_Inven_win3_middle= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven3:AddPicture( g_pPicture_Pat_Inven_win3_middle )
g_pPicture_Pat_Inven_win3_middle:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_win3_middle" )

g_pPicture_Pat_Inven_win3_middle:SetPoint
{
--	ADD_SIZE_Y = 231,
    ADD_SIZE_Y = sizeYForWin,
	"LEFT_TOP		= D3DXVECTOR2(413+1,367)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Pat_Inven_win3_bottom= g_pUIDialog:CreatePicture()
g_pStatic_Pat_Inven3:AddPicture( g_pPicture_Pat_Inven_win3_bottom )
g_pPicture_Pat_Inven_win3_bottom:SetTex( "DLG_UI_Common_Texture39.TGA", "Pat_Inven_win3_bottom" )

g_pPicture_Pat_Inven_win3_bottom:SetPoint
{
    
--	"LEFT_TOP		= D3DXVECTOR2(413+1,600)",
	"LEFT_TOP		= D3DXVECTOR2(413+1, posForWinLeftTopOfBottom)",	
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonX:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(517-4,316)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonX:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(517+1-4,316+1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStatic_Pat_Inven3:AddPicture( g_pPicture_Pat_Inven_title)
...
if numOfLineInPetInven >= 1 then
	...
	g_pPicture_Pat_Inven_Slot2:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(424+51,395)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 424+51 + 1 ,395 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}
...
if numOfLineInPetInven >= 2 then
	...
	g_pPicture_Pat_Inven_Slot5:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(424+51,446)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 424+51 + 1 ,446 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}
...
if numOfLineInPetInven >= 3 then
	...
	g_pPicture_Pat_Inven_Slot8:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(424+51,497)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 424+51 + 1 ,497 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}	
...
if numOfLineInPetInven >= 4 then
	...
	g_pPicture_Pat_Inven_Slot11:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(424+51,548)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 424+51 + 1 ,548 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}		
