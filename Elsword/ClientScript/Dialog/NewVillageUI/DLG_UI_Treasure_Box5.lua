...
g_pPictureImage5 = g_pUIDialog:CreatePicture()
g_pStaticTreasure_Box:AddPicture( g_pPictureImage5 )

g_pPictureImage5:SetTex( "DLG_UI_Treasure_Box5.tga", "TREASURE_BOX5" )

g_pPictureImage5:SetPoint
{
