...
g_pStaticbroken = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticbroken )
g_pStaticbroken:SetName( "broken" )
...
g_pStaticbroken:AddPicture( g_pPicture_bg )
...
g_pStaticbroken:AddPicture( g_pPicture_title )
...
g_pStaticbroken:AddPicture( g_pPicturebg2 )
...
g_pStaticbroken:AddPicture( g_pPictureWindow_image )

g_pPictureWindow_image:SetTex( "DLG_UI_Common_Texture07.tga", "broken" )

g_pPictureWindow_image:SetPoint
{


	"LEFT_TOP		= D3DXVECTOR2(33,54)",
...
g_pPictureWindow_image:SetTex( "DLG_UI_Title01_A.tga", "DISABLED" )

g_pPictureWindow_image:SetPoint
{


	"LEFT_TOP		= D3DXVECTOR2(145,54-10)",
...
g_pStaticbroken:AddPicture( g_pPicturebg3 )
...
g_pStaticbroken:AddPicture( g_pPicturemark )
...
g_pPicturemark:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(28-16,202-5)",
...
g_pStaticbroken:AddPicture( g_pPicturelevel_box )
...
g_pPicturebroken = g_pUIDialog:CreatePicture()
g_pStaticbroken:AddPicture( g_pPicturebroken )

g_pPicturebroken:SetTex( "DLG_UI_Title01.TGA", "broken2" )

g_pPicturebroken:SetPoint
{
	ADD_SIZE_X		= -16,
	ADD_SIZE_Y		= -3,
	"LEFT_TOP		= D3DXVECTOR2(282-20+12,154+5)",
...
g_pStaticbroken:AddPicture( g_pPicturebar )
