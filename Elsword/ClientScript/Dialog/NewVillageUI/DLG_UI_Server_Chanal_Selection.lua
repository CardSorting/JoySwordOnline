...
g_pPicture_title:SetTex( "DLG_UI_Title01_A.TGA", "server_selec" )
...
--	"LEFT_TOP		= D3DXVECTOR2(20,188)",
	"LEFT_TOP		= D3DXVECTOR2(20,188-57)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButton_sever_select02:SetShowEnable( false , false)	-- 2011. 1. 3 조효진  안보이도록 수정
...
--[[
								...
								g_pPicture_red:SetTex( "DLG_UI_Title01_A.TGA", "confusion" )
								...
								g_pPicture_blue:SetTex( "DLG_UI_Title01_A.TGA", "normal" )
								...
								g_pPicture_green:SetTex( "DLG_UI_Title01_A.TGA", "smooth" )
...
g_pStatic_server:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_LEFT"],
	--"POS 			= D3DXVECTOR2(165+5,103+56)",
	"POS 			= D3DXVECTOR2(165+5 + 15,103)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	"OUTLINE_COLOR		= D3DXCOLOR(0.0,0.0,0.0,1.0)",
}
...
g_pPicture_title:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(413-8,76-1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonesc:SetDownPoint
{
     ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(903+1,10+1)",
...
-- 2010. 12. 7 조효진  안보이도록 수정
--g_pStatic_Notice:SetShowEnable( false , false)
...
-- 2010. 12. 7 조효진  안보이도록 수정
--g_pPicture_Notice:SetShow( false, false )

g_pPicture_Notice:SetPoint
{
    
	"LEFT_TOP		= D3DXVECTOR2(465-10,81)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
