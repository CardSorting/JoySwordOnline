...
g_pPicture_Item:SetTex( "DLG_UI_Title01.TGA", "Item3" )

g_pPicture_Item:SetPoint
{
   
	"LEFT_TOP		= D3DXVECTOR2(258+61,119)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
   ADD_SIZE_Y = 18,
	"LEFT_TOP		= D3DXVECTOR2(315+47,116)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_info:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(322+47,119)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
   ADD_SIZE_Y = 18,
	"LEFT_TOP		= D3DXVECTOR2(352+47,116)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_info:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(359+47,119)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
   ADD_SIZE_Y = 18,
	"LEFT_TOP		= D3DXVECTOR2(388+47,116)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_info:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(396+47,119)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Item:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(663+61,119)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
   ADD_SIZE_Y = 18,
	"LEFT_TOP		= D3DXVECTOR2(720+47,116)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_info:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(727+47,119)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
   ADD_SIZE_Y = 18,
	"LEFT_TOP		= D3DXVECTOR2(757+47,116)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_info:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(765+47,119)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
   ADD_SIZE_Y = 18,
	"LEFT_TOP		= D3DXVECTOR2(793+47,116)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_info:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(801+47,119)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
ChannelGuide4 = string.format( "VP: %d - 99999999", PVP_EMBLEM["PE_MERCENARY"] ) --, PVP_EMBLEM["PE_END"] - 1 )
...
for i = 0, 5 do
	...
	for j = 0, 1 do
			...
			g_pStatic_list:AddString
			{
				...
				SORT_FLAG		= DRAW_TEXT["DT_CENTER"],
				"POS 			= D3DXVECTOR2(tempX + 149 + 47,tempY + 14)",
				"COLOR			= D3DXCOLOR(0.0,0.0,0.0,0.7)",
				"OUTLINE_COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
			}
			...
			g_pStatic_list:AddString
			{
				...
				FONT_INDEX		= XUF_DODUM_11_NORMAL,
				SORT_FLAG		= DRAW_TEXT["DT_CENTER"],
				"POS 			= D3DXVECTOR2(tempX + 186 + 46,tempY + 14)",
				"COLOR			= D3DXCOLOR(0.0,0.0,0.0,0.7)",
				"OUTLINE_COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
			}
			...
			g_pStatic_list:AddString
			{
				...
				"POS 			= D3DXVECTOR2(tempX + 211 + 47,tempY + 14)",
				"COLOR			= D3DXCOLOR(0.0,0.0,0.0,0.7)",
				"OUTLINE_COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
			}
			...
			g_pStatic_list:AddString
			{
				...
				FONT_INDEX		= XUF_DODUM_11_NORMAL,
				SORT_FLAG		= DRAW_TEXT["DT_LEFT"],
				"POS 			= D3DXVECTOR2(tempX + 66 + 9, tempY + 16 - 2)",
			...
			g_pStatic_list:AddString
			{
				...
				FONT_INDEX		= XUF_DODUM_11_NORMAL,
				SORT_FLAG		= DRAW_TEXT["DT_CENTER"],
				"POS 			= D3DXVECTOR2(tempX + 152 + 3,tempY + 14)",
				"COLOR			= D3DXCOLOR(0.0,0.0,0.0,0.7)",
				"OUTLINE_COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
			}
			ListID = ListID + 1
