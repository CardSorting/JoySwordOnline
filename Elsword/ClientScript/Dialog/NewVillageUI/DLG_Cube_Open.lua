...
g_pUIDialog:SetCloseCustomUIEventID( UI_INVENTORY_MSG["UIM_EXIT_RANDOM_ITEM_NEW"]  )
...
g_pPictureNote_Loading_BG1:SetTex( "DLG_UI_Common_Texture40.tga", "Note" )
...
g_pPictureNote_Loading_BG2:SetTex( "DLG_UI_Common_Texture40.TGA", "Blue_Bar" )
