...
g_pStatic_Help_Epic:SetName( "Help_skill" )
...
g_pPicture_Q:SetTex( "DLG_UI_Common_Texture36.TGA", "Guide_Skill01" )

g_pPicture_Q:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(100,63)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_Q:SetTex( "DLG_UI_Common_Texture37.TGA", "Guide_Skill02" )

g_pPicture_Q:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(612,63)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtoncomplete:SetCustomMsgMouseUp( SKILL_TREE_UI_CUSTOM_MSG["STUCM_FIRST_GUIDE_CLOSE"] )
