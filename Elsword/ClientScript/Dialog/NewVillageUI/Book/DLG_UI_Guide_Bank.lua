...
g_pStaticGuide_Bank = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticGuide_Bank )
g_pStaticGuide_Bank:SetName( "Guide_Bank" )


g_pPicturePvp01 = g_pUIDialog:CreatePicture()
g_pStaticGuide_Bank:AddPicture( g_pPicturePvp01 )

g_pPicturePvp01:SetTex( "DLG_UI_Guide_Bank01.TGA", "Guide_Bank01" )
...
g_pStaticGuide_Bank:AddPicture( g_pPicturePvp02 )

g_pPicturePvp02:SetTex( "DLG_UI_Guide_Bank02.TGA", "Guide_Bank02" )
