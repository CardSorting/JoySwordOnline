...
g_pUIDialog:AddDummyPos( D3DXVECTOR3( 59, 113+OFFSET_Y, 200 ) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3( 286, 113+OFFSET_Y, 200 ) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3( 513, 113+OFFSET_Y, 200 ) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3( 740, 113+OFFSET_Y, 200 ) )
...
--- 3D 캐릭터 위치
g_pUIDialog:AddDummyPos( D3DXVECTOR3( 1480, 148-40, 50-120 ) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3( 1720, 148-40, 50-140 ) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3( 1960, 148-40, 50-140 ) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3( 2200, 148-40, 100-120 ) )
...
g_pPicture_title:SetTex( "DLG_UI_Title01.TGA", "charac_selec" )
...
g_pPicture_help:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(61,421+OFFSET_Y)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtontutorial:SetNormalTex( "DLG_UI_Button08_TEST.tga", "tutorial_normal" )

g_pButtontutorial:SetOverTex( "DLG_UI_Button08_TEST.tga", "tutorial_over" )

g_pButtontutorial:SetDownTex( "DLG_UI_Button08_TEST.tga", "tutorial_over" )
...
g_pButtontutorial:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(57,418+OFFSET_Y)",
...
g_pButtontutorial:SetDownPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(57+1,418+1+OFFSET_Y)",
...
g_pPicture_start:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(729,421+OFFSET_Y)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonstart:SetNormalTex( "DLG_UI_Button08_TEST.tga", "start_normal" )

g_pButtonstart:SetOverTex( "DLG_UI_Button08_TEST.tga", "start_over" )

g_pButtonstart:SetDownTex( "DLG_UI_Button08_TEST.tga", "start_over" )
...
g_pButtonstart:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(725,418+OFFSET_Y)",
...
g_pButtonstart:SetDownPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(725+1,418+1+OFFSET_Y)",
...
g_pPicture_delete:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(846,421+OFFSET_Y)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtondelete:SetNormalTex( "DLG_UI_Button08_TEST.tga", "delete_normal" )

g_pButtondelete:SetOverTex( "DLG_UI_Button08_TEST.tga", "delete_over" )

g_pButtondelete:SetDownTex( "DLG_UI_Button08_TEST.tga", "delete_over" )
...
g_pButtondelete:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(842,418+OFFSET_Y)",
...
g_pButtondelete:SetDownPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(842+1,418+1+OFFSET_Y)",
...
g_pButtonchanal:SetNormalTex( "DLG_UI_Button08_TEST.tga", "chanalselrec_normal" )

g_pButtonchanal:SetOverTex( "DLG_UI_Button08_TEST.tga", "chanalselrec_over" )

g_pButtonchanal:SetDownTex( "DLG_UI_Button08_TEST.tga", "chanalselrec_over" )

g_pButtonchanal:SetNormalPoint
{
	
    "LEFT_TOP		= D3DXVECTOR2(907,10)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonchanal:SetDownPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(905+1,10 +1)",
...
g_pButtonL_arrow:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(869,80+OFFSET_Y)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonL_arrow:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(869,79+OFFSET_Y)",
...
g_pButtonL_arrow:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(869+1,79+1+OFFSET_Y)",
...
g_pButtonR_arrow:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(946,80+OFFSET_Y)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonR_arrow:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(945,79+OFFSET_Y)",
...
g_pButtonR_arrow:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(945+1,79+1+OFFSET_Y)",
...
g_pPicture_page:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(886,78+OFFSET_Y)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStatic_number:AddString
{
	...
	"POS 			= D3DXVECTOR2(915,84+OFFSET_Y)",
...
{
    ADD_SIZE_X = 914, 
	"LEFT_TOP		= D3DXVECTOR2(53,107+OFFSET_Y)", 
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
--]]
...
g_pPictureBox:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(805,8+OFFSET_Y)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
     ADD_SIZE_X = 63,
	"LEFT_TOP		= D3DXVECTOR2(811,8+OFFSET_Y)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPictureBox:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(875,8+OFFSET_Y)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStaticNum:AddString
{
	...
	SORT_FLAG		= DRAW_TEXT["DT_CENTER"],
	"POS 			= D3DXVECTOR2( 843, 14+OFFSET_Y )",
