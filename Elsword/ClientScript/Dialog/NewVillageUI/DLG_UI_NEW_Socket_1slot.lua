...
g_pPicture_bg5:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(0,193+40+40+40-1-40-40-40)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStatic_ED:AddString
{
	...
	"POS 			= D3DXVECTOR2(114,377-40-40-40)",
...
g_pButton_Socket:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(201+4,362+4-40-40-40)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButton_Socket:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(201,362-40-40-40)",
...
g_pButton_Socket:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(201+1,362+1-40-40-40)",
...
g_pStatic_Btn_Socket:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_CENTER"],
	"POS 			= D3DXVECTOR2(246+2,373+2-40-40-40)",
...
g_pStatic_Btn_Socket:AddString
{
	...
	FONT_STYLE      = FONT_STYLE["FS_SHELL"],
	SORT_FLAG		= DRAW_TEXT["DT_CENTER"],
	"POS 			= D3DXVECTOR2(246,373-40-40-40)",
