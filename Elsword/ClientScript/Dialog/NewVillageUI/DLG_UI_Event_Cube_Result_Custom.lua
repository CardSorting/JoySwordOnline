...
{
    ADD_SIZE_Y		= FIX_Y_SIZE,
	"LEFT_TOP		= D3DXVECTOR2(435 - 205,0)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_result:SetTex( "DLG_UI_Title03.tga", "BRIDGE_BUNNING" )
...
{
    ADD_SIZE_Y		= FIX_Y_SIZE + 10,
	"LEFT_TOP		= D3DXVECTOR2(425-205,70)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonX:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(409-205,13)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonX:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(405-205,9)",
...
g_pButtonX:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(405+1-205,9+1)",
...
g_pButtoncheck:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(179-100,278-133)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtoncheck:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(176-100,275-133)",
...
g_pButtoncheck:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(176+1-100,275+1-133)",
