...
g_pUIDialog:SetPos( 384,334 )
g_pUIDialog:SetModal( false )
g_pUIDialog:SetFront( true )
g_pUIDialog:SetLayer( X2_DIALOG_LAYER["XDL_POP_UP"] )
g_pUIDialog:SetCloseCustomUIEventID( RELATIONSHIP_UI_MESSAGE["RUM_COUPLE_INVITE_USE_ITEM_CANCEL"] )
...
g_pPictureCashshop_PresentWindow_BG1:SetTex( "DLG_UI_Common_Texture_MarriageSystem_04.TGA", "Bg_CoupleNickname_Notice" )

g_pPictureCashshop_PresentWindow_BG1:SetPoint
{

	"LEFT_TOP		= D3DXVECTOR2(50,55)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonFriend:SetCustomMsgMouseUp( RELATIONSHIP_UI_MESSAGE["RUM_COUPLE_INVITE_USE_ITEM_OK"]  )
...
g_pButtonGuild:SetCustomMsgMouseUp( RELATIONSHIP_UI_MESSAGE["RUM_COUPLE_INVITE_USE_ITEM_CANCEL"]  )
...
{
--	MSG 			= STR_ID_24454, --"[커플 신청할 유저의 닉네임을 입력하세요.]",
...
g_pIME_Password = g_pUIDialog:CreateIMEEditBox()
g_pUIDialog:AddControl( g_pIME_Password )
g_pIME_Password:SetName( "IMEEditBoxMessage" )
...
g_pIME_Password:SetCustomMsgEnter( RELATIONSHIP_UI_MESSAGE["RUM_COUPLE_INVITE_USE_ITEM_OK"] )
g_pIME_Password:SetByteLimit( 16 )
g_pIME_Password:RequestFocus()
