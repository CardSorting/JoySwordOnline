...
g_pUIDialog:SetCloseCustomUIEventID( UI_PERSONAL_SHOP_CUSTOM_MSG["UPSCM_SELL_EXIT"] )
...
g_pPicture_title:SetTex( "DLG_UI_Title01.TGA", "shop_open2" )
...
g_pButtonX:SetCustomMsgMouseUp( UI_PERSONAL_SHOP_CUSTOM_MSG["UPSCM_SELL_EXIT"] )
...
g_pButtonL_arrow:SetCustomMsgMouseUp( UI_PERSONAL_SHOP_CUSTOM_MSG["UPSCM_SELL_PREV_PAGE"] )
...
g_pButtonR_arrow:SetCustomMsgMouseUp( UI_PERSONAL_SHOP_CUSTOM_MSG["UPSCM_SELL_NEXT_PAGE"] )
...
g_pButtonsell:SetCustomMsgMouseUp( UI_PERSONAL_SHOP_CUSTOM_MSG["UPSCM_SELL_BEGIN"] )
