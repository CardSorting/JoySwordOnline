...
g_pStaticTreasure_Box:SetName( "Treasure_Box2" )


g_pPictureImage2 = g_pUIDialog:CreatePicture()
g_pStaticTreasure_Box:AddPicture( g_pPictureImage2 )

g_pPictureImage2:SetTex( "DLG_UI_Treasure_Box2.tga", "TREASURE_BOX2" )

g_pPictureImage2:SetPoint
{
