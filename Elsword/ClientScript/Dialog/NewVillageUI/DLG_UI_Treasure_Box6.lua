...
g_pPictureImage6 = g_pUIDialog:CreatePicture()
g_pStaticTreasure_Box:AddPicture( g_pPictureImage6 )

g_pPictureImage6:SetTex( "DLG_UI_Treasure_Box6.tga", "TREASURE_BOX6" )

g_pPictureImage6:SetPoint
{
