...
g_pRadioButton_team_match:SetRBPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(414,492)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(510,540)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pRadioButton_team_match:SetCheckPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(412+1,490+1)",
 	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pRadioButton_death_match:SetRBPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(512,492)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(608,540)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pRadioButton_death_match:SetCheckPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(510+1,490+1)",
 	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pRadioButton_survival_match:SetRBPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(610,492)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(706,540)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pRadioButton_survival_match:SetCheckPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(607+1,490+1)",
 	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButton_exit:SetDownPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(693+1,392+1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButton_minus:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(488+1,548+1)",
...
g_pButton_plus:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(613+1,548+1)",
...
g_pButton_plus:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(613+1,576+1)",
...
g_pButtonroom:SetDownPoint
{
      ADD_SIZE_X = -2,
     ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(490+1,633+1)",
...
g_pCheckBoxsecret:SetBGPoint
{
	USE_TEXTURE_SIZE	= FALSE,
	"LEFT_TOP		= D3DXVECTOR2(462,609)",
 	"RIGHT_BOTTOM		= D3DXVECTOR2(477,624)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
	USE_TEXTURE_SIZE= FALSE,
	"LEFT_TOP		= D3DXVECTOR2(466,440)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(705,465)",
...
g_pIME_Editname:SetLengthLimit(20)
...
{
	USE_TEXTURE_SIZE= FALSE,
	"LEFT_TOP		= D3DXVECTOR2(505,607)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(617,627)",
	"COLOR			= D3DXCOLOR(0.0,0.0,0.0,1.0)",
	CHANGE_TIME		= 0.0,
}
