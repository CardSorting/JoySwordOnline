...
--g_pUIDialog:SetModal( false )
g_pUIDialog:SetPos( 250, 125 ) 
--g_pUIDialog:SetPos( 0, 0 ) 
g_pUIDialog:SetLayer( X2_DIALOG_LAYER["XDL_GAME_EDIT"] )
g_pUIDialog:SetCloseCustomUIEventID( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_EXIT"] )
...
g_pStaticNoticeTop:AddString
{
	...
	"POS 			= D3DXVECTOR2(163+21+ 55,19+5)",
...
g_pPictureBlind_Notice1:SetPoint
{
	"LEFT_TOP		= D3DXVECTOR2(126-66,152)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
	}
...
{
	"LEFT_TOP		= D3DXVECTOR2(126-66,152+94)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
	}
...
{
	"LEFT_TOP		= D3DXVECTOR2(126-66,152+94+94)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
	}
...
g_pButton_Skill_Reset:SetCustomMsgMouseUp( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_SKILL_RESET_MODE_CHANGE"] )
g_pButton_Skill_Reset:SetCustomMsgMouseOver( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_SKILL_RESET_MODE_CHANGE_MOUSEOVER"] )
g_pButton_Skill_Reset:SetCustomMsgMouseOut( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_SKILL_RESET_MODE_CHANGE_MOUSEOUT"] )
...
g_pButton_Notice_Notice_SP:SetCustomMsgMouseOver( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_CSP_GUIDE_MOUSEIN"] )
g_pButton_Notice_Notice_SP:SetCustomMsgMouseOut( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_CSP_GUIDE_MOUSEOUT"] )
...
g_pButton_Notice_Slot:SetCustomMsgMouseOver( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_SKILLTREESLOTB_GUIDE_MOUSEIN"] )
g_pButton_Notice_Slot:SetCustomMsgMouseOut( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_SKILLTREESLOTB_GUIDE_MOUSEOUT"] )
...
g_pControlList:SetCustomMsgScroll( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_CONTROLLIST_SCROLL"] )
...
g_pButtonX:SetCustomMsgMouseUp( GUILD_SKILL_TREE_INFO_CUSTOM_MSG["GSTICM_EXIT"] )
...
g_pRadioButtonGuild_Skill:SetRBPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(90+76+70,55+1)",
	"RIGHT_BOTTOM	= D3DXVECTOR2(90+64+76+70,80+1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
