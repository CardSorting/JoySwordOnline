...
if numOfLineInPetInven >= 1 then
	...
	g_pPicture_Pat_Inven_Slot1:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(424+25,395)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 424+25 + 1 ,395 + 1 )",
...
if numOfLineInPetInven >= 2 then
	...
	g_pPicture_Pat_Inven_Slot4:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(424+25,446)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 424+25 + 1 ,446 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}
...
if numOfLineInPetInven >= 3 then
	...
	g_pPicture_Pat_Inven_Slot7:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(424+25,497)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 424+25 + 1 ,497 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}	
...
if numOfLineInPetInven >= 4 then
	...
	g_pPicture_Pat_Inven_Slot10:SetPoint
	{
		...
		"LEFT_TOP		= D3DXVECTOR2(424+25,548)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		CHANGE_TIME		= 0.0,
	}
		...
		pItemSlot:SetSlotData
		{
			...
			"POS		= D3DXVECTOR2( 424+25 + 1 ,548 + 1 )",
			"SIZE		= D3DXVECTOR2( 47, 47 )",
		}
