...
g_pStaticTreasure_Box:SetName( "Treasure_Box3" )



g_pPictureImage3 = g_pUIDialog:CreatePicture()
g_pStaticTreasure_Box :AddPicture( g_pPictureImage3 )

g_pPictureImage3:SetTex( "DLG_UI_Treasure_Box3.tga", "TREASURE_BOX3" )

g_pPictureImage3:SetPoint
{
