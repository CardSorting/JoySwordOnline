...
g_pStaticRuben_Gate = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticRuben_Gate )
g_pStaticRuben_Gate:SetName( "Ruben_Gate" )
...
g_pStaticRuben_Gate:AddPicture( g_pPicture_shadow )
...
g_pStaticRuben_Gate:AddPicture( g_pPicture_bg1 )

g_pPicture_bg1:SetTex( "DLG_UI_MAP_Gate01.tga", "Ruben_Gate" ) 
...
g_pButtonNPC1:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(438-70,459-20)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonNPC1:SetNormalPoint
{
    "LEFT_TOP		= D3DXVECTOR2(438+30,459-20)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonNPC1:SetOverPoint
...
g_pButtonNPC1:SetCustomMsgMouseOver( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_NPC_MOUSE_OVER"] )
g_pButtonNPC1:SetCustomMsgMouseOut( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_NPC_MOUSE_OUT"] )
g_pButtonNPC1:AddDummyInt( NPC_UNIT_ID["NUI_EVENT_APINK"] )
--]]
...
g_pButtonNPC1 = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButtonNPC1 )
g_pButtonNPC1:SetName( "APINK_ARCHANGEL" )
...
g_pButtonNPC1:SetCustomMsgMouseOver( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_NPC_MOUSE_OVER"] )
g_pButtonNPC1:SetCustomMsgMouseOut( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_NPC_MOUSE_OUT"] )
g_pButtonNPC1:AddDummyInt( NPC_UNIT_ID["NUI_EVENT_APINK_ARCHANGEL"] )
...
g_pButtonBOARD1:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(438-126,459)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonBOARD1:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(438+50,459)",
...
--[[
			g_pButtonBOARD2 = g_pUIDialog:CreateButton()
			g_pUIDialog:AddControl( g_pButtonBOARD2 )
			g_pButtonBOARD2:SetName( "GLAVE" )

			g_pButtonBOARD2:SetNormalTex( "MiniMap_BOARD.dds", "MiniMap_BOARD" )

			g_pButtonBOARD2:SetOverTex( "MiniMap_BOARD.dds", "MiniMap_BOARD" )

			g_pButtonBOARD2:SetDownTex( "MiniMap_BOARD.dds", "MiniMap_BOARD" )

			g_pButtonBOARD2:SetNormalPoint
			{
				
				"LEFT_TOP		= D3DXVECTOR2(438+65,459)",
				"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
				CHANGE_TIME		= 0.0,
			}
			g_pButtonBOARD2:SetOverPoint
			{
			...
			g_pButtonBOARD2:SetCustomMsgMouseOver( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_NPC_MOUSE_OVER"] )
			g_pButtonBOARD2:SetCustomMsgMouseOut( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_NPC_MOUSE_OUT"] )
			g_pButtonBOARD2:AddDummyInt( NPC_UNIT_ID["NUI_BILLBOARD"] )

			--g_pButtonBOARD2:SetCustomMsgMouseOver( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_BILLBOARD_MOUSE_OVER"] )
			--g_pButtonBOARD2:SetCustomMsgMouseOut( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_BILLBOARD_MOUSE_OUT"] )
--]]

----------------타이틀


g_pPictureRuben_Gate = g_pUIDialog:CreatePicture()
g_pStaticRuben_Gate:AddPicture( g_pPictureRuben_Gate )

g_pPictureRuben_Gate:SetTex( "DLG_UI_Title02.tga", "Ruben_out" )

g_pPictureRuben_Gate:SetPoint
{
...
g_pButtonLeft:SetNormalPoint
{
	ADD_SIZE_X = 2,
	ADD_SIZE_Y = 2,
    "LEFT_TOP		= D3DXVECTOR2(72+40,477)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(73-2+40,478-2)",
...
g_pButtonLeft:SetDisablePoint
{
	...
	ADD_SIZE_Y = 2,
 	"LEFT_TOP		= D3DXVECTOR2(75+40,477)",
    "COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonLeft:AddDummyInt( VILLAGE_MAP_ID["VMI_RUBEN"] )
...
g_pButtonRight:SetNormalPoint
{
	ADD_SIZE_X = 2,
	ADD_SIZE_Y = 2,
    "LEFT_TOP		= D3DXVECTOR2(918-35,477)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(919-2-35,478-2)",
...
g_pButtonRight:AddDummyInt( VILLAGE_MAP_ID["VMI_ELDER"] )
---------------------- 도움말

g_pPictureHelper = g_pUIDialog:CreatePicture()
g_pStaticRuben_Gate:AddPicture( g_pPictureHelper )
...
g_pButtonRuben_Town = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButtonRuben_Town )
g_pButtonRuben_Town:SetName( "Ruben_Town" )

g_pButtonRuben_Town:SetNormalTex( "DLG_UI_Button11.tga", "L_Ruben_Town_normal" )

g_pButtonRuben_Town:SetOverTex( "DLG_UI_Button11.tga", "L_Ruben_Town_over" )

g_pButtonRuben_Town:SetDownTex( "DLG_UI_Button11.tga", "L_Ruben_Town_over" )

g_pButtonRuben_Town:SetDisableTex( "DLG_UI_Button11.tga", "L_Ruben_Town_noactive" )


g_pButtonRuben_Town:SetNormalPoint
{
	
    "LEFT_TOP		= D3DXVECTOR2(47,457)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonRuben_Town:SetOverPoint
{
...
g_pButtonRuben_Town:SetDownPoint
{
     ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(47+1,457+1)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}

g_pButtonRuben_Town:SetDisablePoint
{

 	"LEFT_TOP		= D3DXVECTOR2(45,457)",
        "COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonRuben_Town:SetCustomMsgMouseUp( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_VILLAGE_CLICKED"] )
g_pButtonRuben_Town:AddDummyInt( VILLAGE_MAP_ID["VMI_RUBEN"] )
...
g_pButtonEldu_Town = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButtonEldu_Town )
g_pButtonEldu_Town:SetName( "Eldu_Town" )

g_pButtonEldu_Town:SetNormalTex( "DLG_UI_Button11.tga", "R_Eldu_Town_normal" )

g_pButtonEldu_Town:SetOverTex( "DLG_UI_Button11.tga", "R_Eldu_Town_over" )

g_pButtonEldu_Town:SetDownTex( "DLG_UI_Button11.tga", "R_Eldu_Town_over" )

g_pButtonEldu_Town:SetDisableTex( "DLG_UI_Button11.tga", "R_Eldu_Town_noactive" )

g_pButtonEldu_Town:SetNormalPoint
{
	
    "LEFT_TOP		= D3DXVECTOR2(869,456)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonEldu_Town:SetOverPoint
{
...
g_pButtonEldu_Town:SetDownPoint
{
     ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
 	"LEFT_TOP		= D3DXVECTOR2(869+1,456+1)",

	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}

g_pButtonEldu_Town:SetDisablePoint
{
...
g_pButtonEldu_Town:SetCustomMsgMouseUp( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_VILLAGE_CLICKED"] )
g_pButtonEldu_Town:AddDummyInt( VILLAGE_MAP_ID["VMI_ELDER"] )
--]]
-------------------------------------- 캐릭터/파티원 위치 마크 'ㅅ'
