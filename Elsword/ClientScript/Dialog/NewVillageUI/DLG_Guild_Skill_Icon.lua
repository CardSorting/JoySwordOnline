...
g_pPicture_Bg_Active = g_pUIDialog:CreatePicture()				-- 0
...
g_pPicture_Bg_Active_Special = g_pUIDialog:CreatePicture()		-- 1
...
g_pPicture_Bg_Active_Buff = g_pUIDialog:CreatePicture()			-- 2
...
g_pPicture_Bg_Passive = g_pUIDialog:CreatePicture()				-- 3
...
g_pPicture_Bg_SPBox = g_pUIDialog:CreatePicture()				-- 4
g_pStaticSkill_Icon:AddPicture( g_pPicture_Bg_SPBox )

g_pPicture_Bg_SPBox:SetTex( "DLG_UI_Common_Texture_NewSkill_01.TGA", "Bg_SkillSp_Text_Box" )

g_pPicture_Bg_SPBox:SetPoint
{
	"LEFT_TOP		= D3DXVECTOR2(35-1,65-1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pButtonPlus:SetCustomMsgMouseUp( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_BUTTON_SKILL_LEVEL_PLUS"] )
g_pButtonPlus:SetCustomMsgMouseOver( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_BUTTON_SKILL_LEVEL_PLUS_MOUSEOVER"] )
g_pButtonPlus:SetCustomMsgMouseOut( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_BUTTON_SKILL_LEVEL_PLUS_MOUSEOUT"] )
...
g_pButtonMinus:SetCustomMsgMouseUp( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_BUTTON_SKILL_LEVEL_MINUS"] )
g_pButtonMinus:SetCustomMsgMouseOver( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_BUTTON_SKILL_LEVEL_MINUS_MOUSEOVER"] )
g_pButtonMinus:SetCustomMsgMouseOut( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_BUTTON_SKILL_LEVEL_MINUS_MOUSEOUT"] )
...
g_pButtonMaster:SetCustomMsgMouseOver( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_BUTTON_SKILL_MASTER_MOUSEOVER"] )
g_pButtonMaster:SetCustomMsgMouseOut( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_BUTTON_SKILL_MASTER_MOUSEOUT"] )
...
g_pSlotSkillTree:SetCustomMsgMouseRightUp( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_SKILLTREESLOT_RMOUSEUP"] )
g_pSlotSkillTree:SetCustomMsgMouseOver( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_SKILLTREESLOT_MOUSEIN"] )
g_pSlotSkillTree:SetCustomMsgMouseOut( GUILD_SKILL_TREE_UI_CUSTOM_MSG["GSTUCM_SKILLTREESLOT_MOUSEOUT"] )
