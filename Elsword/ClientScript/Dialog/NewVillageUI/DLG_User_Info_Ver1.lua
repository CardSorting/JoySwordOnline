...
g_pPictureText_grade:SetTex( "DLG_UI_Title03.TGA", "TOTAL_SCORE" )
...
g_pPictureText_total_rank:SetTex( "DLG_UI_Title03.TGA", "RANKING_SCORE" )

g_pPictureText_total_rank:SetPoint
{
   
	"LEFT_TOP		= D3DXVECTOR2(21,119+3)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
