...
g_pStaticuser_list:AddPicture( g_pPicture_bg )

g_pPicture_bg:SetTex( "DLG_UI_Common_Texture39.TGA", "PAT_INVEN_WIN2_TOP" )
...
g_pPicture_bg:SetTex( "DLG_UI_Common_Texture39.TGA", "PAT_INVEN_WIN2_middle" )
g_pPicture_bg:SetIndex(1)
g_pPicture_bg:SetPoint
{ 
    ADD_SIZE_X = -7,
    ADD_SIZE_Y = 158-12,
	"LEFT_TOP		= D3DXVECTOR2(1,13)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.75)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_bg:SetTex( "DLG_UI_Common_Texture39.TGA", "PAT_INVEN_WIN2_bottom" )
g_pPicture_bg:SetIndex(2)
g_pPicture_bg:SetPoint
{
    ADD_SIZE_X = -7, 
	"LEFT_TOP		= D3DXVECTOR2(0,179-6-12)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.75)",
	CHANGE_TIME		= 0.0,
}
...
g_pStaticuser_list:AddPicture( g_pPicture_bg2 )
...
g_pPicture_bg2:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(10+1,32-1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.75)",
	CHANGE_TIME		= 0.0,
}
...
{
    ADD_SIZE_Y = 103,
	"LEFT_TOP		= D3DXVECTOR2(10+1,37-1)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.75)",
	CHANGE_TIME		= 0.0,
}
...
g_pPicture_bg2:SetPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(10+1,148-8)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.75)",
	CHANGE_TIME		= 0.0,
...
g_pPicture_elsword1:SetTex( "DLG_UI_Common_Texture02.TGA", "elsword_base" )
...
g_pPicture_elsword2:SetTex( "DLG_UI_Common_Texture02.TGA", "elsword_base" )
...
g_pPicture_elsword3:SetTex( "DLG_UI_Common_Texture02.TGA", "elsword_base" )
...
g_pPicture_elsword4:SetTex( "DLG_UI_Common_Texture02.TGA", "elsword_base" )
...
g_pButtonUser_list_left_Triangle:SetNormalPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(35,157-4-7)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.75)",
	CHANGE_TIME		= 0.0,
}
g_pButtonUser_list_left_Triangle:SetOverPoint
{
    ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
	"LEFT_TOP		= D3DXVECTOR2(35-1,157-1-4-7)",
...
g_pButtonUser_list_right_Triangle:SetNormalPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(112,157-4-7)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,0.75)",
	CHANGE_TIME		= 0.0,
}
g_pButtonUser_list_right_Triangle:SetOverPoint
{
    ADD_SIZE_X = -2,
	ADD_SIZE_Y = -2,
	"LEFT_TOP		= D3DXVECTOR2(112-1,157-1-4-7)",
