...
g_pStaticvelder_town:SetName( "velder_town" )
...
g_pStaticvelder_town:AddPicture( g_pPicture_shadow )
...
g_pPicture_bg1:SetTex( "DLG_UI_MAP_Village03.tga", "VELDER_TOWN" ) 
...
g_pButtonNPC1:SetCustomMsgMouseOver( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_NPC_MOUSE_OVER"] )
g_pButtonNPC1:SetCustomMsgMouseOut( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_NPC_MOUSE_OUT"] )
g_pButtonNPC1:AddDummyInt( NPC_UNIT_ID["NUI_VANESSA"] )
...
g_pButtonNPC2:SetNormalPoint
{
    ...
    "LEFT_TOP		= D3DXVECTOR2(467-33,340)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonNPC2:SetOverPoint
...
g_pStaticvelder_town:AddPicture( g_pPicturebesma )

g_pPicturebesma:SetTex( "DLG_UI_Title02.tga", "velder_out" )
...
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(66-2,400-2)",
...
g_pButtonLeft:AddDummyInt( VILLAGE_MAP_ID["VMI_PEITA"] )
...
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(930-2,407-2)",
...
g_pButtonRight:AddDummyInt( VILLAGE_MAP_ID["VMI_DUNGEON_GATE_VELDER"] )
---------------------- 도움말

g_pPictureHelper = g_pUIDialog:CreatePicture()
g_pStaticvelder_town:AddPicture( g_pPictureHelper )
