...
g_pPicture_bg:SetIndex( 3 )
g_pPicture_bg:SetPoint
{
    ADD_SIZE_Y	= 3,
	"LEFT_TOP	= D3DXVECTOR2( 0, 46 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pPicture_bg:SetIndex( 4 )
g_pPicture_bg:SetPoint
{
    ADD_SIZE_X	= 46,
	ADD_SIZE_Y	= 3,
	"LEFT_TOP	= D3DXVECTOR2( 30, 46 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pPicture_bg:SetIndex( 5 )
g_pPicture_bg:SetPoint
{
     ADD_SIZE_Y	= 3,
	"LEFT_TOP	= D3DXVECTOR2( 86, 46 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pPicture_bg:SetIndex( 6 )
g_pPicture_bg:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2( 0, 166 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pPicture_bg:SetIndex( 7 )
g_pPicture_bg:SetPoint
{
    ADD_SIZE_X	= 36,
	"LEFT_TOP	= D3DXVECTOR2( 30, 166 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pPicture_bg:SetIndex( 8 )
g_pPicture_bg:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2( 86, 166 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
{
	"LEFT_TOP	= D3DXVECTOR2(11+17,12-5)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
...
g_pPicture_zero:SetPoint
{
	"LEFT_TOP	= D3DXVECTOR2(17+17,12-5)",
	"COLOR		= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME	= 0.0,
}
