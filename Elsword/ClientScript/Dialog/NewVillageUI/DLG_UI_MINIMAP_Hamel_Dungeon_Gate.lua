...
--------------------
g_pStatic_Hamel_Gate = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_Hamel_Gate )
g_pStatic_Hamel_Gate:SetName( "Hamel_Gate" )
--------------------
g_pPicture_shadow = g_pUIDialog:CreatePicture()
g_pStatic_Hamel_Gate:AddPicture( g_pPicture_shadow )
...
g_pStatic_Hamel_Gate:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_MAP_Gate04.tga", "HAMEL_GATE" ) 
...
{
    "LEFT_TOP		= D3DXVECTOR2(220+155,473)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
    "LEFT_TOP		= D3DXVECTOR2(330+140,473)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
    "LEFT_TOP		= D3DXVECTOR2(438+140,473)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStatic_Hamel_Gate:AddPicture( g_pPicturealtera_Gate )
g_pPicturealtera_Gate:SetTex( "DLG_UI_Title02.tga", "hamel_out" )
...
g_pButtonLeft:SetNormalPoint
{
	ADD_SIZE_X = 2,
	ADD_SIZE_Y = 2,
    "LEFT_TOP		= D3DXVECTOR2(66+20,490-30)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X = 4,
	ADD_SIZE_Y = 4,
	"LEFT_TOP		= D3DXVECTOR2(67-2+20,491-2-30)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
{
	ADD_SIZE_Y = 2,
 	"LEFT_TOP		= D3DXVECTOR2(69+20,493-30)",
    "COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
...
g_pStatic_Hamel_Gate:AddPicture( g_pPictureHelper )
...
ADD_SIZE_X = -10,
ADD_SIZE_Y = -10, 	
    "LEFT_TOP		= D3DXVECTOR2(330+140+80,473)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
