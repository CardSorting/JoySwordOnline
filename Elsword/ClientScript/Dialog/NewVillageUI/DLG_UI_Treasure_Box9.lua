...
g_pPictureImage9 = g_pUIDialog:CreatePicture()
g_pStaticTreasure_Box:AddPicture( g_pPictureImage9 )

g_pPictureImage9:SetTex( "DLG_UI_Treasure_Box9.tga", "TREASURE_BOX9" )

g_pPictureImage9:SetPoint
{
