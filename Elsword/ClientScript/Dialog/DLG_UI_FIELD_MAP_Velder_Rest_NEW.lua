...
g_pUIDialog:SetName( "DLG_UI_FIELD_MAP_VELDER_Rest" )
...
-- 지도 부분
g_pStaticVelder_Rest = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticVelder_Rest )
g_pStaticVelder_Rest:SetName( "Velder_Rest" )

g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Rest:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Rest_01.DDS", "VELDER_Rest_01" ) 
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Rest:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Rest_02.DDS", "VELDER_Rest_02" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Rest:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Rest_03.DDS", "VELDER_Rest_03" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Rest:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Rest_04.DDS", "VELDER_Rest_04" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Rest:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Rest_04.DDS", "VELDER_Rest_05" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Rest:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_Rest_05.DDS", "VELDER_Rest_06" ) 
g_pPicture_bg1:SetPoint
{
...
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 130-1, 645-2 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 2,
 	"LEFT_TOP	= D3DXVECTOR2( 130+3, 645 )",
    "COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonLeft:AddDummyInt( VILLAGE_MAP_ID["VMI_BATTLE_FIELD_VELDER_FIELD_01"] )
...
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 1460-1, 633-2 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 2,
 	"LEFT_TOP	= D3DXVECTOR2( 1460+3, 633 )",
    "COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonRight:AddDummyInt( VILLAGE_MAP_ID["VMI_BATTLE_FIELD_VELDER_FIELD_03"] )

-- 오른쪽 출구2
g_pButtonRight2 = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButtonRight2 )
g_pButtonRight2:SetName( "Right_Cusor2" )
...
g_pButtonRight2:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 1126-1, 501-2 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 2,
 	"LEFT_TOP	= D3DXVECTOR2( 1126+3, 501 )",
    "COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonRight2:AddDummyInt( VILLAGE_MAP_ID["VMI_BATTLE_FIELD_VELDER_FIELD_02"] )