...
g_pUIDialog:SetName( "DLG_UI_FIELD_MAP_VELDER_04" )
...
-- 지도 부분
g_pStaticVelder_Field04 = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticVelder_Field04 )
g_pStaticVelder_Field04:SetName( "Velder_Field04" )

g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Field04:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_04_01.DDS", "VELDER_04_01" ) 
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Field04:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_04_02.DDS", "VELDER_04_02" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Field04:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_04_03.DDS", "VELDER_04_03" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Field04:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_04_04.DDS", "VELDER_04_04" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Field04:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_04_04.DDS", "VELDER_04_05" ) 
g_pPicture_bg1:SetPoint
{
...
g_pPicture_bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_Field04:AddPicture( g_pPicture_bg1 )
g_pPicture_bg1:SetTex( "DLG_UI_FIELD_MAP_Velder_04_05.DDS", "VELDER_04_06" ) 
g_pPicture_bg1:SetPoint
{
...
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 435-1, 203-2 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 2,
 	"LEFT_TOP	= D3DXVECTOR2( 435+3, 203 )",
    "COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonLeft:AddDummyInt( VILLAGE_MAP_ID["VMI_BATTLE_FIELD_VELDER_FIELD_03"] )

-- 왼쪽 출구 2
g_pButtonLeft2 = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButtonLeft2 )
g_pButtonLeft2:SetName( "LEFT_cusor" )
g_pButtonLeft2:SetNormalTex( "DLG_UI_Button04.tga", "l_gate" )
g_pButtonLeft2:SetOverTex( "DLG_UI_Button04.tga", "l_gate" )
g_pButtonLeft2:SetDownTex( "DLG_UI_Button04.tga", "l_gate" )
g_pButtonLeft2:SetDisableTex( "DLG_UI_Button04.tga", "l_gate_noactive" )
g_pButtonLeft2:SetNormalPoint
{
	ADD_SIZE_X	= 2,
	ADD_SIZE_Y	= 2,
    "LEFT_TOP	= D3DXVECTOR2( 110, 320 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
g_pButtonLeft2:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 110-1, 320-2 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
g_pButtonLeft2:SetDownPoint
{
    ADD_SIZE_X	= 2,
	ADD_SIZE_Y	= 2,
 	"LEFT_TOP	= D3DXVECTOR2( 110, 320 )",
...
g_pButtonLeft2:SetDisablePoint
{
	ADD_SIZE_Y	= 2,
 	"LEFT_TOP	= D3DXVECTOR2( 110+3, 320 )",
    "COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
g_pButtonLeft2:SetCustomMsgMouseOver( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_OTHER_FIELD_MOUSE_OVER"] )
g_pButtonLeft2:SetCustomMsgMouseOut( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_OTHER_FIELD_MOUSE_OUT"] )
g_pButtonLeft2:SetCustomMsgMouseUp( WORLD_MAP_UI_CUSTOM_MSG["WMUCM_PREV_FIELD_MAP"] )
g_pButtonLeft2:AddDummyInt( VILLAGE_MAP_ID["VMI_BATTLE_FIELD_VELDER_FIELD_02"] )
...
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 1375-1, 378-1 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonRight:AddDummyInt( VILLAGE_MAP_ID["VMI_BATTLE_FIELD_VELDER_SHIP_STAGE"] )