...
g_pUIDialog:SetName( "DLG_UI_FIELD_MAP_VELDER_VILLAGE" )
...
g_pStaticVelder_town = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticVelder_town )
g_pStaticVelder_town:SetName( "g_pStaticVelder_town" )

------------------------------------------    월드맵    ----------------------------------------------------
-------------------------------------------------------------------------------------------------------------
--상_좌
g_pPicture_Bg1 = g_pUIDialog:CreatePicture()
g_pStaticVelder_town:AddPicture( g_pPicture_Bg1 )
g_pPicture_Bg1:SetTex( "DLG_UI_Town_VELDER_Map01.DDS", "TOWN_VELDER_BG1" )
...
g_pStaticVelder_town:AddPicture( g_pPicture_Bg2 )
g_pPicture_Bg2:SetTex( "DLG_UI_Town_VELDER_Map02.DDS", "TOWN_VELDER_BG2" )
...
g_pStaticVelder_town:AddPicture( g_pPicture_Bg3 )
g_pPicture_Bg3:SetTex( "DLG_UI_Town_VELDER_Map03.DDS", "TOWN_VELDER_BG3" )
...
g_pStaticVelder_town:AddPicture( g_pPicture_Bg4 )
g_pPicture_Bg4:SetTex( "DLG_UI_Town_VELDER_Map04.DDS", "TOWN_VELDER_BG4" )
...
g_pStaticVelder_town:AddPicture( g_pPicture_Bg5 )
g_pPicture_Bg5:SetTex( "DLG_UI_Town_VELDER_Map04.DDS", "TOWN_VELDER_BG5" )
...
g_pStaticVelder_town:AddPicture( g_pPicture_Bg6 )
g_pPicture_Bg6:SetTex( "DLG_UI_Town_VELDER_Map05.DDS", "TOWN_VELDER_BG6" )
...
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 34-1, 591-2 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonLeft:AddDummyInt( VILLAGE_MAP_ID["VMI_BATTLE_FIELD_PEITA_FIELD_03"] )
...
g_pButtonACC:AddDummyInt( NPC_UNIT_ID["NUI_PRAUS"] )
...
g_pButtonNPC1:AddDummyInt( NPC_UNIT_ID["NUI_NOEL"] )

-- 바네사
g_pButtonNPC2 = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButtonNPC2 )
g_pButtonNPC2:SetName( "VANESSA" )
...
g_pButtonNPC2:AddDummyInt( NPC_UNIT_ID["NUI_VANESSA"] )
...
g_pButtonAlche:AddDummyInt( NPC_UNIT_ID["NUI_GRAIL"] )
...
g_pButtonWeapon:AddDummyInt( NPC_UNIT_ID["NUI_HANNA"] )
...
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 1431-1, 602-1 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 2,
 	"LEFT_TOP	= D3DXVECTOR2( 1431+3, 602 )",
    "COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonRight:AddDummyInt( VILLAGE_MAP_ID["VMI_BATTLE_FIELD_VELDER_FIELD_01"] )