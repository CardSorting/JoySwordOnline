...
g_pButtonKillLeft_Triangle:SetName( "PVP_Room_Item_LeftArrow" )
...
g_pButtonKillLeft_Triangle:SetNormalPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(862,138-30)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonKillLeft_Triangle:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(860,136-30)",
...
g_pButtonKillLeft_Triangle:SetCustomMsgMouseUp( PVP_ROOM_UI_CUSTOM_MSG["PRUCM_CHANGE_PVP_ITEMMODE"] )

g_pButtonKillRight_Triangle = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButtonKillRight_Triangle )
g_pButtonKillRight_Triangle:SetName( "PVP_Room_Item_RightArrow" )
...
g_pButtonKillRight_Triangle:SetNormalPoint
{
 	...
 	"LEFT_TOP		= D3DXVECTOR2(966,138-30)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
	CHANGE_TIME		= 0.0,
}
g_pButtonKillRight_Triangle:SetOverPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(964,136-30)",
...
g_pButtonKillRight_Triangle:SetCustomMsgMouseUp( PVP_ROOM_UI_CUSTOM_MSG["PRUCM_CHANGE_PVP_ITEMMODE"] )
