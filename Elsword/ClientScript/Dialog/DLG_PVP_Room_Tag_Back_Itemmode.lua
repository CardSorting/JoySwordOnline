...
g_pUIDialog:SetName( "DLG_PVP_Room_Tag_Back" )
...
--던전 캐릭터 뒷 배경 위치
g_pUIDialog:AddDummyPos( D3DXVECTOR3(76-33-25,109-18) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3(256-33-16,109-18)  )
g_pUIDialog:AddDummyPos( D3DXVECTOR3(436-33-8,109-18) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3(616-33,109-18) )

g_pUIDialog:AddDummyPos( D3DXVECTOR3(836-33+20-1,435+10-18	) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3(656-33+14-1,435+10-18	) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3(476-33+7-1,435+10-18	) )
g_pUIDialog:AddDummyPos( D3DXVECTOR3(296-33-3,435+10-18  	) )
...
function PVPRoomOXDownAnim( pButton )
	...
	pButton:ChangeMouseDownSound_LUA( "Card_Flip.wav" )
	pButton:ChangeMouseUpSound_LUA( "Card_Flip.wav" )
...
g_pPicturePVP_Room_Title_Tag = g_pUIDialog:CreatePicture()
g_pStaticPVP_Room_Title:AddPicture( g_pPicturePVP_Room_Title_Tag )
--g_pPicturePVP_Room_Title_Tag:SetShow( false )

g_pPicturePVP_Room_Title_Tag:SetTex( "DLG_Common_Texture00_A.TGA", "Tag" )

g_pPicturePVP_Room_Title_Tag:SetPoint
{
...
g_pPicturePVP_Room_Control_Bg1:SetTex( "DLG_UI_TAGMODE.TGA", "TAGMODE_SETUP" )
...
g_pIMEPVP_Room_Name:SetTextPoint
{
	...
	"LEFT_TOP		= D3DXVECTOR2(295-60,20-2)",
	"RIGHT_BOTTOM		= D3DXVECTOR2(295-60+450,20-2+18)",
...
--{{ JOIN_PVP_ROOM_NUMBER
g_pStaticPVP_Room_Number = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticPVP_Room_Number )
g_pStaticPVP_Room_Number:SetName( "StaticPVP_Room_Number" )

	g_pStaticPVP_Room_Number:AddString
	{
		-- MSG 			= "하하하하하하하하하하하하핳하하하하핳하하할",
		FONT_INDEX		= XUF_DODUM_11_NORMAL,
		SORT_FLAG		= DRAW_TEXT["DT_LEFT"],
		"POS 			= D3DXVECTOR2(295-60-55,20)",
		"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
		"OUTLINE_COLOR		= D3DXCOLOR(0.2,0.2,0.2,1.0)",
	}
