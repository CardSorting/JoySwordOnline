...
g_pUIDialog:SetName( "DLG_UI_FIELD_MAP_HAMEL_VILLAGE" )
...
g_pStaticHamel_town = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStaticHamel_town )
g_pStaticHamel_town:SetName( "g_pStaticHamel_town" )

------------------------------------------    월드맵    ----------------------------------------------------
-------------------------------------------------------------------------------------------------------------
--상_좌
g_pPicture_Bg1 = g_pUIDialog:CreatePicture()
g_pStaticHamel_town:AddPicture( g_pPicture_Bg1 )
g_pPicture_Bg1:SetTex( "DLG_UI_Town_HAMEL_Map01.DDS", "TOWN_HAMEL_BG1" )
...
g_pStaticHamel_town:AddPicture( g_pPicture_Bg2 )
g_pPicture_Bg2:SetTex( "DLG_UI_Town_HAMEL_Map02.DDS", "TOWN_HAMEL_BG2" )
...
g_pStaticHamel_town:AddPicture( g_pPicture_Bg3 )
g_pPicture_Bg3:SetTex( "DLG_UI_Town_HAMEL_Map03.DDS", "TOWN_HAMEL_BG3" )
...
g_pStaticHamel_town:AddPicture( g_pPicture_Bg4 )
g_pPicture_Bg4:SetTex( "DLG_UI_Town_HAMEL_Map04.DDS", "TOWN_HAMEL_BG4" )
...
g_pStaticHamel_town:AddPicture( g_pPicture_Bg5 )
g_pPicture_Bg5:SetTex( "DLG_UI_Town_HAMEL_Map04.DDS", "TOWN_HAMEL_BG5" )
...
g_pStaticHamel_town:AddPicture( g_pPicture_Bg6 )
g_pPicture_Bg6:SetTex( "DLG_UI_Town_HAMEL_Map05.DDS", "TOWN_HAMEL_BG6" )
...
g_pButtonLeft:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 100-1, 555-2 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 2,
 	"LEFT_TOP	= D3DXVECTOR2( 100+3, 555 )",
    "COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonLeft:AddDummyInt( VILLAGE_MAP_ID["VMI_BATTLE_FIELD_HAMEL_SHIP_STAGE"] )
...
g_pButtonACC:AddDummyInt( NPC_UNIT_ID["NUI_LUCY"] )
...
g_pButtonNPC1:AddDummyInt( NPC_UNIT_ID["NUI_PENENSIO"] )

-- 데이지
g_pButtonNPC2 = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButtonNPC2 )
g_pButtonNPC2:SetName( "DAISY" )
...
g_pButtonNPC2:AddDummyInt( NPC_UNIT_ID["NUI_DAISY"] )
...
g_pButtonAlche:AddDummyInt( NPC_UNIT_ID["NUI_DENKA"] )
...
g_pButtonWeapon:AddDummyInt( NPC_UNIT_ID["NUI_HORATIO"] )
--[[
-- 이벤트 NPC
g_pButtonNPC2 = g_pUIDialog:CreateButton()
g_pUIDialog:AddControl( g_pButtonNPC2 )
...
g_pButtonRight:SetOverPoint
{
    ADD_SIZE_X	= 4,
	ADD_SIZE_Y	= 4,
	"LEFT_TOP	= D3DXVECTOR2( 1411-1, 552-1 )",
	"COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
{
	ADD_SIZE_Y	= 2,
 	"LEFT_TOP	= D3DXVECTOR2( 1411+3, 552 )",
    "COLOR		= D3DXCOLOR( 1.0, 1.0, 1.0, 1.0 )",
	CHANGE_TIME	= 0.0,
}
...
g_pButtonRight:AddDummyInt( VILLAGE_MAP_ID["VMI_BATTLE_FIELD_HAMEL_FIELD_01"] )