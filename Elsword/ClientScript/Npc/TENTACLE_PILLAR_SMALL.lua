...
INIT_STATE = 
{
	{ STATE_NAME = "TENTACLE_PILLAR_SMALL_START",							LUA_STATE_START_FUNC = "TENTACLE_PILLAR_SMALL_START_START",
																			LUA_STATE_END_FUNC = "TENTACLE_PILLAR_SMALL_START_END",				},
	{ STATE_NAME = "TENTACLE_PILLAR_SMALL_WAIT",							LUA_FRAME_MOVE_FUNC = "TENTACLE_PILLAR_SMALL_WAIT_FRAME_MOVE",		},
	
	{ STATE_NAME = "TENTACLE_PILLAR_SMALL_START_ATTACK",							},
	--5초 주기로 소환
	{ STATE_NAME = "TENTACLE_PILLAR_SMALL_SUMMON_A",						LUA_FRAME_MOVE_FUNC = "TENTACLE_PILLAR_SMALL_SUMMON_A_FRAME_MOVE",	},
	--2초 주기로 소환
	{ STATE_NAME = "TENTACLE_PILLAR_SMALL_SUMMON_B",						LUA_FRAME_MOVE_FUNC = "TENTACLE_PILLAR_SMALL_SUMMON_B_FRAME_MOVE",	},
	
	{ STATE_NAME = "TENTACLE_PILLAR_SMALL_DYING",							},
	{ STATE_NAME = "TENTACLE_PILLAR_SMALL_DAMAGE",							},

	START_STATE					= "TENTACLE_PILLAR_SMALL_START",
	WAIT_STATE					= "TENTACLE_PILLAR_SMALL_WAIT",
	
	SMALL_DAMAGE_LAND_FRONT		= "TENTACLE_PILLAR_SMALL_DAMAGE",
	SMALL_DAMAGE_LAND_BACK		= "TENTACLE_PILLAR_SMALL_DAMAGE",
	BIG_DAMAGE_LAND_FRONT		= "TENTACLE_PILLAR_SMALL_DAMAGE",
	BIG_DAMAGE_LAND_BACK		= "TENTACLE_PILLAR_SMALL_DAMAGE",
	DOWN_DAMAGE_LAND_FRONT		= "TENTACLE_PILLAR_SMALL_DAMAGE",
	DOWN_DAMAGE_LAND_BACK		= "TENTACLE_PILLAR_SMALL_DAMAGE",
	
	DYING_LAND_FRONT			= "TENTACLE_PILLAR_SMALL_DYING",
	DYING_LAND_BACK				= "TENTACLE_PILLAR_SMALL_DYING",
	DYING_SKY					= "TENTACLE_PILLAR_SMALL_DYING",
...
TENTACLE_PILLAR_SMALL_START = 
{
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"TENTACLE_PILLAR_SMALL_START_ATTACK",			"CT_TENTACLE_PILLAR_SMALL_START_ATTACK",		},
	},

	CT_TENTACLE_PILLAR_SMALL_START_ATTACK = 
	{
		EVENT_INTERVAL_ID			= 0,
...
function TENTACLE_PILLAR_SMALL_START_START( pKTDXApp, pX2Game, pNPCUnit )
...
function TENTACLE_PILLAR_SMALL_START_END( pKTDXApp, pX2Game, pNPCUnit )
	pNPCUnit:SetTimerRestart( 0 )	--체크 시간 리셋
end
------------------------------------------------------------------------------------------
---------------------------------TENTACLE_PILLAR_SMALL_START---------------------------------
TENTACLE_PILLAR_SMALL_START_ATTACK = 
{
	ANIM_NAME					= "Start",
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],		"TENTACLE_PILLAR_SMALL_WAIT",							},
	},
}

---------------------------------TENTACLE_PILLAR_SMALL_WAIT---------------------------------
TENTACLE_PILLAR_SMALL_WAIT = 
{
...
function TENTACLE_PILLAR_SMALL_WAIT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if HpPercent > CheckHpPercent.x then 		
		...
		if CheckTime_SummonA < pNPCUnit:GetTimerElapsedTime( 0 ) then
			...
			if true == CheckAbleSummon( pX2Game, pNPCUnit ) then --최대 마릿수 체크
				pNPCUnit:StateChange_LUA( "TENTACLE_PILLAR_SMALL_SUMMON_A" )
			end
		...
		if CheckTime_SummonB < pNPCUnit:GetTimerElapsedTime( 0 ) then
			...
			if true == CheckAbleSummon( pX2Game, pNPCUnit ) then --최대 마릿수 체크
				pNPCUnit:StateChange_LUA( "TENTACLE_PILLAR_SMALL_SUMMON_B" )
			end
...
---------------------------------TENTACLE_PILLAR_SMALL_SUMMON_A-----------------------------
TENTACLE_PILLAR_SMALL_SUMMON_A = 
{
	ANIM_NAME					= "Summon",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
...
function TENTACLE_PILLAR_SMALL_SUMMON_A_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
---------------------------------TENTACLE_PILLAR_SMALL_SUMMON_B-----------------------------
TENTACLE_PILLAR_SMALL_SUMMON_B = 
{
	ANIM_NAME					= "Summon",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
...
function TENTACLE_PILLAR_SMALL_SUMMON_B_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
