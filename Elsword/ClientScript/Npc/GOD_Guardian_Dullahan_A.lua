...
INIT_COMPONENT = 
{
	...
	BOSS_GAGE_FACE_TEX_PIECE	= "DARK_DURAHAN_1",		
...
{
	-- 기본 스테이트
	{ STATE_NAME = "GOD_GUARDIAN_DULLAHAN_A_START",				LUA_STATE_START_FUNC = "GOD_GUARDIAN_DULLAHAN_A_STATE_START",						},
	{ STATE_NAME = "GOD_GUARDIAN_DULLAHAN_A_WAIT",				LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_DULLAHAN_A_CHECK_POSSIBLE_ATTACK_FRAME_MOVE",	},
	{ STATE_NAME = "GOD_GUARDIAN_DULLAHAN_A_SELECT_ATTACK",	},
	{ STATE_NAME = "GOD_GUARDIAN_DULLAHAN_A_WALK",				LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_DULLAHAN_A_CHECK_POSSIBLE_ATTACK_FRAME_MOVE",	},
	{ STATE_NAME = "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",			LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_DULLAHAN_A_CHECK_POSSIBLE_ATTACK_FRAME_MOVE",	},
	{ STATE_NAME = "GOD_GUARDIAN_DULLAHAN_A_DYING",				LUA_STATE_START_FUNC = "GOD_GUARDIAN_DULLAHAN_A_DYING_STATE_START",					},
	
	-- 공격 스테이트
	{ STATE_NAME = "GOD_GUARDIAN_DULLAHAN_A_ATTACK",			LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_DULLAHAN_A_ATTACK_FRAME_MOVE",	 				
																STATE_COOL_TIME	= 5,																},
	{ STATE_NAME = "GOD_GUARDIAN_DULLAHAN_A_SPECIAL_ATTACK",	LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_DULLAHAN_A_SPECIAL_ATTACK_FRAME_MOVE",
																INITIALIZE_STATE_ELAPSED_TIME = 29, STATE_COOL_TIME	= 30,																},
	
	START_STATE					= "GOD_GUARDIAN_DULLAHAN_A_START",
	WAIT_STATE					= "GOD_GUARDIAN_DULLAHAN_A_WAIT",
	
	SMALL_DAMAGE_LAND_FRONT		= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	SMALL_DAMAGE_LAND_BACK		= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	BIG_DAMAGE_LAND_FRONT		= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	BIG_DAMAGE_LAND_BACK		= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	DOWN_DAMAGE_LAND_FRONT		= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	DOWN_DAMAGE_LAND_BACK		= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	FLY_DAMAGE_FRONT			= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	FLY_DAMAGE_BACK				= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	SMALL_DAMAGE_AIR			= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",	
	BIG_DAMAGE_AIR				= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	DOWN_DAMAGE_AIR				= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	DOWN_DAMAGE_AIR_LANDING		= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	UP_DAMAGE					= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	DAMAGE_REVENGE				= "GOD_GUARDIAN_DULLAHAN_A_DAMAGE",
	
	DYING_LAND_FRONT			= "GOD_GUARDIAN_DULLAHAN_A_DYING",
	DYING_LAND_BACK				= "GOD_GUARDIAN_DULLAHAN_A_DYING",
	DYING_SKY					= "GOD_GUARDIAN_DULLAHAN_A_DYING",
...
INIT_AI = 
{
	TARGET = 
	{
		...
		MANUAL_TARGETING_FUNC		= "GOD_GUARDIAN_DULLAHAN_A_MANUAL_TARGET",
	},
...
GOD_GUARDIAN_DULLAHAN_A_START = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],	"GOD_GUARDIAN_DULLAHAN_A_WALK",	},
	},
	
	PARTICLE_SEQ = 
	{
		--Major, time, Name, weaponBonePos, Pos, StateEndDelete, bTrace, posx, posy, posz, bApplyUnitRotation, rotx, roty, rotz,
		{ TRUE, 0.01, "Flare_Dullahan_Eye_A01", FALSE, "Dummy3_Eye", FALSE, TRUE, 0, 0, 0, TRUE, },
	},
}

function GOD_GUARDIAN_DULLAHAN_A_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
	...
	pNPCUnit:SetVector_LUA( 0,  D3DXVECTOR3( 1.0, GATE_OF_DARKNESS_ATTACK_RANGE["GOD_AR_GUARDIAN"], 0.0 ) )		-- x 
...
GOD_GUARDIAN_DULLAHAN_A_WAIT = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_DULLAHAN_A_WALK",	"CT_GOD_GUARDIAN_DULLAHAN_A_WALK",	},
	},
	
	CT_GOD_GUARDIAN_DULLAHAN_A_WALK = 
	{
		FLAG_TRUE = 0,
	},
}
...
GOD_GUARDIAN_DULLAHAN_A_SELECT_ATTACK = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= TRUE,
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_DULLAHAN_A_ATTACK",			"CT_GOD_GUARDIAN_DULLAHAN_A_ATTACK",					},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_DULLAHAN_A_SPECIAL_ATTACK",	"CT_GLITER_GOD_GUARDIAN_DULLAHAN_A_SPECIAL_ATTACK",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],		"GOD_GUARDIAN_DULLAHAN_A_WAIT",			},
	},
	
	CT_GOD_GUARDIAN_DULLAHAN_A_ATTACK = 
	{
		EVENT_INTERVAL_ID	= 0,
	},
	
	CT_GLITER_GOD_GUARDIAN_DULLAHAN_A_SPECIAL_ATTACK = 
	{
		EVENT_INTERVAL_ID	= 0,
	},
}
...
GOD_GUARDIAN_DULLAHAN_A_WALK = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_DULLAHAN_A_WAIT",	"CT_GOD_GUARDIAN_DULLAHAN_A_WAIT",	},
	},
	
	CT_GOD_GUARDIAN_DULLAHAN_A_WAIT = 
	{
		FLAG_FALSE = 0,
	},
}

function GOD_GUARDIAN_DULLAHAN_A_WALK_STATE_END( pKTDXApp, pX2Game, pNPCUnit )
...
GOD_GUARDIAN_DULLAHAN_A_ATTACK = 
{
	ANIM_NAME					= "Attack",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	TRANSITION					= FALSE,
...
function GOD_GUARDIAN_DULLAHAN_A_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
GOD_GUARDIAN_DULLAHAN_A_SPECIAL_ATTACK = 
{
	...
	EFFECT_SET_LIST =
	{
		"EffectSet_GOD_DULLAHAN_ATTACK_A", 0.6,	
	},
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],	"GOD_GUARDIAN_DULLAHAN_A_WAIT",	},	
...
function GOD_GUARDIAN_DULLAHAN_A_SPECIAL_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	
end

-----------------------------------------------------------------------------------------------------------

GOD_GUARDIAN_DULLAHAN_A_DAMAGE = 
{
...
function GOD_GUARDIAN_DULLAHAN_A_DYING_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
	...
	GOD_GUARDIAN_DULLAHAN_A_HEAL( pX2Game, pNPCUnit )
	
end

-----------------------------------------------------------------------------------------------------------

function GOD_GUARDIAN_DULLAHAN_A_HEAL( pX2Game, pNPCUnit )
...
-- 공격 가능 여부에 대한 검사 함수
function GOD_GUARDIAN_DULLAHAN_A_CHECK_POSSIBLE_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if vCheckAttackInterval.x <= fCheckAttackCoolTime then
		...
		if true == GOD_GUARDIAN_DULLAHAN_A_CHECK_NEAR_ENEMY( fCheckAttackRange, pX2Game, pNPCUnit ) then	-- 근처에 적( User 혹은 팀이 다른 NPC )이 있는지 검사
		
			pNPCUnit:SetFlag_LUA( 0, false )		-- 적이 공격 범위에 있기 때문에, 이동 제한
			pNPCUnit:StateChange_LUA( "GOD_GUARDIAN_DULLAHAN_A_SELECT_ATTACK", true )	-- 적이 있다면, 공격 수행
...
function GOD_GUARDIAN_DULLAHAN_A_CHECK_NEAR_ENEMY( fRange, pX2Game, pNPCUnit )
	...
	for i = 0, iNumOfNPC - 1 do
		...
		if pNPC ~= nil and false == pNPC:IsUnitID( NPC_UNIT_ID["NUI_GOD_GATE_ALLY"] ) then
			...
			-- 일정 거리 아하이고, 살아있으며, 같은 팀이 아니면서 내가 보고 있는 방향에 있을 때 공격 수행
			 if fRange >= vDistance and 0.0 < pNPC:GetNowHP() and pNPC:GetTeam() ~= pNPCUnit:GetTeam() and true == GOD_GUARDIAN_DULLAHAN_A_CHECK_ISRIGHT_OF_NPC_FROM_ME( pNPCUnit, pNPC ) then
					return true		-- 공격 처리
			end
	...
	for i = 0, iNumOfUser - 1 do
		...
		if pUser ~= nil then
			...
			-- 일정 거리 아하이고, 살아있으며, 같은 팀이 아니면서 내가 보고 있는 방향에 있을 때 공격 수행
			if fRange >= vDistance and 0.0 < pUser:GetNowHP() and pUser:GetTeam() ~= pNPCUnit:GetTeam() and true == GOD_GUARDIAN_DULLAHAN_A_CHECK_ISRIGHT_OF_USER_FROM_ME( pNPCUnit, pUser ) then
				return true		-- 공격 처리
			end
...
function GOD_GUARDIAN_DULLAHAN_A_CHECK_ISRIGHT_OF_NPC_FROM_ME( pNPCUnit, pTargetNPC  )
...
function GOD_GUARDIAN_DULLAHAN_A_CHECK_ISRIGHT_OF_USER_FROM_ME( pNPCUnit, pTargetUser  )
...
-- 강제 타겟팅 설정 함수
function GOD_GUARDIAN_DULLAHAN_A_MANUAL_TARGET( pKTDXApp, pX2Game, pNPCUnit )
