...
INIT_STATE =
{
	...
	-- 광명의 룬을 시전합니다.
	{ STATE_NAME = "PVP_BOT_PENENSIO_Rune_Guard",					STATE_COOL_TIME = 9999,	LUA_FRAME_MOVE_FUNC = "PVP_BOT_PENENSIO_Rune_Guard_FRAME_MOVE"	 },
	...
	DOWN_DAMAGE_LAND_FRONT		= "PVP_BOT_PENENSIO_DAMAGE_BIG_FRONT",
	DOWN_DAMAGE_LAND_BACK		= "PVP_BOT_PENENSIO_DAMAGE_BIG_BACK",
	...
	DAMAGE_EXTRA_STATES         = {"PVP_BOT_PENENSIO_DAMAGE_AIR_DOWN","PVP_BOT_PENENSIO_DAMAGE_AIR_FALL",
	"PVP_BOT_PENENSIO_STAND_UP_FRONT","PVP_BOT_PENENSIO_STAND_UP_BACK",
...
function PVP_BOT_PENENSIO_DYING_LAND_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
	...
	if nil ~= pSummonGate then
		...
		pSummonGate:SetVector_LUA( 3,  D3DXVECTOR3( vSummonUserNPC.x, vSummonUserNPC.y, 1.0 ) )
