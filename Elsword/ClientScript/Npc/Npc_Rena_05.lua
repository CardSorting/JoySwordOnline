...
INIT_MOTION =
{
	MOTION_FILE_NAME	= "Npc_RENA_05.x",
}
--------------------------------------------------------------------------
INIT_PHYSIC =
{
...
INIT_COMPONENT =
{
	...
	WEAPON0 = 
	{
		WEAPON_FILE_NAME			= "Mesh_Lire_Ed_Weapon30_1_Sorted.X",
...
INIT_STATE =
{
	...
	DAMAGE_EXTRA_STATES         = {"PVP_BOT_RENA_DAMAGE_AIR_DOWN","PVP_BOT_RENA_DAMAGE_AIR_FALL","PVP_BOT_RENA_STAND_UP_FRONT","PVP_BOT_RENA_STAND_UP_BACK",
