...
INIT_MOTION = 
{
	MOTION_FILE_NAME		= "Motion_TROCK_DARK_POISON.X",
}
...
INIT_STATE = 
{
	{ STATE_NAME = "TROCK_DARK_POISON_START",	LUA_FRAME_MOVE_FUNC = "TROCK_DARK_POISON_STATE_START"	},
	{ STATE_NAME = "TROCK_DARK_POISON_WAIT",		},
	
	START_STATE					= "TROCK_DARK_POISON_START",
	WAIT_STATE					= "TROCK_DARK_POISON_WAIT",
...
TROCK_DARK_POISON_START = 
{
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],			"TROCK_DARK_POISON_WAIT",		},
	},
}


function TROCK_DARK_POISON_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
TROCK_DARK_POISON_WAIT = 
{
	...
	-- EFFECT_SET_LIST =
	-- {
		-- "EffectSet_Sander_Trock_Dark_Poison_Start", 0,
		-- "EffectSet_Sander_Trock_Dark_Poison_End", 0,
	-- },
}
