...
INIT_STATE =
{
	...
	DAMAGE_EXTRA_STATES         = {"PVP_BOT_AMELIA_DAMAGE_AIR_DOWN","PVP_BOT_AMELIA_DAMAGE_AIR_FALL",
	"PVP_BOT_AMELIA_STAND_UP_FRONT","PVP_BOT_AMELIA_STAND_UP_BACK",
	...
	SUMMON_END_STATE			= "PVP_BOT_AMELIA_DYING_FRONT",
