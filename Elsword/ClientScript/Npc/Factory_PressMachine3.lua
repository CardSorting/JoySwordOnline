...
INIT_STATE = 
{
    { STATE_NAME = "FACTORY_PRESSMACHINE3_START",						},	
	{ STATE_NAME = "FACTORY_PRESSMACHINE3_WAIT",						},	
	{ STATE_NAME = "FACTORY_PRESSMACHINE3_ATTACK",					LUA_FRAME_MOVE_FUNC = "FACTORY_PRESSMACHINE3_ATTACK_FRAME_MOVE" },

	START_STATE					= "FACTORY_PRESSMACHINE3_START",
	WAIT_STATE					= "FACTORY_PRESSMACHINE3_WAIT",
	...
	DOWN_DAMAGE_AIR				= "",
	UP_DAMAGE					= "",
	DAMAGE_REVENGE				= "FACTORY_PRESSMACHINE3_WAIT",
	
	DYING_LAND_FRONT			= "",
	DYING_LAND_BACK				= "",
	DYING_SKY					= "",

	REVENGE_ATTACK				= "FACTORY_PRESSMACHINE3_WAIT",	
}
...
FACTORY_PRESSMACHINE3_START =
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"FACTORY_PRESSMACHINE3_ATTACK",				"CT_FACTORY_PRESSMACHINE3_ATTACK",	},
	},
	
	CT_FACTORY_PRESSMACHINE3_ATTACK = 
	{
		STATE_TIME_OVER			= 4,
	},
}

FACTORY_PRESSMACHINE3_WAIT = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= FALSE,
...
FACTORY_PRESSMACHINE3_ATTACK = 
{
  ...
  SOUND_PLAY5			= { 4.883, "Nasod_Press5.ogg" },
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"FACTORY_PRESSMACHINE3_WAIT",					},
	},
...
function FACTORY_PRESSMACHINE3_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
