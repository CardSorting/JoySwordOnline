...
INIT_STATE = 
{
	{ STATE_NAME = "BOX_DROPPER_WAIT",							},
	{ STATE_NAME = "BOX_DROPPER_ATTACK_UNIT",					LUA_FRAME_MOVE_FUNC = "BOX_DROPPER_ATTACK_UNIT_FRAME_MOVE"	},
	{ STATE_NAME = "BOX_DROPPER_ATTACK_LEFT",					LUA_FRAME_MOVE_FUNC = "BOX_DROPPER_ATTACK_LEFT_FRAME_MOVE"	},
	{ STATE_NAME = "BOX_DROPPER_ATTACK_RIGHT",					LUA_FRAME_MOVE_FUNC = "BOX_DROPPER_ATTACK_RIGHT_FRAME_MOVE"	},

	START_STATE					= "BOX_DROPPER_WAIT",
	...
	DOWN_DAMAGE_AIR				= "",
	UP_DAMAGE					= "",
	DAMAGE_REVENGE				= "BOX_DROPPER_WAIT",
	
	DYING_LAND_FRONT			= "",
	DYING_LAND_BACK				= "",
	DYING_SKY					= "",

	REVENGE_ATTACK				= "BOX_DROPPER_WAIT",	
}
...
BOX_DROPPER_WAIT = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"BOX_DROPPER_ATTACK_UNIT",				"CT_BOX_DROPPER_ATTACK_UNIT",	},	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"BOX_DROPPER_ATTACK_LEFT",				"CT_BOX_DROPPER_ATTACK_LEFT",	},
	},
	
	CT_BOX_DROPPER_ATTACK_LEFT = 
	{
		EVENT_INTERVAL_ID			= 0,
		STATE_TIME_OVER				= 0.4,
		RATE						= 100,
...
BOX_DROPPER_ATTACK_UNIT = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"BOX_DROPPER_ATTACK_RIGHT",				"CT_BOX_DROPPER_ATTACK_RIGHT",	},
		
	},
	
	CT_BOX_DROPPER_ATTACK_RIGHT = 
	{
		EVENT_INTERVAL_ID		= 0,
		STATE_TIME_OVER			= 0.4,
		RATE					= 100,
...
BOX_DROPPER_ATTACK_RIGHT = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"BOX_DROPPER_WAIT",				"CT_BOX_DROPPER_WAIT",	},
	},
...
-------------------------------------------------------------------------------
function BOX_DROPPER_ATTACK_UNIT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.25 ) then
		...
		pDamageEffect:CreateInstance_LUA( pNPCUnit, "DROPPING_BOX", pos, unitLandPos.y )
...
-------------------------------------------------------------------------------
function BOX_DROPPER_ATTACK_LEFT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.25 ) then
		...
		pDamageEffect = pX2Game:GetDamageEffect()
		pDamageEffect:CreateInstance_LUA( pNPCUnit, "DROPPING_BOX", pos, leftLandPos.y )
...
-------------------------------------------------------------------------------
function BOX_DROPPER_ATTACK_RIGHT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.25 ) then
		...
		pDamageEffect = pX2Game:GetDamageEffect()
		pDamageEffect:CreateInstance_LUA( pNPCUnit, "DROPPING_BOX", pos, rightLandPos.y )
