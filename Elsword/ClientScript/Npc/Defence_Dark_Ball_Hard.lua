...
function CHECK_NEXT_SUMMON_GROUP(pX2Game, pNPCUnit)
	...
	if iSummonGroupPhase >= 15 then												--소환 종료 후, 자신이 소환한 몬스터가 없으면 사망
		...
		if pX2Game:LiveKeyCodeNPCNum(pNPCUnit:GetKeyCode())	> 14	then		--(하나는 자기 자신)  ---맵상에 최대 몬스터 숫자 --승만
			return
		end
	end
	...
	local pDarknessBoss = pX2Game:GetNPCUnitByType( NPC_UNIT_ID["NUI_DEFENCE_DARKNESS_BOSS_HARD"] )
...
function SUMMON_GROUP_1( pX2Game, pNPCUnit )
	...
	----------(A:위치, B:소환간격, C:소환시간, D:엘리트확률, E:엘리트최대개체, F:드랍여부, G:몬스터ID)---------------------	
	----------(A,			B,		  C,	D,	E,	 F,			G)---------------------------------------------------------------
	SUMMON_NPC(vPosOffset,	1, 		 1.1,	5,	2,	false,	NPC_UNIT_ID["NUI_DEFENCE_SOLDIER_BENDERS"], pX2Game, pNPCUnit,  	0)
	SUMMON_NPC(vPosOffset,	4, 		 20.1,	5,	2,	false,	NPC_UNIT_ID["NUI_DEFENCE_SOLDIER_BENDERS"], pX2Game, pNPCUnit,  	1)
...
function SUMMON_GROUP_3( pX2Game, pNPCUnit )
	...
	----------(A:위치, B:소환간격, C:소환시간, D:엘리트확률, E:엘리트최대개체, F:드랍여부, G:몬스터ID)---------------------	
	----------(A,			B,	C,	D,	E,	F,		G)---------------------------------------------------------------
	SUMMON_NPC(vPosOffset,	1,	 1.1,	5,	3,	false,	NPC_UNIT_ID["NUI_DEFENCE_AIRSHIP_SOLDIER_SWORDMAN"], pX2Game, pNPCUnit, 0)
	SUMMON_NPC(vPosOffset,	6,	24.1,	5,	3,	false,	NPC_UNIT_ID["NUI_DEFENCE_AIRSHIP_SOLDIER_SWORDMAN"], pX2Game, pNPCUnit, 1)
	SUMMON_NPC(vPosOffset,	5,	20.1, 	0,	0,	false,	NPC_UNIT_ID["NUI_DEFENCE_SHADOW_BLAST"], pX2Game, pNPCUnit, 2)
end
...
function SUMMON_GROUP_5( pX2Game, pNPCUnit )
	...
	----------(A:위치, B:소환간격, C:소환시간, D:엘리트확률, E:엘리트최대개체, F:드랍여부, G:몬스터ID)---------------------	
	----------(A,			B,	C,	D,	E,	F,		G)---------------------------------------------------------------
	SUMMON_NPC(vPosOffset,	10,	10.1,	0,	0,	false,	NPC_UNIT_ID["NUI_DEFENCE_STINGER"], pX2Game, pNPCUnit,  0)
	SUMMON_NPC(vPosOffset,	35,	35.1,	0,	0,	false,	NPC_UNIT_ID["NUI_DEFENCE_STINGER"], pX2Game, pNPCUnit,  1)
	SUMMON_NPC(vPosOffset,	60,	60.1,	0,	0,	false,	NPC_UNIT_ID["NUI_DEFENCE_STINGER"], pX2Game, pNPCUnit, 	2)	
	SUMMON_NPC(vPosOffset,	10,	60.1,	0,	0,	false,	NPC_UNIT_ID["NUI_DEFENCE_SHADOW_BLAST"], pX2Game, pNPCUnit, 3)	
end
...
function SUMMON_GROUP_6( pX2Game, pNPCUnit )
	...
	SUMMON_NPC(vPosOffset,	10,	20.1,	0,	0,	false,		NPC_UNIT_ID["NUI_DEFENCE_SHADOW_BLAST_BOSS"], pX2Game, pNPCUnit, 2)
...
function SUMMON_GROUP_7( pX2Game, pNPCUnit )
	...
	SUMMON_NPC(vPosOffset,	6,	36.1,	5,	3,	false,	NPC_UNIT_ID["NUI_DEFENCE_SHIELD"], pX2Game, pNPCUnit, 1)
...
function SUMMON_GROUP_9( pX2Game, pNPCUnit )
	...
	SUMMON_NPC(vPosOffset,	1,	1.1, 	5,	2,	false,		NPC_UNIT_ID["NUI_DEFENCE_THIEF_GREAT"], pX2Game, pNPCUnit, 0)
	SUMMON_NPC(vPosOffset,	4,	28.1,	5,	2,	false,		NPC_UNIT_ID["NUI_DEFENCE_THIEF_GREAT"], pX2Game, pNPCUnit, 1)
	SUMMON_NPC(vPosOffset,	30,	30.1,	5,	2,	false,		NPC_UNIT_ID["NUI_DEFENCE_THIEF_GREAT"], pX2Game, pNPCUnit, 2)
...
function SUMMON_GROUP_10( pX2Game, pNPCUnit )
	...
	SUMMON_NPC(vPosOffset,	25,	25.1,	0,	0,	false,	NPC_UNIT_ID["NUI_DEFENCE_THIEF_BOSS"], pX2Game, pNPCUnit,  1)
	SUMMON_NPC(vPosOffset,	50,	50.1,	0,	0,	false,	NPC_UNIT_ID["NUI_DEFENCE_THIEF_BOSS"], pX2Game, pNPCUnit, 	2)	
...
function SUMMON_GROUP_11( pX2Game, pNPCUnit )
	...
	SUMMON_NPC(vPosOffset,	20,	40.1,	0,	0,	false,		NPC_UNIT_ID["NUI_DEFENCE_SHADOW_BLAST_BOSS"], pX2Game, pNPCUnit, 3)		
end
...
function SUMMON_GROUP_12( pX2Game, pNPCUnit )
	...
	SUMMON_NPC(vPosOffset,	5,	30.1, 5, 3,	false,	NPC_UNIT_ID["NUI_DEFENCE_GLITER_LANCE"], 	   pX2Game, pNPCUnit, 1)
	SUMMON_NPC(vPosOffset,	5,	30.1, 0, 0,	false,	NPC_UNIT_ID["NUI_DEFENCE_SHADOW_BLAST"], pX2Game, pNPCUnit, 2)
end
...
function SUMMON_GROUP_13( pX2Game, pNPCUnit )
	...
	----------(A:위치, B:소환간격, C:소환시간, D:엘리트확률, E:엘리트최대개체, F:드랍여부, G:몬스터ID)---------------------	
	----------(A,			B,	C,	D,	E,	F,		G)---------------------------------------------------------------
	SUMMON_NPC(vPosOffset,	1,	1.1,  0, 0,	false,	NPC_UNIT_ID["NUI_DEFENCE_GOLEM_RAGE"], 	   pX2Game, pNPCUnit, 0)
	SUMMON_NPC(vPosOffset,	8,	56.1, 0, 0,	false,	NPC_UNIT_ID["NUI_DEFENCE_GOLEM_RAGE"], 	   pX2Game, pNPCUnit, 1)
	SUMMON_NPC(vPosOffset,	5,	55.1, 0, 0,	false,	NPC_UNIT_ID["NUI_DEFENCE_SHADOW_BLAST"], 		pX2Game, pNPCUnit, 2)	
end
...
function SUMMON_GROUP_14( pX2Game, pNPCUnit )
	...
	--------(A:위치, B:소환간격, C:소환시간, D:엘리트확률, E:엘리트최대개체, F:드랍여부, G:몬스터ID)---------------------	
	--------(A,			B,	C,	D,	E,	F,		G)---------------------------------------------------------------
	SUMMON_NPC(vPosOffset,	10,		10.1,	0,	0,	false,		NPC_UNIT_ID["NUI_DEFENCE_DURAHAN"], pX2Game, pNPCUnit, 		0)	
	SUMMON_NPC(vPosOffset,	55,		55.1,	0,	0,	false,		NPC_UNIT_ID["NUI_DEFENCE_DURAHAN"], pX2Game, pNPCUnit,  		1)
	SUMMON_NPC(vPosOffset,	100,	100.1,	0,	0,	false,		NPC_UNIT_ID["NUI_DEFENCE_DURAHAN"], pX2Game, pNPCUnit,  		2)
	SUMMON_NPC(vPosOffset,	10,		90.1,	0,	0,	false,		NPC_UNIT_ID["NUI_DEFENCE_SHADOW_BLAST"], pX2Game, pNPCUnit, 	3)
end  
...
function SUMMON_GROUP_15( pX2Game, pNPCUnit )
	...
	----------(A:위치, B:소환간격, C:소환시간, D:엘리트확률, E:엘리트최대개체, F:드랍여부, G:몬스터ID)---------------------	
	----------(A,			B,	C,	D,	E,	F,		G)---------------------------------------------------------------
	SUMMON_NPC(vPosOffset,	5,		50.1,	0,	0,	false,	NPC_UNIT_ID["NUI_DEFENCE_SHADOW_BLAST"], 		pX2Game, pNPCUnit, 0)
	SUMMON_NPC(vPosOffset,	10,		50.1,	0,	0,	false,	NPC_UNIT_ID["NUI_DEFENCE_SHADOW_BLAST_BOSS"], 	pX2Game, pNPCUnit, 1)	
end
