...
INIT_STATE = 
{
	...
	{ STATE_NAME = "SHADOW_TRICKSTER_STAND_UP_ATTACK_BACK",		}, --LUA_FRAME_MOVE_FUNC = "SHADOW_TRICKSTER_STAND_UP_ATTACK_BACK_FRAME_MOVE"	},
	...
	DAMAGE_EXTRA_STATES         = { "SHADOW_TRICKSTER_DAMAGE_AIR_FALL","SHADOW_TRICKSTER_STAND_UP_FRONT","SHADOW_TRICKSTER_STAND_UP_BACK",
		"SHADOW_TRICKSTER_STAND_UP_ATTACK_FRONT","SHADOW_TRICKSTER_STAND_UP_ATTACK_BACK",
		"SHADOW_TRICKSTER_JUMP_DOWN","SHADOW_TRICKSTER_JUMP_LANDING",},	
