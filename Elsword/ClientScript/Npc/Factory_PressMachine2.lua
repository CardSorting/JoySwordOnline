...
INIT_STATE = 
{
    { STATE_NAME = "FACTORY_PRESSMACHINE2_START",						},	
	{ STATE_NAME = "FACTORY_PRESSMACHINE2_WAIT",						},	
	{ STATE_NAME = "FACTORY_PRESSMACHINE2_ATTACK",					LUA_FRAME_MOVE_FUNC = "FACTORY_PRESSMACHINE2_ATTACK_FRAME_MOVE" },

	START_STATE					= "FACTORY_PRESSMACHINE2_START",
	WAIT_STATE					= "FACTORY_PRESSMACHINE2_WAIT",
	...
	DOWN_DAMAGE_AIR				= "",
	UP_DAMAGE					= "",
	DAMAGE_REVENGE				= "FACTORY_PRESSMACHINE2_WAIT",
	
	DYING_LAND_FRONT			= "",
	DYING_LAND_BACK				= "",
	DYING_SKY					= "",

	REVENGE_ATTACK				= "FACTORY_PRESSMACHINE2_WAIT",	
}
...
FACTORY_PRESSMACHINE2_START =
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"FACTORY_PRESSMACHINE2_ATTACK",				"CT_FACTORY_PRESSMACHINE2_ATTACK",	},
	},
	
	CT_FACTORY_PRESSMACHINE2_ATTACK = 
	{
		STATE_TIME_OVER			= 3,
	},
}

FACTORY_PRESSMACHINE2_WAIT = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= FALSE,
...
FACTORY_PRESSMACHINE2_ATTACK = 
{
  ...
  SOUND_PLAY5			= { 4.883, "Nasod_Press5.ogg" },
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"FACTORY_PRESSMACHINE2_WAIT",					},
	},
...
function FACTORY_PRESSMACHINE2_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
