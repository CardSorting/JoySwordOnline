...
INIT_STATE = 
{
    { STATE_NAME = "BESMA_ROCK_START",				},
    { STATE_NAME = "BESMA_ROCK_READY",				},	
	{ STATE_NAME = "BESMA_ROCK_READY2",				--LUA_CAMERA_MOVE_FUNC = "BESMA_ROCK_READY2_CAMERA_MOVE",
	                                                LUA_FRAME_MOVE_FUNC = "BESMA_ROCK_READY2_FRAME_MOVE",	},	
		
	{ STATE_NAME = "BESMA_ROCK_DOWN",					},	
	{ STATE_NAME = "BESMA_ROCK_DOWNLANDING",		LUA_FRAME_MOVE_FUNC = "BESMA_ROCK_DOWNLANDING_FRAME_MOVE",	},	
	
	{ STATE_NAME = "BESMA_ROCK_WALK",				},	
	{ STATE_NAME = "BESMA_ROCK_DASH",				LUA_FRAME_MOVE_FUNC = "BESMA_ROCK_DASH_FRAME_MOVE",	},	

    { STATE_NAME = "BESMA_ROCK_WAIT",				},	
    { STATE_NAME = "BESMA_ROCK_BROKEN",				},	
    
	START_STATE					= "BESMA_ROCK_START",
	WAIT_STATE					= "BESMA_ROCK_WAIT",
	...
	DYING_LAND_FRONT			= "BESMA_ROCK_BROKEN",
	DYING_LAND_BACK				= "BESMA_ROCK_BROKEN",
	DYING_SKY					= "BESMA_ROCK_BROKEN",
...
function ROCK_MANUAL_TARGET( pKTDXApp, pX2Game, pNPCUnit )
	local pUnit = pX2Game:GetNearNPCUnitInStart_LUA( pNPCUnit:GetPos(), NPC_UNIT_ID["NUI_BESMA_ROCK_END"], 9999 )
...
BESMA_ROCK_START = 
{
	...
	EVENT_PROCESS = 
	{
		--{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_TRUE"],		"BESMA_ROCK_DOWN",						},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"BESMA_ROCK_READY",						},
	},
}
...
BESMA_ROCK_READY2 = 
{
    ...
    SOUND_PLAY0			= { 0.113, "Besma_Rock_Ready2.ogg" },
	...
	{
		--{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_TRUE"],		"BESMA_ROCK_DOWN",						},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"BESMA_ROCK_DASH",						},
	},
}
...
BESMA_ROCK_WALK = 
{
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"BESMA_ROCK_DOWN",								},
		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"BESMA_ROCK_DASH",				"CT_BESMA_ROCK_DASH",			},		
	},
...
BESMA_ROCK_DOWN = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_TRUE"],		"BESMA_ROCK_DASH",				},
	},
}

BESMA_ROCK_DOWNLANDING = 
{
...
function BESMA_ROCK_READY2_CAMERA_MOVE( pKTDXApp, pX2Game, pNPCUnit )
--[[
...
function BESMA_ROCK_READY2_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function BESMA_ROCK_DOWNLANDING_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function BESMA_ROCK_DASH_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pUID ~= 0 then
	    ...
	    if pUnit ~= nil then	            
	        ...
	        if fDist <= 100 then
	            ...
	            --print("rock end")
	            --pNPCUnit:StateChange_LUA( "BESMA_ROCK_BROKEN", true )
	            pNPCUnit:SetNowHP_LUA(0)
	        end
	    end
	end
