...
INIT_STATE = 
{
	...
	{ STATE_NAME = "SHADOW_TRICKSTER_TOTEM_C_ATTACK",	LUA_FRAME_MOVE_FUNC = "SHADOW_TRICKSTER_TOTEM_C_ATTACK_FRAME_MOVE",	STATE_COOL_TIME = 5,	},
	{ STATE_NAME = "SHADOW_TRICKSTER_TOTEM_C_DYING",	},
	{ STATE_NAME = "SHADOW_TRICKSTER_TOTEM_C_DAMAGE",	},
	
	{ STATE_NAME = "SHADOW_TRICKSTER_TOTEM_C_END",		},
...
SHADOW_TRICKSTER_TOTEM_C_WAIT = 
{
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"SHADOW_TRICKSTER_TOTEM_C_END",		"CT_SHADOW_TRICKSTER_TOTEM_C_END",		},	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"SHADOW_TRICKSTER_TOTEM_C_DYING",	"CT_SHADOW_TRICKSTER_TOTEM_C_DYING"		},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"SHADOW_TRICKSTER_TOTEM_C_ATTACK",	"CT_SHADOW_TRICKSTER_TOTEM_C_ATTACK"	},
	},
	
	CT_SHADOW_TRICKSTER_TOTEM_C_END = 
	{
		EVENT_INTERVAL_ID			= 0,
		TIMER_ELAPSED0				= 120,
		RATE						= 100,
	...
	CT_SHADOW_TRICKSTER_TOTEM_C_DYING =
	{	-- 사망
		EVENT_INTERVAL_ID			= 0,
		TIMER_ELAPSED0				= 15,
		RATE						= 100,		
...
function SHADOW_TRICKSTER_TOTEM_C_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	if pNPCUnit:AnimEventTimer_LUA( 0.706 ) then
		...
		local pCEffect = pDamageEffect:CreateInstance_LUA( pNPCUnit, "CSM_TOTEM_GUIDED_FIREBALL", pNPCUnit:GetBonePos_LUA( "Totem_Dummy02" ), pos.y )
