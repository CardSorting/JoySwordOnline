...
INIT_MOTION = 
{
	...
	MOTION_FILE_NAME		= "Motion_Lire.x",
}
...
INIT_COMPONENT = 
{
	...
	WEAPON0 = 
	{
		WEAPON_FILE_NAME	= "Hyper_Mesh_Lire_Cash_Weapon_Long_Bow.X",
...
INIT_STATE = 
{
	{ STATE_NAME = "LIRE_ELVEN_RANGER_WAIT",						},
	
	START_STATE					= "LIRE_ELVEN_RANGER_WAIT",
