...
INIT_STATE = 
{
	{ STATE_NAME = "STEAM_TRAP_UP_WAIT",					LUA_STATE_START_FUNC = "STEAM_TRAP_UP_WAIT_STATE_START",},
	{ STATE_NAME = "STEAM_TRAP_UP_ATTACK",					LUA_FRAME_MOVE_FUNC = "STEAM_TRAP_UP_ATTACK_FRAME_MOVE"	},

	START_STATE					= "STEAM_TRAP_UP_WAIT",
	...
	DOWN_DAMAGE_AIR				= "",
	UP_DAMAGE					= "",
	DAMAGE_REVENGE				= "STEAM_TRAP_UP_WAIT",
	
	DYING_LAND_FRONT			= "",
	DYING_LAND_BACK				= "",
	DYING_SKY					= "",

	REVENGE_ATTACK				= "STEAM_TRAP_UP_WAIT",	
}
...
STEAM_TRAP_UP_WAIT = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"STEAM_TRAP_UP_ATTACK",				"CT_STEAM_TRAP_UP_ATTACK",	},
	},
	
	CT_STEAM_TRAP_UP_ATTACK = 
	{
		FLAG_FALSE = 0,
	},
}

STEAM_TRAP_UP_ATTACK = 
{
	ANIM_NAME					= "Attack",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= FALSE,
...
--[[	
	PARTICLE_SEQ = 
	{
		...
		{ TRUE, 0.01, "SteamAttackUp", FALSE, "ATTACK_LINE_START1", TRUE, FALSE, 0, 55, 0, FALSE},
	},
--]]
	
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],				"STEAM_TRAP_UP_WAIT",		"CT_STEAM_TRAP_UP_WAIT",			},
	},

	
	CT_STEAM_TRAP_UP_WAIT = 
	{
		FLAG_TRUE = 0,
	},
}
...
function STEAM_TRAP_UP_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
                ...
                if pMajorParticle ~= nil then
                    ...
                    if pUnit:GetNowHP() > pUnit:GetMaxHP() * 0.3 then
	                    ...
	                    if pParticle == nil then
	                        particle = pMajorParticle:GameUnitCreateSequence_LUA( pNPCUnit, "SteamAttackUp", vpos, D3DXVECTOR2(100,100), D3DXVECTOR2(-1,-1) )    	
...
function STEAM_TRAP_UP_WAIT_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
