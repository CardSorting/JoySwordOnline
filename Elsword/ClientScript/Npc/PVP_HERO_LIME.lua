...
PVP_BOT_LIME_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_LIME_WAIT",	"CF_PVP_BOT_LIME_AI_TICK",							},
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_Airelinna",   		  		"CF_PVP_BOT_LIME_AIRELINNA",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_Pulling_Arrow",    		 	"CF_PVP_BOT_LIME_PULLING_ARROW",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_Slide_Double_Kick_Start",    	"CF_PVP_BOT_LIME_SLIDE_KICK",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_Reflect_Kick_READY",     		"CF_PVP_BOT_LIME_REFLECT_KICK",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_Back_Tumbling_Shot",    	 	"CF_PVP_BOT_LIME_TUMBLING_SHOT",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_ComboZ",     					"CF_PVP_BOT_LIME_COMBO_Z",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_JUMP_UP_DIR_for_Jump_X",   	"CF_PVP_BOT_LIME_ANTI_AIR",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_DashComboZ",     				"CF_PVP_BOT_LIME_CATCH",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_BACKWARD_DashX",     			"CF_PVP_BOT_LIME_BACKDASH_ARROW",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_DashJumpComboZ_Direct",    	"CF_PVP_BOT_LIME_LONG_AIR_CATCH",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_ComboX",     					"CF_PVP_BOT_LIME_COMBO_X",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_DASH",         				"CF_PVP_BOT_LIME_ADVANCE",       		    },
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_DashJump",          			"CF_PVP_BOT_LIME_AERIAL_ENTRY",      			},
		  		
		-- 뒤로 돌아 걷거나 뛰며 거리를 벌리는 동작입니다.
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LIME_BACKWARD_DASH_READY",     	"CF_PVP_BOT_LIME_BACKWARD_DASH",   	},
...
PVP_BOT_LIME_STANDUP_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_LIME_STANDUP_WAIT",	"CF_PVP_BOT_LIME_AI_TICK",						},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_LIME_BOOST_POWER",	"CF_PVP_BOT_LIME_BOOST_POWER",					},
...
PVP_BOT_LIME_ComboZ = 
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PVP_BOT_LIME_JUMP_DOWN_ACT",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"PVP_BOT_LIME_BACKWARD_DASH_READY",		},
	},
...
PVP_BOT_LIME_ComboXX =
{
	...
	EVENT_PROCESS =
	{
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],			"PVP_BOT_LIME_BACKWARD_DASH_READY",	"CF_PVP_BOT_LIME_COMBO_RESET",	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"PVP_BOT_LIME_BACKWARD_DASH_READY",	"CT_PVP_BOT_LIME_WAIT2",	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"PVP_BOT_LIME_BACKWARD_DASH_READY",	"CT_PVP_BOT_LIME_WAIT3",	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"PVP_BOT_LIME_ComboX",	"CT_PVP_BOT_LIME_ComboX",	},
...
PVP_BOT_LIME_Sharp_Fall = 
{
	...
	TALK_BOX =
	{
		{ RATE = 33, MESSAGE = STR_ID_12430 },
		{ RATE = 33, MESSAGE = STR_ID_12431 },
	},
...
PVP_BOT_LIME_Nature_Force = 
{
	...
	TALK_BOX =
	{
		{ RATE = 33, MESSAGE = STR_ID_12432 },
		{ RATE = 33, MESSAGE = STR_ID_12433 },
	},
...
PVP_BOT_LIME_Pulling_Arrow = 
{
	...
	TALK_BOX =
	{
		{ RATE = 33, MESSAGE = STR_ID_12426 },
		{ RATE = 33, MESSAGE = STR_ID_12427 },
	},
...
PVP_BOT_LIME_BOOST_POWER =
{
	...
	TALK_BOX =
	{
		{ RATE = 33, MESSAGE = STR_ID_12428 },
		{ RATE = 33, MESSAGE = STR_ID_12429 },
	},
...
function CF_PVP_BOT_LIME_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_LIME_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_LIME_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end

function CF_PVP_BOT_LIME_PULLING_ARROW( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "pulling_arrow", "control", 570, 1280, 40, 49, 9 )
end

function CF_PVP_BOT_LIME_SLIDE_KICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "slide_kick", "chase", 360, 820, 100, 37, 10 )
end

function CF_PVP_BOT_LIME_REFLECT_KICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "reflect_kick", "guard", 0, 410, 60, 45, 12 )
end

function CF_PVP_BOT_LIME_TUMBLING_SHOT( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "tumbling_shot", "escape", 0, 560, 50, 31, 9 )
end

function CF_PVP_BOT_LIME_CATCH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "dash_kick_catch", "combo", 180, 900, 0, 44, 6 )
end

function CF_PVP_BOT_LIME_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "ranger_spacing", "escape", 0, 330, 0, 24, 7 )
end
...
function CF_PVP_BOT_LIME_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, 560, 36 )
end

function CF_PVP_BOT_LIME_BOOST_POWER( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_AWAKEN( pX2Game, pNPCUnit, 325, 7 )
end
...
function CF_PVP_BOT_LIME_AIRELINNA( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "airelinna", "support", 0, 1600, 170, 29, 36 )
end

function CF_PVP_BOT_LIME_COMBO_Z( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "kick_pressure", "combo", 0, 310, 0, 58, 5 )
end

function CF_PVP_BOT_LIME_ANTI_AIR( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "jump_arrow_intercept", "air", 260, 1060, 0, 43, 8 )
end

function CF_PVP_BOT_LIME_LONG_AIR_CATCH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "long_air_catch", "air", 620, 1550, 0, 34, 9 )
end

function CF_PVP_BOT_LIME_COMBO_X( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "longbow_poke", "poke", 690, 1280, 0, 39, 6 )
end

function CF_PVP_BOT_LIME_ADVANCE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "wind_advance", "advance", 390, 1600, 0, 48, 3 )
end

function CF_PVP_BOT_LIME_AERIAL_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "wind_air_entry", "air_move", 300, 1240, 0, 35, 6 )
end
...
PVP_PRO_AI_PROFILE_LIME = {
	name = "mobile_longbow",
	preferred_range = 690,
	aggression = 0.98,
	discipline = 1.17,
	volatility = 4,
	role_bias = { poke = 7, control = 7, air = 6, escape = 3, support = 2, combo = 1 },
	openers = { pulling_arrow = 5, longbow_poke = 5, jump_arrow_intercept = 4 },
	finishers = { slide_kick = 8, dash_kick_catch = 7, kick_pressure = 5 },
	mixups = { tumbling_shot = 7, reflect_kick = 6, long_air_catch = 5, airelinna = 4 },
}

function CF_PVP_BOT_LIME_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_LIME )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V4_PROFILE_LIME = {
	name = "aerial_kiting_specialist",
	patience = 1.42,
	risk = 0.89,
	creativity = 5,
	condition_limit = 2,
	finisher_threshold = 0.31,
	probe_role = "poke",
	contest_role = "air",
	...
	reset_role = "escape",
	counter_roles = {
		approach = "escape", retreat = "poke", jump = "air",
		feint = "control", hold = "poke",
	},
	secondary_roles = {
		approach = "guard", retreat = "chase", jump = "control",
		feint = "guard", hold = "air",
	},
	signature = {
		longbow_poke = 6, pulling_arrow = 6, long_air_catch = 6,
		jump_arrow_intercept = 6, tumbling_shot = 5, kick_pressure = 4,
	},
	engagement_bias = { probe = 5, trap = 5, scramble = -3 },
}

function CF_PVP_BOT_LIME_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_LIME )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_LIME )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V5_PROFILE_LIME = {
	name = "tournament_aerial_kiter",
	read_skill = 0.91,
	exploration = 1.02,
	commitment = 0.88,
	reset_threshold = 0.61,
	creativity = 5,
	playbooks = {
		download = { "poke", "escape", "air" },
		outplay = { "poke", "control", "air" },
		pressure = { "air", "chase", "combo" },
		deny = { "control", "poke", "air" },
		stabilize = { "escape", "guard", "poke" },
		survive = { "escape", "guard", "control" },
		finish = { "control", "chase", "combo" },
	},
	actions = {
		download = { "longbow_poke", "tumbling_shot", "jump_arrow_intercept" },
		outplay = { "longbow_poke", "pulling_arrow", "jump_arrow_intercept" },
		pressure = { "long_air_catch", "slide_kick", "kick_pressure" },
		deny = { "pulling_arrow", "longbow_poke", "jump_arrow_intercept" },
		stabilize = { "tumbling_shot", "reflect_kick", "longbow_poke" },
		survive = { "ranger_spacing", "reflect_kick", "pulling_arrow" },
		finish = { "pulling_arrow", "slide_kick", "dash_kick_catch", "kick_pressure" },
	},
	action_prior = {
		longbow_poke = 4, pulling_arrow = 6, jump_arrow_intercept = 5,
		long_air_catch = 6, tumbling_shot = 4, dash_kick_catch = 6,
	},
	goal_bias = {
		download = 3, outplay = 5, pressure = 2,
		deny = 5, stabilize = 4, finish = 4,
	},
	finisher_actions = { "dash_kick_catch", "slide_kick", "kick_pressure", "long_air_catch" },
}

function CF_PVP_BOT_LIME_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_LIME )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_LIME )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE( pNPCUnit, PVP_PRO_AI_V5_PROFILE_LIME )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end

function CF_PVP_BOT_LIME_BACKDASH_ARROW(
	pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE(
		pX2Game, pNPCUnit, "backdash_arrow", "poke",
		0, 650, 0, 34, 7 )
end
...
PVP_PRO_AI_V6_PROFILE_LIME = {
	character = "lime",
	identity = "wind_defensive_survivor",
	identity_mode = "defensive_survivor",
	probe_style = "survival",
	preferred_min = 420,
	preferred_max = 1150,
	vertical_tolerance = 220,
	resource_target = 185,
	reset_threshold = 0.58,
	adaptation_rate = 0.98,
	strategy_hysteresis = 7,
	default_tempo = "controlled_reset",
	strategy_order = {
		"safe_range_diagnosis",
		"defensive_option_preservation",
		"airelinna_resource_plan",
		"health_lead_shelter",
		"layered_survival_recovery",
		"selective_catch_finish",
	},
	strategies = {
		safe_range_diagnosis = {
			base = 10,
			...
			plans = { "longbow_observation", "vertical_denial", "wakeup_recheck" },
		},
		defensive_option_preservation = {
			base = 11,
			min_ticks = 48,
			...
			plans = { "safe_kick_pressure", "escape_timing_test", "support_resource_cycle" },
		},
		airelinna_resource_plan = {
			base = 10.5,
			min_ticks = 44,
			...
			plans = { "support_resource_cycle", "defensive_reclaim", "vertical_denial" },
		},
		health_lead_shelter = {
			base = 9,
			min_ticks = 58,
			...
			plans = { "health_lead_shell", "longbow_observation", "wakeup_recheck" },
		},
		layered_survival_recovery = {
			base = 6,
			min_ticks = 30,
			...
			plans = { "defensive_reclaim", "health_lead_shell", "wakeup_recheck" },
		},
		selective_catch_finish = {
			base = 6,
			min_ticks = 28,
			...
			plans = { "grounded_finish", "air_catch_finish", "safe_kick_pressure" },
		},
	},
	plans = {
		longbow_observation = {
			...
			intentions = { "longbow_observe", "vertical_screen" },
		},
		vertical_denial = {
			base = 9,
			min_ticks = 19,
			...
			changeup = true,
			tempo = "measured_neutral",
			roles = { "combo", "combo", "escape" },
			intentions = { "kick_check", "support_then_hold" },
		},
		safe_kick_pressure = {
			base = 9,
			min_ticks = 17,
			...
			roles = { "poke", "escape", "chase" },
			intentions = { "escape_gap", "side_recovery" },
		},
		escape_timing_test = {
			base = 8,
			min_ticks = 16,
			...
			tempo = "measured_neutral",
			roles = { "support", "control", "guard" },
			intentions = { "health_lead_shell", "route_recheck" },
		},
		support_resource_cycle = {
			base = 10,
			min_ticks = 19,
			max_ticks = 38,
			resource = true,
			pressure = true,
			tempo = "measured_neutral",
			roles = { "control", "combo", "chase" },
			intentions = { "safe_conversion", "air_finish" },
		},
		defensive_reclaim = {
			base = 10,
			min_ticks = 18,
			...
			survival = true,
			tempo = "controlled_reset",
			roles = { "escape", "guard", "support" },
			intentions = { "emergency_reset", "expectation_switch" },
		},
		health_lead_shell = {
			base = 11,
			min_ticks = 21,
			...
			survival = true,
			tempo = "lead_preserving_slowdown",
			roles = { "air_move", "air", "control" },
			intentions = { "vertical_screen", "health_lead_shell" },
		},
		wakeup_recheck = {
			base = 7,
			min_ticks = 16,
			...
			changeup = true,
			tempo = "slow_observation",
			roles = { "support", "guard", "poke" },
			intentions = { "support_then_hold", "safe_conversion" },
		},
		grounded_finish = {
			base = 12,
			min_ticks = 12,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "escape", "air_move", "air" },
			intentions = { "side_recovery", "emergency_reset" },
		},
		air_catch_finish = {
			base = 10,
			min_ticks = 13,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "air_move", "air", "combo" },
			intentions = { "air_finish", "expectation_switch" },
		},
	},
	intentions = {
		longbow_observe = {
		...
		vertical_screen = {
			...
			risk = 0.32,
			roles = { "air_move", "air", "control" },
			actions = { "wind_air_entry", "jump_arrow_intercept", "pulling_arrow" },
		},
		kick_check = {
			base = 10,
			min_ticks = 8,
			...
			risk = 0.38,
			roles = { "combo", "combo", "escape" },
			actions = { "dash_kick_catch", "kick_pressure", "ranger_spacing" },
		},
		support_then_hold = {
			base = 11,
			min_ticks = 6,
			...
			risk = 0.19,
			roles = { "support", "guard", "poke" },
			actions = { "airelinna", "reflect_kick", "longbow_poke" },
		},
		escape_gap = {
			base = 8,
			min_ticks = 7,
			...
			conditioning = true,
			roles = { "poke", "escape", "chase" },
			actions = { "longbow_poke", "tumbling_shot", "slide_kick" },
		},
		side_recovery = {
			base = 9,
			min_ticks = 8,
			...
			risk = 0.31,
			roles = { "escape", "air_move", "air" },
			actions = { "ranger_spacing", "wind_air_entry", "long_air_catch" },
		},
		health_lead_shell = {
			base = 10,
			min_ticks = 6,
			...
			risk = 0.2,
			roles = { "support", "control", "guard" },
			actions = { "airelinna", "pulling_arrow", "reflect_kick" },
		},
		route_recheck = {
			base = 11,
			min_ticks = 7,
			max_ticks = 15,
			risk = 0.28,
			roles = { "poke", "advance", "air" },
			actions = { "longbow_poke", "wind_advance", "jump_arrow_intercept" },
		},
		safe_conversion = {
			base = 8,
			min_ticks = 8,
			...
			risk = 0.43,
			roles = { "control", "combo", "chase" },
			actions = { "pulling_arrow", "dash_kick_catch", "slide_kick" },
		},
		air_finish = {
			base = 9,
			min_ticks = 6,
			...
			risk = 0.49,
			roles = { "air_move", "air", "combo" },
			actions = { "wind_air_entry", "long_air_catch", "dash_kick_catch" },
		},
		emergency_reset = {
			base = 10,
			min_ticks = 7,
			...
			risk = 0.16,
			roles = { "escape", "guard", "support" },
			actions = { "tumbling_shot", "reflect_kick", "airelinna" },
		},
		expectation_switch = {
			base = 11,
			min_ticks = 8,
			...
			actions = { "longbow_poke", "wind_advance", "kick_pressure" },
		},
	},
	action_traits = {
		pulling_arrow = {
	...
	probe_order = { "safe_poke_response", "wake_pressure", "roll_destination" },
	probes = {
		safe_poke_response = {
			style = "survival",
			question = "does_longbow_space_trigger_an_approach",
			hypothesis = "aggressive_opener",
			expected = "approach",
			actions = { "longbow_poke", "ranger_spacing", "reflect_kick" },
			risk = 0.16,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
		...
		wake_pressure = {
			style = "survival",
			question = "does_the_opponent_attack_the_wakeup",
			hypothesis = "wakeup_attacker",
			expected = "counter",
			actions = { "reflect_kick", "tumbling_shot", "kick_pressure" },
			risk = 0.2,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
		...
		roll_destination = {
			style = "position",
			question = "does_pressure_force_a_predictable_roll",
			hypothesis = "habitual_roller",
			expected = "escape",
			actions = { "longbow_poke", "ranger_spacing", "slide_kick" },
			risk = 0.21,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
	...
	conditioning_breaks = {
		longbow_poke = "wind_advance",
		ranger_spacing = "pulling_arrow",
		reflect_kick = "tumbling_shot",
		dash_kick_catch = "long_air_catch",
	},
	fallback_intention = "longbow_observe",
	error_profile = {
		base = 0.024,
		load_scale = 0.096,
		surprise_scale = 0.043,
		overconfidence_scale = 0.022,
		range_bias = 1.02,
		late_confirm = 0.92,
		familiar_route = 0.9,
		greedy_resource = 1.34,
		stale_read = 0.96,
		overcommit = 0.48,
	},
}
...
function CF_PVP_BOT_LIME_AI_TICK(
	pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE(
		pNPCUnit, PVP_PRO_AI_PROFILE_LIME )
	PVP_PRO_AI_SET_META_PROFILE(
		pNPCUnit, PVP_PRO_AI_V4_PROFILE_LIME )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE(
		pNPCUnit, PVP_PRO_AI_V5_PROFILE_LIME )
	PVP_PRO_AI_SET_COMPETITIVE_PROFILE(
		pNPCUnit, PVP_PRO_AI_V6_PROFILE_LIME )
	PVP_PRO_AI_SET_RUNTIME_PROFILE(
		pNPCUnit, PVP_PRO_AI_V7_PROFILE_LIME )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
