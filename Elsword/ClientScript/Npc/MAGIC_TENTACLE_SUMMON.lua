...
INIT_STATE = 
{
	{ STATE_NAME = "MAGIC_TENTACLE_SUMMON_START",							},
	{ STATE_NAME = "MAGIC_TENTACLE_SUMMON_WAIT",							},

	{ STATE_NAME = "MAGIC_TENTACLE_SUMMON_MAGIC_ATTACK",		LUA_FRAME_MOVE_FUNC = "MAGIC_TENTACLE_SUMMON_MAGIC_ATTACK_FRAME_MOVE",			STATE_COOL_TIME = 5,		},

	--리액션 관련
	{ STATE_NAME = "MAGIC_TENTACLE_SUMMON_DAMAGE",							},
	
	{ STATE_NAME = "MAGIC_TENTACLE_SUMMON_DYING",				LUA_STATE_END_FUNC = "MAGIC_TENTACLE_SUMMON_DYING_END",	},
	
	START_STATE					= "MAGIC_TENTACLE_SUMMON_START",
	WAIT_STATE					= "MAGIC_TENTACLE_SUMMON_WAIT",
	
	SMALL_DAMAGE_LAND_FRONT		= "MAGIC_TENTACLE_SUMMON_DAMAGE",
	SMALL_DAMAGE_LAND_BACK		= "MAGIC_TENTACLE_SUMMON_DAMAGE",
	BIG_DAMAGE_LAND_FRONT		= "MAGIC_TENTACLE_SUMMON_DAMAGE",
	BIG_DAMAGE_LAND_BACK		= "MAGIC_TENTACLE_SUMMON_DAMAGE",
	
	-- fix!! 안넘어지게 테스트
	DOWN_DAMAGE_LAND_FRONT		= "MAGIC_TENTACLE_SUMMON_DAMAGE",
	DOWN_DAMAGE_LAND_BACK		= "MAGIC_TENTACLE_SUMMON_DAMAGE",
	

	REVENGE_ATTACK				= "",
	
	DYING_LAND_FRONT			= "MAGIC_TENTACLE_SUMMON_DYING",
	DYING_LAND_BACK				= "MAGIC_TENTACLE_SUMMON_DYING",
	DYING_SKY					= "MAGIC_TENTACLE_SUMMON_DYING",
}
...
MAGIC_TENTACLE_SUMMON_START = 
{
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],		"MAGIC_TENTACLE_SUMMON_WAIT",							},
		
	},
}

MAGIC_TENTACLE_SUMMON_WAIT = 
{
	ANIM_NAME					= "Wait",
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"MAGIC_TENTACLE_SUMMON_MAGIC_ATTACK",			"CT_MAGIC_TENTACLE_SUMMON_MAGIC_ATTACK"		}, 	
	},
	
	CT_MAGIC_TENTACLE_SUMMON_MAGIC_ATTACK = 
	{
...
MAGIC_TENTACLE_SUMMON_MAGIC_ATTACK = 
{
	...
	SOUND_PLAY0			= { 0.1, "Shadow_Master_SpecialAttackA01.ogg " },
	SOUND_PLAY1			= { 0.7, "hadow_Defender_SpecialAttackA.ogg" },
...
function MAGIC_TENTACLE_SUMMON_MAGIC_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function MAGIC_TENTACLE_SUMMON_DYING_END( pKTDXApp, pX2Game, pNPCUnit )
