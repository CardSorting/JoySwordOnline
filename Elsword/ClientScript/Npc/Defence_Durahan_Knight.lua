...
INIT_MOTION = 
{
	...
	MOTION_CHANGE_TEX_XET		= "NUI_Deffence_DULLAHAN.xet",
	MOTION_ANI_TEX_XET			= "NUI_Deffence_DULLAHAN.xet",
}
...
INIT_STATE = 
{
	...
	{ STATE_NAME = "DULLAHAN_WAIT",								LUA_FRAME_MOVE_FUNC = "DULLAHAN_WAIT_FRAME_MOVE",	},
...
INIT_AI = 
{
	TARGET = 
	{
		...
		TARGET_NPC					= TRUE,	
		MANUAL_TARGETING_FUNC		= "DULLAHAN_MANUAL_TARGET",
	},
...
function CF_DULLAHAN_MAGICBLADE( pKTDXApp, pX2Game, pNPCUnit )
    ...
    local vPos2 = pX2Game:GetLineMap():GetStartPosition( 2 )
    --vPos3 = pX2Game:GetLineMap():GetStartPosition( 3 )
    local vPos4 = pX2Game:GetLineMap():GetStartPosition( 21 )
    local vPos5 = pX2Game:GetLineMap():GetStartPosition( 22 )
...
function DULLAHAN_SPECIAL_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
    ...
    if pNPCUnit:AnimEventTimer_LUA( 2.233 ) then
        ...
        if pDamageEffect ~= nil then
            local unitPos = pNPCUnit:GetNearestUserPos()
	        local unitLandPos = pX2Game:GetLineMap():GetLandPosition_LUA( unitPos )	
...
function DULLAHAN_MAGICBLADE_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
    ...
    local vPos2 = pX2Game:GetLineMap():GetStartPosition( 2 )
    local vPos3 = pX2Game:GetLineMap():GetStartPosition( 3 )
    local vPos4 = pX2Game:GetLineMap():GetStartPosition( 21 )
    local vPos5 = pX2Game:GetLineMap():GetStartPosition( 22 )
    ...
    if pNPCUnit:AnimEventTimer_LUA( 1.73 ) then        
        if pMajorParticle ~= nil then
		    pMajorParticle:CreateSequence_LUA( "Light02_Dullahan_MagicBlade", vPos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "UpLight02_Dullahan_MagicBlade", vPos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "Light02_Dullahan_MagicBlade", vPos2, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "UpLight02_Dullahan_MagicBlade", vPos2, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "Light02_Dullahan_MagicBlade", vPos3, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "UpLight02_Dullahan_MagicBlade", vPos3, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "Light02_Dullahan_MagicBlade", vPos4, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "UpLight02_Dullahan_MagicBlade", vPos4, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "Light02_Dullahan_MagicBlade", vPos5, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "UpLight02_Dullahan_MagicBlade", vPos5, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
        end		        
    end
    ...
    if pNPCUnit:AnimEventTimer_LUA( 2.4 ) then        
        if pMajorParticle ~= nil then
		    pMajorParticle:CreateSequence_LUA( "LightParticle01_Dullahan_MagicBlade", vPos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "LightParticle01_Dullahan_MagicBlade", vPos2, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "LightParticle01_Dullahan_MagicBlade", vPos3, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "LightParticle01_Dullahan_MagicBlade", vPos4, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
		    pMajorParticle:CreateSequence_LUA( "LightParticle01_Dullahan_MagicBlade", vPos5, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
        end		        
    end    
...
function DULLAHAN_MANUAL_TARGET( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pX2Game:AnyUserUnitInRange( pNPCUnit:GetPos(), 600 ) == true then
		...
		if pNPCUnit:IsRightTarget_LUA(pNPCUnit, TargetPos) == true then
			if( bIsRight == true ) then
				DULLAHAN_DO_ATTACK(pX2Game, pNPCUnit)
				return
			end
		else
			if( bIsRight == false ) then
...
function DULLAHAN_WAIT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function DULLAHAN_DO_ATTACK(pX2Game, pNPCUnit)
	local iRate = pNPCUnit:GetRandVal() % 100
	
	if iRate < 90 then
		pNPCUnit:StateChange_LUA( "DULLAHAN_ATTACK" )
	else
		pNPCUnit:StateChange_LUA( "DULLAHAN_SPECIAL" )
	end
end
