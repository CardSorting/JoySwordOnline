...
INIT_STATE =
{
	{ STATE_NAME = "VEHIMOS_FX_START", 		LUA_STATE_START_FUNC = "VEHIMOS_FX_START_STATE_START_FUNC", },
	{ STATE_NAME = "VEHIMOS_FX_DAMAGE", 		},
	{ STATE_NAME = "VEHIMOS_FX_WAIT_HABIT",  	LUA_FRAME_MOVE_FUNC = "VEHIMOS_FX_WAIT_HABIT_FRAME_MOVE",	STATE_COOL_TIME	= 30, },		-- 쿨타임 임의 지정
	{ STATE_NAME = "VEHIMOS_FX_WALK", 			LUA_FRAME_MOVE_FUNC = "VEHIMOS_FX_WALK_FRAME_MOVE",},
	{ STATE_NAME = "VEHIMOS_FX_DYING",			LUA_STATE_START_FUNC = "VEHIMOS_FX_DYING_STATE_START_FUNC",},	
	{ STATE_NAME = "VEHIMOS_FX_FX", },
	
	START_STATE					= "VEHIMOS_FX_START",
	WAIT_STATE					= "VEHIMOS_FX_WALK",
		
	SMALL_DAMAGE_LAND_FRONT		= "VEHIMOS_FX_DAMAGE",
	SMALL_DAMAGE_LAND_BACK		= "VEHIMOS_FX_DAMAGE",
	BIG_DAMAGE_LAND_FRONT		= "VEHIMOS_FX_DAMAGE",
	BIG_DAMAGE_LAND_BACK		= "VEHIMOS_FX_DAMAGE",
	DOWN_DAMAGE_LAND_FRONT		= "VEHIMOS_FX_DAMAGE",
	DOWN_DAMAGE_LAND_BACK		= "VEHIMOS_FX_DAMAGE",
	FLY_DAMAGE_FRONT			= "VEHIMOS_FX_DAMAGE",
	FLY_DAMAGE_BACK				= "VEHIMOS_FX_DAMAGE",
	SMALL_DAMAGE_AIR			= "VEHIMOS_FX_DAMAGE",	
	BIG_DAMAGE_AIR				= "VEHIMOS_FX_DAMAGE",
	DOWN_DAMAGE_AIR				= "VEHIMOS_FX_DAMAGE",
	DOWN_DAMAGE_AIR_LANDING		= "VEHIMOS_FX_DAMAGE",
	UP_DAMAGE					= "VEHIMOS_FX_DAMAGE",
	DAMAGE_REVENGE				= "",

	DYING_LAND_FRONT			= "VEHIMOS_FX_DYING",
	DYING_LAND_BACK				= "VEHIMOS_FX_DYING",
	DYING_SKY					= "VEHIMOS_FX_DYING",
...
VEHIMOS_FX_START = 
{
	...
	EVENT_PROCESS = 
	{								
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],			"VEHIMOS_FX_FX",	},
	},
...
VEHIMOS_FX_FX = 
{
	...
	EVENT_PROCESS = 
	{								
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],		"VEHIMOS_FX_WALK",			"CT_VEHIMOS_FX_FX",	},
	},
	EFFECT_SET_LIST =
	{
		"EffectSet_VEHIMOS_Dust", 0,	
...
function VEHIMOS_FX_START_STATE_START_FUNC( pKTDXApp, pX2Game, pNPCUnit ) -- 
	...
	local iSummonSize1 = 3
	local iSummonSize2 = 3
	local iSummonSize3 = 3
	...
	pNPCUnit:SetFogNPC_LUA (  -2000, 120000, 0, 0, -0.28, D3DXCOLOR(0.478431, 0.313726, 0.168627, 1) )	-- 안개값 수정
...
VEHIMOS_FX_WALK = 
{
	...
	EVENT_PROCESS = 
	{
		-- { STATE_CHANGE_TYPE["SCT_MOTION_END"],			"VEHIMOS_FX_WALK",	},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],		"VEHIMOS_FX_WAIT_HABIT",		"CF_VEHIMOS_FX_WAIT_HABIT",	},					
	},
}
---------------------------------------------------------------------------------------------------------------------------------------


function VEHIMOS_FX_WALK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_VEHIMOS_FX_WAIT_HABIT( pKTDXApp, pX2Game, pNPCUnit ) -- 베히모스가 Magic A State 로 전환될 조건 및 좌표 설정
...
function VEHIMOS_FX_WAIT_HABIT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function VEHIMOS_FX_DYING_STATE_START_FUNC( pKTDXApp, pX2Game, pNPCUnit ) -- 베히모스가 소환할 몬스터 UID 및 위치 를 저장
	local pEffectSet = pX2Game:GetEffectSet()
