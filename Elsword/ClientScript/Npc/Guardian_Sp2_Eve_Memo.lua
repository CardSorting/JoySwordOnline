...
INIT_STATE = 
{
	{ STATE_NAME = "GUARDIAN_SP2_EVE_MEMO_WAIT",						},

	{ STATE_NAME = "GUARDIAN_SP2_EVE_MEMO_DISAPPEAR",					LUA_STATE_START_FUNC = "GUARDIAN_SP2_EVE_MEMO_DISAPPEAR_STATE_START",	},
	
	{ STATE_NAME = "GUARDIAN_SP2_EVE_MEMO_TELEPORT",					LUA_STATE_START_FUNC = "GUARDIAN_SP2_EVE_MEMO_TELEPORT_STATE_START",	
	                                                            LUA_FRAME_MOVE_FUNC = "GUARDIAN_SP2_EVE_MEMO_TELEPORT_FRAME_MOVE",    },
	
	{ STATE_NAME = "GUARDIAN_SP2_EVE_MEMO_ATTACK",					LUA_FRAME_MOVE_FUNC = "GUARDIAN_SP2_EVE_MEMO_ATTACK_FRAME_MOVE",	},
	
	
	
	--리액션 관련
	{ STATE_NAME = "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",			},
	{ STATE_NAME = "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_BACK",				},
	{ STATE_NAME = "GUARDIAN_SP2_EVE_MEMO_DYING_SKY",					},
	
	
	
	START_STATE					= "GUARDIAN_SP2_EVE_MEMO_ATTACK",
	WAIT_STATE					= "GUARDIAN_SP2_EVE_MEMO_WAIT",
	
	
	SMALL_DAMAGE_LAND_FRONT		= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	SMALL_DAMAGE_LAND_BACK		= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	BIG_DAMAGE_LAND_FRONT		= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	BIG_DAMAGE_LAND_BACK		= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	DOWN_DAMAGE_LAND_FRONT		= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	DOWN_DAMAGE_LAND_BACK		= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	FLY_DAMAGE_FRONT			= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	FLY_DAMAGE_BACK				= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	SMALL_DAMAGE_AIR			= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",	
	BIG_DAMAGE_AIR				= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	DOWN_DAMAGE_AIR				= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	UP_DAMAGE					= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	DAMAGE_REVENGE				= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	
	DYING_LAND_FRONT			= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT",
	DYING_LAND_BACK				= "GUARDIAN_SP2_EVE_MEMO_DYING_LAND_BACK",
	DYING_SKY					= "GUARDIAN_SP2_EVE_MEMO_DYING_SKY",
...
--------------------------------------------------------------------------------------------------------
GUARDIAN_SP2_EVE_MEMO_DISAPPEAR = 
{
	SHOW						= FALSE,
...
GUARDIAN_SP2_EVE_MEMO_TELEPORT = 
{
	ANIM_NAME					= "Win",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	TRANSITION					= TRUE,
	...
	EVENT_PROCESS = 
	{
	    { STATE_CHANGE_TYPE["SCT_MOTION_END"],					"GUARDIAN_SP2_EVE_MEMO_DISAPPEAR",					},
	},
...
GUARDIAN_SP2_EVE_MEMO_ATTACK = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"GUARDIAN_SP2_EVE_MEMO_TELEPORT",								},	
	},
...
GUARDIAN_SP2_EVE_MEMO_DYING_LAND_FRONT = 
{
	SHOW						= FALSE,
...
GUARDIAN_SP2_EVE_MEMO_DYING_LAND_BACK = 
{
	SHOW						= FALSE,
...
GUARDIAN_SP2_EVE_MEMO_DYING_SKY = 
{
	SHOW						= FALSE,
...
----------------------------------------------------------
function GUARDIAN_SP2_EVE_MEMO_DISAPPEAR_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
----------------------------------------------------------
function GUARDIAN_SP2_EVE_MEMO_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
-- Fade End    
    ...
    if pNPCUnit:AnimEventTimer_LUA( 0.7 ) then
		...
		pDamageEffect:CreateInstance_LUA( pNPCUnit, "NASOD_GUARDIAN_SONICWAVE_MEMO", vBonePos, vLandPos.y )			
...
function GUARDIAN_SP2_EVE_MEMO_TELEPORT_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function GUARDIAN_SP2_EVE_MEMO_TELEPORT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
-- Fade Start    
