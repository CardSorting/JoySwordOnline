...
PVP_BOT_BALAK_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_BALAK_WAIT",			"CF_PVP_BOT_BALAK_AI_TICK",										},
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_BALAK_Charged_Bolt",     			"CF_PVP_BOT_BALAK_CHARGED_BOLT",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_BALAK_Valkyries_Javelin",     		"CF_PVP_BOT_BALAK_JAVELIN",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_BALAK_Wild_Charge_Ready",     		"CF_PVP_BOT_BALAK_WILD_CHARGE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_BALAK_SHADOW_STEP",     			"CF_PVP_BOT_BALAK_SHADOW_STEP",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_BALAK_ComboZ",     				"CF_PVP_BOT_BALAK_COMBO_ENTRY",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_BALAK_DASH",         				"CF_PVP_BOT_BALAK_ADVANCE",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_BALAK_DASH",         				"CF_PVP_BOT_BALAK_ADVANCE",       		    },
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_BALAK_DashJump",          			"CF_PVP_BOT_BALAK_AERIAL_ENTRY",      		},
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_BALAK_WALK",         				"CT_PVP_BOT_BALAK_WALK",       		    },
		
		-- 뒤로 돌아 걷거나 뛰며 거리를 벌리는 동작입니다.
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_BALAK_BACKWARD_DASH_READY",     	"CF_PVP_BOT_BALAK_BACKWARD_DASH",   },
...
PVP_BOT_BALAK_STANDUP_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_BALAK_STANDUP_WAIT",			"CF_PVP_BOT_BALAK_AI_TICK",								},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_BALAK_BOOST_POWER",			"CF_PVP_BOT_BALAK_BOOST_POWER",									},
...
PVP_BOT_BALAK_WALK =
{
	...
	EVENT_PROCESS =
	{
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_BALAK_BACKWARD_DASH_READY",         				"CT_PVP_BOT_BALAK_WAIT",       		    },
...
PVP_BOT_BALAK_FLIP_DIR = {
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PVP_BOT_BALAK_JUMP_DOWN_ACT",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"PVP_BOT_BALAK_BACKWARD_DASH_READY",		},
	},
...
PVP_BOT_BALAK_ComboZZ =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],			"PVP_BOT_BALAK_BACKWARD_DASH_READY",	"CF_PVP_BOT_BALAK_COMBO_RESET",	},
...
function CF_PVP_BOT_BALAK_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_BALAK_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_BALAK_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end

function CF_PVP_BOT_BALAK_CHARGED_BOLT( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "charged_bolt", "guard", 0, 460, 100, 31, 13 )
end

function CF_PVP_BOT_BALAK_JAVELIN( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "valkyrie_javelin", "burst", 220, 760, 200, 35, 18 )
end

function CF_PVP_BOT_BALAK_WILD_CHARGE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "wild_charge", "chase", 560, 1250, 200, 42, 17 )
end

function CF_PVP_BOT_BALAK_SHADOW_STEP( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shadow_step", "chase", 260, 980, 60, 39, 8 )
end

function CF_PVP_BOT_BALAK_COMBO_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "blade_combo", "combo", 0, 500, 0, 50, 5 )
end

function CF_PVP_BOT_BALAK_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "assassin_feint", "escape", 0, 275, 0, 19, 9 )
end
...
function CF_PVP_BOT_BALAK_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, 310, 24 )
end

function CF_PVP_BOT_BALAK_BOOST_POWER( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_AWAKEN( pX2Game, pNPCUnit, 285, 10 )
end
...
function CF_PVP_BOT_BALAK_ADVANCE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "assassin_advance", "advance", 300, 1500, 0, 61, 3 )
end

function CF_PVP_BOT_BALAK_AERIAL_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "assassin_air_entry", "air_move", 260, 1080, 0, 36, 6 )
end
...
PVP_PRO_AI_PROFILE_BALAK = {
	name = "tempo_assassin",
	preferred_range = 285,
	aggression = 1.22,
	discipline = 1.05,
	volatility = 5,
	role_bias = { chase = 7, combo = 6, burst = 3, guard = 3, advance = 3, escape = -1 },
	openers = { shadow_step = 5, blade_combo = 4, assassin_advance = 3 },
	finishers = { valkyrie_javelin = 10, wild_charge = 7 },
	mixups = { charged_bolt = 7, assassin_feint = 6, assassin_air_entry = 4 },
}

function CF_PVP_BOT_BALAK_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_BALAK )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V4_PROFILE_BALAK = {
	name = "whiff_punish_assassin",
	patience = 0.78,
	risk = 1.22,
	creativity = 5,
	condition_limit = 2,
	finisher_threshold = 0.34,
	probe_role = "advance",
	contest_role = "chase",
	...
	counter_roles = {
		...
		feint = "escape", hold = "combo",
	},
	secondary_roles = {
		approach = "combo", retreat = "advance", jump = "chase",
		feint = "guard", hold = "chase",
	},
	signature = {
		shadow_step = 7, blade_combo = 5, wild_charge = 7,
		valkyrie_javelin = 6, assassin_feint = 5,
	},
	engagement_bias = { convert = 7, cashout = 5, probe = -3 },
}

function CF_PVP_BOT_BALAK_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_BALAK )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_BALAK )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V5_PROFILE_BALAK = {
	name = "tournament_whiff_assassin",
	read_skill = 0.90,
	exploration = 0.76,
	commitment = 1.16,
	...
	creativity = 5,
	playbooks = {
		download = { "escape", "guard", "advance" },
		outplay = { "guard", "chase", "combo" },
		pressure = { "advance", "chase", "combo" },
		deny = { "advance", "chase", "burst" },
		stabilize = { "escape", "guard", "advance" },
		survive = { "escape", "guard", "air_move" },
		finish = { "chase", "combo", "burst" },
	},
	actions = {
		download = { "assassin_feint", "charged_bolt", "assassin_advance" },
		outplay = { "charged_bolt", "shadow_step", "blade_combo" },
		pressure = { "assassin_advance", "shadow_step", "blade_combo" },
		deny = { "assassin_advance", "wild_charge", "valkyrie_javelin" },
		stabilize = { "assassin_feint", "charged_bolt", "assassin_advance" },
		survive = { "assassin_feint", "charged_bolt", "assassin_air_entry" },
		finish = { "shadow_step", "blade_combo", "valkyrie_javelin", "wild_charge" },
	},
	action_prior = {
		shadow_step = 6, blade_combo = 5, wild_charge = 6,
		valkyrie_javelin = 7, assassin_feint = 4,
	},
	goal_bias = {
		download = 1, outplay = 4, pressure = 6,
		deny = 4, stabilize = 2, finish = 6,
	},
	finisher_actions = { "valkyrie_javelin", "wild_charge", "blade_combo" },
}

function CF_PVP_BOT_BALAK_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_BALAK )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_BALAK )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE( pNPCUnit, PVP_PRO_AI_V5_PROFILE_BALAK )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V6_PROFILE_BALAK = {
	character = "balak",
	identity = "assassin_movement_technician",
	identity_mode = "movement_technician",
	probe_style = "movement",
	preferred_min = 260,
	preferred_max = 820,
	vertical_tolerance = 210,
	resource_target = 160,
	reset_threshold = 0.6,
	adaptation_rate = 1.12,
	strategy_hysteresis = 4.5,
	default_tempo = "measured_neutral",
	strategy_order = {
		"lane_orbit_mapping",
		"approach_vector_rotation",
		"assassin_resource_patience",
		"mobility_lead_keepaway",
		"escape_path_recovery",
		"javelin_intercept_finish",
	},
	strategies = {
		lane_orbit_mapping = {
			base = 10,
			...
			plans = { "ground_lane_measure", "vertical_lane_rotation", "vector_change_review" },
		},
		approach_vector_rotation = {
			base = 11,
			min_ticks = 48,
			...
			plans = { "dash_dance_threat", "shadow_escape_test", "charged_spacing_cycle" },
		},
		assassin_resource_patience = {
			base = 10.5,
			min_ticks = 44,
			...
			plans = { "charged_spacing_cycle", "mobility_reclaim", "vertical_lane_rotation" },
		},
		mobility_lead_keepaway = {
			base = 9,
			min_ticks = 58,
			...
			plans = { "centerline_preserve", "ground_lane_measure", "vector_change_review" },
		},
		escape_path_recovery = {
			base = 6,
			min_ticks = 30,
			...
			plans = { "mobility_reclaim", "centerline_preserve", "vector_change_review" },
		},
		javelin_intercept_finish = {
			base = 6,
			min_ticks = 28,
			...
			plans = { "javelin_confirm", "wild_chase_close", "dash_dance_threat" },
		},
	},
	plans = {
		ground_lane_measure = {
			...
			position = true,
			tempo = "slow_observation",
			roles = { "advance", "escape", "guard" },
			intentions = { "ground_orbit", "air_lane_swap" },
		},
		vertical_lane_rotation = {
			base = 9,
			min_ticks = 19,
			max_ticks = 37,
			position = true,
			changeup = true,
			tempo = "measured_neutral",
			roles = { "advance", "escape", "combo" },
			intentions = { "dash_stop_blade", "shadow_cross" },
		},
		dash_dance_threat = {
			base = 9,
			min_ticks = 17,
			...
			roles = { "guard", "chase", "combo" },
			intentions = { "charge_intercept", "retreat_reversal" },
		},
		shadow_escape_test = {
			base = 8,
			min_ticks = 16,
			...
			tempo = "measured_neutral",
			roles = { "air_move", "chase", "guard" },
			intentions = { "vertical_cutoff", "vector_recheck" },
		},
		charged_spacing_cycle = {
			base = 10,
			min_ticks = 19,
			max_ticks = 38,
			resource = true,
			pressure = true,
			tempo = "measured_neutral",
			roles = { "guard", "burst", "chase" },
			intentions = { "javelin_cashout", "wild_pursuit" },
		},
		mobility_reclaim = {
			base = 10,
			min_ticks = 18,
			...
			survival = true,
			tempo = "controlled_reset",
			roles = { "advance", "guard", "combo" },
			intentions = { "delayed_entry", "side_switch_finish" },
		},
		centerline_preserve = {
			base = 11,
			min_ticks = 21,
			...
			survival = true,
			tempo = "lead_preserving_slowdown",
			roles = { "air_move", "chase", "escape" },
			intentions = { "air_lane_swap", "vertical_cutoff" },
		},
		vector_change_review = {
			base = 7,
			min_ticks = 16,
			max_ticks = 30,
			probe = true,
			changeup = true,
			tempo = "slow_observation",
			roles = { "escape", "chase", "combo" },
			intentions = { "shadow_cross", "javelin_cashout" },
		},
		javelin_confirm = {
			base = 12,
			min_ticks = 12,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "escape", "guard", "chase" },
			intentions = { "retreat_reversal", "delayed_entry" },
		},
		wild_chase_close = {
			base = 10,
			min_ticks = 13,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "chase", "chase", "combo" },
			intentions = { "wild_pursuit", "side_switch_finish" },
		},
	},
	intentions = {
		ground_orbit = {
			...
			conditioning = true,
			roles = { "advance", "escape", "guard" },
			actions = { "assassin_advance", "assassin_feint", "charged_bolt" },
		},
		air_lane_swap = {
			base = 9,
			min_ticks = 7,
			...
			risk = 0.34,
			roles = { "air_move", "chase", "escape" },
			actions = { "assassin_air_entry", "shadow_step", "assassin_feint" },
		},
		dash_stop_blade = {
			base = 10,
			min_ticks = 8,
			...
			conditioning = true,
			roles = { "advance", "escape", "combo" },
			actions = { "assassin_advance", "assassin_feint", "blade_combo" },
		},
		shadow_cross = {
			base = 11,
			min_ticks = 6,
			...
			risk = 0.43,
			roles = { "escape", "chase", "combo" },
			actions = { "assassin_feint", "shadow_step", "blade_combo" },
		},
		charge_intercept = {
			base = 8,
			min_ticks = 7,
			...
			risk = 0.48,
			roles = { "guard", "chase", "combo" },
			actions = { "charged_bolt", "wild_charge", "blade_combo" },
		},
		retreat_reversal = {
			base = 9,
			min_ticks = 8,
			...
			risk = 0.29,
			roles = { "escape", "guard", "chase" },
			actions = { "assassin_feint", "charged_bolt", "shadow_step" },
		},
		vertical_cutoff = {
			base = 10,
			min_ticks = 6,
			...
			risk = 0.46,
			roles = { "air_move", "chase", "guard" },
			actions = { "assassin_air_entry", "wild_charge", "charged_bolt" },
		},
		vector_recheck = {
			base = 11,
			min_ticks = 7,
			max_ticks = 15,
			risk = 0.26,
			roles = { "advance", "air_move", "escape" },
			actions = { "assassin_advance", "assassin_air_entry", "assassin_feint" },
		},
		javelin_cashout = {
			base = 8,
			min_ticks = 8,
			...
			risk = 0.61,
			roles = { "guard", "burst", "chase" },
			actions = { "charged_bolt", "valkyrie_javelin", "wild_charge" },
		},
		wild_pursuit = {
			base = 9,
			min_ticks = 6,
			...
			risk = 0.54,
			roles = { "chase", "chase", "combo" },
			actions = { "shadow_step", "wild_charge", "blade_combo" },
		},
		delayed_entry = {
			base = 10,
			min_ticks = 7,
			...
			conditioning = true,
			roles = { "advance", "guard", "combo" },
			actions = { "assassin_advance", "charged_bolt", "blade_combo" },
		},
		side_switch_finish = {
			base = 11,
			min_ticks = 8,
			max_ticks = 15,
			risk = 0.58,
			roles = { "escape", "chase", "burst" },
			actions = { "assassin_feint", "shadow_step", "valkyrie_javelin" },
		},
	},
	action_traits = {
		charged_bolt = {
	...
	probe_order = { "dash_stop_counter", "lane_repeat", "retreat_chase" },
	probes = {
		dash_stop_counter = {
			style = "movement",
			question = "does_dash_stop_draw_a_retaliation",
		...
		lane_repeat = {
			style = "movement",
			question = "does_the_opponent_repeat_an_entry_lane",
			hypothesis = "repetitive_approach",
			expected = "approach",
			actions = { "assassin_air_entry", "assassin_feint", "shadow_step" },
			risk = 0.2,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
		...
		retreat_chase = {
			style = "position",
			question = "does_spacing_pressure_force_corner_escape",
			hypothesis = "corner_averse",
			expected = "escape",
			actions = { "charged_bolt", "assassin_feint", "wild_charge" },
			risk = 0.25,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
	...
	conditioning_breaks = {
		assassin_advance = "assassin_air_entry",
		assassin_air_entry = "shadow_step",
		charged_bolt = "blade_combo",
		shadow_step = "assassin_feint",
	},
	fallback_intention = "ground_orbit",
	error_profile = {
		base = 0.034,
		load_scale = 0.112,
		surprise_scale = 0.048,
		overconfidence_scale = 0.036,
		range_bias = 1.34,
		late_confirm = 0.78,
		familiar_route = 0.86,
		greedy_resource = 0.72,
		stale_read = 0.84,
		overcommit = 0.92,
	},
}
...
function CF_PVP_BOT_BALAK_AI_TICK(
	pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE(
		pNPCUnit, PVP_PRO_AI_PROFILE_BALAK )
	PVP_PRO_AI_SET_META_PROFILE(
		pNPCUnit, PVP_PRO_AI_V4_PROFILE_BALAK )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE(
		pNPCUnit, PVP_PRO_AI_V5_PROFILE_BALAK )
	PVP_PRO_AI_SET_COMPETITIVE_PROFILE(
		pNPCUnit, PVP_PRO_AI_V6_PROFILE_BALAK )
	PVP_PRO_AI_SET_RUNTIME_PROFILE(
		pNPCUnit, PVP_PRO_AI_V7_PROFILE_BALAK )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
