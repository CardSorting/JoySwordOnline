...
INIT_STATE = 
{
	{ STATE_NAME = "GHOST_MAGICIAN_WAIT",						},
	{ STATE_NAME = "GHOST_MAGICIAN_WAIT2",					LUA_FRAME_MOVE_FUNC = "GHOST_MAGICIAN_WAIT2_FRAME_MOVE"					},
	{ STATE_NAME = "GHOST_MAGICIAN_WAIT3",					LUA_FRAME_MOVE_FUNC = "GHOST_MAGICIAN_WAIT3_FRAME_MOVE"					},
	{ STATE_NAME = "GHOST_MAGICIAN_WALK",						LUA_STATE_END_FUNC = "GHOST_MAGICIAN_WALK_STATE_END"						},
	...
	{ STATE_NAME = "GHOST_MAGICIAN_FIRE_BALL",				LUA_FRAME_MOVE_FUNC = "GHOST_MAGICIAN_FIRE_BALL_FRAME_MOVE", STATE_COOL_TIME = 10,		},
	...
	START_STATE					= "GHOST_MAGICIAN_WAIT2",
	...
	DAMAGE_EXTRA_STATES         = {"GHOST_MAGICIAN_DAMAGE_DOWN_FRONT","GHOST_MAGICIAN_DAMAGE_DOWN_BACK","GHOST_MAGICIAN_DAMAGE_AIR_FALL",
	"GHOST_MAGICIAN_STAND_UP_FRONT","GHOST_MAGICIAN_STAND_UP_BACK","GHOST_MAGICIAN_STAND_UP_ATTACK_FRONT","GHOST_MAGICIAN_STAND_UP_ATTACK_BACK","GHOST_MAGICIAN_JUMP_DOWN","GHOST_MAGICIAN_JUMP_LANDING",},	
...
INIT_AI = 
{
	...
	ESCAPE_CONDITION = 
	{
		RATE				= 10,      -- 타격 당하는 순간 10% 확률로 이스케이프 
...
GHOST_MAGICIAN_WAIT = 
{
	...
	{		
		...
		--{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"GHOST_MAGICIAN_ATTACK",				"CT_GHOST_MAGICIAN_ATTACK",	},

		
	
		{ STATE_CHANGE_TYPE["SCT_AI_WALK"],					"GHOST_MAGICIAN_WALK",						},
		{ STATE_CHANGE_TYPE["SCT_AI_DASH"],					"GHOST_MAGICIAN_WALK",						},
		{ STATE_CHANGE_TYPE["SCT_AI_JUMP"],					"GHOST_MAGICIAN_JUMP_UP",						},
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"GHOST_MAGICIAN_WAIT2",						"CT_GHOST_MAGICIAN_WAIT2",		},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"GHOST_MAGICIAN_WAIT3",						"CT_GHOST_MAGICIAN_WAIT3",		},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"GHOST_MAGICIAN_WAIT2",						"CT_GHOST_MAGICIAN_WAIT2_B",		},
	},
	...
	CT_GHOST_MAGICIAN_WAIT2 = 
	{
		ANIM_PLAY_COUNT		= 8,
		RATE				= 50,
	},
	CT_GHOST_MAGICIAN_WAIT3 = 
	{
		ANIM_PLAY_COUNT		= 15,
		RATE				= 50,
	},
	
	CT_GHOST_MAGICIAN_WAIT2_B = 
	{
		ANIM_PLAY_COUNT		= 20,
		RATE				= 100,
	},
