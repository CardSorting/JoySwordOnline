...
INIT_MOTION = 
{
	MOTION_FILE_NAME		= "Motion_DragonLake_Gate_Boss.x",
	--MOTION_CHANGE_TEX_XET	= "Motion_Common_Gate_Boss_Besma_Lake.xet",
	MOTION_MULTI_TEX_XET	= "Motion_Common_Gate_Boss_Besma_Lake.xet",
