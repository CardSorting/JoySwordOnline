...
INIT_STATE =
{
	...
	{ STATE_NAME = "SHADOW_STINGER_WAIT",						LUA_FRAME_MOVE_FUNC = "SHADOW_STINGER_WAIT_FRAME_MOVE",						},

	{ STATE_NAME = "SHADOW_STINGER_WALK",						LUA_FRAME_MOVE_FUNC = "SHADOW_STINGER_WALK_FRAME_MOVE",
																LUA_STATE_END_FUNC = "SHADOW_STINGER_WALK_STATE_END"							},
	...
	{ STATE_NAME = "SHADOW_STINGER_ATTACK_A",					LUA_FRAME_MOVE_FUNC = "SHADOW_STINGER_ATTACK_A_FRAME_MOVE",  STATE_COOL_TIME = 10,	},
    { STATE_NAME = "SHADOW_STINGER_ATTACK_B",					LUA_FRAME_MOVE_FUNC = "SHADOW_STINGER_ATTACK_B_FRAME_MOVE",	STATE_COOL_TIME = 10, },
    { STATE_NAME = "SHADOW_STINGER_SPECIAL_ATTACK_A",			LUA_FRAME_MOVE_FUNC = "SHADOW_STINGER_SPECIAL_ATTACK_A_FRAME_MOVE",	STATE_COOL_TIME = 10, },
	...
	DAMAGE_EXTRA_STATES         = {"SHADOW_STINGER_DAMAGE_AIR_DOWN","SHADOW_STINGER_DAMAGE_AIR_FALL","SHADOW_STINGER_STAND_UP_FRONT","SHADOW_STINGER_STAND_UP_BACK",
...
INIT_AI =
{
	TARGET =
	{
		...
		MANUAL_TARGETING_FUNC		= "SHADOW_STINGER_MANUAL_TARGET",
	...
	CHASE_MOVE =
	{
		...
		WALK_INTERVAL		= 2,
		NEAR_WALK_RATE		= 100,   -- 70, 많이 뛰게할 수 있음
...
SHADOW_STINGER_WAIT =
{
    ...
    CT_SHADOW_STINGER_JUMP_FOR_ATTACK =
	{
		EVENT_INTERVAL_ID			= 0,
		DISTANCE_TO_TARGET_NEAR		= 500,
		RATE						= 80,
	...
	CT_SHADOW_STINGER_SPECIAL_ATTACK_A =
	{
		EVENT_INTERVAL_ID			= 0,
...
function SHADOW_STINGER_MANUAL_TARGET( pKTDXApp, pX2Game, pNPCUnit )
...
function SHADOW_STINGER_WALK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pX2Game:AnyUserUnitInRange( pNPCUnit:GetPos(), 600 ) == true then
		...
		if pNPCUnit:IsRightTarget_LUA(pNPCUnit, TargetPos) == true then
			if( bIsRight == true ) then
				SHADOW_STINGER_DO_ATTACK(pX2Game, pNPCUnit)
				return
			end
		else
...
function SHADOW_STINGER_WAIT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	
	if pX2Game:AnyUserUnitInRange( pNPCUnit:GetPos(), 700 ) == true then
		local TargetPos = pX2Game:GetNearestUserUnitPos_LUA( pNPCUnit:GetPos(), 0, 999999 )
...
function SHADOW_STINGER_DO_ATTACK(pX2Game, pNPCUnit)
	local iRate = pNPCUnit:GetRandVal() % 100
	
	if iRate < 50 then
		pNPCUnit:StateChange_LUA( "SHADOW_STINGER_ATTACK_A" )
	elseif iRate < 80 then
		pNPCUnit:StateChange_LUA( "SHADOW_STINGER_ATTACK_B" )
	else
		pNPCUnit:StateChange_LUA( "SHADOW_STINGER_SPECIAL_ATTACK_A" )
	end
end
