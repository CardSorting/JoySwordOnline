...
INIT_STATE = 
{
    { STATE_NAME = "ALARM_SYSTEMB_START",					LUA_STATE_START_FUNC = "ALARM_SYSTEMB_START_STATE_START"},	
	{ STATE_NAME = "ALARM_SYSTEMB_WAIT",					LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMB_FRAME_MOVE",},	
	{ STATE_NAME = "ALARM_SYSTEMB_TURN1",					LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMB_FRAME_MOVE",},	
	{ STATE_NAME = "ALARM_SYSTEMB_TURN2",					LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMB_FRAME_MOVE",},	
	
	{ STATE_NAME = "ALARM_SYSTEMB_SUMMON",					LUA_STATE_START_FUNC = "ALARM_SYSTEMB_SUMMON_STATE_START",
	                                                        LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMB_SUMMON_FRAME_MOVE", 
	                                                        LUA_STATE_END_FUNC = "ALARM_SYSTEMB_SUMMON_STATE_END",},	
	
	{ STATE_NAME = "ALARM_SYSTEMB_ATTACK_READY",	        LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMB_FRAME_MOVE",},	
	{ STATE_NAME = "ALARM_SYSTEMB_ATTACK1",				LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMB_FRAME_MOVE",  },
	{ STATE_NAME = "ALARM_SYSTEMB_ATTACK2",				LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMB_FRAME_MOVE",  },	
																	
	
	--리액션 관련
	
	{ STATE_NAME = "ALARM_SYSTEMB_DYING",		LUA_STATE_START_FUNC = "ALARM_SYSTEMB_DYING_LAND_STATE_START",},
	
	
	START_STATE					= "ALARM_SYSTEMB_START",
	WAIT_STATE					= "ALARM_SYSTEMB_WAIT",
	
		
	DYING_LAND_FRONT			= "ALARM_SYSTEMB_DYING",
	DYING_LAND_BACK				= "ALARM_SYSTEMB_DYING",
	DYING_SKY					= "ALARM_SYSTEMB_DYING",

	REVENGE_ATTACK				= "",	
	
	ATTACKED_FUNC               = "AttackedBFunc",
}
...
ALARM_SYSTEMB_START = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"ALARM_SYSTEMB_WAIT",												},	
	},
--[[
	PARTICLE_SEQ = 
	{
...
--[[	
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"ALARM_SYSTEMB_ATTACK_READY",												},	
	},
--]]	
}

ALARM_SYSTEMB_SUMMON = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= TRUE,
	...
	EVENT_PROCESS = 
	{
	    { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],		"ALARM_SYSTEMB_WAIT",     "CT_ALARM_SYSTEMB_DYING",  },
	},
	
	CT_ALARM_SYSTEMB_DYING =
	{
		ANIM_PLAY_COUNT		= 5,
	},
...
ALARM_SYSTEMB_TURN1 = 
{
	...
	EVENT_PROCESS = 
	{	
	    { STATE_CHANGE_TYPE["SCT_MOTION_END"],	                "ALARM_SYSTEMB_ATTACK2",      },		
	},	
}
...
ALARM_SYSTEMB_TURN2 = 
{
	...
	EVENT_PROCESS = 
	{	
	    { STATE_CHANGE_TYPE["SCT_MOTION_END"],	            "ALARM_SYSTEMB_ATTACK1",      },		
	},	
}

ALARM_SYSTEMB_ATTACK_READY = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	TRANSITION					= TRUE,
...
ALARM_SYSTEMB_ATTACK1 = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],		"ALARM_SYSTEMB_TURN1",			},
	},
...
ALARM_SYSTEMB_ATTACK2 = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],		"ALARM_SYSTEMB_TURN2",		},
	},
...
function ALARM_SYSTEMB_START_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function ALARM_SYSTEMB_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function ALARM_SYSTEMB_DYING_LAND_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function AttackedBFunc( pKTDXApp, pX2Game, pNPCUnit )

    pNPCUnit:StateChange_LUA( "ALARM_SYSTEMB_SUMMON", true )
end

function ALARM_SYSTEMB_SUMMON_STATE_START( pKTDXApp, pX2Game, pNPCUnit )    
...
function ALARM_SYSTEMB_SUMMON_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )    
...
function ALARM_SYSTEMB_SUMMON_STATE_END( pKTDXApp, pX2Game, pNPCUnit )
