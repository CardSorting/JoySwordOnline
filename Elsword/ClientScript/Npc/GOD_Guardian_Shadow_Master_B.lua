...
INIT_SYSTEM = 
{
	UNIT_WIDTH		= 350.0 * GATE_OF_DARKNESS_NPC_SCALE["GOD_NS_BOSS"] / 100,
...
INIT_MOTION = 
{
	MOTION_FILE_NAME			= "Motion_God_Guardian_Shadow_Master_B.x",
}
...
INIT_COMPONENT = 
{
    ...
    BOSS_GAGE_FACE_TEX_PIECE	= "DARK_SHADOW_MASTER_2",
...
{
	-- 기본 스테이트
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_B_START",			LUA_STATE_START_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_B_STATE_START",						},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_B_WAIT",				LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_B_CHECK_POSSIBLE_ATTACK_FRAME_MOVE",	},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_B_SELECT_ATTACK",	},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_B_WALK",				LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_B_CHECK_POSSIBLE_ATTACK_FRAME_MOVE",	},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",			LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_B_CHECK_POSSIBLE_ATTACK_FRAME_MOVE",	},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_B_DYING",			LUA_STATE_START_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_B_DYING_STATE_START",				},
	
	-- 공격 스테이트
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_B_ATTACK",			LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_B_ATTACK_FRAME_MOVE",	 				
																	STATE_COOL_TIME	= 5,																	},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_B_SPECIAL_ATTACK",	LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_B_SPECIAL_ATTACK_FRAME_MOVE",
																	INITIALIZE_STATE_ELAPSED_TIME = 29, STATE_COOL_TIME	= 30,																	},
	
	START_STATE					= "GOD_GUARDIAN_SHADOW_MASTER_B_START",
	WAIT_STATE					= "GOD_GUARDIAN_SHADOW_MASTER_B_WAIT",
	
	SMALL_DAMAGE_LAND_FRONT		= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	SMALL_DAMAGE_LAND_BACK		= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	BIG_DAMAGE_LAND_FRONT		= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	BIG_DAMAGE_LAND_BACK		= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	DOWN_DAMAGE_LAND_FRONT		= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	DOWN_DAMAGE_LAND_BACK		= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	FLY_DAMAGE_FRONT			= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	FLY_DAMAGE_BACK				= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	SMALL_DAMAGE_AIR			= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",	
	BIG_DAMAGE_AIR				= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	DOWN_DAMAGE_AIR				= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	DOWN_DAMAGE_AIR_LANDING		= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	UP_DAMAGE					= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	DAMAGE_REVENGE				= "GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE",
	
	DYING_LAND_FRONT			= "GOD_GUARDIAN_SHADOW_MASTER_B_DYING",
	DYING_LAND_BACK				= "GOD_GUARDIAN_SHADOW_MASTER_B_DYING",
	DYING_SKY					= "GOD_GUARDIAN_SHADOW_MASTER_B_DYING",
...
INIT_AI = 
{
	TARGET = 
	{
		...
		MANUAL_TARGETING_FUNC		= "GOD_GUARDIAN_SHADOW_MASTER_B_MANUAL_TARGET",
	},
...
GOD_GUARDIAN_SHADOW_MASTER_B_START = 
{
	ANIM_SPEED					= 0.5,
	ANIM_NAME					= "Walk",
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],	"GOD_GUARDIAN_SHADOW_MASTER_B_WALK",	},
	},
	
	PARTICLE_SEQ = 
	{
		--Major, time, Name, weaponBonePos, Pos, StateEndDelete, bTrace, posx, posy, posz, bApplyUnitRotation, rotx, roty, rotz,
		{ TRUE, 0.001, "Pa_SHADOW_MASTER_B_Basic", FALSE, "Dummy01", FALSE, TRUE, 0, 0, 0, TRUE, },
	},
}

function GOD_GUARDIAN_SHADOW_MASTER_B_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
GOD_GUARDIAN_SHADOW_MASTER_B_WAIT = 
{
	ANIM_NAME					= "Wait",
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_SHADOW_MASTER_B_WALK",	"CT_GOD_GUARDIAN_SHADOW_MASTER_B_WALK",	},
	},
	
	CT_GOD_GUARDIAN_SHADOW_MASTER_B_WALK = 
	{
		FLAG_TRUE = 0,
	},
}
...
GOD_GUARDIAN_SHADOW_MASTER_B_SELECT_ATTACK = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= TRUE,
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_SHADOW_MASTER_B_ATTACK",			"CT_GOD_GUARDIAN_SHADOW_MASTER_B_ATTACK",					},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_SHADOW_MASTER_B_SPECIAL_ATTACK",	"CT_GLITER_GOD_GUARDIAN_SHADOW_MASTER_B_SPECIAL_ATTACK",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],		"GOD_GUARDIAN_SHADOW_MASTER_B_WAIT",			},
	},
	
	CT_GOD_GUARDIAN_SHADOW_MASTER_B_ATTACK = 
	{
		EVENT_INTERVAL_ID	= 0,
	},
	
	CT_GLITER_GOD_GUARDIAN_SHADOW_MASTER_B_SPECIAL_ATTACK = 
	{
		EVENT_INTERVAL_ID	= 0,
	},
}
...
GOD_GUARDIAN_SHADOW_MASTER_B_WALK = 
{
	ANIM_SPEED					= 0.5,
	ANIM_NAME					= "Walk",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_SHADOW_MASTER_B_WAIT",	"CT_GOD_GUARDIAN_SHADOW_MASTER_B_WAIT",	},
	},
	
	CT_GOD_GUARDIAN_SHADOW_MASTER_B_WAIT = 
	{
		FLAG_FALSE = 0,
	},
}

function GOD_GUARDIAN_SHADOW_MASTER_B_WALK_STATE_END( pKTDXApp, pX2Game, pNPCUnit )
...
GOD_GUARDIAN_SHADOW_MASTER_B_ATTACK = 
{
...
function GOD_GUARDIAN_SHADOW_MASTER_B_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	
end

-----------------------------------------------------------------------------------------------------------

GOD_GUARDIAN_SHADOW_MASTER_B_SPECIAL_ATTACK = 
{
...
function GOD_GUARDIAN_SHADOW_MASTER_B_SPECIAL_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	if pNPCUnit:AnimEventTimer_LUA( 1.821 ) then
		local pDamageEffect = pX2Game:GetDamageEffect()
		local pos 			= pNPCUnit:GetLandPosition_LUA()		
		pDamageEffect:CreateInstance_LUA( pNPCUnit, "DamageEffect_GOD_SHADOW_MASTER_B_ATTACK", pNPCUnit:GetLandPosition_LUA(), pos.y )	
	elseif pNPCUnit:AnimEventTimer_LUA( 2.3 ) then
		local pDamageEffect = pX2Game:GetDamageEffect()
		local pos 			= pNPCUnit:GetLandPosition_LUA()		
		pDamageEffect:CreateInstance_LUA( pNPCUnit, "DamageEffect_GOD_SHADOW_MASTER_B_ATTACK2", pNPCUnit:GetLandPosition_LUA(), pos.y )	
	end
end

-----------------------------------------------------------------------------------------------------------

GOD_GUARDIAN_SHADOW_MASTER_B_DAMAGE = 
{
...
GOD_GUARDIAN_SHADOW_MASTER_B_DYING = 
{
	ANIM_NAME					= "Dying",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	TRANSITION					= FALSE,
...
function GOD_GUARDIAN_SHADOW_MASTER_B_DYING_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
	...
	GOD_GUARDIAN_SHADOW_MASTER_B_HEAL( pX2Game, pNPCUnit )
	
end

-----------------------------------------------------------------------------------------------------------

function GOD_GUARDIAN_SHADOW_MASTER_B_HEAL( pX2Game, pNPCUnit )
...
-- 공격 가능 여부에 대한 검사 함수
function GOD_GUARDIAN_SHADOW_MASTER_B_CHECK_POSSIBLE_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if vCheckAttackInterval.x <= fCheckAttackCoolTime then
		...
		if true == GOD_GUARDIAN_SHADOW_MASTER_B_CHECK_NEAR_ENEMY( fCheckAttackRange, pX2Game, pNPCUnit ) then	-- 근처에 적( User 혹은 팀이 다른 NPC )이 있는지 검사
		
			pNPCUnit:SetFlag_LUA( 0, false )		-- 적이 공격 범위에 있기 때문에, 이동 제한
			pNPCUnit:StateChange_LUA( "GOD_GUARDIAN_SHADOW_MASTER_B_SELECT_ATTACK", true )	-- 적이 있다면, 공격 수행
...
function GOD_GUARDIAN_SHADOW_MASTER_B_CHECK_NEAR_ENEMY( fRange, pX2Game, pNPCUnit )
	...
	for i = 0, iNumOfNPC - 1 do
		...
		if pNPC ~= nil and false == pNPC:IsUnitID( NPC_UNIT_ID["NUI_GOD_GATE_ALLY"] ) then
			...
			-- 일정 거리 아하이고, 살아있으며, 같은 팀이 아니면서 내가 보고 있는 방향에 있을 때 공격 수행
			 if fRange >= vDistance and 0.0 < pNPC:GetNowHP() and pNPC:GetTeam() ~= pNPCUnit:GetTeam() and true == GOD_GUARDIAN_SHADOW_MASTER_B_CHECK_ISRIGHT_OF_NPC_FROM_ME( pNPCUnit, pNPC ) then
					return true		-- 공격 처리
			end
	...
	for i = 0, iNumOfUser - 1 do
		...
		if pUser ~= nil then
			...
			-- 일정 거리 아하이고, 살아있으며, 같은 팀이 아니면서 내가 보고 있는 방향에 있을 때 공격 수행
			if fRange >= vDistance and 0.0 < pUser:GetNowHP() and pUser:GetTeam() ~= pNPCUnit:GetTeam() and true == GOD_GUARDIAN_SHADOW_MASTER_B_CHECK_ISRIGHT_OF_USER_FROM_ME( pNPCUnit, pUser ) then
				return true		-- 공격 처리
			end
...
function GOD_GUARDIAN_SHADOW_MASTER_B_CHECK_ISRIGHT_OF_NPC_FROM_ME( pNPCUnit, pTargetNPC  )
...
function GOD_GUARDIAN_SHADOW_MASTER_B_CHECK_ISRIGHT_OF_USER_FROM_ME( pNPCUnit, pTargetUser  )
...
-- 강제 타겟팅 설정 함수
function GOD_GUARDIAN_SHADOW_MASTER_B_MANUAL_TARGET( pKTDXApp, pX2Game, pNPCUnit )
