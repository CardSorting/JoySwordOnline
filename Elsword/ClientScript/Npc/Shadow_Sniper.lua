...
INIT_STATE = 
{
	...
	DAMAGE_EXTRA_STATES         = { "SNIPER_DAMAGE_AIR_FALL","SNIPER_STAND_UP_FRONT","SNIPER_STAND_UP_BACK",
		"SNIPER_JUMP_DOWN","SNIPER_JUMP_LANDING",},	
...
--[[		if pNPCUnit:GetIsRight() == true then
	...
	if pNPCUnit:AnimEventTimer_LUA( 1.1 ) then
		...
		pDamageEffect:CreateInstance_LUA2( pNPCUnit, "SHADOW_SNIPER_LASER", vPos , vLandPos.y, vRotDegree )
