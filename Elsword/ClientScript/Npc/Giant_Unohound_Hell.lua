...
INIT_STATE = 
{
	...
	{ STATE_NAME = "GIANT_UNOHOUND_MAGIC_ATTACK_A",			LUA_FRAME_MOVE_FUNC = "GIANT_UNOHOUND_MAGIC_ATTACK_A_FRAME_MOVE", STATE_COOL_TIME = 7,	},
	{ STATE_NAME = "GIANT_UNOHOUND_MAGIC_ATTACK_A_Combo",	LUA_FRAME_MOVE_FUNC = "GIANT_UNOHOUND_MAGIC_ATTACK_A_Combo_FRAME_MOVE", STATE_COOL_TIME = 7,	},
