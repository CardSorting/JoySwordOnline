...
INIT_MOTION = 
{
	MOTION_FILE_NAME		= "stone_Common.x",
}
...
INIT_STATE = 
{
    { STATE_NAME = "BESMA_ROCK_COMMON_START",					},
		
	{ STATE_NAME = "BESMA_ROCK_COMMON_DOWN",					},	
	{ STATE_NAME = "BESMA_ROCK_COMMON_DOWNLANDING",		LUA_FRAME_MOVE_FUNC = "BESMA_ROCK_COMMON_DOWNLANDING_FRAME_MOVE",	},	
	
	{ STATE_NAME = "BESMA_ROCK_COMMON_DASH",					LUA_FRAME_MOVE_FUNC = "BESMA_ROCK_COMMON_DASH_FRAME_MOVE",	},	

    { STATE_NAME = "BESMA_ROCK_COMMON_BROKEN",				},	
    
	
	START_STATE								= "BESMA_ROCK_COMMON_DASH",
	...
	DYING_LAND_FRONT						= "BESMA_ROCK_COMMON_BROKEN",
	DYING_LAND_BACK						= "BESMA_ROCK_COMMON_BROKEN",
	DYING_SKY									= "BESMA_ROCK_COMMON_BROKEN",
...
BESMA_ROCK_COMMON_START = 
{
	...
	EVENT_PROCESS = 
	{
		--{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_TRUE"],		"BESMA_ROCK_COMMON_DOWN",						},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"BESMA_ROCK_COMMON_DASH",						},
	},
}

BESMA_ROCK_COMMON_DOWN = 
{
    ANIM_NAME					= "Down",
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_TRUE"],		"BESMA_ROCK_COMMON_DASH",				},
	},
}

BESMA_ROCK_COMMON_DOWNLANDING = 
{
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"BESMA_ROCK_COMMON_DOWN",			},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"BESMA_ROCK_COMMON_DASH",			},
	},
}

BESMA_ROCK_COMMON_DASH = 
{
    ANIM_NAME					= "Dash_Start",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= FALSE,
...
function BESMA_ROCK_COMMON_READY2_CAMERA_MOVE( pKTDXApp, pX2Game, pNPCUnit )
--[[
...
function BESMA_ROCK_COMMON_DOWNLANDING_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function BESMA_ROCK_COMMON_DASH_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
