...
INIT_MOTION = 
{
	MOTION_FILE_NAME		= "Motion_Alarm_SystemA.X",
}
...
INIT_STATE = 
{
    { STATE_NAME = "ALARM_SYSTEMA_START",					LUA_STATE_START_FUNC = "ALARM_SYSTEMA_START_STATE_START"},	
	{ STATE_NAME = "ALARM_SYSTEMA_WAIT",					LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMA_FRAME_MOVE",},	
	{ STATE_NAME = "ALARM_SYSTEMA_TURN1",					LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMA_FRAME_MOVE",},	
	{ STATE_NAME = "ALARM_SYSTEMA_TURN2",					LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMA_FRAME_MOVE",},	
	
	{ STATE_NAME = "ALARM_SYSTEMA_SUMMON",					LUA_STATE_START_FUNC = "ALARM_SYSTEMA_SUMMON_STATE_START",
	                                                        LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMA_SUMMON_FRAME_MOVE",
	                                                        LUA_STATE_END_FUNC = "ALARM_SYSTEMA_SUMMON_STATE_END", },	
	
	--{ STATE_NAME = "ALARM_SYSTEMA_ATTACK_READY",	        LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMA_FRAME_MOVE",},	
	--{ STATE_NAME = "ALARM_SYSTEMA_ATTACK1",				LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMA_FRAME_MOVE",  },
	--{ STATE_NAME = "ALARM_SYSTEMA_ATTACK2",				LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMA_FRAME_MOVE",  },	
																	
	
	--리액션 관련
	
	{ STATE_NAME = "ALARM_SYSTEMA_DYING",		LUA_STATE_START_FUNC = "ALARM_SYSTEMA_DYING_LAND_STATE_START",},
	
	
	START_STATE					= "ALARM_SYSTEMA_START",
	WAIT_STATE					= "ALARM_SYSTEMA_WAIT",
		
	DYING_LAND_FRONT			= "ALARM_SYSTEMA_DYING",
	DYING_LAND_BACK				= "ALARM_SYSTEMA_DYING",
	DYING_SKY					= "ALARM_SYSTEMA_DYING",

	REVENGE_ATTACK				= "",	
	
	ATTACKED_FUNC               = "AttackedAFunc",
}
...
ALARM_SYSTEMA_START = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"ALARM_SYSTEMA_WAIT",												},	
	},
--[[
	PARTICLE_SEQ = 
	{
...
ALARM_SYSTEMA_SUMMON = 
{
	...
	EVENT_PROCESS = 
	{
	    { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],		"ALARM_SYSTEMA_WAIT",     "CT_ALARM_SYSTEMA_DYING",  },
	},
	
	CT_ALARM_SYSTEMA_DYING =
	{
		ANIM_PLAY_COUNT		= 5,
	},
...
ALARM_SYSTEMA_TURN1 = 
{
	...
	--EVENT_PROCESS = 
	--{	
	--    { STATE_CHANGE_TYPE["SCT_MOTION_END"],	                "ALARM_SYSTEMA_ATTACK2",      },		
	--},	
}
...
ALARM_SYSTEMA_TURN2 = 
{
	...
	--EVENT_PROCESS = 
	--{	
	--    { STATE_CHANGE_TYPE["SCT_MOTION_END"],	            "ALARM_SYSTEMA_ATTACK1",      },		
	--},	
}

--ALARM_SYSTEMA_ATTACK_READY = 
--{
--	ANIM_NAME					= "Wait",
--	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
--	TRANSITION					= TRUE,
...
-- {
	...
	-- EVENT_PROCESS = 
	-- {	
		-- { STATE_CHANGE_TYPE["SCT_MOTION_END"],		"ALARM_SYSTEMA_TURN1",			},
	-- },
...
-- {
	...
	-- EVENT_PROCESS = 
	-- {	
		-- { STATE_CHANGE_TYPE["SCT_MOTION_END"],		"ALARM_SYSTEMA_TURN2",		},
	-- },
...
function ALARM_SYSTEMA_START_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function ALARM_SYSTEMA_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function ALARM_SYSTEMA_DYING_LAND_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function AttackedAFunc( pKTDXApp, pX2Game, pNPCUnit )

    pNPCUnit:StateChange_LUA( "ALARM_SYSTEMA_SUMMON", true )
end

function ALARM_SYSTEMA_SUMMON_STATE_START( pKTDXApp, pX2Game, pNPCUnit )    
...
function ALARM_SYSTEMA_SUMMON_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )    
...
function ALARM_SYSTEMA_SUMMON_STATE_END( pKTDXApp, pX2Game, pNPCUnit )
