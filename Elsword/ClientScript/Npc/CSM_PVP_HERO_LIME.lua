...
INIT_STATE =
{
	...
	DAMAGE_EXTRA_STATES         = {"PVP_BOT_LIME_DAMAGE_AIR_DOWN","PVP_BOT_LIME_DAMAGE_AIR_FALL",
	"PVP_BOT_LIME_STAND_UP_FRONT","PVP_BOT_LIME_STAND_UP_BACK",
	...
	SUMMON_END_STATE			= "PVP_BOT_LIME_DYING_FRONT",
...
function PVP_BOT_LIME_Nature_Force_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.2 ) then
		-- pNPCUnit:AddOnStatReq( ADD_ON_STAT["AOS_ATK_PHYSIC"], 0.75 , 10.0 )
