...
INIT_STATE = 
{
	...
	-- 공중 낙하 공격
    { STATE_NAME = "GIANT_HARPY_DASH_ATTACK_B_READY",			STATE_COOL_TIME	= 4, 													},
...
{ STATE_NAME = "GIANT_HARPY_FLY_END", },

    START_STATE					= "GIANT_HARPY_FLY_WAIT_START",	
	WAIT_STATE					= "GIANT_HARPY_FLY_WAIT",
	SUMMON_END_STATE			= "GIANT_HARPY_FLY_END",
...
GIANT_HARPY_FLY_WAIT = 
{
	...
	{	
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],		"GIANT_HARPY_ATTACK_B_READY",		"CT_GIANT_HARPY_ATTACK_B_READY",		},
...
GIANT_HARPY_ATTACK_A =
{
	...
	ATTACK_TIME0				= { 0.785, 0.887, },
	ATTACK_TIME1				= { 1.543, 1.672, },
