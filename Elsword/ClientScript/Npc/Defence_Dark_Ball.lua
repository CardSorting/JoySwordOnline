...
function CHECK_NEXT_SUMMON_GROUP(pX2Game, pNPCUnit)
	...
	local pDarknessBoss = pX2Game:GetNPCUnitByType( NPC_UNIT_ID["NUI_DEFENCE_DARKNESS_BOSS_NORMAL"] )
...
function SUMMON_GROUP_14( pX2Game, pNPCUnit )
	...
	--------(A:위치, B:소환간격, C:소환시간, D:엘리트확률, E:엘리트최대개체, F:드랍여부, G:몬스터ID)---------------------	
	--------(A,			B,	C,	D,	E,	F,		G)---------------------------------------------------------------
	SUMMON_NPC(vPosOffset,	10,		10.1,	0,	0,	false,		NPC_UNIT_ID["NUI_DEFENCE_GOLEM_BOSS"], pX2Game, pNPCUnit, 		0)	
	SUMMON_NPC(vPosOffset,	45,		45.1,	0,	0,	false,		NPC_UNIT_ID["NUI_DEFENCE_GOLEM_BOSS"], pX2Game, pNPCUnit,  		1)
	SUMMON_NPC(vPosOffset,	80,	    80.1,	0,	0,	false,		NPC_UNIT_ID["NUI_DEFENCE_GOLEM_BOSS"], pX2Game, pNPCUnit,  		2)
