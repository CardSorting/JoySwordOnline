...
INIT_SYSTEM = 
{
	UNIT_WIDTH		= 420.0 * GATE_OF_DARKNESS_NPC_SCALE["GOD_NS_BOSS"] / 100,
	UNIT_HEIGHT		= 500.0 * GATE_OF_DARKNESS_NPC_SCALE["GOD_NS_BOSS"] / 100,
	UNIT_LAYER		= X2_LAYER["XL_UNIT_0"],
	UNIT_SCALE		= 1.55 * GATE_OF_DARKNESS_NPC_SCALE["GOD_NS_BOSS"] / 100,
}
...
INIT_MOTION = 
{
	MOTION_FILE_NAME			= "Motion_God_Guardian_Shadow_Master_C.x",
}
...
INIT_COMPONENT = 
{
    ...
    BOSS_GAGE_FACE_TEX_PIECE	= "DARK_SHADOW_MASTER_3",
...
{
	-- 기본 스테이트
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_C_START",			LUA_STATE_START_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_C_STATE_START",						},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_C_WAIT",				LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_C_CHECK_POSSIBLE_ATTACK_FRAME_MOVE",	},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_C_SELECT_ATTACK",	},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_C_WALK",				LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_C_CHECK_POSSIBLE_ATTACK_FRAME_MOVE",	},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",			LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_C_CHECK_POSSIBLE_ATTACK_FRAME_MOVE",	},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_C_DYING",			LUA_STATE_START_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_C_DYING_STATE_START",				},
	
	-- 공격 스테이트
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_C_ATTACK",			LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_C_ATTACK_FRAME_MOVE",	 				
																	STATE_COOL_TIME	= 5,																	},
	{ STATE_NAME = "GOD_GUARDIAN_SHADOW_MASTER_C_SPECIAL_ATTACK",	LUA_FRAME_MOVE_FUNC = "GOD_GUARDIAN_SHADOW_MASTER_C_SPECIAL_ATTACK_FRAME_MOVE",
																	INITIALIZE_STATE_ELAPSED_TIME = 29, STATE_COOL_TIME	= 30,																	},
	
	START_STATE					= "GOD_GUARDIAN_SHADOW_MASTER_C_START",
	WAIT_STATE					= "GOD_GUARDIAN_SHADOW_MASTER_C_WAIT",
	
	SMALL_DAMAGE_LAND_FRONT		= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	SMALL_DAMAGE_LAND_BACK		= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	BIG_DAMAGE_LAND_FRONT		= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	BIG_DAMAGE_LAND_BACK		= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	DOWN_DAMAGE_LAND_FRONT		= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	DOWN_DAMAGE_LAND_BACK		= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	FLY_DAMAGE_FRONT			= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	FLY_DAMAGE_BACK				= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	SMALL_DAMAGE_AIR			= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",	
	BIG_DAMAGE_AIR				= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	DOWN_DAMAGE_AIR				= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	DOWN_DAMAGE_AIR_LANDING		= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	UP_DAMAGE					= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	DAMAGE_REVENGE				= "GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE",
	
	DYING_LAND_FRONT			= "GOD_GUARDIAN_SHADOW_MASTER_C_DYING",
	DYING_LAND_BACK				= "GOD_GUARDIAN_SHADOW_MASTER_C_DYING",
	DYING_SKY					= "GOD_GUARDIAN_SHADOW_MASTER_C_DYING",
...
INIT_AI = 
{
	TARGET = 
	{
		...
		MANUAL_TARGETING_FUNC		= "GOD_GUARDIAN_SHADOW_MASTER_C_MANUAL_TARGET",
	},
...
GOD_GUARDIAN_SHADOW_MASTER_C_START = 
{
	ANIM_SPEED					= 0.5,
	ANIM_NAME					= "Walk",
	...
	ALARM =
	{
		...
		ALARM_MESSAGE 			 = STR_ID_24016,  		  		    --경고 문구
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],	"GOD_GUARDIAN_SHADOW_MASTER_C_WALK",	},
	},
	
	PARTICLE_SEQ = 
	{
		--Major, time, Name, weaponBonePos, Pos, StateEndDelete, bTrace, posx, posy, posz, bApplyUnitRotation, rotx, roty, rotz,
		{ TRUE, 0.001, "Pa_SHADOW_MASTER_C_Basic", FALSE, "Dummy01", FALSE, TRUE, 0, 0, 0, TRUE, },
	},
	
	EFFECT_SET_LIST = 
	{
		"EffectSet_GOD_GUARDIAN_SHADOW_MASTER_C_AURA", 0.01,
	},
}

function GOD_GUARDIAN_SHADOW_MASTER_C_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
GOD_GUARDIAN_SHADOW_MASTER_C_WAIT = 
{
	ANIM_NAME					= "Wait",
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_SHADOW_MASTER_C_WALK",	"CT_GOD_GUARDIAN_SHADOW_MASTER_C_WALK",	},
	},
	
	CT_GOD_GUARDIAN_SHADOW_MASTER_C_WALK = 
	{
		FLAG_TRUE = 0,
	},
}
...
GOD_GUARDIAN_SHADOW_MASTER_C_SELECT_ATTACK = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= TRUE,
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_SHADOW_MASTER_C_ATTACK",			"CT_GOD_GUARDIAN_SHADOW_MASTER_C_ATTACK",					},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_SHADOW_MASTER_C_SPECIAL_ATTACK",	"CT_GLITER_GOD_GUARDIAN_SHADOW_MASTER_C_SPECIAL_ATTACK",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],		"GOD_GUARDIAN_SHADOW_MASTER_C_WAIT",			},
	},
	
	CT_GOD_GUARDIAN_SHADOW_MASTER_C_ATTACK = 
	{
		EVENT_INTERVAL_ID	= 0,
	},
	
	CT_GLITER_GOD_GUARDIAN_SHADOW_MASTER_C_SPECIAL_ATTACK = 
	{
		EVENT_INTERVAL_ID	= 0,
	},
}
...
GOD_GUARDIAN_SHADOW_MASTER_C_WALK = 
{
	ANIM_SPEED					= 0.5,
	ANIM_NAME					= "Walk",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"GOD_GUARDIAN_SHADOW_MASTER_C_WAIT",	"CT_GOD_GUARDIAN_SHADOW_MASTER_C_WAIT",	},
	},
	
	CT_GOD_GUARDIAN_SHADOW_MASTER_C_WAIT = 
	{
		FLAG_FALSE = 0,
	},
}

function GOD_GUARDIAN_SHADOW_MASTER_C_WALK_STATE_END( pKTDXApp, pX2Game, pNPCUnit )
...
GOD_GUARDIAN_SHADOW_MASTER_C_ATTACK = 
{
	...
	EFFECT_SET_LIST = 
	{
		"EffectSet_GOD_SHADOW_MASTER_ATTACK", 0,
	},
...
function GOD_GUARDIAN_SHADOW_MASTER_C_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )	

end

-----------------------------------------------------------------------------------------------------------

GOD_GUARDIAN_SHADOW_MASTER_C_SPECIAL_ATTACK = 
{
...
function GOD_GUARDIAN_SHADOW_MASTER_C_SPECIAL_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )

    local pDamageEffect = pX2Game:GetDamageEffect()
    	
	local landPos = pNPCUnit:GetLandPosition_LUA()
	landPos.y = landPos.y + 400
	
	local vRot = pNPCUnit:GetRotateDegree()
	
    for i = 0, 15 do        
		if pNPCUnit:AnimEventTimer_LUA( 0.15 * i ) then 
			landPos.y = landPos.y + ( pNPCUnit:GetRandVal( math.random( i ) ) % 21 ) * 45
			local posR = pNPCUnit:GetVector_LUA()
			pDamageEffect:CreateInstance_LUA2( pNPCUnit, "DamageEffect_GOD_SHADOW_MASTER_C_ATTACK", landPos, landPos.y, vRot)
		end	               
	end    
end
...
GOD_GUARDIAN_SHADOW_MASTER_C_DAMAGE = 
{
...
GOD_GUARDIAN_SHADOW_MASTER_C_DYING = 
{
	ANIM_NAME					= "Dying",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	TRANSITION					= FALSE,
	...
	ALARM =
	{
		...
		ALARM_MESSAGE 			 = STR_ID_24018,  		  		    --경고 문구
		DELAY   				 = 0,  				    	 		--이 스테이트가 시작되고 이 시간이 경과 후에 경고가 나갑니다.
		REPEAT   				 = TRUE,  		 		   		    --한 번만 반복 FALSE, 이 스테이트 취할때 마다 반복 TRUE
		ALARM_COLOR_TYPE		 = ALARM_COLOR_TYPE["ACT_ORANGE"],  --경고 문구 색깔 (ACT_RED, ACT_BLUE, ACT_YELLOW ,ACT_ORANGE, ACT_MAGENTA
		DISAPPEAR_TIME  		 = 5, 				  			    -- 표시 지속 시간
...
function GOD_GUARDIAN_SHADOW_MASTER_C_DYING_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
	...
	GOD_GUARDIAN_SHADOW_MASTER_C_HEAL( pX2Game, pNPCUnit )
	
end

-----------------------------------------------------------------------------------------------------------

function GOD_GUARDIAN_SHADOW_MASTER_C_HEAL( pX2Game, pNPCUnit )
...
-- 공격 가능 여부에 대한 검사 함수
function GOD_GUARDIAN_SHADOW_MASTER_C_CHECK_POSSIBLE_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if vCheckAttackInterval.x <= fCheckAttackCoolTime then
		...
		if true == GOD_GUARDIAN_SHADOW_MASTER_C_CHECK_NEAR_ENEMY( fCheckAttackRange, pX2Game, pNPCUnit ) then	-- 근처에 적( User 혹은 팀이 다른 NPC )이 있는지 검사
		
			pNPCUnit:SetFlag_LUA( 0, false )		-- 적이 공격 범위에 있기 때문에, 이동 제한
			pNPCUnit:StateChange_LUA( "GOD_GUARDIAN_SHADOW_MASTER_C_SELECT_ATTACK", true )	-- 적이 있다면, 공격 수행
...
function GOD_GUARDIAN_SHADOW_MASTER_C_CHECK_NEAR_ENEMY( fRange, pX2Game, pNPCUnit )
	...
	for i = 0, iNumOfNPC - 1 do
		...
		if pNPC ~= nil and false == pNPC:IsUnitID( NPC_UNIT_ID["NUI_GOD_GATE_ALLY"] ) then
			...
			-- 일정 거리 아하이고, 살아있으며, 같은 팀이 아니면서 내가 보고 있는 방향에 있을 때 공격 수행
			 if fRange >= vDistance and 0.0 < pNPC:GetNowHP() and pNPC:GetTeam() ~= pNPCUnit:GetTeam() and true == GOD_GUARDIAN_SHADOW_MASTER_C_CHECK_ISRIGHT_OF_NPC_FROM_ME( pNPCUnit, pNPC ) then
					return true		-- 공격 처리
			end
	...
	for i = 0, iNumOfUser - 1 do
		...
		if pUser ~= nil then
			...
			-- 일정 거리 아하이고, 살아있으며, 같은 팀이 아니면서 내가 보고 있는 방향에 있을 때 공격 수행
			if fRange >= vDistance and 0.0 < pUser:GetNowHP() and pUser:GetTeam() ~= pNPCUnit:GetTeam() and true == GOD_GUARDIAN_SHADOW_MASTER_C_CHECK_ISRIGHT_OF_USER_FROM_ME( pNPCUnit, pUser ) then
				return true		-- 공격 처리
			end
...
function GOD_GUARDIAN_SHADOW_MASTER_C_CHECK_ISRIGHT_OF_NPC_FROM_ME( pNPCUnit, pTargetNPC  )
...
function GOD_GUARDIAN_SHADOW_MASTER_C_CHECK_ISRIGHT_OF_USER_FROM_ME( pNPCUnit, pTargetUser  )
...
-- 강제 타겟팅 설정 함수
function GOD_GUARDIAN_SHADOW_MASTER_C_MANUAL_TARGET( pKTDXApp, pX2Game, pNPCUnit )
...
function MovePos( pos, dirvector, dist )
	...
	local vResult = D3DXVECTOR3( 0.0, 0.0, 0.0 )
	
	vResult.x = pos.x + dist * dirvector.x
	vResult.y = pos.y + dist * dirvector.y
	vResult.z = pos.z + dist * dirvector.z
