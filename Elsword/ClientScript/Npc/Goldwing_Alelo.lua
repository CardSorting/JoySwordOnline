...
INIT_STATE = 
{
	...
	-- LAND_MODE 기본 공격
	{ STATE_NAME = "GOLDWING_ALELO_ATTACK_A_READY",				STATE_COOL_TIME	= 5,	},
	{ STATE_NAME = "GOLDWING_ALELO_ATTACK_A",						},
	
	-- LAND_MODE 차크람 2개 날리는 공격
	{ STATE_NAME = "GOLDWING_ALELO_MAGIC_ATTACK_A",			LUA_FRAME_MOVE_FUNC = "GOLDWING_ALELO_MAGIC_ATTACK_A_FRAME_MOVE",	STATE_COOL_TIME	= 15,	},	
	
	-- LAND_MODE 휠윈드
	{ STATE_NAME = "GOLDWING_ALELO_SPECIAL_ATTACK_A_READY",		STATE_COOL_TIME	= 20,		},
	{ STATE_NAME = "GOLDWING_ALELO_SPECIAL_ATTACK_A_LOOP",		},
	{ STATE_NAME = "GOLDWING_ALELO_SPECIAL_ATTACK_A_END",		},
	
	
	-- FLY_MODE 차크람 2개 날리는 공격
	{ STATE_NAME = "GOLDWING_ALELO_MAGIC_ATTACK_B",				STATE_COOL_TIME	= 10,				},	
	
	-- FLY_MODE 땅에 박혀서 전진하는 차크람 2개 날리는 공격
	{ STATE_NAME = "GOLDWING_ALELO_SPECIAL_ATTACK_B",			STATE_COOL_TIME	= 25,				},	
...
GOLDWING_ALELO_MAGIC_ATTACK_A =
{
	...
	ATTACK_TIME0	= { 0.85, 0.883, },
	ATTACK_TIME1	= { 1.018, 1.051, },
...
function GOLDWING_ALELO_MAGIC_ATTACK_A_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )

	if pNPCUnit:AnimEventTimer_LUA( 0.9 ) then	-- 넘어뜨리는 데미지 데이타로 변경
