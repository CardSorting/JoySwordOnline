...
INIT_STATE = 
{
	{ STATE_NAME = "CARZYPUPPETNOTMOVEHELL_START",					},
	{ STATE_NAME = "CARZYPUPPETNOTMOVEHELL_WAIT",					},
	{ STATE_NAME = "CARZYPUPPETNOTMOVEHELL_ATTACK_LEFT",			LUA_FRAME_MOVE_FUNC = "CARZYPUPPETNOTMOVEHELL_ATTACK_LEFT_FRAME_MOVE",		},
	{ STATE_NAME = "CARZYPUPPETNOTMOVEHELL_ATTACK_RIGHT",			LUA_FRAME_MOVE_FUNC = "CARZYPUPPETNOTMOVEHELL_ATTACK_RIGHT_FRAME_MOVE",		},
	
	--리액션 관련	
	{ STATE_NAME = "CARZYPUPPETNOTMOVEHELL_DYING",						}, --	LUA_FRAME_MOVE_FUNC = "CARZYPUPPETNOTMOVEHELL_DYING_FRAME_MOVE" },
	
	START_STATE					= "CARZYPUPPETNOTMOVEHELL_START",
	WAIT_STATE          = "CARZYPUPPETNOTMOVEHELL_WAIT",
  ...
  DOWN_DAMAGE_LAND_BACK		= "",
	...
	DYING_LAND_FRONT			= "CARZYPUPPETNOTMOVEHELL_DYING",
	DYING_LAND_BACK				= "CARZYPUPPETNOTMOVEHELL_DYING",
	DYING_SKY					= "CARZYPUPPETNOTMOVEHELL_DYING",
...
CARZYPUPPETNOTMOVEHELL_START = 
{
  ...
  INVINCIBLE					= { 0, 100, }, 			
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"CARZYPUPPETNOTMOVEHELL_WAIT",						},
	},
...
CARZYPUPPETNOTMOVEHELL_WAIT = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	  "CARZYPUPPETNOTMOVEHELL_ATTACK_LEFT",  "CT_CARZYPUPPETNOTMOVEHELL_ATTACK_LEFT",				},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	  "CARZYPUPPETNOTMOVEHELL_ATTACK_RIGHT",  "CT_CARZYPUPPETNOTMOVEHELL_ATTACK_RIGHT",				},
	},
	
	
	CT_CARZYPUPPETNOTMOVEHELL_ATTACK_LEFT = 
	{
		EVENT_INTERVAL_ID			= 0,
	...
	CT_CARZYPUPPETNOTMOVEHELL_ATTACK_RIGHT = 
	{
		EVENT_INTERVAL_ID			= 0,
		DISTANCE_TO_TARGET_NEAR		= 1000,
		CHECK_TARGET_DIRECTION  = TRUE,
...
CARZYPUPPETNOTMOVEHELL_ATTACK_LEFT =
{
...
CARZYPUPPETNOTMOVEHELL_ATTACK_RIGHT =
{
...
function CARZYPUPPETNOTMOVEHELL_ATTACK_LEFT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function CARZYPUPPETNOTMOVEHELL_ATTACK_RIGHT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function CARZYPUPPETNOTMOVEHELL_DYING_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
