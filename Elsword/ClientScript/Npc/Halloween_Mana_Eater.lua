...
RUNAWAY_TIME_AFTER_ABSORB = 7.0		-- 흡수 성공 후 공격 모션이 끝난 후부터 이 시간이 지나고 나면 도주를 시도한다.
...
INIT_COMPONENT = 
{
	...
	WEAPON0 = 
	{
		WEAPON_FILE_NAME	= "HALLOWEEN_MANA_EATER _HEAD_ACC.x",
		WEAPON_BONE_NAME	= "Bip01_c",
...
MANA_EATER_MAGIC_ATTACK = 
{
	...
	DAMAGE_DATA = 
	{
		...
		BUFF_FACTOR =
		{
			BUFF_TEMPLET_ID = BUFF_TEMPLET_ID["BTI_DEBUFF_MANA_BURN"],
			RATE	=
			{
				1,
			},
