...
INIT_STATE = 
{
    { STATE_NAME = "ALARM_SYSTEMC_START",					LUA_STATE_START_FUNC = "ALARM_SYSTEMC_START_STATE_START"},	
	{ STATE_NAME = "ALARM_SYSTEMC_WAIT",					LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMC_FRAME_MOVE",},	
	{ STATE_NAME = "ALARM_SYSTEMC_TURN1",					LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMC_FRAME_MOVE",},	
	{ STATE_NAME = "ALARM_SYSTEMC_TURN2",					LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMC_FRAME_MOVE",},	
	
	{ STATE_NAME = "ALARM_SYSTEMC_SUMMON",					LUA_STATE_START_FUNC = "ALARM_SYSTEMC_SUMMON_STATE_START",
	                                                        LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMC_SUMMON_FRAME_MOVE",
	                                                        LUA_STATE_END_FUNC = "ALARM_SYSTEMC_SUMMON_STATE_END", },	
	
	{ STATE_NAME = "ALARM_SYSTEMC_ATTACK_READY",	        LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMC_FRAME_MOVE",},	
	{ STATE_NAME = "ALARM_SYSTEMC_ATTACK1",				LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMC_FRAME_MOVE",  },
	{ STATE_NAME = "ALARM_SYSTEMC_ATTACK2",				LUA_FRAME_MOVE_FUNC = "ALARM_SYSTEMC_FRAME_MOVE",  },	
																	
	
	--리액션 관련
	
	{ STATE_NAME = "ALARM_SYSTEMC_DYING",		LUA_STATE_START_FUNC = "ALARM_SYSTEMC_DYING_LAND_STATE_START",},
	
	
	START_STATE					= "ALARM_SYSTEMC_START",
	WAIT_STATE					= "ALARM_SYSTEMC_WAIT",
	
		
	DYING_LAND_FRONT			= "ALARM_SYSTEMC_DYING",
	DYING_LAND_BACK				= "ALARM_SYSTEMC_DYING",
	DYING_SKY					= "ALARM_SYSTEMC_DYING",

	REVENGE_ATTACK				= "",	
	
	ATTACKED_FUNC               = "AttackedCFunc",
}
...
ALARM_SYSTEMC_START = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"ALARM_SYSTEMC_WAIT",												},	
	},
--[[
	PARTICLE_SEQ = 
	{
...
--[[	
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"ALARM_SYSTEMC_ATTACK_READY",												},	
	},
--]]	
}

ALARM_SYSTEMC_SUMMON = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= TRUE,
	...
	EVENT_PROCESS = 
	{
	    { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],		"ALARM_SYSTEMC_WAIT",     "CT_ALARM_SYSTEMC_DYING",  },
	},
	
	CT_ALARM_SYSTEMC_DYING =
	{
		ANIM_PLAY_COUNT		= 5,
	},
...
ALARM_SYSTEMC_TURN1 = 
{
	...
	EVENT_PROCESS = 
	{	
	    { STATE_CHANGE_TYPE["SCT_MOTION_END"],	                "ALARM_SYSTEMC_ATTACK2",      },		
	},	
}
...
ALARM_SYSTEMC_TURN2 = 
{
	...
	EVENT_PROCESS = 
	{	
	    { STATE_CHANGE_TYPE["SCT_MOTION_END"],	            "ALARM_SYSTEMC_ATTACK1",      },		
	},	
}

ALARM_SYSTEMC_ATTACK_READY = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	TRANSITION					= TRUE,
...
ALARM_SYSTEMC_ATTACK1 = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],		"ALARM_SYSTEMC_TURN1",			},
	},
...
ALARM_SYSTEMC_ATTACK2 = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],		"ALARM_SYSTEMC_TURN2",		},
	},
...
function ALARM_SYSTEMC_START_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function ALARM_SYSTEMC_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function ALARM_SYSTEMC_DYING_LAND_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function AttackedCFunc( pKTDXApp, pX2Game, pNPCUnit )
  
    pNPCUnit:StateChange_LUA( "ALARM_SYSTEMC_SUMMON", true )
end

function ALARM_SYSTEMC_SUMMON_STATE_START( pKTDXApp, pX2Game, pNPCUnit )    
...
function ALARM_SYSTEMC_SUMMON_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )    
...
function ALARM_SYSTEMC_SUMMON_STATE_END( pKTDXApp, pX2Game, pNPCUnit )
