...
INIT_STATE = 
{
	...
	DOWN_DAMAGE_LAND_FRONT		= "BEE_DAMAGE_DOWN",
	DOWN_DAMAGE_LAND_BACK		= "BEE_DAMAGE_DOWN",
	...
	DAMAGE_EXTRA_STATES         = {"BEE_DAMAGE_FLY_BACK_DOWN","BEE_DAMAGE_AIR_FALL","BEE_DAMAGE_STAND_UP","BEE_JUMP_DOWN","BEE_JUMP_LANDING",},	
...
BEE_WAIT = 
{
	...
	EVENT_PROCESS = 
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"BEE_FLY",				"CT_BEE_FLY"		}, 
