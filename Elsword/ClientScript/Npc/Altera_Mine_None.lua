...
INIT_MOTION = 
{
	MOTION_FILE_NAME		= "Altera_Mine_None.X",
}
...
INIT_STATE = 
{
    { STATE_NAME = "ALTERA_MINE_NONE_START",				},
	{ STATE_NAME = "ALTERA_MINE_NONE_WAIT",				LUA_FRAME_MOVE_FUNC = "ALTERA_MINE_NONE_WAIT_FRAME_MOVE",	},	
	
	{ STATE_NAME = "ALTERA_MINE_NONE_READY_EXPLODE",		LUA_STATE_START_FUNC = "ALTERA_MINE_NONE_READY_EXPLODE_STATE_START",
	                                                LUA_FRAME_MOVE_FUNC = "ALTERA_MINE_NONE_READY_EXPLODE_FRAME_MOVE",	
													LUA_STATE_END_FUNC = "ALTERA_MINE_NONE_READY_EXPLODE_STATE_END",		},
	{ STATE_NAME = "ALTERA_MINE_NONE_EXPLODE",			LUA_FRAME_MOVE_FUNC = "ALTERA_MINE_NONE_EXPLODE_FRAME_MOVE",			},

	START_STATE					= "ALTERA_MINE_NONE_START",
	WAIT_STATE					= "ALTERA_MINE_NONE_WAIT",
	...
	DOWN_DAMAGE_AIR				= "",
	UP_DAMAGE					= "",
	DAMAGE_REVENGE				= "ALTERA_MINE_NONE_WAIT",
	
	--DYING_LAND_FRONT			= "ALTERA_MINE_NONE_DYING",
	--DYING_LAND_BACK				= "ALTERA_MINE_NONE_DYING",
	--DYING_SKY					= "ALTERA_MINE_NONE_DYING",
...
ALTERA_MINE_NONE_START = 
{
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],					"ALTERA_MINE_NONE_WAIT",				},
	},
	
	
}

ALTERA_MINE_NONE_WAIT = 
{
	ANIM_NAME					= "Wait",
	...
	EVENT_PROCESS = 
	{		
	    --{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	    "ALTERA_MINE_NONE_WAIT",			},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],			"ALTERA_MINE_NONE_READY_EXPLODE",				"CF_ALTERA_MINE_NONE_READY_EXPLODE",	},
	},
}

function CF_ALTERA_MINE_NONE_READY_EXPLODE( pKTDXApp, pX2Game, pNPCUnit )
...
ALTERA_MINE_NONE_READY_EXPLODE = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= FALSE,
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],			"ALTERA_MINE_NONE_EXPLODE",		"CF_ALTERA_MINE_NONE_EXPLODE",		},
		--{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],		"ALTERA_MINE_NONE_WAIT",			"CF_ALTERA_MINE_NONE_WAIT",			},
	},	
}

function CF_ALTERA_MINE_NONE_EXPLODE( pKTDXApp, pX2Game, pNPCUnit )
...
function ALTERA_MINE_NONE_DYING_LAND_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function ALTERA_MINE_NONE_READY_EXPLODE_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.5 ) or pNPCUnit:AnimEventTimer_LUA( 1.0 ) then
        ...
        if pMajorParticle ~= nil then
            ...
            vPos.y = vPos.y + 25
            vPos.z = vPos.z - 10
		    pMajorParticle:GameUnitCreateSequence_LUA( pNPCUnit, "Light_Altera_Mine01", vPos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(1,-1) )
        end		
...
function ALTERA_MINE_NONE_READY_EXPLODE_STATE_END( pKTDXApp, pX2Game, pNPCUnit )

		
end

function ALTERA_MINE_NONE_READY_EXPLODE_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function ALTERA_MINE_NONE_EXPLODE_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
    ...
    if pNPCUnit:AnimEventTimer_LUA( 0.8 ) then
	    ...
	    pDamageEffect:CreateInstance_LUA( pNPCUnit, "MINE_NONE_EXPLOSION", vPos, vLandPos.y )
...
function ALTERA_MINE_NONE_WAIT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
