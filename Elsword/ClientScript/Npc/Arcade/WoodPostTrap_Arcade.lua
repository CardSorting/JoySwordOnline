...
INIT_STATE = 
{
	{ STATE_NAME = "WOOD_POST_TRAP_ARCADE_WAIT",						},
	--{ STATE_NAME = "WOOD_POST_TRAP_ARCADE_ATTACK",					LUA_FRAME_MOVE_FUNC = "WOOD_POST_TRAP_ARCADE_ATTACK_FRAME_MOVE"	},
	{ STATE_NAME = "WOOD_POST_TRAP_ARCADE_ATTACK",					STATE_COOL_TIME = 3, },

	START_STATE					= "WOOD_POST_TRAP_ARCADE_WAIT",	
	...
	DOWN_DAMAGE_AIR				= "",
	UP_DAMAGE					= "",
	DAMAGE_REVENGE				= "WOOD_POST_TRAP_ARCADE_WAIT",
	
	DYING_LAND_FRONT			= "",
	DYING_LAND_BACK				= "",
	DYING_SKY					= "",

	REVENGE_ATTACK				= "WOOD_POST_TRAP_ARCADE_WAIT",	
}
...
WOOD_POST_TRAP_ARCADE_WAIT = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"WOOD_POST_TRAP_ARCADE_ATTACK",				"CT_WOOD_POST_TRAP_ARCADE_ATTACK",	},
	},
	
	CT_WOOD_POST_TRAP_ARCADE_ATTACK = 
	{
		EVENT_INTERVAL_ID			= 0,
...
WOOD_POST_TRAP_ARCADE_ATTACK = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"WOOD_POST_TRAP_ARCADE_WAIT",					},
	},
	
	ATTACK_TIME0				= { 0.4, 0.7, },
...
--[[
	function WOOD_POST_TRAP_ARCADE_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
