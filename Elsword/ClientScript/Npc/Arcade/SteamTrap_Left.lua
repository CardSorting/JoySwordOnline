...
INIT_STATE = 
{
	{ STATE_NAME = "STEAM_TRAP_LEFT_WAIT",						},
	{ STATE_NAME = "STEAM_TRAP_LEFT_ATTACK",					LUA_FRAME_MOVE_FUNC = "STEAM_TRAP_LEFT_ATTACK_FRAME_MOVE"	},

	START_STATE					= "STEAM_TRAP_LEFT_WAIT",
	...
	DOWN_DAMAGE_AIR				= "",
	UP_DAMAGE					= "",
	DAMAGE_REVENGE				= "STEAM_TRAP_LEFT_WAIT",
	
	DYING_LAND_FRONT			= "",
	DYING_LAND_BACK				= "",
	DYING_SKY					= "",

	REVENGE_ATTACK				= "STEAM_TRAP_LEFT_WAIT",	
}
...
STEAM_TRAP_LEFT_WAIT = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"STEAM_TRAP_LEFT_ATTACK",				"CT_STEAM_TRAP_LEFT_ATTACK",	},
	},
	
	CT_STEAM_TRAP_LEFT_ATTACK = 
	{
		STATE_TIME_OVER			= 5,
	},
}

STEAM_TRAP_LEFT_ATTACK = 
{
	ANIM_NAME					= "Attack",
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],				"STEAM_TRAP_LEFT_WAIT",		"CT_STEAM_TRAP_LEFT_WAIT",			},
	},

	
	CT_STEAM_TRAP_LEFT_WAIT = 
	{
		STATE_TIME_OVER			= 5,
	},
...
function STEAM_TRAP_LEFT_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.01 ) then
		...
		pParticle = pMajorParticle:GameUnitCreateSequence_LUA( pNPCUnit, "SteamAttack01_small_left",	pos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
	...
	if pNPCUnit:AnimEventTimer_LUA( 1.7 ) then
		...
		pMajorParticle = pX2Game:GetMajorParticle()
		pParticle = pMajorParticle:GameUnitCreateSequence_LUA( pNPCUnit, "SteamAttack02_small_left",	pos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
