...
function STEAM_TRAP_RIGHT_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.01 ) then
		...
		pMajorParticle:GameUnitCreateSequence_LUA( pNPCUnit, "SteamAttack01_small2_right",	pos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
	end
	...
	if pNPCUnit:AnimEventTimer_LUA( 1.7 ) then
		...
		pMajorParticle = pX2Game:GetMajorParticle()
		pMajorParticle:GameUnitCreateSequence_LUA( pNPCUnit, "SteamAttack02_small2_right",	pos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
	end
