...
INIT_STATE = 
{
	{ STATE_NAME = "STEAM_TRAP_DOWN_WAIT",						},
...
function STEAM_TRAP_DOWN_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.01 ) then
		...
		pMajorParticle:GameUnitCreateSequence_LUA( pNPCUnit, "SteamAttack01_small_down",	pos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
	...
	if pNPCUnit:AnimEventTimer_LUA( 1.7 ) then
		...
		pMajorParticle = pX2Game:GetMajorParticle()
		pMajorParticle:GameUnitCreateSequence_LUA( pNPCUnit, "SteamAttack02_small_down",	pos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
