...
function STEAM_TRAP_UP_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.01 ) then
		...
		pParticle = pMajorParticle:GameUnitCreateSequence_LUA( pNPCUnit, "SteamAttack01_small_up",	pos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
	...
	if pNPCUnit:AnimEventTimer_LUA( 1.7 ) then
		...
		pMajorParticle = pX2Game:GetMajorParticle()
		pParticle = pMajorParticle:GameUnitCreateSequence_LUA( pNPCUnit, "SteamAttack02_small_up",	pos, D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) )
