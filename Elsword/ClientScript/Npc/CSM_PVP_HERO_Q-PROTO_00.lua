...
INIT_STATE =
{
	...
	SUMMON_END_STATE			= "PVP_BOT_Q_PROTO_00_DYING_FRONT",
...
PVP_BOT_Q_PROTO_00_THORNS_ILLUSION =
{
	...
	SOUND_PLAY0			= { 0.01, "Eve_SP_ThornsSIllusion_01.ogg" },
	SOUND_PLAY1			= { 0.8, "Eve_SP_ThornsSIllusion_02.ogg" },
