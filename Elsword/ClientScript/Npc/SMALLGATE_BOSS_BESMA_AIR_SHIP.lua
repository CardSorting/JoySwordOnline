...
INIT_MOTION = 
{
	MOTION_FILE_NAME		= "Motion_Besma_AirShip_Gate_Boss.x",
	--MOTION_CHANGE_TEX_XET	= "Motion_Common_Gate_Boss_Besma_Air_Ship.xet",
	MOTION_MULTI_TEX_XET	= "Motion_Common_Gate_Boss_Besma_Air_Ship.xet",
