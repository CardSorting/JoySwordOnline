...
INIT_STATE =
{
	...
	DOWN_DAMAGE_LAND_FRONT		= "PVP_BOT_LOW_DAMAGE_BIG_FRONT",
	DOWN_DAMAGE_LAND_BACK		= "PVP_BOT_LOW_DAMAGE_BIG_BACK",
...
function PVP_BOT_LOW_DYING_LAND_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
	...
	if nil ~= pSummonGate then
		...
		pSummonGate:SetVector_LUA( 3,  D3DXVECTOR3( 1.0, vSummonUserNPC.y, vSummonUserNPC.z ) )
