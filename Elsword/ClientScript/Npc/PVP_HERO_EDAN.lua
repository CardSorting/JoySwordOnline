...
PVP_BOT_EDAN_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_EDAN_WAIT",			"CF_PVP_BOT_EDAN_AI_TICK",										},
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_EDAN_Wolf_Pang_Rush",     			"CF_PVP_BOT_EDAN_WOLF_PANG",       	     	},
        -- { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_EDAN_PULL_SOUL_WEAPON",     			"CT_PVP_BOT_EDAN_PULL_SOUL_WEAPON",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_EDAN_Berserker_Blade",     			"CF_PVP_BOT_EDAN_BERSERKER_BLADE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_EDAN_Shock_Wave",     		"CF_PVP_BOT_EDAN_SHOCK_WAVE",       	     	},
        -- { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_EDAN_Flying_Impact_Ready",     		"CT_PVP_BOT_EDAN_Flying_Impact_Ready",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_EDAN_SHADOW_STEP",     			"CF_PVP_BOT_EDAN_SHADOW_STEP",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_EDAN_ComboZ",     				"CF_PVP_BOT_EDAN_COMBO_ENTRY",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_EDAN_WALK",         				"CT_PVP_BOT_EDAN_WALK",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_EDAN_DASH",         				"CF_PVP_BOT_EDAN_ADVANCE",       		    },
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_EDAN_DashJump",          			"CF_PVP_BOT_EDAN_AERIAL_ENTRY",      		},
		
		-- 뒤로 돌아 걷거나 뛰며 거리를 벌리는 동작입니다.
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_EDAN_BACKWARD_DASH_READY",     	"CF_PVP_BOT_EDAN_BACKWARD_DASH",   },
...
PVP_BOT_EDAN_STANDUP_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_EDAN_STANDUP_WAIT",			"CF_PVP_BOT_EDAN_AI_TICK",								},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_EDAN_BOOST_POWER",			"CF_PVP_BOT_EDAN_BOOST_POWER",									},
...
PVP_BOT_EDAN_WALK =
{
	...
	EVENT_PROCESS =
	{
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_EDAN_BACKWARD_DASH_READY",         				"CT_PVP_BOT_EDAN_WAIT",       		    },
...
PVP_BOT_EDAN_FLIP_DIR = {
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PVP_BOT_EDAN_JUMP_DOWN_ACT",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"PVP_BOT_EDAN_BACKWARD_DASH_READY",		},
	},
...
PVP_BOT_EDAN_ComboZZ =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],			"PVP_BOT_EDAN_BACKWARD_DASH_READY",	"CF_PVP_BOT_EDAN_COMBO_RESET",	},
...
function CF_PVP_BOT_EDAN_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_EDAN_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_EDAN_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end

function CF_PVP_BOT_EDAN_WOLF_PANG( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "wolf_pang", "chase", 180, 860, 100, 48, 9 )
end

function CF_PVP_BOT_EDAN_BERSERKER_BLADE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "berserker_blade", "burst", 0, 420, 100, 44, 12 )
end

function CF_PVP_BOT_EDAN_SHOCK_WAVE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shock_wave", "control", 470, 1220, 200, 32, 17 )
end

function CF_PVP_BOT_EDAN_SHADOW_STEP( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shadow_step", "chase", 250, 1020, 60, 46, 7 )
end

function CF_PVP_BOT_EDAN_COMBO_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "wound_combo", "combo", 0, 520, 0, 56, 5 )
end

function CF_PVP_BOT_EDAN_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "rushdown_feint", "escape", 0, 240, 0, 13, 10 )
end
...
function CF_PVP_BOT_EDAN_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, 300, 20 )
end

function CF_PVP_BOT_EDAN_BOOST_POWER( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_AWAKEN( pX2Game, pNPCUnit, 300, 12 )
end
...
function CF_PVP_BOT_EDAN_ADVANCE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "rushdown_advance", "advance", 300, 1500, 0, 64, 3 )
end

function CF_PVP_BOT_EDAN_AERIAL_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "rushdown_air_entry", "air_move", 250, 1080, 0, 38, 6 )
end
...
PVP_PRO_AI_PROFILE_EDAN = {
	name = "relentless_rushdown",
	preferred_range = 235,
	aggression = 1.30,
	discipline = 0.98,
	volatility = 5,
	role_bias = { combo = 8, chase = 8, burst = 5, advance = 4, control = 1, escape = -2 },
	openers = { wolf_pang = 5, shadow_step = 5, wound_combo = 3 },
	finishers = { berserker_blade = 10, shock_wave = 7 },
	mixups = { rushdown_feint = 7, rushdown_air_entry = 5 },
}

function CF_PVP_BOT_EDAN_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_EDAN )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end
...
PVP_PRO_AI_V4_PROFILE_EDAN = {
	name = "momentum_rushdown",
	patience = 0.58,
	risk = 1.34,
	creativity = 4,
	condition_limit = 2,
	finisher_threshold = 0.38,
	probe_role = "advance",
	contest_role = "combo",
	...
	reset_role = "escape",
	counter_roles = {
		approach = "combo", retreat = "chase", jump = "air_move",
		feint = "escape", hold = "combo",
	},
	secondary_roles = {
		approach = "chase", retreat = "advance", jump = "control",
		feint = "combo", hold = "burst",
	},
	signature = {
		wolf_pang = 7, wound_combo = 6, shadow_step = 6,
		berserker_blade = 7, rushdown_feint = 4,
	},
	engagement_bias = { convert = 8, scramble = 6, probe = -4 },
}

function CF_PVP_BOT_EDAN_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_EDAN )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_EDAN )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end
...
PVP_PRO_AI_V5_PROFILE_EDAN = {
	name = "tournament_momentum_rushdown",
	read_skill = 0.87,
	exploration = 0.70,
	commitment = 1.22,
	...
	creativity = 4,
	playbooks = {
		download = { "escape", "control", "advance" },
		outplay = { "control", "chase", "combo" },
		pressure = { "advance", "chase", "combo" },
		deny = { "control", "chase", "advance" },
		stabilize = { "escape", "control", "advance" },
		survive = { "escape", "control", "air_move" },
		finish = { "chase", "combo", "burst" },
	},
	actions = {
		download = { "rushdown_feint", "shock_wave", "rushdown_advance" },
		outplay = { "shock_wave", "wolf_pang", "wound_combo" },
		pressure = { "rushdown_advance", "shadow_step", "wound_combo" },
		deny = { "shock_wave", "wolf_pang", "rushdown_advance" },
		stabilize = { "rushdown_feint", "shock_wave", "rushdown_advance" },
		survive = { "rushdown_feint", "shock_wave", "rushdown_air_entry" },
		finish = { "wolf_pang", "wound_combo", "berserker_blade", "shock_wave" },
	},
	action_prior = {
		wolf_pang = 6, shadow_step = 6, wound_combo = 6,
		berserker_blade = 7, shock_wave = 4,
	},
	goal_bias = {
		download = 1, outplay = 3, pressure = 7,
		deny = 3, stabilize = 1, finish = 7,
	},
	finisher_actions = { "berserker_blade", "shock_wave", "wolf_pang" },
}

function CF_PVP_BOT_EDAN_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_EDAN )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_EDAN )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE( pNPCUnit, PVP_PRO_AI_V5_PROFILE_EDAN )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end
...
PVP_PRO_AI_V6_PROFILE_EDAN = {
	character = "edan",
	identity = "wound_pressure_specialist",
	identity_mode = "relentless_pressure",
	probe_style = "pressure",
	preferred_min = 0,
	preferred_max = 520,
	vertical_tolerance = 175,
	resource_target = 120,
	reset_threshold = 0.7,
	adaptation_rate = 0.92,
	strategy_hysteresis = 7,
	default_tempo = "sustained_pressure",
	strategy_order = {
		"opener_velocity_crush",
		"defensive_gap_overload",
		"rush_resource_turn",
		"pressure_lead_snowball",
		"forced_reset_survival",
		"berserker_closeout",
	},
	strategies = {
		opener_velocity_crush = {
			...
			plans = { "opener_speed_read", "aerial_rush_lane", "challenge_recheck" },
		},
		defensive_gap_overload = {
			base = 11,
			min_ticks = 48,
			...
			plans = { "layered_pressure", "panic_gap_test", "shock_resource_turn" },
		},
		rush_resource_turn = {
			base = 10.5,
			min_ticks = 44,
			...
			plans = { "shock_resource_turn", "forced_reset", "aerial_rush_lane" },
		},
		pressure_lead_snowball = {
			base = 9,
			min_ticks = 58,
			...
			plans = { "lead_snowball", "opener_speed_read", "challenge_recheck" },
		},
		forced_reset_survival = {
			base = 6,
			min_ticks = 30,
			...
			plans = { "forced_reset", "lead_snowball", "challenge_recheck" },
		},
		berserker_closeout = {
			base = 6,
			min_ticks = 28,
			...
			plans = { "berserker_cashout", "wound_chase_finish", "layered_pressure" },
		},
	},
	plans = {
		opener_speed_read = {
			...
			intentions = { "fast_check", "air_crash" },
		},
		aerial_rush_lane = {
			base = 9,
			min_ticks = 19,
			...
			changeup = true,
			tempo = "measured_neutral",
			roles = { "advance", "chase", "combo" },
			intentions = { "layered_rush", "stop_short_maul" },
		},
		layered_pressure = {
			base = 9,
			min_ticks = 17,
			...
			intentions = { "gap_overload", "retreat_retake" },
		},
		panic_gap_test = {
			base = 8,
			min_ticks = 16,
			...
			tempo = "measured_neutral",
			roles = { "combo", "chase", "burst" },
			intentions = { "corner_drive", "defense_change_check" },
		},
		shock_resource_turn = {
			base = 10,
			min_ticks = 19,
			...
			pressure = true,
			tempo = "measured_neutral",
			roles = { "combo", "burst", "chase" },
			intentions = { "wound_cashout", "distant_closeout" },
		},
		forced_reset = {
			base = 10,
			min_ticks = 18,
			...
			survival = true,
			tempo = "controlled_reset",
			roles = { "escape", "air_move", "control" },
			intentions = { "scramble_recovery", "tempo_spike" },
		},
		lead_snowball = {
			base = 11,
			min_ticks = 21,
			...
			intentions = { "air_crash", "corner_drive" },
		},
		challenge_recheck = {
			base = 7,
			min_ticks = 16,
			...
			changeup = true,
			tempo = "slow_observation",
			roles = { "advance", "escape", "burst" },
			intentions = { "stop_short_maul", "wound_cashout" },
		},
		berserker_cashout = {
			base = 12,
			min_ticks = 12,
			...
			intentions = { "retreat_retake", "scramble_recovery" },
		},
		wound_chase_finish = {
			base = 10,
			min_ticks = 13,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "control", "chase", "burst" },
			intentions = { "distant_closeout", "tempo_spike" },
		},
	},
	intentions = {
		fast_check = {
			...
			conditioning = true,
			roles = { "advance", "escape", "combo" },
			actions = { "rushdown_advance", "rushdown_feint", "wound_combo" },
		},
		air_crash = {
			base = 9,
			min_ticks = 7,
			...
			risk = 0.48,
			roles = { "air_move", "chase", "combo" },
			actions = { "rushdown_air_entry", "shadow_step", "wound_combo" },
		},
		layered_rush = {
			base = 10,
			min_ticks = 8,
			...
			risk = 0.51,
			roles = { "advance", "chase", "combo" },
			actions = { "rushdown_advance", "wolf_pang", "wound_combo" },
		},
		stop_short_maul = {
			base = 11,
			min_ticks = 6,
			...
			conditioning = true,
			roles = { "advance", "escape", "burst" },
			actions = { "rushdown_advance", "rushdown_feint", "berserker_blade" },
		},
		gap_overload = {
			base = 8,
			min_ticks = 7,
			...
			risk = 0.58,
			roles = { "control", "chase", "chase" },
			actions = { "shock_wave", "wolf_pang", "shadow_step" },
		},
		retreat_retake = {
			base = 9,
			min_ticks = 8,
			...
			risk = 0.4,
			roles = { "escape", "chase", "combo" },
			actions = { "rushdown_feint", "shadow_step", "wound_combo" },
		},
		corner_drive = {
			base = 10,
			min_ticks = 6,
			...
			risk = 0.63,
			roles = { "combo", "chase", "burst" },
			actions = { "wound_combo", "wolf_pang", "berserker_blade" },
		},
		defense_change_check = {
			base = 11,
			min_ticks = 7,
			max_ticks = 15,
			risk = 0.34,
			roles = { "control", "escape", "advance" },
			actions = { "shock_wave", "rushdown_feint", "rushdown_advance" },
		},
		wound_cashout = {
			base = 8,
			min_ticks = 8,
			...
			risk = 0.66,
			roles = { "combo", "burst", "chase" },
			actions = { "wound_combo", "berserker_blade", "wolf_pang" },
		},
		distant_closeout = {
			base = 9,
			min_ticks = 6,
			...
			risk = 0.68,
			roles = { "control", "chase", "burst" },
			actions = { "shock_wave", "shadow_step", "berserker_blade" },
		},
		scramble_recovery = {
			base = 10,
			min_ticks = 7,
			...
			risk = 0.39,
			roles = { "escape", "air_move", "control" },
			actions = { "rushdown_feint", "rushdown_air_entry", "shock_wave" },
		},
		tempo_spike = {
			base = 11,
			min_ticks = 8,
			...
			risk = 0.57,
			conditioning = true,
			roles = { "advance", "chase", "chase" },
			actions = { "rushdown_advance", "shadow_step", "wolf_pang" },
		},
	},
	action_traits = {
		wolf_pang = {
	...
	probe_order = { "gap_challenge", "panic_after_wound", "jump_from_rush" },
	probes = {
		gap_challenge = {
			style = "pressure",
			question = "does_a_stopped_rush_draw_a_challenge",
		...
		panic_after_wound = {
			style = "pressure",
			question = "does_close_pressure_force_escape",
			hypothesis = "panic_escape",
			expected = "escape",
			actions = { "wound_combo", "rushdown_feint", "wolf_pang" },
			risk = 0.3,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
		...
		jump_from_rush = {
			style = "vertical",
			question = "does_the_opponent_jump_from_ground_rush",
			hypothesis = "movement_heavy",
			expected = "jump",
			actions = { "rushdown_advance", "rushdown_air_entry", "shadow_step" },
			risk = 0.27,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
	...
	conditioning_breaks = {
		rushdown_advance = "shadow_step",
		wound_combo = "rushdown_feint",
		wolf_pang = "shadow_step",
		rushdown_feint = "berserker_blade",
	},
	fallback_intention = "fast_check",
	error_profile = {
		base = 0.041,
		load_scale = 0.12,
		surprise_scale = 0.047,
		overconfidence_scale = 0.062,
		range_bias = 0.94,
		late_confirm = 0.76,
		familiar_route = 1.08,
		greedy_resource = 0.64,
		stale_read = 0.82,
		overcommit = 1.42,
	},
}
...
function CF_PVP_BOT_EDAN_AI_TICK(
	pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE(
		pNPCUnit, PVP_PRO_AI_PROFILE_EDAN )
	PVP_PRO_AI_SET_META_PROFILE(
		pNPCUnit, PVP_PRO_AI_V4_PROFILE_EDAN )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE(
		pNPCUnit, PVP_PRO_AI_V5_PROFILE_EDAN )
	PVP_PRO_AI_SET_COMPETITIVE_PROFILE(
		pNPCUnit, PVP_PRO_AI_V6_PROFILE_EDAN )
	PVP_PRO_AI_SET_RUNTIME_PROFILE(
		pNPCUnit, PVP_PRO_AI_V7_PROFILE_EDAN )
