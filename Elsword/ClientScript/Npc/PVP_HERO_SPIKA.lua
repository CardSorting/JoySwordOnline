...
INIT_STATE =
{
	...
	-- 텔레포트를 시전합니다.
	{ STATE_NAME = "PVP_BOT_SPIKA_TELEPORT_READY",					STATE_COOL_TIME = 1.5,			LUA_FRAME_MOVE_FUNC = "PVP_BOT_SPIKA_TELEPORT_READY_FRAME_MOVE"		},
	{ STATE_NAME = "PVP_BOT_SPIKA_TELEPORT_FINISH",					LUA_STATE_START_FUNC = "PVP_BOT_SPIKA_TELEPORT_FINISH_STATE_START"									},
	...
	-- 스피카는 각성을 하지 않습니다.
	{ STATE_NAME = "PVP_BOT_SPIKA_BOOST_POWER",					STATE_COOL_TIME = 5,			LUA_FRAME_MOVE_FUNC = "PVP_BOT_SPIKA_BOOST_POWER_FRAME_MOVE"	},
	
	-- 리액션 관련
	-- 정면에서 맞았을 때의 리액션 입니다. (small, big, down, fly)
	{ STATE_NAME = "PVP_BOT_SPIKA_DAMAGE_SMALL_FRONT",				LUA_STATE_START_FUNC = "PVP_BOT_SPIKA_DAMAGE_SMALL_FRONT_STATE_START"	,	
																	LUA_FRAME_MOVE_FUNC = "PVP_BOT_SPIKA_DAMAGE_FRONT_FRAME_MOVE"				},
	...
	--{ STATE_NAME = "PVP_BOT_SPIKA_STAND_UP_ATTACK_FRONT",			LUA_FRAME_MOVE_FUNC = "PVP_BOT_SPIKA_STAND_UP_ATTACK_FRONT_FRAME_MOVE"  	},
    --{ STATE_NAME = "PVP_BOT_SPIKA_STAND_UP_ATTACK_BACK",			LUA_FRAME_MOVE_FUNC = "PVP_BOT_SPIKA_STAND_UP_ATTACK_BACK_FRAME_MOVE"   	},
...
PVP_BOT_SPIKA_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_SPIKA_WAIT",	"CF_PVP_BOT_SPIKA_AI_TICK",									},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_SPIKA_BOOST_POWER",	"CF_PVP_BOT_SPIKA_BOOST_POWER",									},

		-- 정지하고 있을 때는 다음의 행동을 수행할 수 있습니다. (z입력, 걷기, 뛰기, 대시점프, 걷기와 뛰기는 강제로 수행 시키는 부분입니다.)
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_MANA_INTAKE",     			"CF_PVP_BOT_SPIKA_MANA_INTAKE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_PLASMA_CUTTER",     			"CF_PVP_BOT_SPIKA_PLASMA",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_PHANTOM_BREATHING",     		"CF_PVP_BOT_SPIKA_PHANTOM",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_BAT_FLY_DISASTER",     		"CF_PVP_BOT_SPIKA_BAT_DISASTER",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_BAT_FLY",     				"CF_PVP_BOT_SPIKA_BAT_FLY",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_HELL_STONE",     			"CF_PVP_BOT_SPIKA_HELL_STONE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_DashJumpComboX_for_QUADRUPLE_COMBO",  "CF_PVP_BOT_SPIKA_AIR_QUAD",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_DashJumpComboX_for_TRIPLE_COMBO",     "CF_PVP_BOT_SPIKA_AIR_TRIPLE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_DashJumpComboX_for_DOUBLE_COMBO",     "CF_PVP_BOT_SPIKA_AIR_DOUBLE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_TELEPORT_READY",     		"CF_PVP_BOT_SPIKA_TELEPORT_ESCAPE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_TELEPORT_READY",     		"CF_PVP_BOT_SPIKA_TELEPORT_CHASE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_DARK_CLOUD",     			"CF_PVP_BOT_SPIKA_DARK_CLOUD",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_CIRCLE_FLAME",     			"CF_PVP_BOT_SPIKA_CIRCLE_FLAME",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_BACKWARD_DashX",     		"CF_PVP_BOT_SPIKA_BACKDASH_MAGIC",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_DashX",     					"CF_PVP_BOT_SPIKA_DASH_MAGIC",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_DashComboZ",     			"CF_PVP_BOT_SPIKA_DASH_CATCH",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_AGING",     					"CF_PVP_BOT_SPIKA_AGING",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_ComboX",     				"CF_PVP_BOT_SPIKA_COMBO_ENTRY",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_WALK",         				"CF_PVP_BOT_SPIKA_AI_TICK",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_DASH",         				"CF_PVP_BOT_SPIKA_ADVANCE",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_DashJump",          			"CF_PVP_BOT_SPIKA_AERIAL_ENTRY",      		},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_CHARGE_MANA",          		"CF_PVP_BOT_SPIKA_CHARGE_MANA",      		},


		-- 뒤로 돌아 걷거나 뛰며 거리를 벌리는 동작입니다.
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_SPIKA_BACKWARD_DASH_READY",     	"CF_PVP_BOT_SPIKA_BACKWARD_DASH",   },
...
PVP_BOT_SPIKA_DASH =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_SPIKA_DASH",	"CF_PVP_BOT_SPIKA_AI_TICK",									},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_SPIKA_BOOST_POWER",	"CF_PVP_BOT_SPIKA_BOOST_POWER",									},
...
PVP_BOT_SPIKA_ComboX =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PVP_BOT_SPIKA_JUMP_DOWN_ACT",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"PVP_BOT_SPIKA_BACKWARD_DASH_READY",		},
	},
...
PVP_BOT_SPIKA_ComboXX =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],		"PVP_BOT_SPIKA_BACKWARD_DASH_READY",		"CF_PVP_BOT_SPIKA_COMBO_RESET",	},
...
--------------------------------------------------------------------------
function PVP_BOT_SPIKA_STAND_UP_ATTACK_FRONT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )

    if pNPCUnit:AnimEventTimer_LUA( 0.00001 ) then
...
--------------------------------------------------------------------------
function PVP_BOT_SPIKA_STAND_UP_ATTACK_BACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function PVP_BOT_SPIKA_BOOST_POWER_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function PVP_BOT_SPIKA_TELEPORT_FINISH_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_SPIKA_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_SPIKA_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return math.random(100) <= 40
end

-- Antigravity Custom Pro-Player Tactical Awakening Callback
function CF_PVP_BOT_SPIKA_BOOST_POWER( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_SPIKA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 2, 4 )
end

function CF_PVP_BOT_SPIKA_MANA_INTAKE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "mana_intake", "guard", 0, 425, 0, 44, 10 )
end

function CF_PVP_BOT_SPIKA_PLASMA( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "plasma_cutter", "burst", 390, 1050, 250, 48, 24 )
end

function CF_PVP_BOT_SPIKA_PHANTOM( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "phantom_breathing", "guard", 0, 650, 180, 42, 16 )
end

function CF_PVP_BOT_SPIKA_BAT_DISASTER( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "bat_disaster", "control", 260, 1300, 60, 37, 10 )
end

function CF_PVP_BOT_SPIKA_BAT_FLY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "bat_fly", "poke", 320, 1300, 50, 32, 7 )
end

function CF_PVP_BOT_SPIKA_HELL_STONE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "hell_stone", "burst", 0, 540, 100, 38, 12 )
end

function CF_PVP_BOT_SPIKA_TELEPORT_ESCAPE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "teleport_escape", "escape", 0, 340, 0, 50, 8 )
end

function CF_PVP_BOT_SPIKA_TELEPORT_CHASE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "teleport_reposition", "chase", 720, 1600, 0, 31, 8 )
end

function CF_PVP_BOT_SPIKA_DARK_CLOUD( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "dark_cloud", "control", 180, 680, 150, 32, 15 )
end

function CF_PVP_BOT_SPIKA_CIRCLE_FLAME( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "circle_flame", "guard", 0, 540, 50, 33, 10 )
end

function CF_PVP_BOT_SPIKA_AGING( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "aging", "control", 0, 680, 280, 46, 25 )
end

function CF_PVP_BOT_SPIKA_COMBO_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shadow_combo", "combo", 0, 620, 0, 44, 4 )
end

function CF_PVP_BOT_SPIKA_CHARGE_MANA( pKTDXApp, pX2Game, pNPCUnit )
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	local dist = PVP_PRO_AI_DISTANCE( pX2Game, pNPCUnit )
	if pNPCUnit:GetNowMP() >= 140 or dist < 900 or memory.pressure >= 4 then return false end
	return PVP_PRO_AI_READY( pNPCUnit, "mana_charge", "control", 43 + memory.far_read * 2, 12, 3, false )
end

function CF_PVP_BOT_SPIKA_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shadow_feint", "escape", 0, 360, 0, 28, 10 )
end
...
function CF_PVP_BOT_SPIKA_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, 500, 30 )
end

function CF_PVP_BOT_SPIKA_BOOST_POWER( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_AWAKEN( pX2Game, pNPCUnit, 320, 6 )
end
...
function CF_PVP_BOT_SPIKA_AIR_QUAD( pKTDXApp, pX2Game, pNPCUnit )
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	local chance = 21
	if memory.plan == "finish" or ( memory.target_hp_rate or 1 ) < 0.34 then chance = chance + 18 end
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shadow_air_quad", "air", 180, 680, 0, chance, 10 )
end

function CF_PVP_BOT_SPIKA_AIR_TRIPLE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shadow_air_triple", "air", 170, 680, 0, 31, 8 )
end

function CF_PVP_BOT_SPIKA_AIR_DOUBLE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shadow_air_double", "air", 150, 680, 0, 40, 6 )
end

function CF_PVP_BOT_SPIKA_DASH_CATCH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shadow_dash_catch", "chase", 140, 560, 0, 41, 7 )
end

function CF_PVP_BOT_SPIKA_ADVANCE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shadow_advance", "advance", 380, 1600, 0, 43, 4 )
end

function CF_PVP_BOT_SPIKA_AERIAL_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "shadow_air_entry", "air_move", 280, 1200, 0, 36, 6 )
end
...
PVP_PRO_AI_PROFILE_SPIKA = {
	name = "aerial_shadow_trickster",
	preferred_range = 455,
	aggression = 1.04,
	discipline = 1.14,
	volatility = 6,
	role_bias = { air = 8, control = 7, escape = 5, poke = 4, burst = 4, chase = 3 },
	openers = { bat_fly = 5, dark_cloud = 5, shadow_dash_catch = 4 },
	finishers = { aging = 11, plasma_cutter = 10, hell_stone = 7 },
	mixups = { shadow_air_quad = 9, shadow_air_triple = 7, shadow_air_double = 5, teleport_escape = 7, circle_flame = 5 },
}

function CF_PVP_BOT_SPIKA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_SPIKA )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 2, 4 )
end
...
PVP_PRO_AI_V4_PROFILE_SPIKA = {
	name = "unorthodox_air_trickster",
	patience = 0.92,
	risk = 1.00,
	creativity = 7,
	condition_limit = 2,
	...
	secondary_roles = {
		...
		feint = "escape", hold = "air",
	},
	signature = {
		shadow_air_quad = 8, shadow_air_triple = 7, shadow_air_double = 5,
		teleport_escape = 7, teleport_reposition = 6,
		dark_cloud = 6, plasma_cutter = 7,
	},
	engagement_bias = { changeup = 8, trap = 6, scramble = 3 },
}

function CF_PVP_BOT_SPIKA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_SPIKA )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_SPIKA )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 2, 4 )
end
...
PVP_PRO_AI_V5_PROFILE_SPIKA = {
	name = "tournament_air_trickster",
	read_skill = 0.88,
	exploration = 1.22,
	commitment = 0.95,
	reset_threshold = 0.63,
	creativity = 7,
	playbooks = {
		download = { "poke", "escape", "air" },
		outplay = { "air", "control", "escape" },
		pressure = { "control", "air", "burst" },
		deny = { "control", "poke", "chase" },
		stabilize = { "escape", "guard", "air" },
		survive = { "escape", "guard", "air_move" },
		finish = { "control", "air", "burst" },
	},
	actions = {
		download = { "bat_fly", "shadow_feint", "shadow_air_double" },
		outplay = { "shadow_air_triple", "dark_cloud", "teleport_escape" },
		pressure = { "dark_cloud", "shadow_air_quad", "plasma_cutter" },
		deny = { "bat_disaster", "bat_fly", "teleport_reposition" },
		stabilize = { "teleport_escape", "circle_flame", "shadow_air_double" },
		survive = { "shadow_feint", "phantom_breathing", "shadow_air_entry" },
		finish = { "aging", "shadow_air_quad", "plasma_cutter", "hell_stone" },
	},
	action_prior = {
		shadow_air_quad = 7, shadow_air_triple = 6, shadow_air_double = 4,
		teleport_escape = 5, dark_cloud = 5, plasma_cutter = 7,
	},
	goal_bias = {
		download = 4, outplay = 6, pressure = 3,
		deny = 4, stabilize = 3, finish = 5,
	},
	finisher_actions = { "plasma_cutter", "hell_stone", "aging", "shadow_air_quad" },
}

function CF_PVP_BOT_SPIKA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_SPIKA )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_SPIKA )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE( pNPCUnit, PVP_PRO_AI_V5_PROFILE_SPIKA )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 2, 4 )
end

function CF_PVP_BOT_SPIKA_BACKDASH_MAGIC(
	pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE(
		pX2Game, pNPCUnit, "backdash_magic", "poke",
		0, 680, 0, 34, 7 )
end

function CF_PVP_BOT_SPIKA_DASH_MAGIC(
	pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE(
		pX2Game, pNPCUnit, "dash_magic", "chase",
		0, 520, 0, 37, 6 )
end
...
PVP_PRO_AI_V6_PROFILE_SPIKA = {
	character = "spika",
	identity = "shadow_deceptive_conditioner",
	identity_mode = "deceptive_conditioner",
	probe_style = "conditioning",
	preferred_min = 260,
	preferred_max = 1050,
	vertical_tolerance = 230,
	resource_target = 210,
	reset_threshold = 0.62,
	adaptation_rate = 1.18,
	strategy_hysteresis = 5,
	default_tempo = "measured_neutral",
	strategy_order = {
		"expectation_rhythm_read",
		"conditioning_web",
		"mana_misdirection_cycle",
		"deceptive_lead_control",
		"escape_pattern_recovery",
		"concealed_cashout",
	},
	strategies = {
		expectation_rhythm_read = {
			...
			plans = { "bat_observation", "teleport_misdirection", "adaptation_review" },
		},
		conditioning_web = {
			base = 11,
			min_ticks = 48,
			...
			plans = { "air_count_condition", "delayed_response_test", "mana_mask_cycle" },
		},
		mana_misdirection_cycle = {
			base = 10.5,
			min_ticks = 44,
			...
			plans = { "mana_mask_cycle", "deceptive_reclaim", "teleport_misdirection" },
		},
		deceptive_lead_control = {
			base = 9,
			min_ticks = 58,
			...
			plans = { "expectation_lead_trap", "bat_observation", "adaptation_review" },
		},
		escape_pattern_recovery = {
			base = 6,
			min_ticks = 30,
			...
			plans = { "deceptive_reclaim", "expectation_lead_trap", "adaptation_review" },
		},
		concealed_cashout = {
			base = 6,
			min_ticks = 28,
			...
			plans = { "plasma_cashout", "hellstone_close", "air_count_condition" },
		},
	},
	plans = {
		bat_observation = {
			...
			intentions = { "bat_rhythm", "teleport_false_entry" },
		},
		teleport_misdirection = {
			base = 9,
			min_ticks = 19,
			max_ticks = 37,
			position = true,
			...
			intentions = { "air_pattern_two", "air_pattern_three" },
		},
		air_count_condition = {
			base = 9,
			min_ticks = 17,
			...
			intentions = { "air_pattern_four", "resource_misdirect" },
		},
		delayed_response_test = {
			...
			tempo = "measured_neutral",
			roles = { "guard", "guard", "escape" },
			intentions = { "guard_rotation", "cloud_trap" },
		},
		mana_mask_cycle = {
			base = 10,
			min_ticks = 19,
			...
			pressure = true,
			tempo = "measured_neutral",
			roles = { "control", "combo", "burst" },
			intentions = { "pressure_mask", "plasma_cashout" },
		},
		deceptive_reclaim = {
			base = 10,
			min_ticks = 18,
			...
			intentions = { "route_break", "guard_break_pattern" },
		},
		expectation_lead_trap = {
			base = 11,
			min_ticks = 21,
			max_ticks = 43,
			reset = true,
			survival = true,
			tempo = "lead_preserving_slowdown",
			roles = { "advance", "escape", "chase" },
			intentions = { "teleport_false_entry", "guard_rotation" },
		},
		adaptation_review = {
			base = 7,
			min_ticks = 16,
			...
			intentions = { "air_pattern_three", "pressure_mask" },
		},
		plasma_cashout = {
			base = 12,
			min_ticks = 12,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "guard", "poke", "control" },
			intentions = { "resource_misdirect", "route_break" },
		},
		hellstone_close = {
			base = 10,
			min_ticks = 13,
			...
			intentions = { "plasma_cashout", "guard_break_pattern" },
		},
	},
	intentions = {
		bat_rhythm = {
		...
		teleport_false_entry = {
			...
			conditioning = true,
			roles = { "advance", "escape", "chase" },
			actions = { "shadow_advance", "teleport_escape", "teleport_reposition" },
		},
		air_pattern_two = {
			base = 10,
			min_ticks = 8,
			...
			risk = 0.38,
			roles = { "air_move", "air", "chase" },
			actions = { "shadow_air_entry", "shadow_air_double", "shadow_dash_catch" },
		},
		air_pattern_three = {
			base = 11,
			min_ticks = 6,
			...
			conditioning = true,
			roles = { "air_move", "air", "combo" },
			actions = { "shadow_air_entry", "shadow_air_triple", "shadow_combo" },
		},
		air_pattern_four = {
			base = 8,
			min_ticks = 7,
			...
			conditioning = true,
			roles = { "air_move", "air", "burst" },
			actions = { "shadow_air_entry", "shadow_air_quad", "hell_stone" },
		},
		resource_misdirect = {
			base = 9,
			min_ticks = 8,
			...
			risk = 0.26,
			roles = { "guard", "poke", "control" },
			actions = { "mana_intake", "bat_fly", "dark_cloud" },
		},
		guard_rotation = {
			base = 10,
			min_ticks = 6,
			...
			conditioning = true,
			roles = { "guard", "guard", "escape" },
			actions = { "circle_flame", "phantom_breathing", "shadow_feint" },
		},
		cloud_trap = {
			base = 11,
			min_ticks = 7,
			...
			actions = { "dark_cloud", "aging", "teleport_reposition" },
		},
		pressure_mask = {
			base = 8,
			min_ticks = 8,
			...
			risk = 0.49,
			roles = { "control", "combo", "burst" },
			actions = { "bat_disaster", "shadow_combo", "hell_stone" },
		},
		plasma_cashout = {
			base = 9,
			min_ticks = 6,
			...
			risk = 0.7,
			roles = { "control", "burst", "burst" },
			actions = { "aging", "plasma_cutter", "hell_stone" },
		},
		route_break = {
			base = 10,
			min_ticks = 7,
	...
	probe_order = { "bat_rhythm_break", "teleport_wait_test", "air_count_expectation" },
	probes = {
		bat_rhythm_break = {
			style = "conditioning",
			question = "does_the_opponent_track_a_repeated_bat_rhythm",
			hypothesis = "repetitive_approach",
			expected = "approach",
			actions = { "bat_fly", "shadow_feint", "bat_disaster" },
			risk = 0.21,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
		...
		teleport_wait_test = {
			style = "conditioning",
			question = "does_false_entry_create_a_delayed_response",
		...
		air_count_expectation = {
			style = "conditioning",
			question = "does_the_opponent_adapt_to_air_hit_count",
			hypothesis = "adapts_after_punish",
			expected = "jump",
			actions = { "shadow_air_entry", "shadow_air_double", "shadow_air_triple" },
			risk = 0.26,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
	...
	conditioning_breaks = {
		bat_fly = "shadow_advance",
		shadow_air_double = "shadow_air_triple",
		shadow_air_triple = "shadow_air_quad",
		teleport_escape = "teleport_reposition",
		mana_intake = "hell_stone",
		circle_flame = "dark_cloud",
	},
	fallback_intention = "bat_rhythm",
	error_profile = {
		base = 0.037,
		load_scale = 0.116,
		surprise_scale = 0.052,
		overconfidence_scale = 0.041,
		range_bias = 1.08,
		late_confirm = 1.02,
		familiar_route = 1.16,
		greedy_resource = 0.94,
		stale_read = 1.28,
		overcommit = 0.84,
	},
}
...
function CF_PVP_BOT_SPIKA_AI_TICK(
	pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE(
		pNPCUnit, PVP_PRO_AI_PROFILE_SPIKA )
	PVP_PRO_AI_SET_META_PROFILE(
		pNPCUnit, PVP_PRO_AI_V4_PROFILE_SPIKA )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE(
		pNPCUnit, PVP_PRO_AI_V5_PROFILE_SPIKA )
	PVP_PRO_AI_SET_COMPETITIVE_PROFILE(
		pNPCUnit, PVP_PRO_AI_V6_PROFILE_SPIKA )
	PVP_PRO_AI_SET_RUNTIME_PROFILE(
		pNPCUnit, PVP_PRO_AI_V7_PROFILE_SPIKA )
