...
PVP_BOT_NOA_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_NOA_WAIT",	"CF_PVP_BOT_NOA_AI_TICK",										},
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_TELEPORT_READY",     			"CF_PVP_BOT_NOA_TELEPORT_ESCAPE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_TELEPORT_READY",     			"CF_PVP_BOT_NOA_TELEPORT_CHASE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_BLIZZARD_SHOWER",     			"CF_PVP_BOT_NOA_BLIZZARD",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_MAGIC_MISSILE",     			"CF_PVP_BOT_NOA_MAGIC_MISSILE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_MAGIC_MISSILE",     			"CF_PVP_BOT_NOA_MAGIC_MISSILE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_FROZEN_STEP",     			"CF_PVP_BOT_NOA_FROZEN_STEP",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_CIRCLE_FLAME",     			"CF_PVP_BOT_NOA_CIRCLE_FLAME",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_BACKWARD_DashX",     			"CF_PVP_BOT_NOA_BACKDASH_STAFF",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_DashX",     			"CF_PVP_BOT_NOA_DASH_STAFF",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_DashComboZ",     			"CF_PVP_BOT_NOA_DASH_CATCH",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_ComboX",     				"CF_PVP_BOT_NOA_POKE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_NOA_WALK",         				"CT_PVP_BOT_NOA_WALK",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_DASH",         				"CF_PVP_BOT_NOA_ADVANCE",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_DashJump",          			"CF_PVP_BOT_NOA_AERIAL_ENTRY",      		},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_ICEBERG",          		"CF_PVP_BOT_NOA_ICEBERG",      		},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_CHARGE_MANA",          		"CF_PVP_BOT_NOA_CHARGE_MANA",      		},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_CHARGE_MANA",          		"CF_PVP_BOT_NOA_CHARGE_MANA",      		},


		-- 뒤로 돌아 걷거나 뛰며 거리를 벌리는 동작입니다.
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_NOA_BACKWARD_DASH_READY",     	"CF_PVP_BOT_NOA_BACKWARD_DASH",   },
...
PVP_BOT_NOA_WALK =
{
	...
	EVENT_PROCESS =
	{
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_NOA_BACKWARD_DASH_READY",         			"CT_PVP_BOT_NOA_WAIT",       		    },
...
PVP_BOT_NOA_ComboX =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PVP_BOT_NOA_JUMP_DOWN_ACT",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"PVP_BOT_NOA_BACKWARD_DASH_READY",		},
	},
...
PVP_BOT_NOA_ComboXX =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],			"PVP_BOT_NOA_BACKWARD_DASH_READY",	"CF_PVP_BOT_NOA_COMBO_RESET",	},
...
function CF_PVP_BOT_NOA_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_NOA_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_NOA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 2, 4 )
end

function CF_PVP_BOT_NOA_TELEPORT_ESCAPE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "teleport_escape", "escape", 0, 330, 0, 46, 8 )
end

function CF_PVP_BOT_NOA_TELEPORT_CHASE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "teleport_reposition", "chase", 780, 1600, 0, 27, 8 )
end

function CF_PVP_BOT_NOA_BLIZZARD( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "blizzard", "burst", 0, 1200, 230, 35, 22 )
end

function CF_PVP_BOT_NOA_MAGIC_MISSILE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "magic_missile", "control", 520, 1600, 200, 42, 13 )
end

function CF_PVP_BOT_NOA_POKE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "staff_poke", "poke", 260, 850, 0, 39, 5 )
end

function CF_PVP_BOT_NOA_CHARGE_MANA( pKTDXApp, pX2Game, pNPCUnit )
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	local dist = PVP_PRO_AI_DISTANCE( pX2Game, pNPCUnit )
	if pNPCUnit:GetNowMP() >= 145 or dist < 850 or memory.pressure >= 4 then return false end
	return PVP_PRO_AI_READY( pNPCUnit, "mana_charge", "control", 42 + memory.far_read * 2, 12, 3, false )
end

function CF_PVP_BOT_NOA_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "mage_feint", "escape", 0, 330, 0, 31, 10 )
end
...
function CF_PVP_BOT_NOA_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, 520, 31 )
end

function CF_PVP_BOT_NOA_BOOST_POWER( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_AWAKEN( pX2Game, pNPCUnit, 310, 5 )
end
...
function CF_PVP_BOT_NOA_FROZEN_STEP( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "frozen_step", "burst", 0, 800, 299, 46, 27 )
end

function CF_PVP_BOT_NOA_CIRCLE_FLAME( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "circle_flame_guard", "guard", 0, 540, 50, 42, 10 )
end

function CF_PVP_BOT_NOA_DASH_CATCH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "mage_dash_catch", "chase", 160, 560, 0, 40, 7 )
end

function CF_PVP_BOT_NOA_ICEBERG( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "iceberg_control", "control", 220, 880, 50, 45, 11 )
end

function CF_PVP_BOT_NOA_ADVANCE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "mage_advance", "advance", 420, 1600, 0, 39, 4 )
end

function CF_PVP_BOT_NOA_AERIAL_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "mage_air_entry", "air_move", 320, 1250, 0, 31, 7 )
end
...
PVP_PRO_AI_PROFILE_NOA = {
	name = "teleport_tactician",
	preferred_range = 640,
	aggression = 0.94,
	discipline = 1.22,
	volatility = 5,
	role_bias = { control = 8, poke = 6, escape = 6, guard = 4, burst = 4, resource = 2 },
	openers = { magic_missile = 5, iceberg_control = 5, staff_poke = 4 },
	finishers = { frozen_step = 11, blizzard = 9 },
	mixups = { teleport_escape = 8, teleport_reposition = 7, circle_flame_guard = 6, mage_dash_catch = 5 },
}

function CF_PVP_BOT_NOA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_NOA )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 2, 4 )
end
...
PVP_PRO_AI_V4_PROFILE_NOA = {
	name = "space_control_tactician",
	patience = 1.58,
	risk = 0.82,
	creativity = 6,
	condition_limit = 3,
	finisher_threshold = 0.30,
	probe_role = "control",
	contest_role = "poke",
	conversion_role = "chase",
	cashout_role = "burst",
	reset_role = "escape",
	counter_roles = {
		approach = "escape", retreat = "control", jump = "control",
	...
	secondary_roles = {
		approach = "guard", retreat = "chase", jump = "air_move",
		feint = "escape", hold = "poke",
	},
	signature = {
		teleport_escape = 7, teleport_reposition = 6, iceberg_control = 7,
		magic_missile = 5, frozen_step = 7, circle_flame_guard = 5,
	},
	engagement_bias = { probe = 6, trap = 7, scramble = -5 },
}

function CF_PVP_BOT_NOA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_NOA )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_NOA )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 2, 4 )
end
...
PVP_PRO_AI_V5_PROFILE_NOA = {
	name = "tournament_space_tactician",
	read_skill = 0.93,
	exploration = 1.06,
	commitment = 0.82,
	reset_threshold = 0.59,
	creativity = 6,
	playbooks = {
		download = { "poke", "escape", "control" },
		outplay = { "poke", "control", "guard" },
		pressure = { "control", "chase", "burst" },
		deny = { "control", "poke", "chase" },
		stabilize = { "escape", "guard", "control" },
		survive = { "escape", "guard", "air_move" },
		finish = { "control", "chase", "burst" },
	},
	actions = {
		download = { "staff_poke", "teleport_escape", "magic_missile" },
		outplay = { "staff_poke", "iceberg_control", "circle_flame_guard" },
		pressure = { "iceberg_control", "mage_dash_catch", "frozen_step" },
		deny = { "magic_missile", "staff_poke", "teleport_reposition" },
		stabilize = { "mage_feint", "circle_flame_guard", "iceberg_control" },
		survive = { "teleport_escape", "circle_flame_guard", "mage_air_entry" },
		finish = { "iceberg_control", "mage_dash_catch", "frozen_step", "blizzard" },
	},
	action_prior = {
		teleport_escape = 5, teleport_reposition = 5, iceberg_control = 7,
		magic_missile = 5, frozen_step = 7, staff_poke = 3,
	},
	goal_bias = {
		download = 4, outplay = 6, pressure = 1,
		deny = 6, stabilize = 5, finish = 4,
	},
	finisher_actions = { "frozen_step", "blizzard", "iceberg_control" },
}

function CF_PVP_BOT_NOA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_NOA )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_NOA )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE( pNPCUnit, PVP_PRO_AI_V5_PROFILE_NOA )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 2, 4 )
end

function CF_PVP_BOT_NOA_BACKDASH_STAFF(
	pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE(
		pX2Game, pNPCUnit, "backdash_staff", "poke",
		0, 620, 0, 32, 7 )
end

function CF_PVP_BOT_NOA_DASH_STAFF(
	pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE(
		pX2Game, pNPCUnit, "dash_staff", "chase",
		0, 480, 0, 36, 6 )
end
...
PVP_PRO_AI_V6_PROFILE_NOA = {
	character = "noa",
	identity = "ice_resource_controller",
	identity_mode = "resource_controller",
	probe_style = "resource",
	preferred_min = 420,
	preferred_max = 1200,
	vertical_tolerance = 210,
	resource_target = 220,
	...
	strategy_order = {
		"resource_pattern_read",
		"approach_lane_freeze",
		"mana_reserve_engine",
		"resource_lead_denial",
		"teleport_survival_cycle",
		"frozen_burst_closeout",
	},
	strategies = {
		resource_pattern_read = {
			base = 10,
			...
			plans = { "staff_observation", "ice_lane_control", "spend_pattern_review" },
		},
		approach_lane_freeze = {
			base = 11,
			min_ticks = 48,
			...
			plans = { "missile_resource_wall", "teleport_test", "mana_build_cycle" },
		},
		mana_reserve_engine = {
			base = 10.5,
			min_ticks = 44,
			...
			plans = { "mana_build_cycle", "frozen_reclaim", "ice_lane_control" },
		},
		resource_lead_denial = {
			base = 9,
			min_ticks = 58,
			...
			plans = { "mana_lead_lock", "staff_observation", "spend_pattern_review" },
		},
		teleport_survival_cycle = {
			base = 6,
			min_ticks = 30,
			...
			plans = { "frozen_reclaim", "mana_lead_lock", "spend_pattern_review" },
		},
		frozen_burst_closeout = {
			base = 6,
			min_ticks = 28,
			...
			plans = { "freeze_cashout", "blizzard_close", "missile_resource_wall" },
		},
	},
	plans = {
		staff_observation = {
			...
			intentions = { "staff_measure", "ice_lane_test" },
		},
		ice_lane_control = {
			base = 9,
			min_ticks = 19,
			...
			changeup = true,
			tempo = "measured_neutral",
			roles = { "control", "guard", "escape" },
			intentions = { "missile_wall", "teleport_question" },
		},
		missile_resource_wall = {
			base = 9,
			min_ticks = 17,
			max_ticks = 34,
			pressure = true,
			...
			roles = { "poke", "control", "control" },
			intentions = { "freeze_resource_cycle", "aerial_reposition" },
		},
		teleport_test = {
			base = 8,
			min_ticks = 16,
			...
			tempo = "measured_neutral",
			roles = { "escape", "poke", "guard" },
			intentions = { "mana_hoard_shell", "escape_capture" },
		},
		mana_build_cycle = {
			base = 10,
			min_ticks = 19,
			...
			intentions = { "frozen_cashout", "blizzard_lock" },
		},
		frozen_reclaim = {
			base = 10,
			min_ticks = 18,
			...
			survival = true,
			tempo = "controlled_reset",
			roles = { "poke", "escape", "advance" },
			intentions = { "low_cost_reclaim", "teleport_burst" },
		},
		mana_lead_lock = {
			base = 11,
			min_ticks = 21,
			...
			survival = true,
			tempo = "lead_preserving_slowdown",
			roles = { "control", "poke", "advance" },
			intentions = { "ice_lane_test", "mana_hoard_shell" },
		},
		spend_pattern_review = {
			base = 7,
			min_ticks = 16,
			max_ticks = 30,
			probe = true,
			...
			intentions = { "teleport_question", "frozen_cashout" },
		},
		freeze_cashout = {
			base = 12,
			min_ticks = 12,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "air_move", "escape", "control" },
			intentions = { "aerial_reposition", "low_cost_reclaim" },
		},
		blizzard_close = {
			base = 10,
			min_ticks = 13,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "control", "burst", "chase" },
			intentions = { "blizzard_lock", "teleport_burst" },
		},
	},
	intentions = {
		staff_measure = {
		...
		ice_lane_test = {
			...
			risk = 0.28,
			roles = { "control", "poke", "advance" },
			actions = { "iceberg_control", "staff_poke", "mage_advance" },
		},
		missile_wall = {
			base = 10,
			min_ticks = 8,
			...
			risk = 0.32,
			roles = { "control", "guard", "escape" },
			actions = { "magic_missile", "circle_flame_guard", "mage_feint" },
		},
		teleport_question = {
			base = 11,
			min_ticks = 6,
		...
		freeze_resource_cycle = {
			base = 8,
			min_ticks = 7,
			max_ticks = 12,
			risk = 0.3,
			roles = { "poke", "control", "control" },
			actions = { "staff_poke", "iceberg_control", "magic_missile" },
		},
		aerial_reposition = {
			base = 9,
			min_ticks = 8,
			...
			risk = 0.29,
			roles = { "air_move", "escape", "control" },
			actions = { "mage_air_entry", "teleport_escape", "iceberg_control" },
		},
		mana_hoard_shell = {
			base = 10,
			min_ticks = 6,
			...
			risk = 0.16,
			roles = { "escape", "poke", "guard" },
			actions = { "mage_feint", "staff_poke", "circle_flame_guard" },
		},
		escape_capture = {
			base = 11,
			min_ticks = 7,
			max_ticks = 15,
			risk = 0.42,
			roles = { "control", "chase", "chase" },
			actions = { "iceberg_control", "mage_dash_catch", "teleport_reposition" },
		},
		frozen_cashout = {
			base = 8,
			min_ticks = 8,
			...
			risk = 0.62,
			roles = { "control", "burst", "burst" },
			actions = { "iceberg_control", "frozen_step", "blizzard" },
		},
		blizzard_lock = {
			base = 9,
			min_ticks = 6,
			...
			risk = 0.58,
			roles = { "control", "burst", "chase" },
			actions = { "magic_missile", "blizzard", "mage_dash_catch" },
		},
		low_cost_reclaim = {
			base = 10,
			min_ticks = 7,
			...
			risk = 0.19,
			roles = { "poke", "escape", "advance" },
			actions = { "staff_poke", "mage_feint", "mage_advance" },
		},
		teleport_burst = {
			base = 11,
			min_ticks = 8,
			...
			risk = 0.55,
			conditioning = true,
			roles = { "chase", "burst", "chase" },
			actions = { "teleport_reposition", "frozen_step", "mage_dash_catch" },
		},
	},
	action_traits = {
		teleport_escape = {
	...
	probe_order = { "missile_spend", "resource_hoard_check", "teleport_chase_response" },
	probes = {
		missile_spend = {
			style = "resource",
			question = "does_missile_threat_force_resource_spending",
			hypothesis = "burst_spender",
			expected = "counter",
			actions = { "staff_poke", "mage_feint", "magic_missile" },
			risk = 0.2,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
		...
		resource_hoard_check = {
			style = "resource",
			question = "does_the_opponent_hold_resources_in_safe_neutral",
			hypothesis = "resource_hoarder",
			expected = "hold",
			actions = { "staff_poke", "circle_flame_guard", "iceberg_control" },
			risk = 0.17,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
		...
		teleport_chase_response = {
			style = "position",
			question = "does_repositioning_force_corner_escape",
			hypothesis = "corner_averse",
			expected = "escape",
			actions = { "mage_advance", "teleport_escape", "teleport_reposition" },
			risk = 0.23,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
	...
	conditioning_breaks = {
		staff_poke = "iceberg_control",
		mage_feint = "teleport_reposition",
		iceberg_control = "mage_dash_catch",
		circle_flame_guard = "magic_missile",
		teleport_escape = "frozen_step",
	},
	fallback_intention = "staff_measure",
	error_profile = {
		base = 0.027,
		load_scale = 0.103,
		surprise_scale = 0.045,
		overconfidence_scale = 0.026,
		range_bias = 0.9,
		late_confirm = 0.98,
		familiar_route = 0.82,
		greedy_resource = 1.48,
		stale_read = 0.88,
		overcommit = 0.58,
	},
}
...
function CF_PVP_BOT_NOA_AI_TICK(
	pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE(
		pNPCUnit, PVP_PRO_AI_PROFILE_NOA )
	PVP_PRO_AI_SET_META_PROFILE(
		pNPCUnit, PVP_PRO_AI_V4_PROFILE_NOA )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE(
		pNPCUnit, PVP_PRO_AI_V5_PROFILE_NOA )
	PVP_PRO_AI_SET_COMPETITIVE_PROFILE(
		pNPCUnit, PVP_PRO_AI_V6_PROFILE_NOA )
	PVP_PRO_AI_SET_RUNTIME_PROFILE(
		pNPCUnit, PVP_PRO_AI_V7_PROFILE_NOA )
