...
INIT_STATE = 
{
	...
	-- 방어 공격
	{ STATE_NAME = "STRONG_STEEL_TROCK_GUARDATTACK_READY",			},
	...
	-- 대시 어택 준비
	{ STATE_NAME = "STRONG_STEEL_TROCK_DASH_ATTACK_READY",			},
	-- 공격을 위한 대시
	...
	SMALL_DAMAGE_LAND_FRONT		= "STRONG_STEEL_TROCK_DAMAGE_FRONT",
	SMALL_DAMAGE_LAND_BACK		= "STRONG_STEEL_TROCK_DAMAGE_BACK",
	BIG_DAMAGE_LAND_FRONT		= "STRONG_STEEL_TROCK_DAMAGE_FRONT",
	BIG_DAMAGE_LAND_BACK		= "STRONG_STEEL_TROCK_DAMAGE_BACK",
	DOWN_DAMAGE_LAND_FRONT		= "STRONG_STEEL_TROCK_DAMAGE_DOWN_FRONT",
	DOWN_DAMAGE_LAND_BACK		= "STRONG_STEEL_TROCK_DAMAGE_DOWN_BACK",
	FLY_DAMAGE_FRONT			= "STRONG_STEEL_TROCK_DAMAGE_FLY_FRONT",
	...
	DAMAGE_EXTRA_STATES         = {"STRONG_STEEL_TROCK_DAMAGE_AIR_DOWN","STRONG_STEEL_TROCK_DAMAGE_AIR_FALL",
	"STRONG_STEEL_TROCK_STAND_UP_FRONT","STRONG_STEEL_TROCK_STAND_UP_BACK",
...
STRONG_STEEL_TROCK_WAIT = 
{
	...
	{		
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"STRONG_STEEL_TROCK_SPECIAL_ATTACK",	"CT_STRONG_STEEL_TROCK_SPECIAL_ATTACK",		},
		...
		-- { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"STRONG_STEEL_TROCK_WAIT_HABIT",		"CT_STRONG_STEEL_TROCK_WAIT_HABIT",			},
	...
	CT_STRONG_STEEL_TROCK_SPECIAL_ATTACK = 
	{
...
STRONG_STEEL_TROCK_GUARD = 
{
	...
	{
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],		"STRONG_STEEL_TROCK_JUMP_DOWN",				},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], 			"STRONG_STEEL_TROCK_GUARDATTACK_READY", 		"CT_STRONG_STRONG_STEEL_TROCK_GUARD_ATTACK",	},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], 			"STRONG_STEEL_TROCK_WAIT",					"CT_STRONG_STEEL_TROCK_WAIT", 					},
	},
	
	
	CT_STRONG_STRONG_STEEL_TROCK_GUARD_ATTACK = 		-- 방어시 일정 확률로 반격
	{
		EVENT_INTERVAL_ID			= 0,
		RATE						= 12.5,
	},
	
	CT_STRONG_STEEL_TROCK_WAIT = 
	{
		STATE_TIME_OVER			= 2.0,
	},
...
STRONG_STEEL_TROCK_SPECIAL_ATTACK =
{
    ...
    SOUND_PLAY6			= { 3.3, "Swing_Big01.ogg" },
    SOUND_PLAY7			= { 4.1, "Swing_Big03.ogg" },
    SOUND_PLAY8			= { 4.65, "Swing_Big02.ogg" },
    SOUND_PLAY9			= { 5.1, "Swing_Big01.ogg" },
    SOUND_PLAY10		= { 5.6, "Swing_Big03.ogg" },
    SOUND_PLAY11		= { 5.8, "Swing_Big04.ogg" },
    SOUND_PLAY12		= { 7.0, "Swing_Big05.ogg" },
    SOUND_PLAY13		= { 7.2, "Landing_Big_Metal02.ogg" },
    SOUND_PLAY14		= { 0.1, "Steel_Trock_Voice_AttackA02.ogg" },
	...
	ATTACK_TIME0				= { 3.303, 3.486, },
	ATTACK_TIME1				= { 4.053, 4.253, },
	ATTACK_TIME2				= { 4.604, 4.837, },
	ATTACK_TIME3				= { 4.987, 5.187, },
	ATTACK_TIME4				= { 5.338, 5.504, },
	ATTACK_TIME5				= { 5.838, 6.038, },
	ATTACK_TIME6				= { 7.122, 7.489, },
...
function STRONG_STEEL_TROCK_SPECIAL_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 5.6 ) then		-- 띄우는 데미지 데이타로 변경
		pNPCUnit:ClearHitUnitList_LUA()
		pNPCUnit:SetDamageData_LUA( "DAMAGE_DATA_NEXT" )
	elseif pNPCUnit:AnimEventTimer_LUA( 6.5 ) then	-- 넘어뜨리는 데미지 데이타로 변경
		pNPCUnit:ClearHitUnitList_LUA()
		pNPCUnit:SetDamageData_LUA( "DAMAGE_DATA_THIRD" )
	end
...
STRONG_STEEL_TROCK_DAMAGE_BACK = 
{
	...
	EVENT_PROCESS = 
	{
		--{ STATE_CHANGE_TYPE["SCT_MOTION_END"], "STRONG_STEEL_TROCK_ATTACK2", "CT_STRONG_STEEL_TROCK_ATTACK2", },
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"], "STRONG_STEEL_TROCK_WAIT",	 },
	},
