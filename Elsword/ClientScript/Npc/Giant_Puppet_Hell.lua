...
INIT_STATE = 
{
	...
	{ STATE_NAME = "GIANT_PUPPET_MAGIC_ATTACK_A",		LUA_FRAME_MOVE_FUNC = "GIANT_PUPPET_MAGIC_ATTACK_A_FRAME_MOVE", STATE_COOL_TIME = 9,	},
	{ STATE_NAME = "GIANT_PUPPET_MAGIC_ATTACK_B",		LUA_FRAME_MOVE_FUNC = "GIANT_PUPPET_MAGIC_ATTACK_B_FRAME_MOVE", STATE_COOL_TIME = 9,	},
	{ STATE_NAME = "GIANT_PUPPET_MAGIC_ATTACK_C",		LUA_FRAME_MOVE_FUNC = "GIANT_PUPPET_MAGIC_ATTACK_C_FRAME_MOVE", STATE_COOL_TIME = 9,	},
