...
INIT_MOTION = 
{
	MOTION_FILE_NAME		= "Motion_Altera_Shock_Stick.x",
}
...
INIT_STATE = 
{
	{ STATE_NAME = "SHOCK_STICK_WAIT",						},
	{ STATE_NAME = "SHOCK_STICK_WAITSTART",					},
	{ STATE_NAME = "SHOCK_STICK_ATTACK",					LUA_FRAME_MOVE_FUNC = "SHOCK_STICK_ATTACK_FRAME_MOVE", STATE_COOL_TIME = 2,	},
	{ STATE_NAME = "SHOCK_STICK_HIDE",						},
	{ STATE_NAME = "SHOCK_STICK_DAMAGE",					},
	{ STATE_NAME = "SHOCK_STICK_DYING",				        LUA_STATE_START_FUNC = "SHOCK_STICK_DYING_STATE_START", },

	START_STATE					= "SHOCK_STICK_WAITSTART",
	WAIT_STATE					= "SHOCK_STICK_WAITSTART",
	
	SMALL_DAMAGE_LAND_FRONT		= "SHOCK_STICK_DAMAGE",
	SMALL_DAMAGE_LAND_BACK		= "SHOCK_STICK_DAMAGE",
	BIG_DAMAGE_LAND_FRONT		= "SHOCK_STICK_DAMAGE",
	BIG_DAMAGE_LAND_BACK		= "SHOCK_STICK_DAMAGE",
	DOWN_DAMAGE_LAND_FRONT		= "SHOCK_STICK_DAMAGE",
	DOWN_DAMAGE_LAND_BACK		= "SHOCK_STICK_DAMAGE",
	FLY_DAMAGE_FRONT			= "SHOCK_STICK_DAMAGE",
	FLY_DAMAGE_BACK				= "SHOCK_STICK_DAMAGE",
	SMALL_DAMAGE_AIR			= "SHOCK_STICK_DAMAGE",	
	BIG_DAMAGE_AIR				= "SHOCK_STICK_DAMAGE",
	DOWN_DAMAGE_AIR				= "SHOCK_STICK_DAMAGE",
	UP_DAMAGE					= "SHOCK_STICK_DAMAGE",
	DAMAGE_REVENGE				= "SHOCK_STICK_DAMAGE",
	
	WAIT_STATES                 = { "SHOCK_STICK_WAIT", },	
	
	DYING_LAND_FRONT			= "SHOCK_STICK_DYING",
	DYING_LAND_BACK				= "SHOCK_STICK_DYING",
	DYING_SKY					= "SHOCK_STICK_DYING",
...
SHOCK_STICK_WAIT = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],			"SHOCK_STICK_HIDE",    },
	},
}
...
SHOCK_STICK_HIDE = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],			"SHOCK_STICK_WAITSTART",    },
	},
}

SHOCK_STICK_WAITSTART = 
{
	ANIM_NAME					= "WaitStart",
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"SHOCK_STICK_ATTACK",				"CT_SHOCK_STICK_ATTACK",	},
	},
	
	CT_SHOCK_STICK_ATTACK = 
	{
		EVENT_INTERVAL_ID			= 0,
		STATE_TIME_OVER				= 0.5,
...
--    SOUND_PLAY0			= { 0.08, "ShockStick_Damage.ogg", },
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],					"SHOCK_STICK_WAIT",				},
	},
}
...
function SHOCK_STICK_DYING_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function SHOCK_STICK_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
