...
INIT_MOTION = 
{
	MOTION_FILE_NAME		= "Motion_EVENT_Infinite_Sword.x",
}
...
INIT_COMPONENT = 
{
	...
	WEAPON0 = 
	{
		WEAPON_FILE_NAME			= "Mesh_Elsword_EIS_Cash_Weapon_Sorted.X",
...
{	
	...
	-- 미라지 스팅
	{ STATE_NAME = "APINK_ANGEL_01_ELSWORD_ATTACK_D",		STATE_COOL_TIME = 2,        },
	--[[
	-- 초롱천사 기본 공격
	-- 퓨리어스 인게이지
--	{ STATE_NAME = "APINK_ANGEL_01_ELSWORD_ATTACK_A",		STATE_COOL_TIME = 3,        },
	-- 글라이딩 스트라이크
--	{ STATE_NAME = "APINK_ANGEL_01_ELSWORD_ATTACK_B",		STATE_COOL_TIME = 11,        },

	-- zxxx 콤보
--	{ STATE_NAME = "APINK_ANGEL_01_ELSWORD_ATTACK_D",										},
--	{ STATE_NAME = "APINK_ANGEL_01_ELSWORD_ATTACK_DX",										},
--	{ STATE_NAME = "APINK_ANGEL_01_ELSWORD_ATTACK_DXX",					},
--	{ STATE_NAME = "APINK_ANGEL_01_ELSWORD_ATTACK_DXXX",					},
	--]]
--리액션 관련
...
APINK_ANGEL_01_ELSWORD_ATTACK_A =
{
	...
	SOUND_PLAY0				= { 0.05,	"ElswordVoice_SwordBlasting.wav" },
	SOUND_PLAY1				= { 0.001,	"Elsword_SwordBlasting1.wav" },
	SOUND_PLAY2				= { 0.001,	"Elsword_SwordBlasting2.wav" },
	SOUND_PLAY3				= { 0.891,	"Elsword_SwordBlasting3.wav" },
	...
	EFFECT_SET_LIST = 
	{
		...
		"EffectSet_APINK_ANGEL_MIRAGESTING_FAST", 0.06,
...
APINK_ANGEL_01_ELSWORD_ATTACK_B =
{
	...
	SOUND_PLAY0					= { 0.1,	"Elsword_RageCutter2.wav" },
	SOUND_PLAY1					= { 0.2,	"ElswordVoice_RageCutter.wav" },
	--SOUND_PLAY1					= { 0.225, "Voice_Chorong_010.wav" },
	-- SOUND_PLAY1     			= { 0.1,    "Voice_Chorong_009.wav" },
	...
	EFFECT_SET_LIST =
	{
		"EffectSet_EVENT_RAGECUTTER", 0.1,	
	},	
...
APINK_ANGEL_01_ELSWORD_ATTACK_D =
{
	...
	SOUND_PLAY0			= { 0.5, "Elsword_MirageSting2.wav" },
	SOUND_PLAY1			= { 0.161, "Elsword_MirageSting3.wav" },
	SOUND_PLAY2			={ 0.2, "ElswordVoice_Shout04.wav" },
