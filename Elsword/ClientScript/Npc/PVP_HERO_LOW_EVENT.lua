...
INIT_COMPONENT =
{
	-- 최대MP가 300이고 초당 MP가 0.1씩 회복됩니다.
	MP_CHANGE_RATE		= 0.1,
	MP_CHARGE_RATE		= 300,
	-- DRAW_SMALL_MP_BAR	= TRUE,
    USE_SLASH_TRACE     = FALSE,

	-- 기본 속도가 -15% 증가로 유저보다 느립니다(AI가 좋기 때문에 다운그레이드).
	DEFAULT_ANIM_SPEED = 0.85,
	...
	WEAPON0 = 
	{
		WEAPON_FILE_NAME			= "Mesh_Elsword_Basic_Weapon.X",
...
INIT_STATE =
{
	...
	{ STATE_NAME = "PVP_BOT_LOW_WAIT_START",							},
	...
	{ STATE_NAME = "PVP_BOT_LOW_ComboZZZZ",						},
	...
	-- 발차기를 시전합니다.
	{ STATE_NAME = "PVP_BOT_LOW_Kick",					STATE_COOL_TIME = 20,	LUA_FRAME_MOVE_FUNC = "PVP_BOT_LOW_Kick_FRAME_MOVE"	 },
	
	-- 아머 브레이크를 시전합니다.
	{ STATE_NAME = "PVP_BOT_LOW_Armor_Break",					STATE_COOL_TIME = 15,	LUA_FRAME_MOVE_FUNC = "PVP_BOT_LOW_Armor_Break_FRAME_MOVE"	 },
	
	-- -- 롤링 스매시를 시전합니다.
	-- { STATE_NAME = "PVP_BOT_LOW_Rolling_Smash_Ready",					STATE_COOL_TIME = 15,	LUA_FRAME_MOVE_FUNC = "PVP_BOT_LOW_Rolling_Smash_FRAME_MOVE"	 },
	-- { STATE_NAME = "PVP_BOT_LOW_Rolling_Smash",				 },
	-- { STATE_NAME = "PVP_BOT_LOW_Rolling_Smash_Landing",				 },
	
	-- -- 반격을 시전합니다.
	-- { STATE_NAME = "PVP_BOT_LOW_RevengeReady",					STATE_COOL_TIME = 20,	LUA_FRAME_MOVE_FUNC = "PVP_BOT_LOW_RevengeReady_FRAME_MOVE"	 },
	...
	-- NPC 리액트별 state 연결
	START_STATE					= "PVP_BOT_LOW_WAIT_START",
	...
	DOWN_DAMAGE_AIR				= "PVP_BOT_LOW_DAMAGE_AIR_FALL",
	...
	DAMAGE_EXTRA_STATES         = { "PVP_BOT_LOW_DAMAGE_AIR_DOWN","PVP_BOT_LOW_STAND_UP_FRONT","PVP_BOT_LOW_STAND_UP_BACK","PVP_BOT_LOW_JUMP_DOWN","PVP_BOT_LOW_JUMP_LANDING",	 },	
...
PVP_BOT_LOW_WAIT_START =
{
	...
	TALK_BOX =
	{
		{ RATE = 100, MESSAGE = STR_ID_15068 },
	},
	
	EVENT_PROCESS =
	{
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"PVP_BOT_LOW_START",	"CT_PVP_BOT_LOW_START",},
	},
	
	CT_PVP_BOT_LOW_START =
	{
...
PVP_BOT_LOW_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_AI_WALK"],			"PVP_BOT_LOW_WALK",																	},
...
PVP_BOT_LOW_ComboZZZ =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"PVP_BOT_LOW_ComboZZZZ", 				"CT_PVP_BOT_LOW_ComboZZZZ", 	},
...
PVP_BOT_LOW_DAMAGE_SMALL_FRONT =
{
	...
	EVENT_PROCESS =
	{
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PVP_BOT_LOW_JUMP_DOWN",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"PVP_BOT_LOW_WAIT",		},
	},
...
PVP_BOT_LOW_STAND_UP_BACK =
{
    ...
    --SOUND_PLAY0			= { 0.283, "PVP_BOT_LOW_StandUp.ogg" },
