...
INIT_STATE = 
{
	...
	-- robobeg : EL_POWER_PLANT_WAIT 상태는 없다
...
function EL_POWER_PLANT_UP_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
    ...
    pUID1 = pX2Game:GetNearNPCUnitUID_LUA( pNPCUnit:GetPos(), NPC_UNIT_ID["NUI_NASOD_KING"], 999999 )
    if pUID1 ~= 0 then
...
function EL_POWER_PLANT_DYING_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
	...
	pUID = pX2Game:GetNearNPCUnitUID_LUA( pNPCUnit:GetPos(), NPC_UNIT_ID["NUI_NASOD_KING"], 999999 )
    if pUID ~= 0 then
