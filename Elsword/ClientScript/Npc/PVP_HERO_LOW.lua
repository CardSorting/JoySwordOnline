...
INIT_STATE =
{
	...
	-- Adaptive awakening / pressure break
	...
	"PVP_BOT_LOW_JUMP_DOWN","PVP_BOT_LOW_JUMP_LANDING","PVP_BOT_LOW_JUMP_DOWN_NOACT",},	
...
PVP_BOT_LOW_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_LOW_WAIT",	"CF_PVP_BOT_LOW_AI_TICK",													},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_LOW_BOOST_POWER",	"CF_PVP_BOT_LOW_BOOST_POWER",									},

		
		-- 뒤로 돌아 걷거나 뛰며 거리를 벌리는 동작입니다.
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_BACKWARD_DASH_READY",     	"CF_PVP_BOT_LOW_BACKWARD_DASH",   },
		
		-- 정지하고 있을 때는 다음의 행동을 수행할 수 있습니다. (z입력, 걷기, 뛰기, 대시점프, 걷기와 뛰기는 강제로 수행 시키는 부분입니다.)

        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_Rolling_Smash_Ready",     	"CF_PVP_BOT_LOW_ROLLING_SMASH",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_RevengeReady",     		"CF_PVP_BOT_LOW_REVENGE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_Fatal_Fury",     			"CF_PVP_BOT_LOW_FATAL_FURY",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_Mega_Slash",     			"CF_PVP_BOT_LOW_MEGA_SLASH",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_Armageddon_Blade",     	"CF_PVP_BOT_LOW_ARMAGEDDON_BLADE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_ComboZ",     				"CF_PVP_BOT_LOW_COMBO_ENTRY",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_ComboX",     				"CF_PVP_BOT_LOW_COMBO_X",       	     	},
        -- { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_LOW_WALK",         			"CT_PVP_BOT_LOW_WALK",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_DASH",         			"CF_PVP_BOT_LOW_ADVANCE",       		    },
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_DashJump",          		"CF_PVP_BOT_LOW_AERIAL_ENTRY",      		},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_LOW_ComboZ",     				"CF_PVP_BOT_LOW_COMBO_ENTRY",       	     	},
...
PVP_BOT_LOW_STANDUP_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_LOW_STANDUP_WAIT",	"CF_PVP_BOT_LOW_AI_TICK",											},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_LOW_BOOST_POWER",	"CF_PVP_BOT_LOW_BOOST_POWER",									},
...
PVP_BOT_LOW_DashJumpComboXX_landing = 
{
	...
	{	
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PVP_BOT_LOW_JUMP_DOWN_ACT",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"PVP_BOT_LOW_BACKWARD_DASH_READY",		},
	},
...
PVP_BOT_LOW_ComboZZ =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],			"PVP_BOT_LOW_BACKWARD_DASH_READY",	"CF_PVP_BOT_LOW_COMBO_RESET",	},
...
function CF_PVP_BOT_LOW_FATAL_FURY( pKTDXApp, pX2Game, pNPCUnit )

	local mp = pNPCUnit:GetNowMP()

	if mp < 150 then return false end

	local dist = GetDistance_LUA( pNPCUnit:GetPos(), pX2Game:GetFocusUnitPos_LUA() )

	if dist > 350 then return false end
...
function CF_PVP_BOT_LOW_ARMAGEDDON_BLADE( pKTDXApp, pX2Game, pNPCUnit )

	local mp = pNPCUnit:GetNowMP()

	if mp < 250 then return false end
...
function CF_PVP_BOT_LOW_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_LOW_REVENGE( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_LOW_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_LOW_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end

function CF_PVP_BOT_LOW_REVENGE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "revenge_parry", "guard", 0, 210, 50, 48, 12 )
end

function CF_PVP_BOT_LOW_FATAL_FURY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "fatal_fury", "burst", 0, 280, 175, 45, 14 )
end

function CF_PVP_BOT_LOW_MEGA_SLASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "mega_slash", "burst", 0, 330, 150, 49, 11 )
end

function CF_PVP_BOT_LOW_ARMAGEDDON_BLADE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "armageddon_blade", "control", 180, 820, 299, 58, 24 )
end

function CF_PVP_BOT_LOW_COMBO_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "sword_loop", "combo", 0, 230, 0, 61, 4 )
end

function CF_PVP_BOT_LOW_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "duelist_feint", "escape", 0, 230, 0, 12, 11 )
end
...
function CF_PVP_BOT_LOW_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, 245, 27 )
end

function CF_PVP_BOT_LOW_BOOST_POWER( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_AWAKEN( pX2Game, pNPCUnit, 275, 11 )
end
...
function CF_PVP_BOT_LOW_ROLLING_SMASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "rolling_smash", "chase", 180, 900, 50, 43, 10 )
end

function CF_PVP_BOT_LOW_COMBO_X( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "heavy_x_mixup", "combo", 90, 350, 0, 39, 5 )
end

function CF_PVP_BOT_LOW_ADVANCE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "sword_advance", "advance", 300, 1500, 0, 58, 3 )
end

function CF_PVP_BOT_LOW_AERIAL_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "sword_air_entry", "air_move", 260, 1050, 0, 33, 6 )
end
...
PVP_PRO_AI_PROFILE_LOW = {
	name = "counter_duelist",
	preferred_range = 215,
	aggression = 1.08,
	discipline = 1.25,
	volatility = 3,
	role_bias = { guard = 8, combo = 7, burst = 5, chase = 4, control = 3, escape = 1 },
	openers = { revenge_parry = 5, rolling_smash = 5, heavy_x_mixup = 4 },
	finishers = { fatal_fury = 10, mega_slash = 9, armageddon_blade = 8 },
	mixups = { duelist_feint = 7, sword_loop = 4, sword_air_entry = 4 },
}

function CF_PVP_BOT_LOW_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_LOW )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end
...
PVP_PRO_AI_V4_PROFILE_LOW = {
	name = "counterhit_duelist",
	patience = 1.08,
	risk = 1.12,
	creativity = 3,
	condition_limit = 2,
	finisher_threshold = 0.35,
	probe_role = "guard",
	contest_role = "combo",
	...
	counter_roles = {
		...
		feint = "guard", hold = "combo",
	},
	secondary_roles = {
		approach = "combo", retreat = "advance", jump = "control",
		feint = "control", hold = "guard",
	},
	signature = {
		revenge_parry = 8, heavy_x_mixup = 6, rolling_smash = 6,
		fatal_fury = 7, armageddon_blade = 7,
	},
	engagement_bias = { trap = 8, scramble = 4, probe = 2 },
}

function CF_PVP_BOT_LOW_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_LOW )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_LOW )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end
...
PVP_PRO_AI_V5_PROFILE_LOW = {
	name = "tournament_counter_duelist",
	read_skill = 0.94,
	exploration = 0.73,
	commitment = 1.06,
	...
	creativity = 3,
	playbooks = {
		download = { "guard", "escape", "advance" },
		outplay = { "guard", "combo", "control" },
		pressure = { "guard", "combo", "burst" },
		deny = { "control", "chase", "guard" },
		stabilize = { "escape", "guard", "control" },
		survive = { "escape", "guard", "air_move" },
		finish = { "guard", "combo", "burst" },
	},
	actions = {
		download = { "revenge_parry", "duelist_feint", "sword_advance" },
		outplay = { "revenge_parry", "heavy_x_mixup", "armageddon_blade" },
		pressure = { "revenge_parry", "sword_loop", "mega_slash" },
		deny = { "armageddon_blade", "rolling_smash", "revenge_parry" },
		stabilize = { "duelist_feint", "revenge_parry", "armageddon_blade" },
		survive = { "duelist_feint", "revenge_parry", "sword_air_entry" },
		finish = { "revenge_parry", "heavy_x_mixup", "fatal_fury", "mega_slash" },
	},
	action_prior = {
		revenge_parry = 7, heavy_x_mixup = 5, rolling_smash = 5,
		fatal_fury = 7, mega_slash = 6, armageddon_blade = 6,
	},
	goal_bias = {
		download = 3, outplay = 6, pressure = 3,
		deny = 4, stabilize = 4, finish = 5,
	},
	finisher_actions = { "fatal_fury", "mega_slash", "armageddon_blade" },
}

function CF_PVP_BOT_LOW_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_LOW )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_LOW )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE( pNPCUnit, PVP_PRO_AI_V5_PROFILE_LOW )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end
...
PVP_PRO_AI_V6_PROFILE_LOW = {
	character = "low",
	identity = "volatile_momentum_duelist",
	identity_mode = "volatile_momentum",
	probe_style = "momentum",
	preferred_min = 0,
	preferred_max = 420,
	vertical_tolerance = 165,
	resource_target = 155,
	reset_threshold = 0.66,
	adaptation_rate = 0.85,
	strategy_hysteresis = 6,
	default_tempo = "sudden_burst",
	strategy_order = {
		"parry_respect_theory",
		"momentum_gap_takeover",
		"blade_resource_gamble",
		"volatile_lead_snowball",
		"composure_recovery",
		"all_in_closeout",
	},
	strategies = {
		parry_respect_theory = {
			...
			plans = { "parry_download", "x_route_rotation", "opponent_brake_check" },
		},
		momentum_gap_takeover = {
			base = 11,
			min_ticks = 48,
			...
			plans = { "sword_loop_pressure", "respect_test", "burst_resource_gate" },
		},
		blade_resource_gamble = {
			base = 10.5,
			min_ticks = 44,
			...
			plans = { "burst_resource_gate", "scramble_reset", "x_route_rotation" },
		},
		volatile_lead_snowball = {
			base = 9,
			min_ticks = 58,
			...
			plans = { "momentum_lead_push", "parry_download", "opponent_brake_check" },
		},
		composure_recovery = {
			base = 6,
			min_ticks = 30,
			...
			plans = { "scramble_reset", "momentum_lead_push", "opponent_brake_check" },
		},
		all_in_closeout = {
			base = 6,
			min_ticks = 28,
			...
			plans = { "fatal_cashout", "armageddon_close", "sword_loop_pressure" },
		},
	},
	plans = {
		parry_download = {
			...
			intentions = { "parry_read", "x_mixup_check" },
		},
		x_route_rotation = {
			base = 9,
			min_ticks = 19,
			...
			changeup = true,
			tempo = "measured_neutral",
			roles = { "advance", "combo", "chase" },
			intentions = { "sword_pressure", "held_parry_punish" },
		},
		sword_loop_pressure = {
			base = 9,
			min_ticks = 17,
			...
			roles = { "burst", "escape", "combo" },
			intentions = { "burst_represent", "air_scramble" },
		},
		respect_test = {
			base = 8,
			min_ticks = 16,
			...
			tempo = "measured_neutral",
			roles = { "combo", "burst", "burst" },
			intentions = { "momentum_cashout", "armageddon_lane" },
		},
		burst_resource_gate = {
			base = 10,
			min_ticks = 19,
			...
			pressure = true,
			tempo = "measured_neutral",
			roles = { "guard", "burst", "burst" },
			intentions = { "comeback_swing", "lead_brake" },
		},
		scramble_reset = {
			base = 10,
			min_ticks = 18,
			...
			intentions = { "route_change", "explosive_reentry" },
		},
		momentum_lead_push = {
			base = 11,
			min_ticks = 21,
			...
			survival = true,
			tempo = "lead_preserving_slowdown",
			roles = { "combo", "escape", "chase" },
			intentions = { "x_mixup_check", "momentum_cashout" },
		},
		opponent_brake_check = {
			base = 7,
			min_ticks = 16,
			max_ticks = 30,
			probe = true,
			...
			intentions = { "held_parry_punish", "comeback_swing" },
		},
		fatal_cashout = {
			base = 12,
			min_ticks = 12,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "air_move", "chase", "combo" },
			intentions = { "air_scramble", "route_change" },
		},
		armageddon_close = {
			base = 10,
			min_ticks = 13,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "escape", "guard", "control" },
			intentions = { "lead_brake", "explosive_reentry" },
		},
	},
	intentions = {
		parry_read = {
			...
			risk = 0.3,
			roles = { "guard", "escape", "combo" },
			actions = { "revenge_parry", "duelist_feint", "sword_loop" },
		},
		x_mixup_check = {
			base = 9,
			min_ticks = 7,
			...
			conditioning = true,
			roles = { "combo", "escape", "chase" },
			actions = { "heavy_x_mixup", "duelist_feint", "rolling_smash" },
		},
		sword_pressure = {
			base = 10,
			min_ticks = 8,
			...
			risk = 0.49,
			roles = { "advance", "combo", "chase" },
			actions = { "sword_advance", "sword_loop", "rolling_smash" },
		},
		held_parry_punish = {
			base = 11,
			min_ticks = 6,
			...
			risk = 0.58,
			roles = { "guard", "combo", "burst" },
			actions = { "revenge_parry", "sword_loop", "fatal_fury" },
		},
		burst_represent = {
			base = 8,
			min_ticks = 7,
			...
			conditioning = true,
			roles = { "burst", "escape", "combo" },
			actions = { "mega_slash", "duelist_feint", "heavy_x_mixup" },
		},
		air_scramble = {
			base = 9,
			min_ticks = 8,
			...
			risk = 0.44,
			roles = { "air_move", "chase", "combo" },
			actions = { "sword_air_entry", "rolling_smash", "sword_loop" },
		},
		momentum_cashout = {
			base = 10,
			min_ticks = 6,
			...
			risk = 0.69,
			roles = { "combo", "burst", "burst" },
			actions = { "sword_loop", "fatal_fury", "mega_slash" },
		},
		armageddon_lane = {
			base = 11,
			min_ticks = 7,
			max_ticks = 15,
			risk = 0.61,
			roles = { "control", "advance", "combo" },
			actions = { "armageddon_blade", "sword_advance", "heavy_x_mixup" },
		},
		comeback_swing = {
			base = 8,
			min_ticks = 8,
			...
			risk = 0.74,
			roles = { "guard", "burst", "burst" },
			actions = { "revenge_parry", "mega_slash", "fatal_fury" },
		},
		lead_brake = {
			base = 9,
			min_ticks = 6,
			...
			risk = 0.31,
			roles = { "escape", "guard", "control" },
			actions = { "duelist_feint", "revenge_parry", "armageddon_blade" },
		},
		route_change = {
			base = 10,
			min_ticks = 7,
			...
			conditioning = true,
			roles = { "combo", "combo", "escape" },
			actions = { "heavy_x_mixup", "sword_loop", "duelist_feint" },
		},
		explosive_reentry = {
			base = 11,
			min_ticks = 8,
			max_ticks = 15,
			risk = 0.67,
			roles = { "advance", "chase", "burst" },
			actions = { "sword_advance", "rolling_smash", "fatal_fury" },
		},
	},
	action_traits = {
		revenge_parry = {
	...
	probe_order = { "parry_respect", "panic_after_mix", "burst_challenge" },
	probes = {
		parry_respect = {
			style = "momentum",
			question = "does_the_opponent_wait_on_parry_representation",
			hypothesis = "defensive_opener",
			expected = "hold",
			actions = { "revenge_parry", "duelist_feint", "sword_loop" },
			risk = 0.23,
			information = 0.88,
		...
		panic_after_mix = {
			style = "momentum",
			question = "does_the_mixup_force_escape",
			hypothesis = "panic_escape",
			expected = "escape",
			actions = { "heavy_x_mixup", "duelist_feint", "rolling_smash" },
			risk = 0.28,
		...
		burst_challenge = {
			style = "pressure",
			question = "does_burst_threat_create_defensive_hesitation",
			hypothesis = "delayed_defense",
			expected = "hold",
			actions = { "mega_slash", "duelist_feint", "sword_advance" },
			risk = 0.31,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
	...
	conditioning_breaks = {
		revenge_parry = "sword_advance",
		sword_advance = "rolling_smash",
		heavy_x_mixup = "sword_loop",
		sword_loop = "duelist_feint",
		duelist_feint = "rolling_smash",
		rolling_smash = "mega_slash",
	},
	fallback_intention = "parry_read",
	error_profile = {
		base = 0.044,
		load_scale = 0.126,
		surprise_scale = 0.052,
		overconfidence_scale = 0.074,
		range_bias = 0.98,
		late_confirm = 0.86,
		familiar_route = 1.22,
		greedy_resource = 0.8,
...
function CF_PVP_BOT_LOW_AI_TICK(
	pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE(
		pNPCUnit, PVP_PRO_AI_PROFILE_LOW )
	PVP_PRO_AI_SET_META_PROFILE(
		pNPCUnit, PVP_PRO_AI_V4_PROFILE_LOW )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE(
		pNPCUnit, PVP_PRO_AI_V5_PROFILE_LOW )
	PVP_PRO_AI_SET_COMPETITIVE_PROFILE(
		pNPCUnit, PVP_PRO_AI_V6_PROFILE_LOW )
	PVP_PRO_AI_SET_RUNTIME_PROFILE(
		pNPCUnit, PVP_PRO_AI_V7_PROFILE_LOW )
