...
INIT_STATE = 
{
	{ STATE_NAME = "GUARDIAN_SP1_EVE_WAIT",						},

	{ STATE_NAME = "GUARDIAN_SP1_EVE_DISAPPEAR",					LUA_STATE_START_FUNC = "GUARDIAN_SP1_EVE_DISAPPEAR_STATE_START",	},
	
	{ STATE_NAME = "GUARDIAN_SP1_EVE_TELEPORT",					LUA_STATE_START_FUNC = "GUARDIAN_SP1_EVE_TELEPORT_STATE_START",	
	                                                            LUA_FRAME_MOVE_FUNC = "GUARDIAN_SP1_EVE_TELEPORT_FRAME_MOVE",    },
	
	{ STATE_NAME = "GUARDIAN_SP1_EVE_ATTACK",					LUA_FRAME_MOVE_FUNC = "GUARDIAN_SP1_EVE_ATTACK_FRAME_MOVE",	},
	
	
	
	--리액션 관련
	{ STATE_NAME = "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",			},
	{ STATE_NAME = "GUARDIAN_SP1_EVE_DYING_LAND_BACK",				},
	{ STATE_NAME = "GUARDIAN_SP1_EVE_DYING_SKY",					},
	
	
	
	START_STATE					= "GUARDIAN_SP1_EVE_ATTACK",
	WAIT_STATE					= "GUARDIAN_SP1_EVE_WAIT",
	
	
	SMALL_DAMAGE_LAND_FRONT		= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	SMALL_DAMAGE_LAND_BACK		= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	BIG_DAMAGE_LAND_FRONT		= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	BIG_DAMAGE_LAND_BACK		= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	DOWN_DAMAGE_LAND_FRONT		= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	DOWN_DAMAGE_LAND_BACK		= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	FLY_DAMAGE_FRONT			= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	FLY_DAMAGE_BACK				= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	SMALL_DAMAGE_AIR			= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",	
	BIG_DAMAGE_AIR				= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	DOWN_DAMAGE_AIR				= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	UP_DAMAGE					= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	DAMAGE_REVENGE				= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	
	DYING_LAND_FRONT			= "GUARDIAN_SP1_EVE_DYING_LAND_FRONT",
	DYING_LAND_BACK				= "GUARDIAN_SP1_EVE_DYING_LAND_BACK",
	DYING_SKY					= "GUARDIAN_SP1_EVE_DYING_SKY",
...
GUARDIAN_SP1_EVE_TELEPORT = 
{
	...
	EVENT_PROCESS = 
	{
	    { STATE_CHANGE_TYPE["SCT_MOTION_END"],					"GUARDIAN_SP1_EVE_DISAPPEAR",					},
	},
...
GUARDIAN_SP1_EVE_ATTACK = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"GUARDIAN_SP1_EVE_TELEPORT",								},	
	},
...
GUARDIAN_SP1_EVE_DYING_LAND_FRONT = 
{
	SHOW						= FALSE,
...
GUARDIAN_SP1_EVE_DYING_LAND_BACK = 
{
	SHOW						= FALSE,
...
----------------------------------------------------------
function GUARDIAN_SP1_EVE_DISAPPEAR_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
----------------------------------------------------------
function GUARDIAN_SP1_EVE_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function GUARDIAN_SP1_EVE_TELEPORT_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function GUARDIAN_SP1_EVE_TELEPORT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
-- Fade Start    
