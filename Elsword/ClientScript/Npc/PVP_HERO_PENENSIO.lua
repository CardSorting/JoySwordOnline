...
INIT_STATE =
{
	...
	"PVP_BOT_PENENSIO_JUMP_DOWN","PVP_BOT_PENENSIO_JUMP_LANDING","PVP_BOT_PENENSIO_JUMP_DOWN_NOACT",
...
PVP_BOT_PENENSIO_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_PENENSIO_WAIT",	"CF_PVP_BOT_PENENSIO_AI_TICK",									},
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_RevengeReady",     		"CF_PVP_BOT_PENENSIO_REVENGE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_Splash_Explosion",     	"CF_PVP_BOT_PENENSIO_SPLASH",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_Luna_Blade",     			"CF_PVP_BOT_PENENSIO_LUNA_BLADE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_Storm_Blade",     		"CF_PVP_BOT_PENENSIO_STORM_BLADE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_Rune_Guard_FIRE",     	"CF_PVP_BOT_PENENSIO_RUNE_FIRE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_Rune_Guard",     			"CF_PVP_BOT_PENENSIO_RUNE_GUARD_DECIDE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_Rune_Guard_ICE",     		"CF_PVP_BOT_PENENSIO_RUNE_ICE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_ComboZ",     				"CF_PVP_BOT_PENENSIO_COMBO_Z",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_ComboX",     				"CF_PVP_BOT_PENENSIO_COMBO_X",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_WALK",         			"CF_PVP_BOT_PENENSIO_AI_TICK",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_DASH",         			"CF_PVP_BOT_PENENSIO_ADVANCE",       		    },
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_DashJump",          		"CF_PVP_BOT_PENENSIO_AERIAL_ENTRY",      		},

		
		-- 뒤로 돌아 걷거나 뛰며 거리를 벌리는 동작입니다.
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_PENENSIO_BACKWARD_DASH_READY",     	"CF_PVP_BOT_PENENSIO_BACKWARD_DASH",   },
...
PVP_BOT_PENENSIO_STANDUP_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_PENENSIO_STANDUP_WAIT",	"CF_PVP_BOT_PENENSIO_AI_TICK",									},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_PENENSIO_BOOST_POWER",	"CF_PVP_BOT_PENENSIO_BOOST_POWER",									},
...
PVP_BOT_PENENSIO_ComboZ = 
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PVP_BOT_PENENSIO_JUMP_DOWN_ACT",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"PVP_BOT_PENENSIO_BACKWARD_DASH_READY",		},
	},
...
PVP_BOT_PENENSIO_ComboZZ =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],		"PVP_BOT_PENENSIO_BACKWARD_DASH_READY",		"CF_PVP_BOT_PENENSIO_COMBO_RESET",	},
...
PVP_BOT_PENENSIO_DAMAGE_DOWN_FRONT =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],			"PVP_BOT_PENENSIO_STANDUP_ROLLING_FRONT_BACK",	"CF_PVP_BOT_CHECK_ROLL_STANDUP",	},
...
PVP_BOT_PENENSIO_DAMAGE_DOWN_BACK =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],			"PVP_BOT_PENENSIO_STANDUP_ROLLING_BACK_FRONT",	"CF_PVP_BOT_CHECK_ROLL_STANDUP",	},
...
function PVP_BOT_PENENSIO_Rune_Guard_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.35 ) then		
		...
		pX2Game:CreateNPCReq_LUA( NPC_UNIT_ID["NUI_PVP_RUNE_GUARD"], pNPCUnit:GetHardLevel(), TRUE, pos, pNPCUnit:GetIsRight(), 0, true  )
	end
end	
...
function CF_PVP_BOT_PENENSIO_LUNA_BLADE( pKTDXApp, pX2Game, pNPCUnit )

	local mp = pNPCUnit:GetNowMP()

	if mp < 230 then return false end

	local dist = GetDistance_LUA( pNPCUnit:GetPos(), pX2Game:GetFocusUnitPos_LUA() )

	if dist > 600 then return false end

	local hp_rate = pNPCUnit:GetNowHP() / pNPCUnit:GetMaxHP()

	if hp_rate < 0.35 then

		return true -- Desperation mode
...
function CF_PVP_BOT_PENENSIO_STORM_BLADE( pKTDXApp, pX2Game, pNPCUnit )

	local mp = pNPCUnit:GetNowMP()

	if mp < 299 then return false end
...
function CF_PVP_BOT_PENENSIO_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
...
-- Antigravity Custom Human-Like Mana Break Callback
...
function CF_PVP_BOT_EPIK_MANA_BREAK( pKTDXApp, pX2Game, pNPCUnit )
	...
	-- Low HP critical status: break immediately to survive
	...
	-- Resource conservation: only break if we have excess mana (save 100-199 MP for special active counters)
...
-- Antigravity Custom Human-Like Wake-up Selection Callback
...
function CF_PVP_BOT_CHECK_ROLL_STANDUP( pKTDXApp, pX2Game, pNPCUnit )
	...
	if dist < 200 then
		...
		-- Opponent is too close: 80% chance to roll away safely

		return math.random(100) <= 80

	else

		-- Opponent is further: only 15% chance to roll, preferring wake-up attacks/normal standup
...
-- Antigravity Custom Pro-Player Defensive Counter Callbacks

function CF_PVP_BOT_PENENSIO_REVENGE( pKTDXApp, pX2Game, pNPCUnit )

	local mp = pNPCUnit:GetNowMP()

	if mp < 20 then return false end
	...
	if dist < 200 then
		...
		-- Pro Reaction: 70% chance to parry incoming melee pressure
...
function CF_PVP_BOT_PENENSIO_RUNE_GUARD_DECIDE( pKTDXApp, pX2Game, pNPCUnit )

	local mp = pNPCUnit:GetNowMP()

	if mp < 30 then return false end



	local dist = GetDistance_LUA( pNPCUnit:GetPos(), pX2Game:GetFocusUnitPos_LUA() )

	if dist >= 250 and dist <= 600 then

		-- Pro Reaction: 65% chance to activate Rune Guard shield to absorb ranged/mid-range zoning pressure
...
-- Antigravity Custom Pro-Player Combo Reset Callback

function CF_PVP_BOT_PENENSIO_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )

	-- 40% chance to drop combo midway to bait player recovery and reset hit-stun
...
function PVP_PRO_AI_GET( pNPCUnit )
	...
	if memory == nil then
		memory = { tick = 0, pressure = 0, close_read = 0, far_read = 0, action_count = 0, tempo = 0,
			last_damage_tick = 0, last_used = {}, last_considered = {}, once = {} }
...
function PVP_PRO_AI_READY( pNPCUnit, action, family, chance, cooldown, reconsider, urgent )
	...
	if urgent ~= true then
		if memory.last_action == action then chance = chance * 0.22
		elseif memory.previous_action == action then chance = chance * 0.58 end
...
function PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, action, role, minDist, maxDist, minMP, chance, cooldown )
	...
	elseif role == "guard" then chance = chance + memory.pressure * 5 + memory.close_read
	...
	elseif role == "poke" then chance = chance + memory.far_read
	elseif role == "combo" then chance = chance + math.max( 0, 5 - memory.pressure )
	elseif role == "chase" then chance = chance + memory.far_read * 2 end
...
function PVP_PRO_AI_MANA_BREAK( pNPCUnit )
	...
	elseif pressure >= 5 then chance = 35 end
...
function PVP_PRO_AI_ROLL( pX2Game, pNPCUnit )
	...
	elseif dist < 420 then chance = 38 + memory.pressure * 2 end
...
function PVP_PRO_AI_AWAKEN( pX2Game, pNPCUnit, offensiveRange, aggression )
	...
	elseif hpRate < 0.42 then chance = 44 + aggression
	elseif dist < offensiveRange and memory.tempo == 1 then chance = 12 + aggression end
	if chance <= 0 then return false end
	return PVP_PRO_AI_READY( pNPCUnit, "awakening", "guard", chance, 32, 4, urgent )
end

function CF_PVP_BOT_PENENSIO_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end

function CF_PVP_BOT_PENENSIO_REVENGE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "revenge_parry", "guard", 0, 210, 50, 52, 12 )
end

function CF_PVP_BOT_PENENSIO_SPLASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "splash_explosion", "control", 0, 430, 100, 42, 12 )
end

function CF_PVP_BOT_PENENSIO_LUNA_BLADE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "luna_blade", "burst", 0, 620, 230, 46, 18 )
end

function CF_PVP_BOT_PENENSIO_STORM_BLADE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "storm_blade", "burst", 0, 430, 299, 57, 24 )
end

function CF_PVP_BOT_PENENSIO_RUNE_GUARD_DECIDE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "rune_guard", "guard", 250, 680, 70, 45, 14 )
end

function CF_PVP_BOT_PENENSIO_COMBO_Z( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "sword_pressure", "combo", 0, 260, 0, 62, 4 )
end

function CF_PVP_BOT_PENENSIO_COMBO_X( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "rune_poke", "poke", 170, 520, 0, 35, 6 )
end

function CF_PVP_BOT_PENENSIO_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "rune_feint", "escape", 0, 250, 0, 13, 11 )
end
...
function CF_PVP_BOT_PENENSIO_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, 280, 26 )
end

function CF_PVP_BOT_PENENSIO_BOOST_POWER( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_AWAKEN( pX2Game, pNPCUnit, 320, 9 )
end
...
function PVP_PRO_AI_GET( pNPCUnit )
	local memory = PVP_PRO_AI_MEMORY[pNPCUnit]
	if memory == nil then memory = {}; PVP_PRO_AI_MEMORY[pNPCUnit] = memory end
	memory.tick = memory.tick or 0; memory.pressure = memory.pressure or 0
	memory.close_read = memory.close_read or 0; memory.far_read = memory.far_read or 0
	memory.approach_read = memory.approach_read or 0; memory.retreat_read = memory.retreat_read or 0
	memory.air_read = memory.air_read or 0; memory.lateral_read = memory.lateral_read or 0
	memory.feint_read = memory.feint_read or 0; memory.punish_read = memory.punish_read or 0
	memory.confirm_read = memory.confirm_read or 0; memory.whiff_read = memory.whiff_read or 0
	memory.action_count = memory.action_count or 0; memory.tempo = memory.tempo or 0
	memory.last_damage_tick = memory.last_damage_tick or 0
	memory.last_used = memory.last_used or {}; memory.last_considered = memory.last_considered or {}
	memory.once = memory.once or {}; memory.action_score = memory.action_score or {}
	memory.family_score = memory.family_score or {}; memory.punished_family = memory.punished_family or {}
	memory.pending_actions = memory.pending_actions or {}
	memory.execution = memory.execution or math.random( 94, 98 )
	memory.plan = memory.plan or "neutral"; memory.plan_until = memory.plan_until or 0
	memory.reserve_mp = memory.reserve_mp or 45
	return memory
end

function PVP_PRO_AI_LEARN( memory, entry, success )
	local actionDelta, familyDelta = -0.32, -0.08
	if success == true then
		actionDelta, familyDelta = 1.0, 0.24
...
function PVP_PRO_AI_RESOLVE_PENDING( memory, targetHP )
	...
	for index = #pending, 1, -1 do
		if memory.tick - pending[index].tick >= pending[index].window then
			PVP_PRO_AI_LEARN( memory, pending[index], false )
			table.remove( pending, index )
		end
	end
end
...
function PVP_PRO_AI_SELECT_PLAN( memory, hpRate, mp )
	...
	if hpRate < 0.23 or ( memory.pressure >= 7 and mp < 170 ) then memory.plan = "recover"
	elseif targetRate < 0.28 then memory.plan = "finish"
	elseif memory.approach_read + memory.feint_read > memory.retreat_read + 2.5 then memory.plan = "bait"
	elseif memory.retreat_read + memory.far_read * 0.35 > memory.approach_read + 2.5 then memory.plan = "hunt"
	elseif memory.confirm_read >= 2.2 and memory.pressure < 4 then memory.plan = "pressure"
	else
...
function PVP_PRO_AI_TICK( pX2Game, pNPCUnit, reactionMin, reactionMax )
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	memory.tick = memory.tick + 1; memory.reaction_min = reactionMin; memory.reaction_max = reactionMax
	memory.once = {}
	local hpRate = PVP_PRO_AI_HP_RATE( pNPCUnit )
	local damageTaken = 0
	...
	if targetHP ~= nil and memory.target_hp ~= nil and targetHP > memory.target_hp + 1 and memory.target_hp <= 0 then
		memory.pending_actions = {}; memory.confirm_read = 0; memory.whiff_read = 0
	end
	...
	else memory.feint_read = math.max( 0, memory.feint_read - 0.1 ) end
	...
	else memory.air_read = math.max( 0, memory.air_read - 0.32 ) end
	local targetZStep = 0
	if memory.target_z ~= nil then targetZStep = targetPos.z - memory.target_z end
	if math.abs( targetZStep ) > 28 then memory.lateral_read = math.min( 8, memory.lateral_read + 0.8 )
	else memory.lateral_read = math.max( 0, memory.lateral_read - 0.16 ) end
	if dist < 320 then memory.close_read = math.min( 10, memory.close_read + 1 )
	else memory.close_read = math.max( 0, memory.close_read - 0.4 ) end
	if dist > 850 then memory.far_read = math.min( 10, memory.far_read + 1 )
	else memory.far_read = math.max( 0, memory.far_read - 0.35 ) end
	...
	memory.hp_rate = hpRate; memory.mp = pNPCUnit:GetNowMP(); memory.distance = dist
	memory.vertical_offset = vertical; memory.target_x = targetPos.x
	memory.target_y = targetPos.y; memory.target_z = targetPos.z; memory.target_hp = targetHP
	return false
end

function PVP_PRO_AI_READY( pNPCUnit, action, family, chance, cooldown, reconsider, urgent )
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	local lastUsed, lastConsidered = memory.last_used[action], memory.last_considered[action]
	reconsider = reconsider or 2; cooldown = cooldown or 0
	if urgent ~= true and memory.tick < ( memory.reaction_until or 0 ) then return false end
	if lastUsed ~= nil and memory.tick - lastUsed < cooldown then return false end
	if lastConsidered ~= nil and memory.tick - lastConsidered < reconsider then return false end
	memory.last_considered[action] = memory.tick
	if urgent ~= true then
		...
		chance = chance + ( memory.action_score[action] or 0 ) * 4
			+ ( memory.family_score[family] or 0 ) * 2
			- ( memory.punished_family[family] or 0 ) * 3
	...
	if math.random( 1000 ) > chance * 10 then return false end
	memory.previous_action = memory.last_action; memory.previous_family = memory.last_family
	memory.last_action = action; memory.last_family = family; memory.last_used[action] = memory.tick
	memory.last_selected_tick = memory.tick; memory.last_selected_family = family
	memory.action_count = memory.action_count + 1
	memory.tempo = math.floor( memory.action_count / 2 ) % 3
	local minReaction, maxReaction = memory.reaction_min or 1, memory.reaction_max or 1
...
function PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, action, role, minDist, maxDist, minMP, chance, cooldown )
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	local dist, mp = PVP_PRO_AI_DISTANCE( pX2Game, pNPCUnit ), pNPCUnit:GetNowMP()
	...
	elseif role == "poke" then
		chance = chance + memory.far_read + memory.retreat_read * 1.2 + memory.lateral_read * 0.7
	...
	elseif role == "air" or role == "air_move" then
		chance = chance + memory.air_read * 2.5 + memory.retreat_read + memory.lateral_read * 0.8
...
function PVP_PRO_AI_MANA_BREAK( pNPCUnit )
	local memory, mp = PVP_PRO_AI_GET( pNPCUnit ), pNPCUnit:GetNowMP()
	if mp < 100 then return false end
	...
	local chance = 13
	if mp >= 250 then chance = 77 elseif mp >= 200 then chance = 57 elseif mp >= 150 then chance = 34 end
...
function PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, resetRange, baseChance )
	...
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	local hitConfirmed, chance = pNPCUnit:GetUnitCondition_bHit(), baseChance
...
function PVP_PRO_AI_AWAKEN( pX2Game, pNPCUnit, offensiveRange, aggression )
	if pNPCUnit:GetHyperModeCount() <= 0 then return false end
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	local hpRate, dist = PVP_PRO_AI_HP_RATE( pNPCUnit ), PVP_PRO_AI_DISTANCE( pX2Game, pNPCUnit )
	local damageTaken = math.max( 0, ( memory.hp_rate or hpRate ) - hpRate )
	local predictedDist = dist + ( memory.distance_velocity or 0 ) * 0.65
	local hitConfirmed = pNPCUnit:GetUnitCondition_bHit()
	local chance, urgent = 0, false
	...
	elseif predictedDist < offensiveRange and ( memory.plan == "pressure" or memory.plan == "finish" ) then
		chance = 13 + aggression + memory.approach_read * 1.5
	elseif hpRate < 0.30 then chance = 34 + aggression + memory.pressure * 3 end
...
function CF_PVP_BOT_PENENSIO_RUNE_FIRE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "fire_rune_guard", "control", 300, 1150, 70, 39, 13 )
end

function CF_PVP_BOT_PENENSIO_RUNE_ICE( pKTDXApp, pX2Game, pNPCUnit )
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	local chance = 40 + memory.approach_read * 1.5 + memory.pressure
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "ice_rune_guard", "guard", 240, 920, 70, chance, 13 )
end

function CF_PVP_BOT_PENENSIO_ADVANCE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "rune_advance", "advance", 300, 1500, 0, 58, 3 )
end

function CF_PVP_BOT_PENENSIO_AERIAL_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "rune_air_entry", "air_move", 260, 1080, 0, 34, 6 )
end
...
PVP_PRO_AI_PROFILE_PENENSIO = {
	name = "adaptive_swordmage",
	preferred_range = 335,
	aggression = 1.10,
	discipline = 1.24,
	volatility = 3,
	role_bias = { guard = 8, combo = 6, control = 6, poke = 3, burst = 4, chase = 2 },
	openers = { rune_poke = 5, fire_rune_guard = 5, splash_explosion = 4 },
	finishers = { storm_blade = 12, luna_blade = 9 },
	mixups = { ice_rune_guard = 8, revenge_parry = 7, rune_feint = 6 },
}

function CF_PVP_BOT_PENENSIO_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_PENENSIO )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end
...
PVP_PRO_AI_V4_PROFILE_PENENSIO = {
	name = "matchup_swordmage",
	patience = 1.12,
	risk = 1.04,
	creativity = 4,
	condition_limit = 3,
	finisher_threshold = 0.33,
	probe_role = "poke",
	contest_role = "guard",
	...
	secondary_roles = {
		approach = "combo", retreat = "advance", jump = "air_move",
		feint = "guard", hold = "poke",
	},
	signature = {
		rune_guard = 7, fire_rune_guard = 6, ice_rune_guard = 7,
		revenge_parry = 7, rune_poke = 5, storm_blade = 7,
	},
	engagement_bias = { trap = 9, contest = 5, changeup = 4 },
}

function CF_PVP_BOT_PENENSIO_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_PENENSIO )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_PENENSIO )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end
...
PVP_PRO_AI_V5_PROFILE_PENENSIO = {
	name = "tournament_matchup_swordmage",
	read_skill = 0.96,
	exploration = 0.79,
	commitment = 1.00,
	...
	creativity = 4,
	playbooks = {
		download = { "poke", "guard", "control" },
		outplay = { "guard", "control", "combo" },
		pressure = { "control", "combo", "burst" },
		deny = { "control", "poke", "advance" },
		stabilize = { "escape", "guard", "control" },
		survive = { "escape", "guard", "air_move" },
		finish = { "control", "combo", "burst" },
	},
	actions = {
		download = { "rune_poke", "rune_guard", "fire_rune_guard" },
		outplay = { "revenge_parry", "ice_rune_guard", "sword_pressure" },
		pressure = { "splash_explosion", "sword_pressure", "luna_blade" },
		deny = { "fire_rune_guard", "rune_poke", "rune_advance" },
		stabilize = { "rune_feint", "revenge_parry", "ice_rune_guard" },
		survive = { "rune_feint", "revenge_parry", "rune_air_entry" },
		finish = { "splash_explosion", "sword_pressure", "storm_blade", "luna_blade" },
	},
	action_prior = {
		revenge_parry = 6, rune_guard = 6, fire_rune_guard = 5,
		ice_rune_guard = 6, sword_pressure = 5, storm_blade = 8,
	},
	goal_bias = {
		download = 3, outplay = 7, pressure = 3,
		deny = 5, stabilize = 5, finish = 5,
	},
	finisher_actions = { "storm_blade", "luna_blade", "splash_explosion" },
}

function CF_PVP_BOT_PENENSIO_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_PENENSIO )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_PENENSIO )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE( pNPCUnit, PVP_PRO_AI_V5_PROFILE_PENENSIO )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 2 )
end
...
PVP_PRO_AI_V6_PROFILE_PENENSIO = {
	character = "penensio",
	identity = "adaptive_tournament_all_rounder",
	identity_mode = "tournament_all_rounder",
	probe_style = "adaptive",
	preferred_min = 180,
	preferred_max = 750,
	vertical_tolerance = 185,
	resource_target = 180,
	reset_threshold = 0.64,
	adaptation_rate = 1.25,
	strategy_hysteresis = 5,
	default_tempo = "measured_neutral",
	strategy_order = {
		"matchup_download_matrix",
		"rune_response_rotation",
		"measured_resource_curve",
		"adaptable_lead_control",
		"tournament_recovery",
		"precision_storm_finish",
	},
	strategies = {
		matchup_download_matrix = {
			base = 10,
			...
			plans = { "rune_observation", "element_lane_rotation", "opponent_change_review" },
		},
		rune_response_rotation = {
			base = 11,
			min_ticks = 48,
			...
			plans = { "sword_pressure_ladder", "guard_response_test", "rune_resource_cycle" },
		},
		measured_resource_curve = {
			base = 10.5,
			min_ticks = 44,
			...
			plans = { "rune_resource_cycle", "adaptive_reclaim", "element_lane_rotation" },
		},
		adaptable_lead_control = {
			base = 9,
			min_ticks = 58,
			...
			plans = { "matchup_lead_control", "rune_observation", "opponent_change_review" },
		},
		tournament_recovery = {
			base = 6,
			min_ticks = 30,
			...
			plans = { "adaptive_reclaim", "matchup_lead_control", "opponent_change_review" },
		},
		precision_storm_finish = {
			base = 6,
			min_ticks = 28,
			...
			plans = { "storm_cashout", "luna_close", "sword_pressure_ladder" },
		},
	},
	plans = {
		rune_observation = {
			...
			position = true,
			tempo = "slow_observation",
			roles = { "poke", "escape", "guard" },
			intentions = { "rune_sample", "element_rotate" },
		},
		element_lane_rotation = {
			base = 9,
			min_ticks = 19,
			max_ticks = 37,
			position = true,
			changeup = true,
			tempo = "measured_neutral",
			roles = { "advance", "combo", "guard" },
			intentions = { "sword_layer", "guard_bait" },
		},
		sword_pressure_ladder = {
			base = 9,
			min_ticks = 17,
			max_ticks = 34,
			pressure = true,
			...
			roles = { "control", "control", "poke" },
			intentions = { "spacing_lock", "air_reentry" },
		},
		guard_response_test = {
			base = 8,
			min_ticks = 16,
			...
			tempo = "measured_neutral",
			roles = { "combo", "control", "burst" },
			intentions = { "adaptive_conversion", "rune_resource_hold" },
		},
		rune_resource_cycle = {
			base = 10,
			min_ticks = 19,
			...
			intentions = { "storm_cashout", "luna_intercept" },
		},
		adaptive_reclaim = {
			base = 10,
			min_ticks = 18,
			...
			survival = true,
			tempo = "controlled_reset",
			roles = { "advance", "escape", "poke" },
			intentions = { "change_test", "matchup_switch" },
		},
		matchup_lead_control = {
			base = 11,
			min_ticks = 21,
			max_ticks = 43,
			reset = true,
			survival = true,
			tempo = "lead_preserving_slowdown",
			roles = { "control", "guard", "poke" },
			intentions = { "element_rotate", "adaptive_conversion" },
		},
		opponent_change_review = {
			base = 7,
			min_ticks = 16,
			max_ticks = 30,
			probe = true,
			changeup = true,
			tempo = "slow_observation",
			roles = { "guard", "escape", "combo" },
			intentions = { "guard_bait", "storm_cashout" },
		},
		storm_cashout = {
			base = 12,
			min_ticks = 12,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "air_move", "escape", "guard" },
			intentions = { "air_reentry", "change_test" },
		},
		luna_close = {
			base = 10,
			min_ticks = 13,
			...
			intentions = { "luna_intercept", "matchup_switch" },
		},
	},
	intentions = {
		rune_sample = {
			...
			risk = 0.2,
			roles = { "poke", "escape", "guard" },
			actions = { "rune_poke", "rune_feint", "rune_guard" },
		},
		element_rotate = {
			base = 9,
			min_ticks = 7,
			...
			risk = 0.31,
			roles = { "control", "guard", "poke" },
			actions = { "fire_rune_guard", "ice_rune_guard", "rune_poke" },
		},
		sword_layer = {
			base = 10,
			min_ticks = 8,
			...
			risk = 0.39,
			roles = { "advance", "combo", "guard" },
			actions = { "rune_advance", "sword_pressure", "revenge_parry" },
		},
		guard_bait = {
			base = 11,
			min_ticks = 6,
			...
			conditioning = true,
			roles = { "guard", "escape", "combo" },
			actions = { "rune_guard", "rune_feint", "sword_pressure" },
		},
		spacing_lock = {
			base = 8,
			min_ticks = 7,
			...
			risk = 0.37,
			roles = { "control", "control", "poke" },
			actions = { "fire_rune_guard", "splash_explosion", "rune_poke" },
		},
		air_reentry = {
			base = 9,
			min_ticks = 8,
			...
			risk = 0.32,
			roles = { "air_move", "escape", "guard" },
			actions = { "rune_air_entry", "rune_feint", "ice_rune_guard" },
		},
		adaptive_conversion = {
			base = 10,
			min_ticks = 6,
			...
			risk = 0.53,
			roles = { "combo", "control", "burst" },
			actions = { "sword_pressure", "splash_explosion", "luna_blade" },
		},
		rune_resource_hold = {
			base = 11,
			min_ticks = 7,
			max_ticks = 15,
			risk = 0.19,
			roles = { "poke", "guard", "guard" },
			actions = { "rune_poke", "ice_rune_guard", "rune_guard" },
		},
		storm_cashout = {
			base = 8,
			min_ticks = 8,
			...
			risk = 0.64,
			roles = { "guard", "combo", "burst" },
			actions = { "revenge_parry", "sword_pressure", "storm_blade" },
		},
		luna_intercept = {
			base = 9,
			min_ticks = 6,
			...
			risk = 0.57,
			roles = { "control", "burst", "control" },
			actions = { "fire_rune_guard", "luna_blade", "splash_explosion" },
		},
		change_test = {
			base = 10,
			min_ticks = 7,
			...
			risk = 0.24,
			roles = { "advance", "escape", "poke" },
			actions = { "rune_advance", "rune_feint", "rune_poke" },
		},
		matchup_switch = {
			base = 11,
			min_ticks = 8,
			...
			risk = 0.36,
			conditioning = true,
			roles = { "guard", "air_move", "combo" },
			actions = { "ice_rune_guard", "rune_air_entry", "sword_pressure" },
		},
	},
	action_traits = {
		revenge_parry = {
	...
	probe_order = { "rune_response", "element_adaptation", "wakeup_guard" },
	probes = {
		rune_response = {
			style = "adaptive",
			question = "which_response_follows_rune_representation",
		...
		element_adaptation = {
			style = "adaptive",
			question = "does_the_opponent_change_after_elemental_punish",
			hypothesis = "adapts_after_punish",
			expected = "hold",
			actions = { "fire_rune_guard", "ice_rune_guard", "rune_poke" },
			risk = 0.22,
			information = 0.88,
		...
		wakeup_guard = {
			style = "defense",
			question = "does_wakeup_pressure_draw_an_attack",
			hypothesis = "wakeup_attacker",
			expected = "counter",
			actions = { "revenge_parry", "rune_feint", "sword_pressure" },
			risk = 0.24,
			information = 0.88,
			cost = 0.2,
			max_repetitions = 2,
	...
	conditioning_breaks = {
		rune_poke = "rune_advance",
		rune_guard = "rune_feint",
		fire_rune_guard = "ice_rune_guard",
		ice_rune_guard = "rune_advance",
		sword_pressure = "revenge_parry",
		rune_feint = "splash_explosion",
	},
	fallback_intention = "rune_sample",
	error_profile = {
		base = 0.025,
		load_scale = 0.1,
		surprise_scale = 0.044,
		overconfidence_scale = 0.027,
		range_bias = 0.94,
		late_confirm = 0.88,
		familiar_route = 0.92,
		greedy_resource = 0.78,
		stale_read = 0.93,
		overcommit = 0.76,
	},
}
...
function CF_PVP_BOT_PENENSIO_AI_TICK(
	pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE(
		pNPCUnit, PVP_PRO_AI_PROFILE_PENENSIO )
	PVP_PRO_AI_SET_META_PROFILE(
		pNPCUnit, PVP_PRO_AI_V4_PROFILE_PENENSIO )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE(
		pNPCUnit, PVP_PRO_AI_V5_PROFILE_PENENSIO )
	PVP_PRO_AI_SET_COMPETITIVE_PROFILE(
		pNPCUnit, PVP_PRO_AI_V6_PROFILE_PENENSIO )
	PVP_PRO_AI_SET_RUNTIME_PROFILE(
		pNPCUnit, PVP_PRO_AI_V7_PROFILE_PENENSIO )
