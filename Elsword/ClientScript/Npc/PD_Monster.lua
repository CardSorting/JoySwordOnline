...
INIT_STATE = 
{
    ...
    { STATE_NAME = "PD_MONSTER_START",				},
	{ STATE_NAME = "PD_MONSTER_WAIT",				LUA_FRAME_MOVE_FUNC = "PD_MONSTER_WAIT_FRAME_MOVE",	},
	{ STATE_NAME = "PD_MONSTER_DIE", },
    
    
	START_STATE					= "PD_MONSTER_START",
	WAIT_STATE					= "PD_MONSTER_WAIT",
	...
	DOWN_DAMAGE_AIR				= "",
	UP_DAMAGE					= "",
	DAMAGE_REVENGE				= "PD_MONSTER_WAIT",
	
	DYING_LAND_FRONT			= "PD_MONSTER_DIE",
	DYING_LAND_BACK				= "PD_MONSTER_DIE",
	DYING_SKY					= "PD_MONSTER_DIE",
...
PD_MONSTER_START = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],		"PD_MONSTER_WAIT",		"CT_PD_MONSTER_WAIT"				},
	},
...
function PD_MONSTER_WAIT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )

    --print("pd framemove")        
        
    if pNPCUnit:AnimEventTimer_LUA( 7.0 ) then
    ...
    if pNPCUnit:AnimEventTimer_LUA( 8.0 ) then
