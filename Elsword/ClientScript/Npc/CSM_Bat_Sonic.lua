...
INIT_STATE = 
{
	...
	SUMMON_END_STATE			= "BAT_SONIC_END",
...
INIT_AI = 
{
	...
	CHASE_MOVE = 
	{		
		DEST_GAP			= 280,	-- 목적지에서 이 거리 안에 있으면 도착했다고 판단한다
		MOVE_GAP			= 320,
...
function BAT_SONIC_STAND_UP_ATTACK_FRONT_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 0.71 ) then
		...
		pMinorParticle = pX2Game:GetMinorParticle()
		pMinorParticle:CreateSequence_LUA( "GroundShockWave", landPos, D3DXVECTOR2(100,100), D3DXVECTOR2(1,-1) )
