...
function CF_PLANT_OVERLOAD_CENTER_CHANGE_OVERMODE( pKTDXApp, pX2Game, pNPCUnit )
    local nOverLoad = pX2Game:LiveNPCNumType_LUA( NPC_UNIT_ID["NUI_PLANT_OVERLOAD"] )
	local nOverLoadQuest = pX2Game:LiveNPCNumType_LUA( NPC_UNIT_ID["NUI_PLANT_OVERLOAD_QUEST"] )
    
    if nOverLoad == 1 and nOverLoadQuest == 0 then
        return true
    end
