...
INIT_MOTION = 
{
	--MOTION_FILE_NAME	= "Motion_DEVELOPER_E.x",
	--MOTION_CHANGE_TEX_XET	= "Mesh_Nui_Rainbow_E.xet",
...
INIT_STATE = 
{
	{ STATE_NAME = "DEVELOPER_E_WAITSTART",					LUA_FRAME_MOVE_FUNC = "DEVELOPER_E_WAITSTART_FRAME_MOVE", 	},

	{ STATE_NAME = "DEVELOPER_E_WAIT",						},
	
	{ STATE_NAME = "DEVELOPER_E_WAITEND",					LUA_STATE_START_FUNC = "DEVELOPER_E_WAITEND_STATE_START",	
	                                                        LUA_FRAME_MOVE_FUNC = "DEVELOPER_E_WAITEND_FRAME_MOVE",    
	                                                        LUA_STATE_END_FUNC = "DEVELOPER_E_WAITEND_STATE_END" },	
	{ STATE_NAME = "DEVELOPER_E_DIE",						},
		
	
	START_STATE					= "DEVELOPER_E_WAITSTART",
	WAIT_STATE					= "DEVELOPER_E_WAIT",
	
	
	SMALL_DAMAGE_LAND_FRONT		= "DEVELOPER_E_DIE",
	SMALL_DAMAGE_LAND_BACK		= "DEVELOPER_E_DIE",
	BIG_DAMAGE_LAND_FRONT		= "DEVELOPER_E_DIE",
	BIG_DAMAGE_LAND_BACK		= "DEVELOPER_E_DIE",
	DOWN_DAMAGE_LAND_FRONT		= "DEVELOPER_E_DIE",
	DOWN_DAMAGE_LAND_BACK		= "DEVELOPER_E_DIE",
	FLY_DAMAGE_FRONT			= "DEVELOPER_E_DIE",
	FLY_DAMAGE_BACK				= "DEVELOPER_E_DIE",
	SMALL_DAMAGE_AIR			= "DEVELOPER_E_DIE",	
	BIG_DAMAGE_AIR				= "DEVELOPER_E_DIE",
	DOWN_DAMAGE_AIR				= "DEVELOPER_E_DIE",
	UP_DAMAGE					= "DEVELOPER_E_DIE",
	DAMAGE_REVENGE				= "DEVELOPER_E_DIE",
	
	DYING_LAND_FRONT			= "DEVELOPER_E_DIE",
	DYING_LAND_BACK				= "DEVELOPER_E_DIE",
	DYING_SKY					= "DEVELOPER_E_DIE",
...
DEVELOPER_E_WAITSTART = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"DEVELOPER_E_WAIT",								},	
	},
}
...
{	
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"DEVELOPER_E_DIE",								},	
	},
...
DEVELOPER_E_WAIT = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"DEVELOPER_E_WAITEND",								},	
	},
	...
	TALK_BOX =
	{
		--{ RATE = 100, MESSAGE = STR_ID_11445 },
		{ RATE = 100, MESSAGE = STR_ID_17505 },
	},
...
----------------------------------------------------------
function DEVELOPER_E_WAITEND_STATE_END( pKTDXApp, pX2Game, pNPCUnit )
...
----------------------------------------------------------
function DEVELOPER_E_WAITSTART_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function DEVELOPER_E_WAITEND_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function DEVELOPER_E_WAITEND_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
-- Fade Start    
