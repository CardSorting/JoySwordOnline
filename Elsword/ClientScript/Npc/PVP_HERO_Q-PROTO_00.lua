...
INIT_COMPONENT =
{
	...
	-- 기본 속도가 29% 증가로 유저보다 매우 빠릅니다.
	DEFAULT_ANIM_SPEED = 1.29,
...
PVP_BOT_Q_PROTO_00_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_Q_PROTO_00_WAIT",	"CF_PVP_BOT_Q_PROTO_00_AI_TICK",									},
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_BACKWARD_DASH_READY",     	"CF_PVP_BOT_Q_PROTO_00_BACKWARD_DASH",   	},

		-- 정지하고 있을 때는 다음의 행동을 수행할 수 있습니다. (z입력, 걷기, 뛰기, 대시점프, 걷기와 뛰기는 강제로 수행 시키는 부분입니다.)
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_ATOMIC_BLASTER",     	"CF_PVP_BOT_Q_PROTO_00_ATOMIC_BLASTER",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_IRON_SCRAPS",     	"CF_PVP_BOT_Q_PROTO_00_IRON_SCRAPS",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_JUNK_BREAK",     	"CF_PVP_BOT_Q_PROTO_00_JUNK_BREAK",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_GENERATE_BLACKHOLE",     	"CF_PVP_BOT_Q_PROTO_00_BLACKHOLE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_METAL_DUST_AURA",     		"CF_PVP_BOT_Q_PROTO_00_METAL_AURA",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_THORNS_ILLUSION",     		"CF_PVP_BOT_Q_PROTO_00_THORNS",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_ComboZ",     				"CF_PVP_BOT_Q_PROTO_00_COMBO_ENTRY",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_DashJump_for_DashJumpZZZ",  "CF_PVP_BOT_Q_PROTO_00_AIR_COMBO",      		},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_MEGA_ELECTRONBALL",     	"CF_PVP_BOT_Q_PROTO_00_MEGA_ELECTRONBALL",     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_DashComboZ",     			"CF_PVP_BOT_Q_PROTO_00_DASH_CATCH",           	},
        -- { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_Q_PROTO_00_WALK",         				"CT_PVP_BOT_Q_PROTO_00_WALK",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_DASH",         				"CF_PVP_BOT_Q_PROTO_00_ADVANCE",       		    },
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_DashJump",          		"CF_PVP_BOT_Q_PROTO_00_AERIAL_ENTRY",      			},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_ComboX",     				"CF_PVP_BOT_Q_PROTO_00_RANGED_COMBO",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_Q_PROTO_00_ComboZ",     				"CF_PVP_BOT_Q_PROTO_00_COMBO_ENTRY",       	     	},
...
PVP_BOT_Q_PROTO_00_STANDUP_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_Q_PROTO_00_STANDUP_WAIT",	"CF_PVP_BOT_Q_PROTO_00_AI_TICK",									},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_Q_PROTO_00_BOOST_POWER",	"CF_PVP_BOT_Q_PROTO_00_BOOST_POWER",									},
...
PVP_BOT_Q_PROTO_00_WALK =
{
	...
	EVENT_PROCESS =
	{
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_Q_PROTO_00_BACKWARD_DASH_READY",         				"CT_PVP_BOT_Q_PROTO_00_WAIT",       		    },
...
PVP_BOT_Q_PROTO_00_BACKWARD_DASH_READY = 
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PVP_BOT_Q_PROTO_00_FRONT_DASH_A2",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"PVP_BOT_Q_PROTO_00_BACKWARD_DASH_READY",		},
	},
...
PVP_BOT_Q_PROTO_00_DASH_END =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_Q_PROTO_00_BACKWARD_DASH_READY",         			"CT_PVP_BOT_TURN_WAIT_POSITION",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_Q_PROTO_00_BACKWARD_DASH_READY",         			"CT_PVP_BOT_TURN_WAIT_POSITION2",       		    },
...
PVP_BOT_Q_PROTO_00_ComboZZ =
{
	...
	EVENT_PROCESS =
	{
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],		"PVP_BOT_Q_PROTO_00_BACKWARD_DASH_READY",		"CF_PVP_BOT_Q_PROTO_00_COMBO_RESET",	},
...
PVP_BOT_Q_PROTO_00_BOOST_POWER =
{
	ANIM_NAME			= "BoostPower",
	PLAY_TYPE			= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	LAND_CONNECT		= FALSE,
...
function PVP_BOT_Q_PROTO_00_BOOST_POWER_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_Q_PROTO_00_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_Q_PROTO_00_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return math.random(100) <= 40
end

-- Antigravity Custom Pro-Player Tactical Awakening Callback
function CF_PVP_BOT_Q_PROTO_00_BOOST_POWER( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_Q_PROTO_00_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end

function CF_PVP_BOT_Q_PROTO_00_ATOMIC_BLASTER( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "atomic_blaster", "burst", 0, 390, 100, 43, 9 )
end

function CF_PVP_BOT_Q_PROTO_00_IRON_SCRAPS( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "iron_scraps", "guard", 0, 490, 200, 44, 14 )
end

function CF_PVP_BOT_Q_PROTO_00_JUNK_BREAK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "junk_break", "burst", 240, 950, 299, 47, 24 )
end

function CF_PVP_BOT_Q_PROTO_00_BLACKHOLE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "generate_blackhole", "control", 580, 2500, 299, 51, 28 )
end

function CF_PVP_BOT_Q_PROTO_00_METAL_AURA( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "metal_dust_aura", "guard", 0, 680, 40, 35, 18 )
end

function CF_PVP_BOT_Q_PROTO_00_THORNS( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "thorns_illusion", "control", 120, 760, 50, 30, 12 )
end

function CF_PVP_BOT_Q_PROTO_00_MEGA_ELECTRONBALL( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "mega_electronball", "poke", 330, 1250, 50, 36, 7 )
end

function CF_PVP_BOT_Q_PROTO_00_DASH_CATCH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "dash_catch", "chase", 430, 850, 0, 37, 6 )
end

function CF_PVP_BOT_Q_PROTO_00_COMBO_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "nasod_pressure", "combo", 0, 650, 0, 55, 4 )
end

function CF_PVP_BOT_Q_PROTO_00_RANGED_COMBO( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "electron_poke", "poke", 230, 760, 60, 38, 5 )
end

function CF_PVP_BOT_Q_PROTO_00_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "nasod_reposition", "escape", 0, 340, 0, 24, 9 )
end
...
function CF_PVP_BOT_Q_PROTO_00_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, 390, 28 )
end

function CF_PVP_BOT_Q_PROTO_00_BOOST_POWER( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_AWAKEN( pX2Game, pNPCUnit, 330, 8 )
end
...
function CF_PVP_BOT_Q_PROTO_00_AIR_COMBO( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "proto_air_combo", "air", 180, 820, 0, 39, 8 )
end

function CF_PVP_BOT_Q_PROTO_00_ADVANCE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "proto_advance", "advance", 360, 1700, 0, 55, 3 )
end

function CF_PVP_BOT_Q_PROTO_00_AERIAL_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "proto_air_entry", "air_move", 280, 1200, 0, 35, 6 )
end
...
PVP_PRO_AI_PROFILE_Q_PROTO_00 = {
	name = "nasod_pressure_controller",
	preferred_range = 445,
	aggression = 1.12,
	discipline = 1.16,
	volatility = 4,
	role_bias = { control = 8, burst = 6, guard = 5, combo = 4, poke = 4, air = 3 },
	openers = { generate_blackhole = 6, electron_poke = 5, mega_electronball = 4, dash_catch = 4 },
	finishers = { junk_break = 12, atomic_blaster = 8 },
	mixups = { thorns_illusion = 7, iron_scraps = 6, proto_air_combo = 6, nasod_reposition = 5 },
}

function CF_PVP_BOT_Q_PROTO_00_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_Q_PROTO_00 )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V4_PROFILE_Q_PROTO_00 = {
	name = "layered_pressure_controller",
	patience = 1.02,
	risk = 1.08,
	creativity = 4,
	condition_limit = 3,
	...
	probe_role = "poke",
	contest_role = "control",
	conversion_role = "combo",
	cashout_role = "burst",
	reset_role = "guard",
	counter_roles = {
		approach = "guard", retreat = "control", jump = "air",
		feint = "poke", hold = "control",
	},
	secondary_roles = {
		approach = "control", retreat = "chase", jump = "control",
		feint = "guard", hold = "poke",
	},
	signature = {
		generate_blackhole = 8, thorns_illusion = 6, proto_air_combo = 6,
		atomic_blaster = 6, iron_scraps = 6, junk_break = 7,
	},
	engagement_bias = { trap = 6, convert = 6, contest = 4 },
}

function CF_PVP_BOT_Q_PROTO_00_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_Q_PROTO_00 )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_Q_PROTO_00 )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V5_PROFILE_Q_PROTO_00 = {
	name = "tournament_layered_controller",
	read_skill = 0.91,
	exploration = 0.86,
	commitment = 1.08,
	...
	actions = {
		download = { "electron_poke", "iron_scraps", "thorns_illusion" },
		outplay = { "generate_blackhole", "metal_dust_aura", "proto_air_combo" },
		pressure = { "generate_blackhole", "nasod_pressure", "atomic_blaster" },
		deny = { "mega_electronball", "thorns_illusion", "dash_catch" },
		stabilize = { "nasod_reposition", "iron_scraps", "thorns_illusion" },
		survive = { "nasod_reposition", "metal_dust_aura", "proto_air_entry" },
		finish = { "generate_blackhole", "nasod_pressure", "junk_break", "atomic_blaster" },
	},
	action_prior = {
		generate_blackhole = 7, thorns_illusion = 5, proto_air_combo = 5,
		atomic_blaster = 6, iron_scraps = 5, junk_break = 8,
	},
	goal_bias = {
		download = 3, outplay = 5, pressure = 4,
		deny = 5, stabilize = 4, finish = 5,
	},
	finisher_actions = { "junk_break", "atomic_blaster", "generate_blackhole" },
}

function CF_PVP_BOT_Q_PROTO_00_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_Q_PROTO_00 )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_Q_PROTO_00 )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE( pNPCUnit, PVP_PRO_AI_V5_PROFILE_Q_PROTO_00 )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V6_PROFILE_Q_PROTO_00 = {
	character = "q_proto_00",
	identity = "nasod_reactive_punisher",
	identity_mode = "reactive_punisher",
	probe_style = "counter",
	preferred_min = 220,
	preferred_max = 850,
	vertical_tolerance = 190,
	resource_target = 180,
	reset_threshold = 0.66,
	adaptation_rate = 1.1,
	strategy_hysteresis = 6,
	default_tempo = "slow_observation",
	strategy_order = {
		"commitment_window_read",
		"armored_counter_theory",
		"heat_resource_cycle",
		"punish_lead_lock",
		"armored_survival_reclaim",
		"reactive_lethal_conversion",
	},
	strategies = {
		commitment_window_read = {
			base = 10,
			...
			plans = { "armor_observation", "projectile_screen", "approach_change_review" },
		},
		armored_counter_theory = {
			base = 11,
			min_ticks = 48,
			...
			plans = { "reactive_pressure", "stop_short_test", "heat_resource_cycle" },
		},
		heat_resource_cycle = {
			base = 10.5,
			min_ticks = 44,
			...
			plans = { "heat_resource_cycle", "armored_reclaim", "projectile_screen" },
		},
		punish_lead_lock = {
			base = 9,
			min_ticks = 58,
			...
			plans = { "punish_lead_control", "armor_observation", "approach_change_review" },
		},
		armored_survival_reclaim = {
			base = 6,
			min_ticks = 30,
			...
			plans = { "armored_reclaim", "punish_lead_control", "approach_change_review" },
		},
		reactive_lethal_conversion = {
			base = 6,
			min_ticks = 28,
			...
			plans = { "junk_cashout", "blackhole_close", "reactive_pressure" },
		},
	},
	plans = {
		armor_observation = {
			...
			position = true,
			tempo = "slow_observation",
			roles = { "poke", "guard", "combo" },
			intentions = { "armor_response", "projectile_counter" },
		},
		projectile_screen = {
			base = 9,
			min_ticks = 19,
			...
			changeup = true,
			tempo = "measured_neutral",
			roles = { "control", "escape", "burst" },
			intentions = { "blackhole_screen", "stop_short_guard" },
		},
		reactive_pressure = {
			base = 9,
			min_ticks = 17,
			...
			roles = { "control", "guard", "combo" },
			intentions = { "thorns_punish", "air_counter" },
		},
		stop_short_test = {
			base = 8,
			min_ticks = 16,
			...
			intentions = { "guarded_conversion", "ranged_patience" },
		},
		heat_resource_cycle = {
			base = 10,
			min_ticks = 19,
			...
			pressure = true,
			tempo = "measured_neutral",
			roles = { "guard", "chase", "burst" },
			intentions = { "whiff_cashout", "blackhole_finish" },
		},
		armored_reclaim = {
			base = 10,
			min_ticks = 18,
			...
			survival = true,
			tempo = "controlled_reset",
			roles = { "advance", "escape", "control" },
			intentions = { "approach_recheck", "layered_armor_break" },
		},
		punish_lead_control = {
			base = 11,
			min_ticks = 21,
			...
			survival = true,
			tempo = "lead_preserving_slowdown",
			roles = { "poke", "guard", "chase" },
			intentions = { "projectile_counter", "guarded_conversion" },
		},
		approach_change_review = {
			base = 7,
			min_ticks = 16,
			max_ticks = 30,
			probe = true,
			...
			intentions = { "stop_short_guard", "whiff_cashout" },
		},
		junk_cashout = {
			base = 12,
			min_ticks = 12,
			...
			intentions = { "air_counter", "approach_recheck" },
		},
		blackhole_close = {
			base = 10,
			min_ticks = 13,
			...
			pressure = true,
			tempo = "sudden_burst",
			roles = { "control", "burst", "burst" },
			intentions = { "blackhole_finish", "layered_armor_break" },
		},
	},
	intentions = {
		armor_response = {
			...
			risk = 0.27,
			roles = { "poke", "guard", "combo" },
			actions = { "electron_poke", "metal_dust_aura", "nasod_pressure" },
		},
		projectile_counter = {
			base = 9,
			min_ticks = 7,
			...
			risk = 0.35,
			roles = { "poke", "guard", "chase" },
			actions = { "mega_electronball", "iron_scraps", "dash_catch" },
		},
		blackhole_screen = {
			base = 10,
			min_ticks = 8,
			...
			risk = 0.58,
			roles = { "control", "escape", "burst" },
			actions = { "generate_blackhole", "nasod_reposition", "atomic_blaster" },
		},
		stop_short_guard = {
			base = 11,
			min_ticks = 6,
			...
			conditioning = true,
			roles = { "advance", "guard", "chase" },
			actions = { "proto_advance", "metal_dust_aura", "dash_catch" },
		},
		thorns_punish = {
			base = 8,
			min_ticks = 7,
			...
			risk = 0.4,
			roles = { "control", "guard", "combo" },
			actions = { "thorns_illusion", "iron_scraps", "nasod_pressure" },
		},
		air_counter = {
			base = 9,
			min_ticks = 8,
			...
			risk = 0.48,
			roles = { "air_move", "air", "burst" },
			actions = { "proto_air_entry", "proto_air_combo", "atomic_blaster" },
		},
		guarded_conversion = {
			base = 10,
			min_ticks = 6,
			...
			risk = 0.6,
			roles = { "guard", "combo", "burst" },
			actions = { "iron_scraps", "nasod_pressure", "junk_break" },
		},
		ranged_patience = {
			base = 11,
			min_ticks = 7,
			max_ticks = 15,
			risk = 0.19,
			roles = { "poke", "poke", "escape" },
			actions = { "electron_poke", "mega_electronball", "nasod_reposition" },
		},
		whiff_cashout = {
			base = 8,
			min_ticks = 8,
			...
			risk = 0.63,
			roles = { "guard", "chase", "burst" },
			actions = { "metal_dust_aura", "dash_catch", "junk_break" },
		},
		blackhole_finish = {
			base = 9,
			min_ticks = 6,
			...
			risk = 0.74,
			roles = { "control", "burst", "burst" },
			actions = { "generate_blackhole", "atomic_blaster", "junk_break" },
		},
		approach_recheck = {
			base = 10,
			min_ticks = 7,
			...
			risk = 0.26,
			roles = { "advance", "escape", "control" },
			actions = { "proto_advance", "nasod_reposition", "thorns_illusion" },
		},
		layered_armor_break = {
			base = 11,
			min_ticks = 8,
			...
			risk = 0.36,
			conditioning = true,
			roles = { "guard", "guard", "combo" },
			actions = { "metal_dust_aura", "iron_scraps", "nasod_pressure" },
		},
	},
	action_traits = {
		atomic_blaster = {
	...
	probe_order = { "armor_bait", "projectile_commit", "dash_punish" },
	probes = {
		armor_bait = {
			style = "counter",
			question = "does_armor_representation_draw_an_approach",
			hypothesis = "aggressive_opener",
			expected = "approach",
			actions = { "electron_poke", "metal_dust_aura", "nasod_pressure" },
			risk = 0.21,
			information = 0.88,
		...
		projectile_commit = {
			style = "counter",
			question = "does_projectile_pressure_force_a_burst_spend",
			hypothesis = "burst_spender",
			expected = "counter",
			actions = { "mega_electronball", "iron_scraps", "dash_catch" },
			risk = 0.24,
			information = 0.88,
		...
		dash_punish = {
			style = "counter",
			question = "does_a_stopped_advance_draw_retaliation",
	...
	conditioning_breaks = {
		electron_poke = "proto_advance",
		metal_dust_aura = "dash_catch",
		iron_scraps = "nasod_reposition",
		mega_electronball = "thorns_illusion",
		nasod_pressure = "generate_blackhole",
	},
	fallback_intention = "armor_response",
	error_profile = {
		base = 0.028,
		load_scale = 0.106,
		surprise_scale = 0.047,
		overconfidence_scale = 0.032,
		range_bias = 0.88,
		late_confirm = 0.94,
		familiar_route = 0.96,
		greedy_resource = 0.76,
		stale_read = 1.14,
		overcommit = 0.7,
	},
}
...
function CF_PVP_BOT_Q_PROTO_00_AI_TICK(
	pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE(
		pNPCUnit, PVP_PRO_AI_PROFILE_Q_PROTO_00 )
	PVP_PRO_AI_SET_META_PROFILE(
		pNPCUnit, PVP_PRO_AI_V4_PROFILE_Q_PROTO_00 )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE(
		pNPCUnit, PVP_PRO_AI_V5_PROFILE_Q_PROTO_00 )
	PVP_PRO_AI_SET_COMPETITIVE_PROFILE(
		pNPCUnit, PVP_PRO_AI_V6_PROFILE_Q_PROTO_00 )
	PVP_PRO_AI_SET_RUNTIME_PROFILE(
		pNPCUnit, PVP_PRO_AI_V7_PROFILE_Q_PROTO_00 )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
