...
INIT_STATE =
{
	...
	DAMAGE_EXTRA_STATES         = {"PVP_BOT_APPLE_DAMAGE_AIR_FALL",	"PVP_BOT_APPLE_DAMAGE_AIR_DOWN","PVP_BOT_APPLE_STAND_UP_FRONT","PVP_BOT_APPLE_STAND_UP_BACK",
	...
	SUMMON_END_STATE			= "PVP_BOT_APPLE_DYING_FRONT",
...
PVP_BOT_APPLE_ELECTRONIC_FIELD =
{
	...
	INVINCIBLE			= { 0, 1.733, },
	STOP_OTHER_UNIT0		= { 0.02, 1.3,},--시간 늘리기
