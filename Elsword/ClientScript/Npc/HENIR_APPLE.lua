...
INIT_STATE =
{
	...
	DAMAGE_EXTRA_STATES         = {"PVP_BOT_APPLE_DAMAGE_AIR_DOWN",	"PVP_BOT_APPLE_DAMAGE_AIR_FALL",
	"PVP_BOT_APPLE_STAND_UP_FRONT",	"PVP_BOT_APPLE_STAND_UP_BACK",
