...
ACTIVE_DISTANCE_FROM_USER = 2000

-- 자기 주변에서 heal 할 대상을 찾는 거리
FIND_HEAL_TARGET_DISTANCE = 2000

-- heal을 시작할 대상의 체력 비율
HEAL_TARGET_HP_PERCENT = 0.5
...
INIT_STATE = 
{
	{ STATE_NAME = "PARASITE_EVOLUTION_START",				},
	{ STATE_NAME = "PARASITE_EVOLUTION_WAIT",					},
	{ STATE_NAME = "PARASITE_EVOLUTION_ATTACK",				LUA_STATE_START_FUNC = "PARASITE_EVOLUTION_ATTACK_STATE_START",
	                                                LUA_FRAME_MOVE_FUNC = "PARASITE_EVOLUTION_ATTACK_FRAME_MOVE", STATE_COOL_TIME = 3},
		
	--리액션 관련
	{ STATE_NAME = "PARASITE_EVOLUTION_DAMAGE",				},	
	{ STATE_NAME = "PARASITE_EVOLUTION_DYING",				LUA_STATE_START_FUNC = "PARASITE_EVOLUTION_DYING_STATE_START", },
	{ STATE_NAME = "PARASITE_EVOLUTION_WALK",					},
	{ STATE_NAME = "PARASITE_EVOLUTION_JUMP_UP",				},
	{ STATE_NAME = "PARASITE_EVOLUTION_JUMP_DOWN",			},
	{ STATE_NAME = "PARASITE_EVOLUTION_JUMP_UP_DIR",			},
	{ STATE_NAME = "PARASITE_EVOLUTION_JUMP_DOWN_DIR",		},
	{ STATE_NAME = "PARASITE_EVOLUTION_JUMP_LANDING",			},
	
	{ STATE_NAME = "PARASITE_EVOLUTION_WAKE_UP",				LUA_STATE_START_FUNC = "PARASITE_EVOLUTION_WAKE_UP_STATE_START", },
	{ STATE_NAME = "PARASITE_EVOLUTION_HEAL",						LUA_STATE_START_FUNC = "PARASITE_EVOLUTION_HEAL_STATE_START", },
	
	START_STATE					= "PARASITE_EVOLUTION_START",
	WAIT_STATE					= "PARASITE_EVOLUTION_WAIT",
	
	SMALL_DAMAGE_LAND_FRONT		= "PARASITE_EVOLUTION_DAMAGE",
	SMALL_DAMAGE_LAND_BACK		= "PARASITE_EVOLUTION_DAMAGE",
	BIG_DAMAGE_LAND_FRONT		= "PARASITE_EVOLUTION_DAMAGE",
	BIG_DAMAGE_LAND_BACK		= "PARASITE_EVOLUTION_DAMAGE",
	DOWN_DAMAGE_LAND_FRONT		= "PARASITE_EVOLUTION_DAMAGE",
	DOWN_DAMAGE_LAND_BACK		= "PARASITE_EVOLUTION_DAMAGE",
	FLY_DAMAGE_FRONT			= "PARASITE_EVOLUTION_DAMAGE",
	FLY_DAMAGE_BACK				= "PARASITE_EVOLUTION_DAMAGE",
	SMALL_DAMAGE_AIR			= "PARASITE_EVOLUTION_DAMAGE",	
	BIG_DAMAGE_AIR				= "PARASITE_EVOLUTION_DAMAGE",
	DOWN_DAMAGE_AIR				= "PARASITE_EVOLUTION_DAMAGE",
	UP_DAMAGE					= "PARASITE_EVOLUTION_DAMAGE",
	DAMAGE_REVENGE				= "PARASITE_EVOLUTION_DAMAGE",
	
	DYING_LAND_FRONT			= "PARASITE_EVOLUTION_DYING",
	DYING_LAND_BACK				= "PARASITE_EVOLUTION_DYING",
	DYING_SKY					= "PARASITE_EVOLUTION_DYING",
...
INIT_AI = 
{
	TARGET = 
	{
		...
		MANUAL_TARGETING_FUNC		= "PARASITE_EVOLUTION_MANUAL_TARGET",
	},
...
function PARASITE_EVOLUTION_MANUAL_TARGET( pKTDXApp, pX2Game, pNPCUnit )
    ...
    if pX2Game:AnyUserUnitInRange( pNPCUnit:GetPos(), ACTIVE_DISTANCE_FROM_USER ) then
        ...
        for i=0, nUnitListSize-1 do    
		    ...
		    if pUnit ~= nil then
                ...
                if pUnit:IsUnitID(NPC_UNIT_ID["NUI_NASOD_GUARDIAN_SMALL_P_DIE"]) == true or pUnit:IsUnitID(NPC_UNIT_ID["NUI_NASOD_WATCH_P_DIE"]) == true then
        ...
        if iNearUnit == -1 then
			...
			for i=0, nUnitListSize-1 do    
				...
				if pUnit ~= nil then
	    		    ...
	    		    if pUnit:IsUnitID(NPC_UNIT_ID["NUI_PARASITE_EVOLUTION"]) == false and pUnit:IsUnitID(NPC_UNIT_ID["NUI_PARASITE_HOUSE_EVOLUTION"]) == false then
...
PARASITE_EVOLUTION_START = 
{
	...
	EVENT_PROCESS = 
	{
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],					"PARASITE_EVOLUTION_WAIT",				},
	},
...
function PARASITE_EVOLUTION_WAKE_UP_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
PARASITE_EVOLUTION_WAIT = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PARASITE_EVOLUTION_JUMP_DOWN",					},
		
		{ STATE_CHANGE_TYPE["SCT_AI_WALK"],					"PARASITE_EVOLUTION_WALK",						},
		{ STATE_CHANGE_TYPE["SCT_AI_DASH"],					"PARASITE_EVOLUTION_WALK",						},
		{ STATE_CHANGE_TYPE["SCT_AI_JUMP"],					"PARASITE_EVOLUTION_JUMP_UP",						},
		{ STATE_CHANGE_TYPE["SCT_AI_JUMP_DIR"],				"PARASITE_EVOLUTION_JUMP_UP_DIR",					},
		{ STATE_CHANGE_TYPE["SCT_AI_DOWN"],					"PARASITE_EVOLUTION_JUMP_DOWN",					},
		{ STATE_CHANGE_TYPE["SCT_AI_DOWN_DIR"],				"PARASITE_EVOLUTION_JUMP_DOWN_DIR",				},
		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],		"PARASITE_EVOLUTION_WAKE_UP",						"CF_PARASITE_EVOLUTION_WAKE_UP", },
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],		"PARASITE_EVOLUTION_ATTACK",						"CF_PARASITE_EVOLUTION_ATTACK", },
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],		"PARASITE_EVOLUTION_HEAL",							"CF_PARASITE_EVOLUTION_HEAL", },
		
	},
}

function CF_PARASITE_EVOLUTION_WAKE_UP( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PARASITE_EVOLUTION_ATTACK( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PARASITE_EVOLUTION_HEAL( pKTDXApp, pX2Game, pNPCUnit )
...
function PARASITE_EVOLUTION_HEAL_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
PARASITE_EVOLUTION_WALK = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PARASITE_EVOLUTION_JUMP_DOWN_DIR",				},
		
		{ STATE_CHANGE_TYPE["SCT_AI_WAIT"],					"PARASITE_EVOLUTION_WAIT",						},
		{ STATE_CHANGE_TYPE["SCT_AI_JUMP"],					"PARASITE_EVOLUTION_JUMP_UP",						},
		{ STATE_CHANGE_TYPE["SCT_AI_JUMP_DIR"],				"PARASITE_EVOLUTION_JUMP_UP_DIR",					},
		{ STATE_CHANGE_TYPE["SCT_AI_DOWN"],					"PARASITE_EVOLUTION_JUMP_DOWN",					},
		{ STATE_CHANGE_TYPE["SCT_AI_DOWN_DIR"],				"PARASITE_EVOLUTION_JUMP_DOWN_DIR",				},
...
PARASITE_EVOLUTION_JUMP_UP = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_NEGATIVE_Y_SPEED"],		"PARASITE_EVOLUTION_JUMP_DOWN",				},
	},
}

PARASITE_EVOLUTION_JUMP_DOWN = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= TRUE,
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_TRUE"],		"PARASITE_EVOLUTION_JUMP_LANDING",				},
	},
}

PARASITE_EVOLUTION_JUMP_UP_DIR = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= TRUE,
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_NEGATIVE_Y_SPEED"],		"PARASITE_EVOLUTION_JUMP_DOWN_DIR",				},
	},
}

PARASITE_EVOLUTION_JUMP_DOWN_DIR = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_LOOP"],
	TRANSITION					= TRUE,
...
PARASITE_EVOLUTION_JUMP_LANDING = 
{
	ANIM_NAME					= "Wait",
	PLAY_TYPE					= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	TRANSITION					= TRUE,
...
function PARASITE_EVOLUTION_DYING_STATE_START( pKTDXApp, pX2Game, pNPCUnit )
...
function PARASITE_EVOLUTION_ATTACK_STATE_START( pKTDXApp, pX2Game, pNPCUnit )    
    pos = pNPCUnit:GetPos()
    pos.y = pos.y + 400
    GetMajorParticle = pX2Game:GetMajorParticle()
...
function PARASITE_EVOLUTION_ATTACK_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )    
