...
{
	-- 대기 및 이동
	{ STATE_NAME = "AVALANCHE_START",		},
	{ STATE_NAME = "AVALANCHE_WIN",			},
	{ STATE_NAME = "AVALANCHE_WAIT",		},
	{ STATE_NAME = "AVALANCHE_WALK",		},
	{ STATE_NAME = "AVALANCHE_COMMON_RAGE",	},
	
	{ STATE_NAME = "AVALANCHE_VANISH_START", LUA_STATE_START_FUNC = "AVALANCHE_VANISH_START_FUNC", STATE_COOL_TIME = 5,},
	{ STATE_NAME = "AVALANCHE_VANISH_END",		},
	
	{ STATE_NAME = "AVALANCHE_VANISH_BACK_START",	},
	{ STATE_NAME = "AVALANCHE_VANISH_BACK_END",	 LUA_STATE_END_FUNC = "AVALANCHE_VANISH_BACK_END_END_FUNC",},
		
	-- 공격
	{ STATE_NAME = "AVALANCHE_ATTACK_A",						STATE_COOL_TIME = 6,	},
	{ STATE_NAME = "AVALANCHE_ATTACK_A2",						STATE_COOL_TIME = 6,	},
	{ STATE_NAME = "AVALANCHE_MAGIC_ATTACK_A",			LUA_FRAME_MOVE_FUNC = "AVALANCHE_MAGIC_ATTACK_A_FRAME_MOVE",	STATE_COOL_TIME = 10,	},
	{ STATE_NAME = "AVALANCHE_MAGIC_ATTACK_A_COMBO",	LUA_FRAME_MOVE_FUNC	= "AVALANCHE_MAGIC_ATTACK_A_COMBO_FRAME_MOVE",	},
	{ STATE_NAME = "AVALANCHE_MAGIC_ATTACK_B",			STATE_COOL_TIME = 4,	},
	{ STATE_NAME = "AVALANCHE_MAGIC_ATTACK_C",			LUA_FRAME_MOVE_FUNC = "AVALANCHE_MAGIC_ATTACK_C_FRAME_MOVE",	},
	{ STATE_NAME = "AVALANCHE_MAGIC_ATTACK_D",			LUA_FRAME_MOVE_FUNC = "AVALANCHE_MAGIC_ATTACK_D_FRAME_MOVE",	},
	
	{ STATE_NAME = "AVALANCHE_SIEGE_MODE_A_START",	},
	{ STATE_NAME = "AVALANCHE_SIEGE_MODE_A_LOOP",	LUA_STATE_START_FUNC = "AVALANCHE_SIEGE_MODE_A_LOOP_START_FUNC",
													LUA_FRAME_MOVE_FUNC = "AVALANCHE_SIEGE_MODE_A_LOOP_FRAME_MOVE",	},
	{ STATE_NAME = "AVALANCHE_SIEGE_MODE_A_END", },
	
	-- 데미지
	{ STATE_NAME = "AVALANCHE_DAMAGE_FRONT",	}, 		
	{ STATE_NAME = "AVALANCHE_DAMAGE_BACK",		}, 		
	
	--{ STATE_NAME = "AVALANCHE_DAMAGE_DOWN_FRONT",	},
	--{ STATE_NAME = "AVALANCHE_DAMAGE_DOWN_BACK",	},
	{ STATE_NAME = "AVALANCHE_DYING",	LUA_STATE_START_FUNC = "AVALANCHE_DYING_START_FUNC",
										LUA_FRAME_MOVE_FUNC = "AVALANCHE_DYING_FRAME_MOVE",	 STATE_COOL_TIME = 10,},
			
	START_STATE					= "AVALANCHE_START",
	WAIT_STATE					= "AVALANCHE_WAIT",
	RAGE_STATE					= "AVALANCHE_COMMON_RAGE",
	
	SMALL_DAMAGE_LAND_FRONT		= "AVALANCHE_DAMAGE_FRONT",
	SMALL_DAMAGE_LAND_BACK		= "AVALANCHE_DAMAGE_BACK",
	SMALL_DAMAGE_AIR			= "AVALANCHE_DAMAGE_FRONT",
	
	BIG_DAMAGE_LAND_FRONT		= "AVALANCHE_DAMAGE_FRONT",
	BIG_DAMAGE_LAND_BACK		= "AVALANCHE_DAMAGE_BACK",
	BIG_DAMAGE_AIR				= "AVALANCHE_DAMAGE_FRONT",
	
	DOWN_DAMAGE_LAND_FRONT		= "AVALANCHE_DAMAGE_FRONT",
	DOWN_DAMAGE_LAND_BACK		= "AVALANCHE_DAMAGE_FRONT",
	DOWN_DAMAGE_AIR				= "AVALANCHE_DAMAGE_FRONT",
	
	UP_DAMAGE					= "AVALANCHE_DAMAGE_FRONT",
	
	FLY_DAMAGE_FRONT			= "AVALANCHE_DAMAGE_FRONT",
	FLY_DAMAGE_BACK				= "AVALANCHE_DAMAGE_BACK",
	
	REVENGE_ATTACK				= "",	
	--DAMAGE_REVENGE				= "AVALANCHE_DAMAGE_REVENGE",
	
	DYING_LAND_FRONT			= "AVALANCHE_DYING",
	DYING_LAND_BACK				= "AVALANCHE_DYING",
	DYING_SKY					= "AVALANCHE_DYING",
	
	--DOWN_DAMAGE_AIR_LANDING		= "AVALANCHE_DAMAGE_AIR_DOWN_LANDING",
	COMMON_FRAME_FUNC           = "AVALANCHE_COMMON_FRAME_FUNC",
}
--------------------------------------------------------------------------
INIT_AI = 
{
...
AVALANCHE_START = 
{
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],	"AVALANCHE_WAIT",	},
	},
...
AVALANCHE_WAIT = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"AVALANCHE_WIN",	"CF_AVALANCHE_WIN",	},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"AVALANCHE_ATTACK_A",	"CT_AVALANCHE_ATTACK_A",	},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"AVALANCHE_MAGIC_ATTACK_A",	"CT_AVALANCHE_MAGIC_ATTACK_A",	},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"AVALANCHE_MAGIC_ATTACK_B",	"CT_AVALANCHE_MAGIC_ATTACK_B",	},
		
		{ STATE_CHANGE_TYPE["SCT_AI_WALK"],	"AVALANCHE_WALK",	},
	},
	
	CT_AVALANCHE_ATTACK_A =
	{	-- 근접 공격
		EVENT_INTERVAL_ID			= 0,
		DISTANCE_TO_TARGET_NEAR		= 1000,	
		RATE						= 70,		
	},
	CT_AVALANCHE_MAGIC_ATTACK_A =
	{	-- 칠링 스파인 후 블리자드 샤워
		EVENT_INTERVAL_ID			= 0,
		DISTANCE_TO_TARGET_NEAR		= 1200,	
		RATE						= 60,		
	},
	CT_AVALANCHE_MAGIC_ATTACK_B =
	{	-- 얼음 창
		EVENT_INTERVAL_ID			= 0,
		DISTANCE_TO_TARGET_NEAR		= 1200,	
		RATE						= 60,		
...
function CF_AVALANCHE_WIN( pKTDXApp, pX2Game, pNPCUnit )
...
AVALANCHE_DAMAGE_FRONT = 
{
	...
	{
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],	"AVALANCHE_WAIT",	},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],		"AVALANCHE_ATTACK_A2",		"CT_AVALANCHE_ATTACK_A2",	},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],		"AVALANCHE_MAGIC_ATTACK_A",	"CT_AVALANCHE_MAGIC_ATTACK_A",	},	
		
	},
	CT_AVALANCHE_ATTACK_A2 =
	{	-- 근접 공격
		EVENT_INTERVAL_ID			= 0,
...
function AVALANCHE_DYING_START_FUNC( pKTDXApp, pX2Game, pNPCUnit )
	...
	if pMajorXMeshPlayer ~= nil then
		...
		pMajorXMeshPlayer:CreateInstance_LUA( "Mesh_AVALANCHE_Dying_Wand", vPos, rotDegree, rotDegree, 14 )
	end
...
function AVALANCHE_DYING_FRAME_MOVE( pKTDXApp, pX2Game, pNPCUnit )
	if pNPCUnit:AnimEventTimer_LUA( 2.95 ) then
		...
		local pMajorXMeshPlayer = pX2Game:GetMajorXMeshPlayer()
			...
			pMajorXMeshPlayer:CreateInstance_LUA( "Mesh_AVALANCHE_Dying", vPos, rotDegree, rotDegree, 14 )
		end
	end
end
--------------------------------------------------------------------------
...
AVALANCHE_MAGIC_ATTACK_A =
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],		"AVALANCHE_MAGIC_ATTACK_A_COMBO",	"CT_AVALANCHE_MAGIC_ATTACK_A_COMBO",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],			"AVALANCHE_WAIT",	},
	},
	
	CT_AVALANCHE_MAGIC_ATTACK_A_COMBO =
	{
		ANIM_PLAY_COUNT		= 1,
		RATE				= 100,
	},
...
function AVALANCHE_MAGIC_ATTACK_A_FRAME_MOVE( pKTDApp, pX2Game, pNPCUnit )
...
--------------------------------------------------------------------------
AVALANCHE_MAGIC_ATTACK_A_COMBO =
{
...
function AVALANCHE_MAGIC_ATTACK_A_COMBO_FRAME_MOVE( pKTDApp, pX2Game, pNPCUnit )
...
function CallBlizzard( pX2Game, pNPCUnit, iRange )
	...
	if pDamageEffect ~= nil then
		pDamageEffect:CreateInstance_LUA2( pNPCUnit, "AVALANCHE_MAGIC_ATTACK_A_COMBO", posR, landPos1.y, vRot)
	end
end
--------------------------------------------------------------------------
AVALANCHE_MAGIC_ATTACK_B =
{
...
AVALANCHE_MAGIC_ATTACK_C =
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],		"AVALANCHE_MAGIC_ATTACK_D",	"CT_AVALANCHE_MAGIC_ATTACK_D",	},
	},
	
	CT_AVALANCHE_MAGIC_ATTACK_D =
	{
		ANIM_PLAY_COUNT		= 1,
		RATE				= 100,
	},
...
function AVALANCHE_MAGIC_ATTACK_C_FRAME_MOVE( pKTDApp, pX2Game, pNPCUnit )
	...
	if pNPCUnit:AnimEventTimer_LUA( 1.768 ) then
		pX2Game:KillNPC( NPC_UNIT_ID["NUI_AVALANCHE_ICE_PILLAR_BIG"], 3 )
		pX2Game:KillNPC( NPC_UNIT_ID["NUI_AVALANCHE_ICE_PILLAR_SMALL"], 3 )
			
		-- 라인 맵 위치 얻어 오기
		local randNum = pNPCUnit:GetRandVal() % 3 + 1
		local vPos = pX2Game:GetLineMap():GetStartPosition( ArrPillarPosB1[randNum] )
		pX2Game:CreateNPCReq_LUA( NPC_UNIT_ID["NUI_AVALANCHE_ICE_PILLAR_BIG"], pNPCUnit:GetHardLevel(), false, vPos, true, 0.01, true  )
		
		vPos = pX2Game:GetLineMap():GetStartPosition( ArrPillarPosB2[randNum] )
		pX2Game:CreateNPCReq_LUA( NPC_UNIT_ID["NUI_AVALANCHE_ICE_PILLAR_BIG"], pNPCUnit:GetHardLevel(), false, vPos, true, 0.02, true  )
		...
		pX2Game:CreateNPCReq_LUA( NPC_UNIT_ID["NUI_AVALANCHE_ICE_PILLAR_SMALL"], pNPCUnit:GetHardLevel(), false, vPos, true, 0.03, true  )
		
		vPos = pX2Game:GetLineMap():GetStartPosition( ArrPillarPosS2[randNum] )
		pX2Game:CreateNPCReq_LUA( NPC_UNIT_ID["NUI_AVALANCHE_ICE_PILLAR_SMALL"], pNPCUnit:GetHardLevel(), false, vPos, true, 0.01, true  )
		
		vPos = pX2Game:GetLineMap():GetStartPosition( ArrPillarPosS3[randNum] )
		pX2Game:CreateNPCReq_LUA( NPC_UNIT_ID["NUI_AVALANCHE_ICE_PILLAR_SMALL"], pNPCUnit:GetHardLevel(), false, vPos, true, 0.02, true  )
...
function AVALANCHE_MAGIC_ATTACK_D_FRAME_MOVE( pKTDApp, pX2Game, pNPCUnit )
	-- 얼음 폭탄 소환
...
AVALANCHE_VANISH_START = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"AVALANCHE_VANISH_END",	"CF_AVALANCHE_VANISH_END",	},
	},
}

function CF_AVALANCHE_VANISH_END( pKTDApp, pX2Game, pNPCUnit )
	if pNPCUnit:AnimEventTimer_LUA( 1.2 ) then
...
function AVALANCHE_VANISH_START_FUNC( pKTDApp, pX2Game, pNPCUnit )
...
AVALANCHE_VANISH_END = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"AVALANCHE_SIEGE_MODE_A_START",	"CT_AVALANCHE_SIEGE_MODE_A_START",	},
	},
	
	CT_AVALANCHE_SIEGE_MODE_A_START = 
	{
		ANIM_PLAY_COUNT		= 1,
	},
}
--------------------------------------------------------------------------
AVALANCHE_SIEGE_MODE_A_START = 
{
	ANIM_NAME	= "SigeModeA",
	PLAY_TYPE	= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	TRANSITION	= FALSE,
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"AVALANCHE_SIEGE_MODE_A_LOOP",	"CT_AVALANCHE_SIEGE_MODE_A_LOOP",	},
	},
	
	CT_AVALANCHE_SIEGE_MODE_A_LOOP = 
	{
		ANIM_PLAY_COUNT		= 1,
	},
}
--------------------------------------------------------------------------
AVALANCHE_SIEGE_MODE_A_LOOP = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"AVALANCHE_SIEGE_MODE_A_END",	"CT_AVALANCHE_SIEGE_MODE_A_END",	},
	},
	
	CT_AVALANCHE_SIEGE_MODE_A_END =
	{
		STATE_TIME_OVER	= 20,
	},
}

function AVALANCHE_SIEGE_MODE_A_LOOP_START_FUNC( pKTDApp, pX2Game, pNPCUnit )
	if nil ~= pNPCUnit then
		local vPos = D3DXVECTOR3( -1084, 7113, -4280 )
		pX2Game:CreateNPCReq_LUA( NPC_UNIT_ID["NUI_AVALANCHE_STATUE"], pNPCUnit:GetHardLevel(), false, vPos, true, 0.01, true  )
...
function AVALANCHE_SIEGE_MODE_A_LOOP_FRAME_MOVE( pKTDApp, pX2Game, pNPCUnit )
	if pNPCUnit:AnimEventTimer_LUA( 0.1 ) then
		...
		if pMajorXMeshPlayer ~= nil then
			...
			pMajorXMeshPlayer:CreateInstance_LUA( "Mesh_AVALANCHE_MaD_Statue_Ice_Sphere", vPos, rotDegree, rotDegree, 14 )
		end
...
AVALANCHE_SIEGE_MODE_A_END = 
{
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],	"AVALANCHE_VANISH_BACK_START",	},
	},
}
--------------------------------------------------------------------------
AVALANCHE_VANISH_BACK_START = 
{
	ANIM_NAME	= "Vanish_Start",
	PLAY_TYPE	= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	TRANSITION	= FALSE,
	...
	EVENT_PROCESS = 
	{	
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"AVALANCHE_VANISH_BACK_END",	"CF_AVALANCHE_VANISH_BACK_END",	},
	},
}

function CF_AVALANCHE_VANISH_BACK_END( pKTDApp, pX2Game, pNPCUnit )
	if pNPCUnit:AnimEventTimer_LUA( 1.2 ) then
...
function AVALANCHE_VANISH_BACK_END_END_FUNC( pKTDApp, pX2Game, pNPCUnit )
	if nul ~= pNPCUnit then
		pNPCUnit:SetInt_LUA( 1, 0 )
	end
end
--------------------------------------------------------------------------
AVALANCHE_COMMON_RAGE =
{
	ANIM_NAME		= "Wait",
	PLAY_TYPE		= XSKIN_ANIM_PLAYTYPE["XAP_ONE_WAIT"],
	TRANSITION		= FALSE,
	...
	EVENT_PROCESS = 
	{		
		{ STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],	"AVALANCHE_MAGIC_ATTACK_C",	"CT_AVALANCHE_MAGIC_ATTACK_C",	},
	},
	
	CT_AVALANCHE_MAGIC_ATTACK_C =
	{
		EVENT_INTERVAL_ID	= 0,
		RATE				= 100,
	},
...
--------------------------------------------------------------------------
function AVALANCHE_COMMON_FRAME_FUNC( pKTDApp, pX2Game, pNPCUnit )
	if nil ~= pNPCUnit then
		local maxHP = pNPCUnit:GetMaxHP()	
		-- 
		if pNPCUnit:GetInt_LUA( 1 ) == 0 then 		
			if pNPCUnit:GetInt_LUA( 0 ) == 0 then
				if pNPCUnit:GetNowHP() < maxHP * 0.75 then
					pNPCUnit:StateChange_LUA( "AVALANCHE_VANISH_START", false )
				end
			elseif pNPCUnit:GetInt_LUA( 0 ) == 1 then
			...
			elseif pNPCUnit:GetInt_LUA( 0 ) == 2 then
				if pNPCUnit:GetNowHP() < maxHP * 0.25 then
					pNPCUnit:StateChange_LUA( "AVALANCHE_VANISH_START", false )
				end
			end		
		end
