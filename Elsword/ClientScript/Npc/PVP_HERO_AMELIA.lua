...
PVP_BOT_AMELIA_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_AMELIA_WAIT",	"CF_PVP_BOT_AMELIA_AI_TICK",							},
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_Aero_Strafe",    		 	"CF_PVP_BOT_AMELIA_AERO_STRAFE",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_GUIDED_ARROW",    		 	"CF_PVP_BOT_AMELIA_GUIDED_ARROW",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_Aero_Tornado",    		 	"CF_PVP_BOT_AMELIA_AERO_TORNADO",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_DASH_JUMP_UP_for_DashJump_X",   	 "CF_PVP_BOT_AMELIA_AIR_DROP",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_JUMP_UP_DIR_for_Jump_X",   	 "CF_PVP_BOT_AMELIA_VERTICAL_INTERCEPT",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_Spread_Shot",   	 		"CF_PVP_BOT_AMELIA_SPREAD_SHOT",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_Wind_Ward",    		 		"CF_PVP_BOT_AMELIA_WIND_WARD",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_Humming_Wind",   		  	"CF_PVP_BOT_AMELIA_HUMMING_WIND",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_Reflect_Kick_READY",     	"CF_PVP_BOT_AMELIA_REFLECT_KICK",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_Back_Tumbling_Shot",     	"CF_PVP_BOT_AMELIA_TUMBLING_SHOT",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_BACKWARD_DashX",     		"CF_PVP_BOT_AMELIA_BACKDASH_ARROW",           	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_DashX",     				"CF_PVP_BOT_AMELIA_DASH_ARROW",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_DashComboZ",     			"CF_PVP_BOT_AMELIA_CATCH",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_ComboX",     				"CF_PVP_BOT_AMELIA_POKE",       	     	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_AMELIA_WALK",         				"CT_PVP_BOT_AMELIA_WALK",       		    },
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_DASH",         				"CF_PVP_BOT_AMELIA_ADVANCE",       		    },
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_DashJump",          		"CF_PVP_BOT_AMELIA_AERIAL_ENTRY",      			},
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"], "PVP_BOT_AMELIA_BACKWARD_DASH_READY",     	"CF_PVP_BOT_AMELIA_BACKWARD_DASH",   	},
...
PVP_BOT_AMELIA_STANDUP_WAIT =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_AMELIA_STANDUP_WAIT",	"CF_PVP_BOT_AMELIA_AI_TICK",						},
		{ STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],	"PVP_BOT_AMELIA_BOOST_POWER",	"CF_PVP_BOT_AMELIA_BOOST_POWER",					},
...
PVP_BOT_AMELIA_WALK =
{
	...
	EVENT_PROCESS =
	{
       ...
       -- { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_AMELIA_Entangle",    		 	"CT_PVP_BOT_AMELIA_Entangle",           	},
        ...
        -- { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"], "PVP_BOT_AMELIA_BACKWARD_DASH_READY",         			"CT_PVP_BOT_AMELIA_WAIT",       		    },
...
PVP_BOT_AMELIA_ComboX =
{
	...
	EVENT_PROCESS =
	{
		...
		{ STATE_CHANGE_TYPE["SCT_FOOT_ON_LINE_FALSE_DOWN"],	"PVP_BOT_AMELIA_JUMP_DOWN_ACT",	},
		{ STATE_CHANGE_TYPE["SCT_MOTION_END"],				"PVP_BOT_AMELIA_BACKWARD_DASH_READY",		},
	},
...
PVP_BOT_AMELIA_ComboXX =
{
	...
	EVENT_PROCESS =
	{
        ...
        { STATE_CHANGE_TYPE["SCT_CONDITION_FUNCTION"],			"PVP_BOT_AMELIA_BACKWARD_DASH_READY",	"CF_PVP_BOT_AMELIA_COMBO_RESET",	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"PVP_BOT_AMELIA_BACKWARD_DASH_READY",	"CT_PVP_BOT_AMELIA_WAIT2",	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"PVP_BOT_AMELIA_BACKWARD_DASH_READY",	"CT_PVP_BOT_AMELIA_WAIT3",	},
        { STATE_CHANGE_TYPE["SCT_CONDITION_TABLE"],			"PVP_BOT_AMELIA_ComboX",	"CT_PVP_BOT_AMELIA_ComboX",	},
...
function CF_PVP_BOT_AMELIA_GUIDED_ARROW( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_AMELIA_FREEZING_ARROW( pKTDXApp, pX2Game, pNPCUnit )

	local mp = pNPCUnit:GetNowMP()

	if mp < 200 then return false end
...
function CF_PVP_BOT_AMELIA_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_AMELIA_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
...
function CF_PVP_BOT_AMELIA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end

function CF_PVP_BOT_AMELIA_AERO_STRAFE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "aero_strafe", "burst", 0, 390, 200, 36, 18 )
end

function CF_PVP_BOT_AMELIA_GUIDED_ARROW( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "guided_arrow", "control", 360, 1250, 200, 42, 16 )
end

function CF_PVP_BOT_AMELIA_CATCH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "dash_catch", "combo", 140, 500, 0, 43, 7 )
end

function CF_PVP_BOT_AMELIA_POKE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "arrow_poke", "poke", 280, 900, 0, 38, 6 )
end

function CF_PVP_BOT_AMELIA_BACKWARD_DASH( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "spacing_retreat", "escape", 0, 340, 0, 30, 7 )
end
...
function CF_PVP_BOT_AMELIA_COMBO_RESET( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, 520, 34 )
end
...
function PVP_PRO_AI_TICK( pX2Game, pNPCUnit, reactionMin, reactionMax )
	...
	if targetHP ~= nil then
		if memory.target_hp_max == nil or targetHP > memory.target_hp_max then
			memory.target_hp_max = targetHP
		end
...
function PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, action, role, minDist, maxDist, minMP, chance, cooldown )
	...
	if minMP > 0 then
		...
		if remaining < memory.reserve_mp then
			...
			if role == "burst" and ( targetLow or hpRate < 0.27 ) then
				chance = chance + penalty * 0.35
			else
...
function PVP_PRO_AI_COMBO_RESET( pX2Game, pNPCUnit, resetRange, baseChance )
	...
	if result == true then
		if hitConfirmed == true then memory.plan = "bait"
		else memory.plan = "recover" end
...
function CF_PVP_BOT_AMELIA_AERO_TORNADO( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "aero_tornado", "burst", 0, 760, 299, 46, 26 )
end

function CF_PVP_BOT_AMELIA_SPREAD_SHOT( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "spread_shot", "control", 370, 1290, 80, 44, 9 )
end

function CF_PVP_BOT_AMELIA_WIND_WARD( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "wind_ward", "guard", 0, 540, 200, 39, 18 )
end

function CF_PVP_BOT_AMELIA_HUMMING_WIND( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "humming_wind", "control", 180, 940, 100, 34, 12 )
end

function CF_PVP_BOT_AMELIA_REFLECT_KICK( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "reflect_kick", "guard", 0, 430, 60, 43, 11 )
end

function CF_PVP_BOT_AMELIA_TUMBLING_SHOT( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "tumbling_shot", "escape", 0, 620, 50, 35, 9 )
end

function CF_PVP_BOT_AMELIA_ADVANCE( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "ranger_advance", "advance", 390, 1600, 0, 50, 3 )
end

function CF_PVP_BOT_AMELIA_AERIAL_ENTRY( pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE( pX2Game, pNPCUnit, "ranger_air_entry", "air_move", 300, 1220, 0, 33, 6 )
end
...
PVP_PRO_AI_PROFILE_AMELIA = {
	name = "precision_ranger",
	preferred_range = 610,
	aggression = 0.96,
	discipline = 1.18,
	volatility = 4,
	role_bias = { poke = 6, control = 6, guard = 3, air = 3, escape = 1, combo = -2 },
	openers = { spread_shot = 5, arrow_poke = 4, humming_wind = 3 },
	finishers = { aero_tornado = 12, aero_strafe = 8, guided_arrow = 6 },
	mixups = { reflect_kick = 7, tumbling_shot = 6, wind_ward = 5, dash_catch = 4 },
}

function CF_PVP_BOT_AMELIA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_AMELIA )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V4_PROFILE_AMELIA = {
	name = "foresight_ranger",
	patience = 1.35,
	risk = 0.88,
	creativity = 4,
	condition_limit = 2,
	...
	reset_role = "escape",
	counter_roles = {
		approach = "guard", retreat = "poke", jump = "air_move",
	...
	signature = {
		spread_shot = 5, guided_arrow = 4, reflect_kick = 5,
		tumbling_shot = 4, aero_tornado = 7,
	},
	engagement_bias = { probe = 3, trap = 5, scramble = -2 },
}

function CF_PVP_BOT_AMELIA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_AMELIA )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_AMELIA )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V5_PROFILE_AMELIA = {
	name = "tournament_foresight_ranger",
	read_skill = 0.91,
	exploration = 0.92,
	commitment = 0.92,
	...
	actions = {
		download = { "arrow_poke", "spread_shot", "humming_wind" },
		outplay = { "arrow_poke", "reflect_kick", "humming_wind", "dash_catch" },
		pressure = { "spread_shot", "dash_catch", "aero_strafe" },
		deny = { "guided_arrow", "spread_shot", "ranger_advance" },
		stabilize = { "tumbling_shot", "reflect_kick", "arrow_poke" },
		survive = { "tumbling_shot", "wind_ward", "reflect_kick" },
		finish = { "guided_arrow", "dash_catch", "aero_tornado", "aero_strafe" },
	},
	action_prior = {
		arrow_poke = 3, spread_shot = 4, reflect_kick = 4,
		dash_catch = 4, aero_tornado = 7, tumbling_shot = 3,
	},
	goal_bias = {
		download = 2, outplay = 4, pressure = 2,
		deny = 4, stabilize = 3, finish = 4,
	},
	finisher_actions = { "aero_tornado", "aero_strafe", "guided_arrow" },
}

function CF_PVP_BOT_AMELIA_AI_TICK( pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE( pNPCUnit, PVP_PRO_AI_PROFILE_AMELIA )
	PVP_PRO_AI_SET_META_PROFILE( pNPCUnit, PVP_PRO_AI_V4_PROFILE_AMELIA )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE( pNPCUnit, PVP_PRO_AI_V5_PROFILE_AMELIA )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
...
PVP_PRO_AI_V6_PROFILE_AMELIA = {
	character = "amelia",
	identity = "patient_foresight_analyst",
	identity_mode = "patient_analyst",
	probe_style = "observation",
	preferred_min = 360,
	preferred_max = 830,
	vertical_tolerance = 155,
	resource_target = 180,
	reset_threshold = 0.63,
	adaptation_rate = 1.16,
	strategy_hysteresis = 6,
	default_tempo = "measured_neutral",
	strategy_order = {
		"lane_denial_analysis",
		"defensive_resource_exhaustion",
		"mana_patience",
		"lead_variance_control",
		"survival_recovery",
		"precision_finish",
	},
	strategies = {
		lane_denial_analysis = {
			base = 10, min_ticks = 52, max_ticks = 94,
			v5_goal = "deny", tempo = "slow_observation",
			hypothesis = "repetitive_approach",
			hypothesis_weight = 8,
			drivers = {
				uncertainty = 0.48, spacing = 0.62,
				vertical = 0.45, change = 0.35,
			},
			plans = {
				"map_entry_reactions",
				"funnel_preferred_lane",
				"whiff_punish_window",
			},
		},
		defensive_resource_exhaustion = {
			base = 11, min_ticks = 48, max_ticks = 88,
			v5_goal = "outplay", tempo = "measured_neutral",
			hypothesis = "panic_escape",
			hypothesis_weight = 11,
			drivers = {
				initiative = 0.62, yield = 0.66,
				uncertainty = 0.25,
			},
			plans = {
				"safe_pressure_layers",
				"leave_controlled_escape_gap",
				"chase_spent_escape",
			},
		},
		mana_patience = {
			base = 10.5, min_ticks = 44, max_ticks = 82,
			v5_goal = "stabilize", tempo = "controlled_reset",
			drivers = {
				resource = 1.28, spacing = 0.42,
				survival = 0.20,
			},
			plans = {
				"rebuild_mana_spacing",
				"represent_skill_lane",
				"funnel_preferred_lane",
			},
		},
		lead_variance_control = {
			base = 9, min_ticks = 58, max_ticks = 108,
			v5_goal = "stabilize",
			tempo = "lead_preserving_slowdown",
			drivers = {
				lead = 1.38, spacing = 0.48,
				survival = 0.30,
			},
			plans = {
				"preserve_health_lead",
				"map_entry_reactions",
				"adaptation_recheck",
			},
		},
		survival_recovery = {
			base = 6, min_ticks = 30, max_ticks = 62,
			v5_goal = "survive", tempo = "controlled_reset",
			drivers = {
				survival = 1.55, resource = 0.45,
				spacing = 0.72,
			},
			plans = {
				"preserve_health_lead",
		...
		precision_finish = {
			base = 6, min_ticks = 28, max_ticks = 58,
			v5_goal = "finish", tempo = "sudden_burst",
			drivers = {
				lethal = 1.65, behind = 0.36,
				initiative = 0.52,
			},
			plans = {
				"confirmed_cashout",
	...
	plans = {
		map_entry_reactions = {
			base = 10, min_ticks = 18, max_ticks = 34,
			probe = true, position = true,
			tempo = "slow_observation",
			roles = { "poke", "guard", "control" },
			intentions = {
				"safe_arrow_probe", "dash_stop_counter",
			},
		},
		funnel_preferred_lane = {
			base = 9, min_ticks = 20, max_ticks = 38,
			position = true, pressure = true,
			tempo = "measured_neutral",
			roles = { "control", "poke", "air_move" },
			intentions = {
				"lane_funnel", "vertical_rotation", "aerial_drop_mix",
			},
		},
		whiff_punish_window = {
			base = 8, min_ticks = 17, max_ticks = 32,
			condition = true, yield_initiative = true,
			tempo = "slow_observation",
			roles = { "guard", "escape", "combo" },
			intentions = {
				"dash_stop_counter", "retreat_reentry",
			},
		},
		safe_pressure_layers = {
			base = 9, min_ticks = 18, max_ticks = 35,
			pressure = true, condition = true,
			tempo = "sustained_pressure",
			roles = { "poke", "control", "combo" },
			intentions = {
				"delayed_pressure", "positional_conversion",
			},
		},
		leave_controlled_escape_gap = {
			base = 8, min_ticks = 16, max_ticks = 30,
			probe = true, condition = true,
			yield_initiative = true,
			tempo = "measured_neutral",
			roles = { "poke", "escape", "chase" },
			intentions = {
				"escape_gap_test", "retreat_reentry",
			},
		},
		chase_spent_escape = {
			base = 8, min_ticks = 14, max_ticks = 28,
			pressure = true,
			tempo = "sudden_burst",
			roles = { "control", "advance", "combo" },
			intentions = {
				"spent_escape_chase", "positional_conversion",
			},
		},
		rebuild_mana_spacing = {
			base = 10, min_ticks = 20, max_ticks = 40,
			resource = true, reset = true, survival = true,
			tempo = "controlled_reset",
			roles = { "escape", "poke", "guard" },
			intentions = {
				"spacing_rebuild", "resource_hold",
			},
		},
		represent_skill_lane = {
			base = 8, min_ticks = 18, max_ticks = 32,
			position = true,
			tempo = "measured_neutral",
			roles = { "control", "guard", "poke" },
			intentions = {
				"lane_funnel", "resource_hold",
			},
		},
		preserve_health_lead = {
			base = 11, min_ticks = 22, max_ticks = 44,
			reset = true, survival = true,
			tempo = "lead_preserving_slowdown",
			roles = { "escape", "guard", "poke" },
			intentions = {
				"spacing_rebuild", "safe_arrow_probe",
			},
		},
		adaptation_recheck = {
			base = 7, min_ticks = 16, max_ticks = 30,
			probe = true, changeup = true,
			tempo = "slow_observation",
			roles = { "poke", "air_move", "control" },
			intentions = {
				"change_detection_probe", "vertical_rotation",
				"aerial_drop_mix",
			},
		},
		confirmed_cashout = {
			base = 12, min_ticks = 12, max_ticks = 25,
			cashout = true, pressure = true,
			tempo = "sudden_burst",
			roles = { "control", "combo", "burst" },
			intentions = {
				"reliable_cashout", "guarded_finish",
			},
		},
	},
	intentions = {
		safe_arrow_probe = {
			base = 10, min_ticks = 7, max_ticks = 13,
			risk = 0.18,
			roles = { "poke", "escape", "guard" },
			actions = {
				"arrow_poke", "spacing_retreat", "reflect_kick",
			},
		},
		dash_stop_counter = {
			base = 9, min_ticks = 7, max_ticks = 14,
			risk = 0.34, conditioning = true,
			roles = { "advance", "guard", "combo" },
			actions = {
				"ranger_advance", "reflect_kick", "dash_catch",
			},
		},
		lane_funnel = {
			base = 10, min_ticks = 8, max_ticks = 15,
			risk = 0.28,
			roles = { "control", "control", "poke" },
			actions = {
				"spread_shot", "humming_wind", "arrow_poke",
			},
		},
		vertical_rotation = {
			base = 8, min_ticks = 7, max_ticks = 14,
			risk = 0.30,
			roles = { "air_move", "air", "control", "escape" },
			actions = {
				"ranger_air_entry", "ranger_vertical_intercept",
				"guided_arrow", "spacing_retreat",
			},
		},
		aerial_drop_mix = {
			base = 8, min_ticks = 7, max_ticks = 14,
			risk = 0.34, conditioning = true,
			roles = { "air", "control", "poke" },
			actions = {
				"ranger_air_drop", "spread_shot", "arrow_poke",
			},
		},
		retreat_reentry = {
			base = 8, min_ticks = 7, max_ticks = 13,
			risk = 0.30, conditioning = true,
			roles = { "poke", "poke", "advance" },
			actions = {
				"backdash_arrow", "arrow_poke", "ranger_advance",
			},
		},
		delayed_pressure = {
			base = 9, min_ticks = 8, max_ticks = 15,
			risk = 0.38, conditioning = true,
			roles = { "poke", "control", "combo" },
			actions = {
				"arrow_poke", "spread_shot", "dash_catch",
			},
		},
		positional_conversion = {
			base = 8, min_ticks = 7, max_ticks = 14,
			risk = 0.42,
			roles = { "chase", "combo", "burst", "escape" },
			actions = {
				"dash_arrow", "dash_catch",
				"aero_strafe", "tumbling_shot",
			},
		},
		escape_gap_test = {
			base = 9, min_ticks = 7, max_ticks = 14,
			risk = 0.26, conditioning = true,
			roles = { "poke", "escape", "combo" },
			actions = {
				"arrow_poke", "spacing_retreat", "dash_catch",
			},
		},
		spent_escape_chase = {
			base = 9, min_ticks = 7, max_ticks = 13,
			risk = 0.40,
			roles = { "control", "advance", "combo" },
			actions = {
				"spread_shot", "ranger_advance", "dash_catch",
			},
		},
		spacing_rebuild = {
			base = 11, min_ticks = 8, max_ticks = 16,
			risk = 0.16,
			roles = { "escape", "poke", "guard" },
			actions = {
				"tumbling_shot", "arrow_poke", "wind_ward",
			},
		},
		resource_hold = {
			base = 9, min_ticks = 8, max_ticks = 15,
			risk = 0.18,
			roles = { "escape", "control", "guard" },
			actions = {
				"spacing_retreat", "humming_wind", "reflect_kick",
			},
		},
		change_detection_probe = {
			base = 9, min_ticks = 7, max_ticks = 14,
			risk = 0.22,
			roles = { "poke", "air_move", "control" },
			actions = {
				"arrow_poke", "ranger_air_entry", "spread_shot",
			},
		},
		reliable_cashout = {
			base = 12, min_ticks = 6, max_ticks = 12,
			risk = 0.58,
			roles = { "control", "burst", "burst" },
			actions = {
				"guided_arrow", "aero_strafe", "aero_tornado",
			},
		},
		guarded_finish = {
			base = 10, min_ticks = 6, max_ticks = 12,
			risk = 0.46,
			roles = { "guard", "combo", "burst" },
			actions = {
				"wind_ward", "dash_catch", "aero_strafe",
			},
		},
	},
	action_traits = {
		aero_strafe = {
			role = "burst", min_dist = 0, max_dist = 390, mp = 200,
			commitment = 0.72, reliability = 0.72, risk = 0.62,
			knockdown = 0.24, conversion = 0.86, carry = 0.35,
		},
		guided_arrow = {
			role = "control", min_dist = 360, max_dist = 1250, mp = 200,
			commitment = 0.54, reliability = 0.78, risk = 0.38,
			knockdown = 0.11, conversion = 0.64,
			vertical_control = true, safe_pressure = true,
		},
		dash_catch = {
			role = "combo", min_dist = 140, max_dist = 500, mp = 0,
			commitment = 0.58, reliability = 0.69, risk = 0.48,
			knockdown = 0.14, conversion = 0.90, carry = 0.52,
			resource_gain = 0.35,
		},
		arrow_poke = {
			role = "poke", min_dist = 280, max_dist = 900, mp = 0,
			commitment = 0.18, reliability = 0.83, risk = 0.15,
			knockdown = 0.05, conversion = 0.34,
			resource_gain = 0.52, safe_pressure = true,
		},
		spacing_retreat = {
			role = "escape", min_dist = 0, max_dist = 340, mp = 0,
			commitment = 0.14, reliability = 0.80, risk = 0.14,
			knockdown = 0, conversion = 0.12,
		},
		aero_tornado = {
			role = "burst", min_dist = 0, max_dist = 760, mp = 299,
			commitment = 0.88, reliability = 0.66, risk = 0.75,
			knockdown = 0.31, conversion = 0.95, carry = 0.60,
			vertical_control = true,
		},
		spread_shot = {
			role = "control", min_dist = 370, max_dist = 1290, mp = 80,
			commitment = 0.34, reliability = 0.78, risk = 0.28,
			knockdown = 0.09, conversion = 0.48,
			safe_pressure = true,
		},
		wind_ward = {
			role = "guard", min_dist = 0, max_dist = 540, mp = 200,
			commitment = 0.36, reliability = 0.76, risk = 0.27,
			knockdown = 0.08, conversion = 0.38,
		},
		humming_wind = {
			role = "control", min_dist = 180, max_dist = 940, mp = 100,
			commitment = 0.38, reliability = 0.74, risk = 0.31,
			knockdown = 0.10, conversion = 0.56,
			safe_pressure = true,
		},
		reflect_kick = {
			role = "guard", min_dist = 0, max_dist = 430, mp = 60,
			commitment = 0.29, reliability = 0.73, risk = 0.26,
			knockdown = 0.08, conversion = 0.62,
		},
		tumbling_shot = {
			role = "escape", min_dist = 0, max_dist = 620, mp = 50,
			commitment = 0.24, reliability = 0.81, risk = 0.19,
			knockdown = 0.05, conversion = 0.28,
		},
		ranger_advance = {
			role = "advance", min_dist = 390, max_dist = 1600, mp = 0,
			commitment = 0.30, reliability = 0.79, risk = 0.24,
			knockdown = 0, conversion = 0.46,
			resource_gain = 0.18,
		},
		ranger_air_entry = {
			role = "air_move", min_dist = 300, max_dist = 1220, mp = 0,
			commitment = 0.33, reliability = 0.70, risk = 0.32,
			knockdown = 0, conversion = 0.48,
			vertical = 520, vertical_control = true,
		},
		ranger_air_drop = {
			role = "air", min_dist = 550, max_dist = 1200, mp = 0,
			commitment = 0.47, reliability = 0.66, risk = 0.39,
			knockdown = 0.13, conversion = 0.65, carry = 0.42,
			vertical = 560, vertical_control = true,
		},
		ranger_vertical_intercept = {
			role = "air", min_dist = 0, max_dist = 1200, mp = 0,
			commitment = 0.44, reliability = 0.68, risk = 0.37,
			knockdown = 0.12, conversion = 0.67, carry = 0.35,
			vertical = 560, vertical_control = true,
		},
		backdash_arrow = {
			role = "poke", min_dist = 0, max_dist = 600, mp = 0,
			commitment = 0.23, reliability = 0.76, risk = 0.20,
			knockdown = 0.06, conversion = 0.38,
			resource_gain = 0.30, safe_pressure = true,
		},
		dash_arrow = {
			role = "chase", min_dist = 0, max_dist = 350, mp = 0,
			commitment = 0.46, reliability = 0.69, risk = 0.40,
			knockdown = 0.12, conversion = 0.72, carry = 0.40,
			resource_gain = 0.22,
		},
	},
	probe_order = {
		"stop_short_retaliation",
		"controlled_escape_gap",
		"repeat_lane_entry",
	},
	probes = {
		stop_short_retaliation = {
			style = "observation",
			question = "does_the_opponent_counter_a_stopped_approach",
			hypothesis = "reactive_counter",
			expected = "counter",
			actions = {
				"ranger_advance", "reflect_kick", "arrow_poke",
			},
			risk = 0.22, information = 0.92, cost = 0.18,
			max_repetitions = 2, stop_confidence = 0.66,
			duration = 18,
		},
		controlled_escape_gap = {
			style = "conditioning",
			question = "does_the_opponent_escape_after_safe_pressure",
			hypothesis = "panic_escape",
			expected = "escape",
			actions = {
				"arrow_poke", "spacing_retreat", "dash_catch",
			},
			risk = 0.24, information = 0.88, cost = 0.20,
			max_repetitions = 2, stop_confidence = 0.68,
			duration = 19,
		},
		repeat_lane_entry = {
			style = "movement",
			question = "does_the_opponent_repeat_the_same_approach_lane",
			hypothesis = "repetitive_approach",
			expected = "approach",
			actions = {
				"spread_shot", "arrow_poke", "reflect_kick",
			},
			risk = 0.20, information = 0.80, cost = 0.22,
			max_repetitions = 2, stop_confidence = 0.64,
			duration = 20,
		},
	},
	conditioning_breaks = {
		arrow_poke = "ranger_advance",
		spread_shot = "reflect_kick",
		ranger_advance = "tumbling_shot",
		dash_catch = "spacing_retreat",
		spacing_retreat = "guided_arrow",
		backdash_arrow = "dash_arrow",
		ranger_air_drop = "ranger_vertical_intercept",
	},
	fallback_intention = "safe_arrow_probe",
	error_profile = {
		base = 0.026,
		load_scale = 0.105,
		surprise_scale = 0.045,
		overconfidence_scale = 0.030,
		range_bias = 1.25,
		late_confirm = 0.85,
		familiar_route = 1.10,
...
PVP_PRO_AI_V7_PROFILE_AMELIA = {
	character = "amelia",
	identity = "patient_foresight_analyst_runtime",
	calibration = {
		confirmation_timeout = 12,
		state_start_timeout = 5,
		strategy_min_commit = 48,
		strategy_failure_threshold = 2,
		exchange_timeout = 40,
		range_tolerance = 105,
		surprise_hesitation = 2,
		probe_confidence = 0.68,
		resource_inference_decay = 0.014,
		route_drop_penalty = 5,
		repetition_tolerance = 4,
		defensive_option_confidence = 0.66,
		tempo_transition_min = 9,
		observation_ttl = 4,
		identity_snapshot_interval = 60,
		counterfactual_noise = 22,
		max_action_timeout = 20,
		range_failure_penalty = 6,
	},
	timing_scale = {
		startup = 1.05,
		contact = 1.08,
	...
	role_timing = {
		poke = { followup_min = 2, followup_max = 8 },
		control = { resource_delay_max = 5, callback_gap = true },
		air = { startup_max = 5, contact_max = 8, callback_gap = true },
	},
	action_timing = {
		ranger_air_drop = {
			startup_min = 2, startup_max = 5,
			contact_min = 2, contact_max = 8,
			recovery_min = 4, recovery_max = 11,
			timeout = 17, timing_confidence = 0.20,
		},
		guided_arrow = {
			startup_min = 2, startup_max = 5,
			contact_min = 3, contact_max = 9,
			recovery_min = 4, recovery_max = 12,
			timeout = 18, timing_confidence = 0.22,
		},
		reflect_kick = {
			startup_min = 1, startup_max = 3,
			contact_min = 1, contact_max = 5,
			recovery_min = 3, recovery_max = 8,
			timeout = 12, timing_confidence = 0.28,
		},
	},
	occupancy = {
		strategy_soft_min = 48,
		strategy_soft_max = 112,
		plan_soft_min = 17,
		plan_soft_max = 44,
		preferred_observation_rate = 0.22,
		preferred_commitment_rate = 0.18,
	},
	identity_targets = {
		preferred_range = "mid_to_far",
		observation = "high",
		commitment = "evidence_gated",
		retreat = "measured",
		probe = "frequent_low_risk",
		strategy_persistence = "high",
		resource_spending = "patient",
		combo_extension = "reliability_first",
		defensive_patience = "high",
		momentum_sensitivity = "low",
	},
	range_overrides = {
		ranger_air_drop = { min_dist = 550, max_dist = 1200 },
		ranger_vertical_intercept = { min_dist = 0, max_dist = 1200 },
		guided_arrow = { min_dist = 360, max_dist = 1250 },
	},
	dormant_actions = {
		ranger_air_drop = {
			parent_plans = {
				"funnel_preferred_lane", "adaptation_recheck",
			},
			parent_intention = "aerial_drop_mix",
			required_vertical = "target_below_minus_55",
			coverage_policy = "targeted_scenario_only_no_probability_boost",
		},
	},
}

function CF_PVP_BOT_AMELIA_AIR_DROP(
	pKTDXApp, pX2Game, pNPCUnit )
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	if ( memory.vertical_offset or 0 ) > -55 then return false end
	return PVP_PRO_AI_DECIDE(
		pX2Game, pNPCUnit, "ranger_air_drop", "air",
		550, 1200, 0, 42, 7 )
end

function CF_PVP_BOT_AMELIA_VERTICAL_INTERCEPT(
	pKTDXApp, pX2Game, pNPCUnit )
	local memory = PVP_PRO_AI_GET( pNPCUnit )
	if ( memory.vertical_offset or 0 ) < 55 then return false end
	return PVP_PRO_AI_DECIDE(
		pX2Game, pNPCUnit, "ranger_vertical_intercept", "air",
		0, 1200, 0, 40, 7 )
end

function CF_PVP_BOT_AMELIA_BACKDASH_ARROW(
	pKTDXApp, pX2Game, pNPCUnit )
	if PVP_PRO_AI_HAS_BACK_SPACE( pNPCUnit, 190 ) ~= true then
		return false
	end
	return PVP_PRO_AI_DECIDE(
...
function CF_PVP_BOT_AMELIA_DASH_ARROW(
	pKTDXApp, pX2Game, pNPCUnit )
	return PVP_PRO_AI_DECIDE(
		pX2Game, pNPCUnit, "dash_arrow", "chase",
		0, 350, 0, 34, 6 )
end

function CF_PVP_BOT_AMELIA_AI_TICK(
	pKTDXApp, pX2Game, pNPCUnit )
	PVP_PRO_AI_SET_PROFILE(
		pNPCUnit, PVP_PRO_AI_PROFILE_AMELIA )
	PVP_PRO_AI_SET_META_PROFILE(
		pNPCUnit, PVP_PRO_AI_V4_PROFILE_AMELIA )
	PVP_PRO_AI_SET_STRATEGIC_PROFILE(
		pNPCUnit, PVP_PRO_AI_V5_PROFILE_AMELIA )
	PVP_PRO_AI_SET_COMPETITIVE_PROFILE(
		pNPCUnit, PVP_PRO_AI_V6_PROFILE_AMELIA )
	PVP_PRO_AI_SET_RUNTIME_PROFILE(
		pNPCUnit, PVP_PRO_AI_V7_PROFILE_AMELIA )
	return PVP_PRO_AI_TICK( pX2Game, pNPCUnit, 1, 3 )
end
