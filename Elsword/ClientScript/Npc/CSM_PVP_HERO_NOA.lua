...
INIT_STATE =
{
	...
	-- 텔레포트를 시전합니다.
	{ STATE_NAME = "PVP_BOT_NOA_TELEPORT_READY",				
																STATE_COOL_TIME = 2,			
																LUA_FRAME_MOVE_FUNC = "PVP_BOT_NOA_TELEPORT_READY_FRAME_MOVE",
																LUA_STATE_END_FUNC = "PVP_BOT_NOA_TELEPORT_READY_STATE_END" ,},
																
	{ STATE_NAME = "PVP_BOT_NOA_TELEPORT_FINISH" },
...
"PVP_BOT_NOA_JUMP_DOWN","PVP_BOT_NOA_JUMP_LANDING",	},	
	...
	SUMMON_END_STATE			= "PVP_BOT_NOA_DYING_FRONT",
...
function PVP_BOT_NOA_TELEPORT_READY_STATE_END( pKTDXApp, pX2Game, pNPCUnit )
