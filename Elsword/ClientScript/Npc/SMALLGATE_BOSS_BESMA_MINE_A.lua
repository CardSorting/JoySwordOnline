...
INIT_MOTION = 
{
	MOTION_FILE_NAME		= "Motion_Besma_BesmaMine_Gate_Boss.x",
	--MOTION_CHANGE_TEX_XET	= "Motion_Common_Gate_Boss_Besma_MINE_A.xet",
	MOTION_MULTI_TEX_XET	= "Motion_Common_Gate_Boss_Besma_MINE_A.xet",
