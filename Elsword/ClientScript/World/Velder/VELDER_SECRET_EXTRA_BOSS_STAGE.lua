-- VELDER_SECRET_EXTRA_BOSS_STAGE.lua
...
g_pWorldLayer:SetTex( "VELDER_SECRET_YUME2.tga" )
g_pWorldLayer:SetAlphaObject(true)
g_pWorldLayer:SetPos(0, 0, 1, 1)
g_pWorldLayer:SetColor(D3DXCOLOR(0.592157, 0.592157, 1, 1))
g_pWorldLayer:SetTexUV(0.03, 0.05)
