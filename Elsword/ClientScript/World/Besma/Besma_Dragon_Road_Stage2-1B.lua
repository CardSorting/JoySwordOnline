...
-- Besma_Dragon_Road_Stage2-1B.lua



g_pWorld:SetLightPos( 50000, 50000, -100000 )
g_pWorld:SetLineMap( "Besma_Dragon_Road_Stage2-1B_linemap.lua" )
g_pWorld:SetBGM( "Music039_Stage.ogg" )
g_pWorld:AddEffectBGM_LUA( "Amb_BesmaDragonRoad.ogg" )


g_pWorld:SetFogWorld( 5200, 14200, 3600, -466, 0, D3DXCOLOR( 1, 1, 0.796079, 1.0 ) )
-- SKY / CLOUD -- 
...
g_pSkyDome:SetFog( 5200, 14200, 3600, -466, D3DXCOLOR(1, 1, 0.796079, 1), -1 )
...
g_pObjectMesh:SetFog( 5200, 14200, 3600, -466, D3DXCOLOR(1, 1, 0.796079, 1), 0 )
