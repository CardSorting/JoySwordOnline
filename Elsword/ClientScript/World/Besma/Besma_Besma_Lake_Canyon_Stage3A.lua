...
-- Besma_Besma_Lake_Canyon_Stage3A.lua



g_pWorld:SetLightPos( 50000, 50000, -100000 )
g_pWorld:SetLightColor_LUA(  1, 0.862745, 0.662745 ) 
g_pWorld:SetOriginColor_LUA(  1, 0.862745, 0.505882 ) 
g_pWorld:SetLineMap( "Besma_Besma_Lake_Canyon_Stage3A_linemap.lua" )
...
g_pSkyDome:SetDomeMesh( "BESMA_BESMA_LAKE_CANYON_STAGE3A_SKY.Y" )
