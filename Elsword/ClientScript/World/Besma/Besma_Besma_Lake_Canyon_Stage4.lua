...
-- Besma_Besma_Lake_Canyon_Stage4.lua



g_pWorld:SetLightPos( 50000, 50000, -100000 )
g_pWorld:SetLightColor_LUA(  1, 0.862745, 0.662745 ) 
g_pWorld:SetOriginColor_LUA(  0.901961, 0.784314, 0.505882 ) 
g_pWorld:SetLineMap( "Besma_Besma_Lake_Canyon_Stage4_linemap.lua" )
...
g_pSkyDome:SetDomeMesh( "BESMA_BESMA_LAKE_CANYON_STAGE4_SKY.Y" )
