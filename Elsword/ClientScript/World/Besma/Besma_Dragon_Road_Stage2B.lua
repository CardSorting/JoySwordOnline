...
-- Besma_Dragon_Road_Stage2B.lua



g_pWorld:SetLightPos( 50000, 50000, -100000 )
g_pWorld:SetLineMap( "Besma_Dragon_Road_Stage2B_linemap.lua" )
g_pWorld:SetBGM( "Music039_Stage.ogg" )
g_pWorld:AddEffectBGM_LUA( "Amb_BesmaDragonRoad.ogg" )


g_pWorld:SetFogWorld( 2200, 23800, 3000, -2532, 0, D3DXCOLOR( 0.941177, 0.941177, 0.745098, 1.0 ) )
-- SKY / CLOUD -- 
