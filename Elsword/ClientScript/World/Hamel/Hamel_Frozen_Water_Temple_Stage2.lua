-- Hamel_Frozen_Water_Temple_Stage2.lua
...
g_pWorld:SetLineMap( "Hamel_Frozen_Water_Temple_Stage2_LineMap.lua" )
...
g_pWorld:SetFogWorld( 0, 26600, 0, 0, 0, D3DXCOLOR( 0.635294, 0.905882, 1, 1.0 ) )
...
g_pObjectMesh:SetFog( 0, 26600, 0, 0, D3DXCOLOR(0.635294, 0.905882, 1, 1), 0 )
...
g_pObjectMesh = g_pWorld:CreateObjectMesh()
g_pObjectMesh:SetXMesh(    "Hamel_Frozen_Water_Temple_S2_bridge2.Y" )
g_pObjectMesh:SetXMeshLOD( "Hamel_Frozen_Water_Temple_S2_bridge2.Y" )
g_pObjectMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_0"] )
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetOriginalColorFactor( D3DXCOLOR(1, 1, 1, 1))
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
...
g_pObjectMesh = g_pWorld:CreateObjectMesh()
g_pObjectMesh:SetXMesh(    "Hamel_Frozen_Water_Temple_S2_ice2-1.Y" )
g_pObjectMesh:SetXMeshLOD( "Hamel_Frozen_Water_Temple_S2_ice2-1.Y" )
g_pObjectMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_0"] )
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetOriginalColorFactor( D3DXCOLOR(1, 1, 1, 1))
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
