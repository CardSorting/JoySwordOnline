-- ANCIENT_WATERWAY_CORE_Boss.lua
...
g_pWorld:SetLineMap( "ANCIENT_WATERWAY_CORE_Boss_LineMap.lua" )
g_pWorld:SetBGM( "ANCIENT_WATERWAY_CORE_Boss.ogg" )
...
g_pObjectSkinMesh:SetXSkinMotion( "HAMEL_WATERWAY_CORE_SBOSS_BODY.X" )
g_pObjectSkinMesh:AddXSkinModel( "HAMEL_WATERWAY_CORE_SBOSS_BODY.X" )
...
g_pObjectSkinMesh = g_pWorld:CreateObjectSkinMesh()
g_pObjectSkinMesh:SetXSkinMotion( "HAMEL_WATERWAY_CORE_SBOSS_CHAINUV.X" )
g_pObjectSkinMesh:AddXSkinModel( "HAMEL_WATERWAY_CORE_SBOSS_CHAINUV.X" )
g_pObjectSkinMesh:AddAnim( "Normal" )
g_pObjectSkinMesh:PlayAnim( WORLD_OBJECT_SKIN_MESH_PLAY_TYPE["WOSMPY_LOOP"] )
...
g_pObjectSkinMesh = g_pWorld:CreateObjectSkinMesh()
g_pObjectSkinMesh:SetXSkinMotion( "HAMEL_WATERWAY_CORE_SBOSS_GMUEL.X" )
g_pObjectSkinMesh:AddXSkinModel( "HAMEL_WATERWAY_CORE_SBOSS_GMUEL.X" )
g_pObjectSkinMesh:AddAnim( "Normal" )
g_pObjectSkinMesh:PlayAnim( WORLD_OBJECT_SKIN_MESH_PLAY_TYPE["WOSMPY_LOOP"] )
...
g_pObjectSkinMesh = g_pWorld:CreateObjectSkinMesh()
g_pObjectSkinMesh:SetXSkinMotion( "HAMEL_WATERWAY_CORE_SBOSS_LIGHT.X" )
g_pObjectSkinMesh:AddXSkinModel( "HAMEL_WATERWAY_CORE_SBOSS_LIGHT.X" )
g_pObjectSkinMesh:AddAnim( "Normal" )
g_pObjectSkinMesh:PlayAnim( WORLD_OBJECT_SKIN_MESH_PLAY_TYPE["WOSMPY_LOOP"] )
g_pObjectSkinMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_1"] )
g_pObjectSkinMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
...
g_pObjectSkinMesh = g_pWorld:CreateObjectSkinMesh()
g_pObjectSkinMesh:SetXSkinMotion( "HAMEL_WATERWAY_CORE_SBOSS_WATER.X" )
g_pObjectSkinMesh:AddXSkinModel( "HAMEL_WATERWAY_CORE_SBOSS_WATER.X" )
g_pObjectSkinMesh:AddAnim( "Normal" )
g_pObjectSkinMesh:PlayAnim( WORLD_OBJECT_SKIN_MESH_PLAY_TYPE["WOSMPY_LOOP"] )
