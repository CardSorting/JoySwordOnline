...
-- TrainingCenter_FreeStage.lua



g_pWorld:SetLightPos( 2000, 2000, -1000 )
g_pWorld:SetLineMap( "TrainingCenter_FreeStage_linemap.lua" )
...
g_pObjectMesh = g_pWorld:CreateObjectMesh()
g_pObjectMesh:SetXMesh(    "TrainingCenter_FreeStage_Floor.Y" )
g_pObjectMesh:SetXMeshLOD( "TrainingCenter_FreeStage_Floor.Y" )
g_pObjectMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_0"] )
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
g_pObjectMesh:SetCanHide( false, false )
