...
g_pWorld:SetFogWorld( -1600, 11600, -2132, 533, -0.05, D3DXCOLOR( 0.67451, 0.243137, 0, 1.0 ) )
...
g_pWorldLayer:SetColor(D3DXCOLOR(1, 0.32549, 0.243137, 1))
...
g_pWorldLayer:SetAlphaObject(true)
g_pWorldLayer:SetPos(0, 0, 1, 1)
g_pWorldLayer:SetColor(D3DXCOLOR(1, 0.4, 0.376471, 1))
g_pWorldLayer:SetTexUV(-0.02, 0.05)
...
g_pWorldLayer:SetColor(D3DXCOLOR(0.254902, 0.223529, 0.211765, 1))
g_pWorldLayer:SetTexUV(0, 0)
...
g_pObjectMesh:SetFog( -1600, 11600, -2132, 533, D3DXCOLOR(0.67451, 0.243137, 0, 1), -0.05 )
