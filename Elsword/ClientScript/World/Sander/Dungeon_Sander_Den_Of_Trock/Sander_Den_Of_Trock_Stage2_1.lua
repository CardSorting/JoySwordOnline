-- Sander_Den_Of_Trock_Stage2_1.lua



g_pWorld:SetLightPos( 50000, 50000, -100000 )
g_pWorld:SetLineMap( "Sander_Den_Of_Trock_Stage2_1_LineMap.lua" )
g_pWorld:SetBGM( "Music057_Stage.ogg" )

g_pWorld:AddEffectBGM_LUA( "Amb_Sander_DrySander1_Wind.ogg" ) 
g_pWorld:Add3DEffectBGM_LUA( "Amb_Sander_DrySander0_Lava.ogg", -288, 3520, -3522, 8000 )    
