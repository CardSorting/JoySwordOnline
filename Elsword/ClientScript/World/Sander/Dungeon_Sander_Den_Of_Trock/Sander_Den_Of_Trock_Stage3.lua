-- Sander_Den_Of_Trock_Stage3.lua



g_pWorld:SetLightPos( 50000, 50000, -100000 )
g_pWorld:SetLineMap( "Sander_Den_Of_Trock_Stage3_LineMap.lua" )
g_pWorld:SetBGM( "Music057_Stage.ogg" )

g_pWorld:AddEffectBGM_LUA( "Amb_Sander_DrySander0_Lava.ogg" )    


g_pWorld:SetFogWorld( -1399, 25800, 0, 0, 0, D3DXCOLOR( 0.364706, 0.466667, 0.364706, 1.0 ) )
...
g_pObjectMesh:SetFog( -1399, 25800, 0, 0, D3DXCOLOR(0.364706, 0.466667, 0.364706, 1), 0 )
...
g_pObjectMesh = g_pWorld:CreateObjectMesh()
g_pObjectMesh:SetXMesh(    "Sander_Den_Of_Trock_Stage3_Balpan01.Y" )
g_pObjectMesh:SetXMeshLOD( "Sander_Den_Of_Trock_Stage3_Balpan01.Y" )
g_pObjectMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_0"] )
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetOriginalColorFactor( D3DXCOLOR(1, 1, 1, 1))
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
...
g_pObjectMesh = g_pWorld:CreateObjectMesh()
g_pObjectMesh:SetXMesh(    "Sander_Den_Of_Trock_Stage3_Balpan02.Y" )
g_pObjectMesh:SetXMeshLOD( "Sander_Den_Of_Trock_Stage3_Balpan02.Y" )
g_pObjectMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_0"] )
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetOriginalColorFactor( D3DXCOLOR(1, 1, 1, 1))
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
...
g_pObjectMesh = g_pWorld:CreateObjectMesh()
g_pObjectMesh:SetXMesh(    "Sander_Den_Of_Trock_Stage3_Balpan03.Y" )
g_pObjectMesh:SetXMeshLOD( "Sander_Den_Of_Trock_Stage3_Balpan03.Y" )
g_pObjectMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_0"] )
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetOriginalColorFactor( D3DXCOLOR(1, 1, 1, 1))
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
...
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetTex0UVSpeed( 0.15, 0.1 )
g_pObjectMesh:SetOriginalColorFactor( D3DXCOLOR(1, 1, 1, 1))
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
g_pObjectMesh:SetCanHide( false, false )
g_pObjectMesh:SetNotRenderWhenHidden( false )
