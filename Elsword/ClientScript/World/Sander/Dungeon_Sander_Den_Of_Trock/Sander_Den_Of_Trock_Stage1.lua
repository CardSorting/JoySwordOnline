-- Sander_Den_Of_Trock_Stage1.lua



g_pWorld:SetLightPos( 50000, 50000, -100000 )
g_pWorld:SetLineMap( "Sander_Den_Of_Trock_Stage1_LineMap.lua" )
...
g_pWorld:Add3DEffectBGM_LUA( "Amb_Sander_Field0_Sandfall.ogg", 2147, 6039, 6729, 4000 )    
g_pWorld:Add3DEffectBGM_LUA( "Amb_Sander_DrySander0_Lava.ogg", -2449, 3290, 2569, 8000 )    
...
g_pObjectMesh = g_pWorld:CreateObjectMesh()
g_pObjectMesh:SetXMesh(    "Sander_Den_Of_Trock_Stage1_Balpan00.Y" )
g_pObjectMesh:SetXMeshLOD( "Sander_Den_Of_Trock_Stage1_Balpan00.Y" )
g_pObjectMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_0"] )
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetOriginalColorFactor( D3DXCOLOR(1, 1, 1, 1))
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
...
g_pObjectMesh = g_pWorld:CreateObjectMesh()
g_pObjectMesh:SetXMesh(    "Sander_Den_Of_Trock_Stage1_Balpan01.Y" )
g_pObjectMesh:SetXMeshLOD( "Sander_Den_Of_Trock_Stage1_Balpan01.Y" )
g_pObjectMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_0"] )
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetOriginalColorFactor( D3DXCOLOR(1, 1, 1, 1))
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
...
g_pObjectMesh = g_pWorld:CreateObjectMesh()
g_pObjectMesh:SetXMesh(    "Sander_Den_Of_Trock_Stage1_Balpan02.Y" )
g_pObjectMesh:SetXMeshLOD( "Sander_Den_Of_Trock_Stage1_Balpan02.Y" )
g_pObjectMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_0"] )
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetOriginalColorFactor( D3DXCOLOR(1, 1, 1, 1))
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
...
g_pObjectMesh = g_pWorld:CreateObjectMesh()
g_pObjectMesh:SetXMesh(    "Sander_Den_Of_Trock_Stage1_GATE.Y" )
g_pObjectMesh:SetXMeshLOD( "Sander_Den_Of_Trock_Stage1_GATE.Y" )
g_pObjectMesh:SetLayer( X2_LAYER["XL_SKY_WORLD_BASE_0"] )
g_pObjectMesh:SetPos( D3DXVECTOR3(0, 0, 0) )
g_pObjectMesh:SetOriginalColorFactor( D3DXCOLOR(1, 1, 1, 1))
g_pObjectMesh:SetColorFactor( D3DXCOLOR(1,1,1,1) )
