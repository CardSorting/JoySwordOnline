...
STAGE_LIST =
{
	...
	STAGE1 =
	{
		WORLD_ID = WORLD_ID["WI_PEITA_CHAPEL_STAGE2_2"],
		...
		SUB_STAGE2 =
		{
            ...
            CLEAR_COND1 =
			{
				...
				NEXT_STAGE0 = { CLEAR_TYPE["CT_STAGE_FORCE"], 4, 0, 100 },
			},
	...
	STAGE4 =
	{
		WORLD_ID = WORLD_ID["WI_PEITA_CHAPEL_STAGE5"],
	...
	STAGE5 =
	{
		WORLD_ID = WORLD_ID["WI_PEITA_CHAPEL_STAGE2_3"],
