...
STAGE0 =
	...
	STAGE1 =
	{
		...
		READY_NPC = 
		{
			...
			NPC_UNIT_ID["NUI_BLOODY_GLITER_LANCE_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_GLITER_SHIELD_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_GLITER_ARCHER_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_GLITER_THIEF_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_GLITER_BOMB_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_WYVERN_HELL"],
			NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_POT_RED"],
			NPC_UNIT_ID["NUI_BLOODY_UNOHOUND_HELL"],
		...
		SUB_STAGE0 =
		{
			...
			NPC_GROUP =
			{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_GLITER_LANCE_HELL"],
					START_POS	= { 14, },
				},
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_GLITER_SHIELD_HELL"],
					START_POS	= { 16, },
				},
				{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_GLITER_ARCHER_HELL"],
					START_POS	= { 19, },
				},
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_GLITER_HAMMER_HELL"],
					START_POS	= { 27, },
				},
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_GLITER_SHIELD_HELL"],
		...
		SUB_STAGE1 =
		{
			...
			NPC_GROUP =
			{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_WYVERN_HELL"],
					START_POS	= { 58, },
				},
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_WYVERN_HELL"],
		...
		SUB_STAGE2 =
		{
			...
			NPC_GROUP =
			{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_UNOHOUND_HELL"],
					START_POS	= { 95, },
				},
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_UNOHOUND_HELL"],
	...
	STAGE2 =
	{
		...
		SUB_STAGE0 =
		{
			...
			NPC_GROUP =
			{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_GLITER_BOMB_HELL"],
					START_POS	= { 19, },
				},
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_GLITER_BOMB_HELL"],
				...
				-- {
					-- NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_GLITER_THIEF_HELL"],
					-- START_POS	= { 34, },
				-- },
	...
	STAGE3 =
	{
		...
		{
			NPC_UNIT_ID["NUI_BLOODY_GLITER_BOMB_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_MAGIC_GLITER_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_RAVEN_GLITER_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_RENA_GLITER_HELL"],
			NPC_UNIT_ID["NUI_CHEST"],
			NPC_UNIT_ID["NUI_BLOODY_GLITER_LANCE_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_GLITER_SHIELD_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_GLITER_ARCHER_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_GLITER_THIEF_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_WYVERN_HELL"],
			NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_POT_BLUE"],
			NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_GREAT_BOSS_STAGE3"],
			NPC_UNIT_ID["NUI_CANNON_DEMON"],
			NPC_UNIT_ID["NUI_GLITER_ZOMBIE_HELL"],
			NPC_UNIT_ID["NUI_BLOODY_WYVERN_HELL"],
		},
		...
		SUB_STAGE0 =
		{
			...
			NPC_GROUP =
			{
				...
				-- {
					-- NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_MAGIC_GLITER_HELL"],
					-- START_POS	= { 10, },
				-- },
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_GLITER_LANCE_HELL"],
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_RAVEN_GLITER_HELL"],
					START_POS	= { 12, },
				},
				{
					NPC_ID		= NPC_UNIT_ID["NUI_CANNON_DEMON"],
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_RENA_GLITER_HELL"],
					START_POS	= { 32, },
				},
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BLOODY_GLITER_LANCE_HELL"],
		...
		SUB_STAGE1 =
		{
			...
			{
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GLITER_ZOMBIE_HELL"],
					DROP_TIMES	= 30,
				},
			},
			...
			{
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GLITER_TOMBSTONE_HELL"],
					START_POS	= { 73, },
					IS_RIGHT	= TRUE,
				},
				{
		...
		SUB_STAGE2 =
		{
			...
			NPC_GROUP =
			{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_GREAT_BOSS_STAGE3_HELL"],
					START_POS	= { 163, },
					ACTIVE		= FALSE,
					NO_DROP		= TRUE,
					GAGE_BAR	= FALSE,
	...
	STAGE6 =
	{
		WORLD_ID = WORLD_ID["WI_VELDER_SECRET_EXTRA_STAGE2"],
		...
		READY_NPC = 
		{
			...
			NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_POT_RED"],
			NPC_UNIT_ID["NUI_BLOODY_UNOHOUND_HELL"],
			NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_GREAT_BOSS_STAGE1_HELL"],
		},
		...
		SUB_STAGE2 =
		{
			...
			{
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_GREAT_BOSS_STAGE1_HELL"],
					START_POS	= { 79, },
					ACTIVE		= FALSE,
					NO_DROP		= TRUE,
					GAGE_BAR	= FALSE,
	...
	STAGE7 =
	{
		WORLD_ID = WORLD_ID["WI_VELDER_SECRET_EXTRA_STAGE3"],
		STAGE_TYPE = STAGE_TYPE["ST_EXTRA"],
		...
		READY_NPC = 
		{
			...
			NPC_UNIT_ID["NUI_BLOODY_WYVERN_HELL"],
			NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_POT_YELLOW"],
			NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_GREAT_BOSS_STAGE2_HELL"],
			NPC_UNIT_ID["NUI_CRAZY_PUPPET_DOLL"],
			NPC_UNIT_ID["NUI_CRAZY_PUPPET_NOT_MOVE_HELL"],
			NPC_UNIT_ID["NUI_CRAZY_PUPPET_NOT_MOVE"],
		...
		SUB_STAGE0 =
		{
			...
			NPC_GROUP =
			{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GIANT_PUPPET_HELL"],
					START_POS	= { 76, },
					ACTIVE		= FALSE,
					NO_DROP		= TRUE,
					GAGE_BAR	= FALSE,
		...
		SUB_STAGE1 =
		{
			...
			NPC_GROUP =
			{
				...
				-- },
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_GREAT_BOSS_STAGE2_HELL"],
					START_POS	= { 123, },
					ACTIVE		= FALSE,
					NO_DROP		= TRUE,
					GAGE_BAR	= FALSE,
	...
	STAGE8 =
	{
		WORLD_ID = WORLD_ID["WI_VELDER_SECRET_EXTRA_STAGE4"],
		STAGE_TYPE = STAGE_TYPE["ST_EXTRA"],
		READY_NPC = 
		{
			NPC_UNIT_ID["NUI_BLOODY_GLITER_BOMB_HELL"],
		...
		SUB_STAGE1 =
		{
			...
			CLEAR_COND0 =
			{
				...
				NEXT_STAGE0 = { CLEAR_TYPE["CT_SUB_STAGE"], 8, 2, 100 },
			},
			...
			NPC_GROUP =
			{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GIANT_SPRIGAN_HELL"],
					START_POS	= { 108, },
					ACTIVE		= FALSE,
					NO_DROP		= TRUE,
					GAGE_BAR	= FALSE,
	...
	STAGE9 =
	{
		WORLD_ID = WORLD_ID["WI_VELDER_SECRET_EXTRA_STAGE5"],
		STAGE_TYPE = STAGE_TYPE["ST_EXTRA"],
		...
		SUB_STAGE1 =
		{
			...
			CLEAR_COND0 =
			{
				...
				NEXT_STAGE0 = { CLEAR_TYPE["CT_SUB_STAGE"], 9, 2, 100 },
			},
			...
			NPC_GROUP =
			{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GIANT_UNOHOUND_HELL"],
					START_POS	= { 69, },
					ACTIVE		= FALSE,
					NO_DROP		= TRUE,
					GAGE_BAR	= FALSE,
	...
	STAGE10 =
	{
		WORLD_ID = WORLD_ID["WI_VELDER_SECRET_EXTRA_BOSS_STAGE"],
		--STAGE_TYPE = STAGE_TYPE["ST_EXTRA"],
		
		READY_NPC = 
		{
			NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_SECRET_BOSS_EXTRA"],
		},
		...
		SUB_STAGE0 =
		{
			...
			{
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GLITER_ALCHEMYST_SECRET_BOSS_EXTRA"],
					START_POS	= { 1, },
					HAVE_BOSS_GAGE  = TRUE,
					SHOW_BOSS_NAME  = TRUE,
					FOCUS_CAMERA    = TRUE,
