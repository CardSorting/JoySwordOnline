...
STAGE_LIST =
{
	...
	STAGE2 =
	{
		WORLD_ID = WORLD_ID["WI_HAMEL_WATERWAY_CORE_STAGE3"],
		...
		SUB_STAGE0 =
		{
			...
			NPC_GROUP =
			{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GEAR_RESPAWN_A"],
					START_POS	= { 40, },
					ACTIVE		= FALSE,
					GAGE_BAR	= FALSE,
					NO_DROP     = TRUE,
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_GEAR_RESPAWN_B"],
					START_POS	= { 41, },
					ACTIVE		= FALSE,
					GAGE_BAR	= FALSE,
					NO_DROP     = TRUE,
	...
	STAGE3 =
	{
		...
		SUB_STAGE2 =
		{
			...
			CLEAR_COND0 =
			{
				...
				NEXT_STAGE0 = { CLEAR_TYPE["CT_SUB_STAGE"], 3, 3, 100 },
			},
	...
	STAGE4 =
	{
		WORLD_ID = WORLD_ID["WI_HAMEL_WATERWAY_CORE_STAGE5"],
		...
		READY_NPC =
		{
			...
			NPC_UNIT_ID["NUI_SHADOW_SNIPER"],
			NPC_UNIT_ID["NUI_SHADOW_DEFENDER"],
			NPC_UNIT_ID["NUI_WATERWAY_CORE_RESPAWNER"],
		},
		...
		SUB_STAGE0 =
		{
			...
			NPC_GROUP =
			{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_WATERWAY_CORE_RESPAWNER"],
					START_POS	= { 2, },
					ACTIVE		= TRUE,
				},
				{
