...
STAGE_LIST =
{
	...
	STAGE1 =
	{
		...
		SUB_STAGE1 =
		{
			...
			{
				{
					NPC_ID		= NPC_UNIT_ID["NUI_TROCK_DOG_BOSS"],
					START_POS	= { 70, },
					SHOW_BOSS_NAME	= TRUE,
					HAVE_BOSS_GAGE	= TRUE,
					FOCUS_CAMERA	= TRUE,
			...
			{
				{
					NPC_ID		= NPC_UNIT_ID["NUI_BOMB_TROCK_BOSS"],
					START_POS	= { 70, },
					SHOW_BOSS_NAME	= TRUE,
					HAVE_BOSS_GAGE	= TRUE,
					FOCUS_CAMERA	= TRUE,
	...
	STAGE2 =
	{
		WORLD_ID = WORLD_ID["WI_SANDER_DEN_OF_TROCK_STAGE2"],
	...
	STAGE3 =
	{
		WORLD_ID = WORLD_ID["WI_SANDER_DEN_OF_TROCK_STAGE3"],
		...
		SUB_STAGE0 =
		{
			...
			NPC_GROUP0 =
			{
				...
				--------첫번째 지역---------
				{
					NPC_ID		= NPC_UNIT_ID["NUI_TROCK_DARK_POISON"],
					START_POS	= { 70, },
					ACTIVE		= FALSE,					
				},
				{
				...
				{
					NPC_ID		= NPC_UNIT_ID["NUI_TROCK_DARK_POISON_SMALL"],
					START_POS	= { 73, },
					ACTIVE		= FALSE,					
				},
				{
