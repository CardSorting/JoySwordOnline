...
STAGE_LIST =
{
   ...
   STAGE0 =
	...
	STAGE1 =
	{
		WORLD_ID = WORLD_ID["WI_ELDER_BELOW_PASSAGE_STAGE2A"],
	...
	-- 지하수로 던전 스테이지 3 (EXPERT)

	STAGE2 =
	{
		WORLD_ID = WORLD_ID["WI_NEW_ELDER_BELOW_PASSAGE_STAGE3_1B"],
	...
	STAGE3 =
	{
		WORLD_ID = WORLD_ID["WI_ELDER_BELOW_PASSAGE_STAGE3B"],
