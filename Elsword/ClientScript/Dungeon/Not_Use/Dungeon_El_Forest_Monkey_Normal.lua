...
function RF_STAGE0_SUB1_TRIGGER0( pKTDXApp, pX2DungeonGame, pX2DungeonSubStage )
	...
	pX2DungeonGame:CreateNPCReq_LUA2( NPC_UNIT_ID[ "NUI_MONKEY_A" ], 1, true, pos, true, vfDelayTimeNKeyCode, true ) 
	
	pos	= pKTDXApp:GetVec3( 10209, 1600, 410 )
	vfDelayTimeNKeyCode	= pKTDXApp:GetVec3( 0, 120, 2100 )
	pX2DungeonGame:CreateNPCReq_LUA2( NPC_UNIT_ID[ "NUI_MONKEY_A" ], 1, true, pos, false, vfDelayTimeNKeyCode, true ) 
