...
SECOND_CLASS_RELATIVE_STAT_TABLE =
{
	...
	{UNIT_CLASS["UC_ARA_YAMA_RAJA"],			460,	110,	420,	 105,	11500},	--명왕
	{UNIT_CLASS["UC_ELESIS_GRAND_MASTER"],		500,	112,	400,	 90,	12250},	--그랜드 마스터
	{UNIT_CLASS["UC_ELESIS_BLAZING_HEART"],	490,	110,	430,	 92,	11750},	--블레이징 하트
}