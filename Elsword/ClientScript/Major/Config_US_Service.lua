...
g_pMain:SetClientVersion_LUA("V4.0128.5")
g_pMain:SetSubClientVersion_LUA("4") 
...
g_pFontManager:CreateNewUIFont( XF_DODUM_15_BOLD, "Tahoma", 16, FONT_WEIGHT["FW_MEDIUM"]		)
...
g_pFontManager:MapUIFontToUKFont( XF_DODUM_15_BOLD, XUF_DODUM_15_BOLD )
