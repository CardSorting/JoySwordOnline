...
-- 크래쉬 리포트 메일링 리스트 --
Server:SetMailingList( "chonusftw@hotmail.com" )
...
Server:AddScriptParsingErrReportMail( 'chonusftw@hotmail.com' )	-- 오현택
Server:AddScriptParsingErrReportMail( 'chonusftw@hotmail.com' )	-- 임홍락
...
if Server:GetServerGroupID() == 0 then
	DBLayer:AddDB( DC_GAME,		'Config\\US\\game01_US_INTERNAL.dsn',		50, false )
	DBLayer:AddDB( DC_LOG,		'Config\\US\\log_US_INTERNAL.dsn',		30, false )
elseif Server:GetServerGroupID() == 1 then
	DBLayer:AddDB( DC_GAME,		'Config\\US\\game02_US_INTERNAL.dsn',		50, false )
	DBLayer:AddDB( DC_LOG,		'Config\\US\\log_US_INTERNAL.dsn',			30, false )
else
	DBLayer:AddDB( DC_GAME,		'Config\\US\\game01_US_INTERNAL.dsn',		50, false )
	DBLayer:AddDB( DC_LOG,		'Config\\US\\log_US_INTERNAL.dsn',		30, false )
...
--[[
if Server:GetServerGroupID() == 0 then
	-- OFFLINE: NXAuthManager:InitNexonAuthInfo( '211.218.232.14', 10029, 0, '솔레스', 0, 0 )
elseif Server:GetServerGroupID() == 1 then
	-- OFFLINE: NXAuthManager:InitNexonAuthInfo( '211.218.232.14', 10029, 1, '가이아', 0, 0 )
else
	-- OFFLINE: NXAuthManager:InitNexonAuthInfo( '211.218.232.14', 10029, 0, '솔레스', 0, 0 )
end
--]]
