...
g_pControlList:SetYScrollBarSize( 21, 67 )
g_pControlList:SetScrollOffset( 80, 34 )
g_pControlList:SetPos(20, 51)

g_pControlList:SetViewSize( 2, 2, true )
...
g_pStatic_Velder_DG = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_Velder_DG )
g_pStatic_Velder_DG:SetName( "Class_120" )

g_pPicture_Icon05 = g_pUIDialog:CreatePicture()
g_pStatic_Velder_DG:AddPicture( g_pPicture_Icon05 )
g_pPicture_Icon05:SetTex( "DLG_UI_Common_Texture16_NEW.TGA", "L_KNIGHT_ICON" )
g_pPicture_Icon05:SetPoint
{
	"LEFT_TOP		= D3DXVECTOR2(0,0)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
...
g_pStatic_Velder_DG = g_pUIDialog:CreateStatic()
g_pUIDialog:AddControl( g_pStatic_Velder_DG )
g_pStatic_Velder_DG:SetName( "Class_121" )

g_pPicture_Icon05 = g_pUIDialog:CreatePicture()
g_pStatic_Velder_DG:AddPicture( g_pPicture_Icon05 )
g_pPicture_Icon05:SetTex( "DLG_UI_Common_Texture16_NEW.TGA", "R_SLAYER_ICON" )
g_pPicture_Icon05:SetPoint
{
	"LEFT_TOP		= D3DXVECTOR2(0,0)",
	"COLOR			= D3DXCOLOR(1.0,1.0,1.0,1.0)",
